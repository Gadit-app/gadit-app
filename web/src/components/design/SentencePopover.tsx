...
const COPY: Record<string, { title: string; loading: string; error: string; login: string }> = {
  ...
  cs: { title: "Co tato věta znamená", loading: "Načítání…", error: "Nepodařilo se načíst. Zkuste to znovu.", login: "Přihlaste se, abyste to mohli použít." },
  sk: { title: "Čo znamená táto veta", loading: "Načítava sa…", error: "Nepodarilo sa načítať. Skúste to znova.", login: "Prihláste sa, aby ste to mohli použiť." },
  it: { title: "Cosa significa questa frase", loading: "Lettura…", error: "Impossibile caricare. Riprova.", login: "Accedi per usare questa funzione." },
  ja: { title: "この文の意味", loading: "読み込み中…", error: "読み込めませんでした。もう一度お試しください。", login: "ご利用にはログインしてください。" },
  hi: { title: "इस वाक्य का मतलब", loading: "पढ़ा जा रहा है…", error: "लोड नहीं हो सका। फिर से कोशिश करें।", login: "इसका उपयोग करने के लिए साइन इन करें।" },
  am: { title: "ይህ ዓረፍተ ነገር ምን ማለት ነው", loading: "በማንበብ ላይ…", error: "መጫን አልተቻለም። እንደገና ይሞክሩ።", login: "ይህን ለመጠቀም ይግቡ።" },
  tr: { title: "Bu cümle ne anlama geliyor", loading: "Okunuyor…", error: "Yüklenemedi. Tekrar deneyin.", login: "Bunu kullanmak için giriş yapın." },
  pl: { title: "Co oznacza to zdanie", loading: "Czytanie…", error: "Nie udało się wczytać. Spróbuj ponownie.", login: "Zaloguj się, aby z tego skorzystać." },
  id: { title: "Arti kalimat ini", loading: "Membaca…", error: "Gagal memuat. Coba lagi.", login: "Masuk untuk menggunakan fitur ini." },
  nl: { title: "Wat deze zin betekent", loading: "Lezen…", error: "Laden mislukt. Probeer het opnieuw.", login: "Log in om dit te gebruiken." },
  el: { title: "Τι σημαίνει αυτή η πρόταση", loading: "Ανάγνωση…", error: "Η φόρτωση απέτυχε. Δοκίμασε ξανά.", login: "Συνδέσου για να το χρησιμοποιήσεις." },
  zu: { title: "Lo musho usho ukuthini", loading: "Kuyafundwa…", error: "Akukwazanga ukulayisha. Zama futhi.", login: "Ngena ukuze usebenzise lokhu." },
  vi: { title: "Câu này có nghĩa là gì", loading: "Đang đọc…", error: "Không tải được. Hãy thử lại.", login: "Đăng nhập để dùng tính năng này." },
  fil: { title: "Ano ang ibig sabihin ng pangungusap na ito", loading: "Binabasa…", error: "Hindi ma-load. Subukang muli.", login: "Mag-sign in para magamit ito." },
  af: { title: "Wat hierdie sin beteken", loading: "Lees tans…", error: "Kon nie laai nie. Probeer weer.", login: "Meld aan om dit te gebruik." },
  sw: { title: "Sentensi hii inamaanisha nini", loading: "Inasoma…", error: "Imeshindwa kupakia. Jaribu tena.", login: "Ingia ili kutumia hiki." },
  "zh-CN": { title: "这句话的意思", loading: "正在读取…", error: "无法加载，请重试。", login: "登录后即可使用。" },
  "zh-TW": { title: "這句話的意思", loading: "正在讀取…", error: "無法載入，請再試一次。", login: "登入後即可使用。" },
  ko: { title: "이 문장의 뜻", loading: "읽는 중…", error: "불러오지 못했어요. 다시 시도해 주세요.", login: "로그인하면 사용할 수 있어요." },
  th: { title: "ประโยคนี้หมายความว่าอะไร", loading: "กำลังอ่าน…", error: "โหลดไม่สำเร็จ ลองอีกครั้ง", login: "เข้าสู่ระบบเพื่อใช้งาน" },
  bn: { title: "এই বাক্যের অর্থ কী", loading: "পড়া হচ্ছে…", error: "লোড করা যায়নি। আবার চেষ্টা করুন।", login: "এটি ব্যবহার করতে সাইন ইন করুন।" },
  da: { title: "Hvad denne sætning betyder", loading: "Læser…", error: "Kunne ikke indlæses. Prøv igen.", login: "Log ind for at bruge dette." },
  hu: { title: "Mit jelent ez a mondat", loading: "Olvasás…", error: "Nem sikerült betölteni. Próbáld újra.", login: "Jelentkezz be a használathoz." },
};
