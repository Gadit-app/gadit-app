...
const T: Record<string, {
  ...
  he: {
    ...
    lede: "אם יש לילד מורה פרטי או מאמן לשיפור מיומנויות למידה, אפשר לתת לו גישה לפרופיל של הילד כדי להוסיף מילים במהלך השיעורים. אפשר לבטל בכל רגע.",
