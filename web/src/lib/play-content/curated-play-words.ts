...
const CURATED_ADULT_EN: PlayWord[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      "Guests lingered at the doorway, sharing one last story.",
      "A doubt lingered in the back of her mind.",
    ],
    uiLang: "en",
  },
  {
...
const CURATED_ADULT_HE: PlayWord[] = [
  ...
  },
  {
    word: "בהירות",
    language: "he",
    meaning: "בהירות מחשבה או ביטוי, ללא בלבול",
    examples: [
      "הסבירה את הבעיה בבהירות כזאת שכולם הבינו.",
      "אחרי שינה טובה הבהירות שלי חוזרת.",
      "המסמך זקוק לעריכה כדי להגיע לבהירות.",
    ],
    uiLang: "he",
  },
  {
  ...
  },
  {
    ...
    examples: [
      "בבהלה היא שכחה איפה השאירה את המפתחות.",
      "הבהלה שאחזה בשוק גרמה למכירות חסרות שיקול דעת.",
      "הכלב ברח מהבית בבהלה כשהתחילו הזיקוקים.",
    ],
    uiLang: "he",
  },
  {
...
const CURATED_KIDS_HE: PlayWord[] = [
  ...
  },
  {
    ...
    examples: [
      "היתה לך תשובה חכמה מאוד למורה.",
      "השועל החכם מצא אוכל גם בחורף.",
      "החכם באמת יודע גם להקשיב.",
    ],
    uiLang: "he",
  },
  {
  ...
  },
  {
    ...
    examples: [
      "בואו נחלוק את העוגיות עם כולם.",
      "הוא חלק איתה מטריה כשהתחיל גשם.",
      "חלוקה של צעצועים הופכת את המשחק ליותר כיף.",
    ],
    uiLang: "he",
  },
  {
    ...
    examples: [
      "תקשיב לפעמון של בית הספר.",
      "כשמקשיבים טוב, מבינים אחד את השני.",
      "התינוק הקשיב לתיבת המוזיקה בסקרנות.",
    ],
    uiLang: "he",
  },
  {
