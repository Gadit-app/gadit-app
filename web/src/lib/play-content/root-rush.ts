...
// ─── Russian content ───────────────────────────────────────────
// Russian roots offer rich derivational families. The game shows how
// a single Slavic root spawns dozens of modern words, while visually
// similar words come from different roots entirely.
const ROOT_RUSH_ROUNDS_RU: RootRushRound[] = [
  {
    root: "ПИС-",
    origin: "праславянский",
    meaning: "писать, записывать",
    correct: ["писатель", "письмо", "описание"],
    distractors: ["писк", "пища", "пистолет"],
    story: "Корень ПИС восходит к индоевропейскому *peik (резать, метить). Писатель, письмо, описание — все от одного корня. Писк, пища и пистолет — другие истории.",
  },
  {
    root: "ХОД-",
    origin: "праславянский",
    meaning: "идти, двигаться",
    correct: ["ходить", "поход", "выход"],
    distractors: ["хобби", "холод", "хорошо"],
    story: "ХОД — один из самых продуктивных корней русского языка. Ходить, поход, выход, переход, заход. Хобби, холод, хорошо — совсем другие корни.",
  },
  {
    root: "УЧ-",
    origin: "праславянский",
    meaning: "учить, учиться, знание",
    correct: ["учитель", "ученик", "наука"],
    distractors: ["участок", "удача", "узел"],
    story: "От УЧ происходят: учитель (тот, кто учит), ученик (тот, кто учится), учёба, наука, изучение. Участок — от ЧАСТ, удача — от ДА, узел — от УЗ.",
  },
  {
    root: "ВОД-",
    origin: "праславянский",
    meaning: "вести, направлять",
    correct: ["водитель", "проводник", "руководитель"],
    distractors: ["вода", "вода (питьё)", "водоросль"],
    story: "Тонкий случай: ВОД может значить «вести» (водитель) или «воду» (вода). По форме почти одинаковы, по происхождению — разные. Водитель ведёт, вода — пьём.",
  },
  {
    root: "ДОМ-",
    origin: "праславянский",
    meaning: "жилище, дом",
    correct: ["домашний", "домовой", "домовладелец"],
    distractors: ["думать", "доход", "дорога"],
    story: "От ДОМ — самый родной корень. Домашний, домовой, домохозяйка, бездомный. Думать и доход — от других корней, лишь созвучных.",
  },
  {
    root: "РУК-",
    origin: "праславянский",
    meaning: "рука, действие рукой",
    correct: ["ручка", "поручение", "рукопожатие"],
    distractors: ["румяный", "руины", "рубль"],
    story: "РУК даёт ручку, рукопожатие, рукав, поручение. Румяный — от РУМ (красный цвет щёк), руины — латинское заимствование, рубль — от РУБ (рубить).",
  },
  {
    root: "ИГР-",
    origin: "праславянский",
    meaning: "играть, развлекаться",
    correct: ["игра", "игрушка", "выигрыш"],
    distractors: ["игла", "иго", "идея"],
    story: "От ИГР: игра, игрушка, играть, выигрыш, проигрыш, разыграть. Игла — от ИГЛ (острый предмет), иго — от ИГ (бремя), идея — греческое.",
  },
  {
    root: "СВЕТ-",
    origin: "праславянский",
    meaning: "свет, светить",
    correct: ["светлый", "рассвет", "освещение"],
    distractors: ["свежий", "свеча", "святой"],
    story: "СВЕТ даёт светлый, рассвет, освещение, светофор. Свеча от того же корня — она светит. Свежий и святой — разные корни, лишь похожие звуком.",
  },
  {
    root: "РАБОТ-",
    origin: "праславянский",
    meaning: "работать, труд",
    correct: ["рабочий", "заработок", "обработка"],
    distractors: ["раб", "радость", "ракета"],
    story: "Корень РАБОТ происходит от РАБ (раб делал работу). Раб, рабство — однокоренные. Радость и ракета — совершенно разные источники.",
  },
  {
    root: "ЛЕС-",
    origin: "праславянский",
    meaning: "лес, древесина",
    correct: ["лесной", "лесник", "лесопилка"],
    distractors: ["лестница", "лето", "лесть"],
    story: "ЛЕС даёт лесной, лесник, лесопилка, перелесок. Лестница — от ЛЕЗТ (лезть наверх), лето — от ЛЕТ, лесть — от ЛЕСТ (хитрость).",
  },
];
