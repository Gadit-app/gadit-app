...
// ─── Russian content ───────────────────────────────────────────
// Russian intensity ladders. Each axis goes from soft to extreme,
// teaching the precise register that distinguishes a good writer
// from a clumsy one. Russian has unusually fine gradations for
// emotional states — emotions occupy a central place in the culture.
const SHADE_SLIDER_ROUNDS_RU: ShadeSliderRound[] = [
  {
    axis: "счастье",
    ladder: ["довольный", "весёлый", "радостный", "счастливый", "восторженный"],
    story: "Довольный — спокойное удовлетворение. Восторженный — открытое восхищение. Лестница помогает писать живее: вместо абстрактного «счастливый» можно выбрать точное слово.",
  },
  {
    axis: "гнев",
    ladder: ["раздражённый", "сердитый", "злой", "разъярённый", "взбешённый"],
    story: "Раздражённый забывает через час. Взбешённый рушит мебель. Русский язык исключительно богат словами гнева — это часть культурного кода.",
  },
  {
    axis: "грусть",
    ladder: ["огорчённый", "печальный", "грустный", "удручённый", "подавленный"],
    story: "Огорчённый из-за случая. Подавленный — психологическое состояние, требующее времени. Лестница как карта внутренней погоды.",
  },
  {
    axis: "усталость",
    ladder: ["вялый", "уставший", "утомлённый", "измотанный", "обессиленный"],
    story: "Вялый — нужно вздремнуть. Обессиленный — нужно несколько дней отдыха. Лестница работает как самопроверка: где я сейчас?",
  },
  {
    axis: "холод",
    ladder: ["прохладный", "холодный", "морозный", "ледяной", "арктический"],
    story: "Прохладный — приятный летом. Арктический — опасный для жизни. Русский язык — язык людей, прекрасно понимающих, что такое холод.",
  },
  {
    axis: "жара",
    ladder: ["тёплый", "жаркий", "горячий", "знойный", "испепеляющий"],
    story: "Тёплый — комфортный. Испепеляющий — поэтическая гипербола. Лестница работает и в прямом, и в переносном смысле (горячий спор, испепеляющий взгляд).",
  },
  {
    axis: "размер (большой)",
    ladder: ["немалый", "большой", "огромный", "громадный", "колоссальный"],
    story: "Немалый — больше среднего. Колоссальный — превосходящий описание. Все пять означают «больше нормы», но степень и регистр различаются.",
  },
  {
    axis: "красота",
    ladder: ["милый", "красивый", "прекрасный", "великолепный", "ослепительный"],
    story: "Милый — мягкий комплимент. Ослепительный — останавливает движение. Лестница комплиментов: подбирай по моменту, чтобы не выглядеть наигранно.",
  },
  {
    axis: "страх",
    ladder: ["обеспокоенный", "встревоженный", "испуганный", "ужасающийся", "оцепенелый"],
    story: "Обеспокоенный — лёгкая тревога. Оцепенелый — буквальный паралич от страха. Лестница описывает и эмоциональное, и физиологическое состояние.",
  },
  {
    axis: "ум",
    ladder: ["сообразительный", "умный", "блестящий", "выдающийся", "гениальный"],
    story: "Сообразительный схватывает на лету. Гениальный создаёт то, чего раньше не было. Шкала идёт от ловкости к творческой мощи.",
  },
];
