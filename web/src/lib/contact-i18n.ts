...
Object.assign(CONTACT, {
  ...
  he: {
    ...
    faq: [
      {
        q: "מה זה Gadit?",
        a: "Gadit הוא מילון חכם שהולך הרבה מעבר להגדרה רגילה. מקבלים הגדרות ברורות, דוגמאות מהחיים, אטימולוגיה (מקור המילה), ניבים וצירופי מילים, הסבר לילדים, המחשה בתמונות, תרגול משפטים עם פידבק, וחידונים קצרים. ותכונות חדשות שמתווספות כל הזמן כדי לוודא שכל אחד מבין מילים עד הסוף.",
      },
      {
