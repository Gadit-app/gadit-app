      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: [
              "Top right of any page, you'll see a small flag icon (or your current language name). Tap it and pick from 21 languages: English, Hebrew, Arabic, Russian, Spanish, Portuguese, French, German, Czech, Slovak, Italian, Japanese, Hindi, Amharic.",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: [
              "בפינה הימנית-עליונה של כל עמוד תראו אייקון קטן של דגל (או את שם השפה הנוכחית). לחצו עליו ובחרו מתוך 21 שפות: עברית, אנגלית, ערבית, רוסית, ספרדית, פורטוגזית, צרפתית, גרמנית, צ'כית, סלובקית, איטלקית, יפנית, הינדי, אמהרית.",
