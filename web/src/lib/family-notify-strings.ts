...
export const NOTIF_STRINGS: Record<string, NotifStrings> = {
  ...
  vi: {
    instantTitle: "{kid} vừa tra một từ",
    instantSubject: "{kid} đã tra: {word}",
    instantLead: "{kid} vừa tra một từ trong từ điển:",
    digestTitle: "Tóm tắt hôm nay: {n} từ",
    digestLead: "Những từ các con đã tra hôm nay:",
  },
  fil: {
    instantTitle: "Naghanap si {kid} ng salita",
    instantSubject: "Hinanap ni {kid}: {word}",
    instantLead: "Kakahanap lang ni {kid} ng salita sa diksiyonaryo:",
    digestTitle: "Buod ngayong araw: {n}",
    digestLead: "Mga salitang hinanap ng mga anak mo ngayong araw:",
  },
  af: {
    instantTitle: "{kid} het 'n woord opgesoek",
    instantSubject: "{kid} het opgesoek: {word}",
    instantLead: "{kid} het pas 'n woord in die woordeboek opgesoek:",
    digestTitle: "Vandag se opsomming: {n}",
    digestLead: "Woorde wat jou kinders vandag opgesoek het:",
  },
  sw: {
    instantTitle: "{kid} ametafuta neno",
    instantSubject: "{kid} ametafuta: {word}",
    instantLead: "{kid} ametafuta neno sasa hivi katika kamusi:",
    digestTitle: "Muhtasari wa leo: {n}",
    digestLead: "Maneno ambayo watoto wako wametafuta leo:",
  },
  "zh-CN": {
    instantTitle: "{kid} 查了一个词",
    instantSubject: "{kid} 查了：{word}",
    instantLead: "{kid} 刚刚在词典里查了一个词：",
    digestTitle: "今日总结：{n} 个词",
    digestLead: "孩子们今天查过的词：",
  },
  "zh-TW": {
    instantTitle: "{kid} 查了一個字詞",
    instantSubject: "{kid} 查了：{word}",
    instantLead: "{kid} 剛剛在字典裡查了一個字詞：",
    digestTitle: "今日摘要：{n} 個字詞",
    digestLead: "孩子們今天查過的字詞：",
  },
  ko: {
    instantTitle: "{kid}의 새 단어 검색",
    instantSubject: "{kid}의 검색: {word}",
    instantLead: "{kid}이(가) 방금 사전에서 단어를 찾아봤어요:",
    digestTitle: "오늘의 요약: 단어 {n}개",
    digestLead: "오늘 아이들이 찾아본 단어:",
  },
  th: {
    instantTitle: "{kid} ค้นหาคำศัพท์",
    instantSubject: "{kid} ค้นหา: {word}",
    instantLead: "{kid} เพิ่งค้นหาคำศัพท์ในพจนานุกรม:",
    digestTitle: "สรุปวันนี้: {n} คำ",
    digestLead: "คำที่ลูก ๆ ค้นหาวันนี้:",
  },
  bn: {
    instantTitle: "{kid} একটি শব্দ খুঁজেছে",
    instantSubject: "{kid} খুঁজেছে: {word}",
    instantLead: "{kid} এইমাত্র অভিধানে একটি শব্দ খুঁজেছে:",
    digestTitle: "আজকের সারসংক্ষেপ: {n}টি শব্দ",
    digestLead: "আপনার সন্তানেরা আজ যে শব্দগুলো খুঁজেছে:",
  },
  da: {
    instantTitle: "{kid} slog et ord op",
    instantSubject: "{kid} slog op: {word}",
    instantLead: "{kid} har lige slået et ord op i ordbogen:",
    digestTitle: "Dagens opsummering: {n} ord",
    digestLead: "Ord, dine børn slog op i dag:",
  },
  hu: {
    instantTitle: "{kid} rákeresett egy szóra",
    instantSubject: "{kid} keresése: {word}",
    instantLead: "{kid} most keresett rá egy szóra a szótárban:",
    digestTitle: "A mai összefoglaló: {n} szó",
    digestLead: "Szavak, amelyekre a gyerekeid ma rákerestek:",
  },
};
