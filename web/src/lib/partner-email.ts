...
export const DEFAULT_WELCOME_CONFIG: WelcomeConfig = {
  he: {
    ...
    opening: "הנה כל מה שצריך כדי להתחיל. Gadit הוא מילון חכם ובטוח לילדים ב-30+ שפות, עם דוגמאות, תמונות ומחברת אישית שעוזרת לילד באמת להבין מילים.",
  ...
  en: {
    ...
    opening: "Here's everything you need to start. Gadit is a smart, child-safe dictionary in 30+ languages, with examples, pictures and a personal notebook that helps a child truly understand words.",
  ...
  nl: {
    ...
    opening: "Hier is alles wat je nodig hebt om te beginnen. Gadit is een slim, kindveilig woordenboek in 30+ talen, met voorbeelden, plaatjes en een persoonlijk notitieboek dat een kind helpt woorden echt te begrijpen.",
  ...
  ar: {
    ...
    opening: "هذا كل ما تحتاجه للبدء. Gadit قاموس ذكي وآمن للأطفال بـ30+ لغة، مع أمثلة وصور ودفتر شخصي يساعد الطفل على فهم الكلمات فهماً حقيقياً.",
  ...
  ru: {
    ...
    opening: "Здесь всё, что нужно для старта. Gadit это умный, безопасный для детей словарь на 30+ языках, с примерами, картинками и личной тетрадью, которая помогает ребёнку по-настоящему понять слова.",
  ...
  es: {
    ...
    opening: "Aquí tienes todo lo que necesitas para empezar. Gadit es un diccionario inteligente y seguro para niños en 30+ idiomas, con ejemplos, imágenes y un cuaderno personal que ayuda a cada niño a entender de verdad las palabras.",
  ...
  pt: {
    ...
    opening: "Aqui está tudo o que você precisa para começar. A Gadit é um dicionário inteligente e seguro para crianças em 30+ idiomas, com exemplos, imagens e um caderno pessoal que ajuda a criança a entender de verdade as palavras.",
  ...
  fr: {
    ...
    opening: "Voici tout ce qu'il vous faut pour commencer. Gadit est un dictionnaire intelligent et sûr pour les enfants, en 30+ langues, avec des exemples, des images et un carnet personnel qui aide l'enfant à vraiment comprendre les mots.",
  ...
  de: {
    ...
    opening: "Hier ist alles, was du für den Start brauchst. Gadit ist ein smartes, kindersicheres Wörterbuch in 30+ Sprachen, mit Beispielen, Bildern und einem persönlichen Notizbuch, das einem Kind hilft, Wörter wirklich zu verstehen.",
  ...
  it: {
    ...
    opening: "Ecco tutto ciò che ti serve per iniziare. Gadit è un dizionario intelligente e sicuro per i bambini in 30+ lingue, con esempi, immagini e un quaderno personale che aiuta il bambino a capire davvero le parole.",
  ...
  ja: {
    ...
    opening: "始めるために必要なものをすべてご用意しました。Gadit は 30+ 言語に対応した、子どもにも安心してお使いいただける賢い辞書です。例文や画像、そして子どもが言葉を本当に理解できるように手助けする専用ノートが備わっています。",
  ...
  hi: {
    ...
    opening: "शुरू करने के लिए जो कुछ आपको चाहिए, वह सब यहाँ है। Gadit 30+ भाषाओं में एक स्मार्ट, बच्चों के लिए सुरक्षित डिक्शनरी है, जिसमें उदाहरण, तस्वीरें और एक निजी नोटबुक है, जो बच्चे को शब्दों को सचमुच समझने में मदद करती है।",
  ...
  am: {
    ...
    opening: "ለመጀመር የሚያስፈልግህ ሁሉ ይኸውልህ። Gadit በ30+ ቋንቋዎች ብልህና ለልጆች ደህንነቱ የተጠበቀ መዝገበ ቃላት ነው, ከምሳሌዎች, ስዕሎችና ልጅ ቃላትን በእውነት እንዲረዳ ከሚያግዝ የግል ማስታወሻ ደብተር ጋር።",
  ...
  uk: {
    ...
    opening: "Ось усе, що потрібно для старту. Gadit це розумний, безпечний для дітей словник 30+ мовами, з прикладами, зображеннями та особистим зошитом, який допомагає дитині по-справжньому зрозуміти слова.",
  ...
  tr: {
    ...
    opening: "Başlamak için ihtiyacın olan her şey burada. Gadit, örnekler, görseller ve bir çocuğun kelimeleri gerçekten anlamasına yardımcı olan kişisel bir defterle, 30+ dilde akıllı ve çocuklar için güvenli bir sözlüktür.",
  ...
  pl: {
    ...
    opening: "Oto wszystko, czego potrzebujesz na start. Gadit to inteligentny, bezpieczny dla dzieci słownik w 30+ językach, z przykładami, obrazkami i osobistym zeszytem, który pomaga dziecku naprawdę zrozumieć słowa.",
  ...
  id: {
    ...
    opening: "Inilah semua yang kamu butuhkan untuk mulai. Gadit adalah kamus cerdas dan aman untuk anak dalam 30+ bahasa, dengan contoh, gambar, dan buku catatan pribadi yang membantu anak benar-benar memahami kata.",
  ...
  el: {
    ...
    opening: "Εδώ είναι όλα όσα χρειάζεσαι για να ξεκινήσεις. Το Gadit είναι ένα έξυπνο, ασφαλές για παιδιά λεξικό σε 30+ γλώσσες, με παραδείγματα, εικόνες και ένα προσωπικό σημειωματάριο που βοηθά το παιδί να καταλάβει πραγματικά τις λέξεις.",
  ...
  vi: {
    subject: "Bạn đã tham gia. Đây là liên kết đối tác Gadit của bạn 🤝",
    greeting: "Thật vui khi có bạn trong Chương trình Đối tác Gadit 🤝",
    opening: "Đây là mọi thứ bạn cần để bắt đầu. Gadit là cuốn từ điển thông minh, an toàn cho trẻ em với hơn 30 ngôn ngữ, có ví dụ, hình ảnh và sổ tay cá nhân giúp trẻ thật sự hiểu từ ngữ.",
    noteUnderLink: "Mọi người đăng ký và thanh toán qua liên kết này đều tự động được ghi nhận cho bạn. Liên kết không bao giờ hiển thị tên của bạn.",
    commissionLine: "Hoa hồng của bạn: {pctY1}% mỗi khoản thanh toán trong năm đầu, sau đó {pctAfter}% chừng nào gia đình còn ở lại.",
    commissionExplain: "Ví dụ, một gia đình tham gia gói Family và ở lại một năm mang lại cho bạn hơn {year1}. Và chừng nào gia đình đó còn đăng ký, chúng tôi tại Gadit tiếp tục trả hoa hồng cho bạn từ gói của họ, tháng này qua tháng khác. Không phải khoản trả một lần, mà là thu nhập tiếp diễn.",
    year1Est: "$60",
    dashboardNote: "Tại đó bạn xem được lượt nhấp, lượt đăng ký và thu nhập theo thời gian thực. Không cần đăng nhập, bảng điều khiển là riêng tư của bạn.",
    tipsHeader: "3 điều giúp bạn lan tỏa",
    tip1: "Nhắc đến Gadit ở nơi phụ huynh vốn đã lắng nghe bạn. Một nhóm WhatsApp, một bài đăng, một cuộc trò chuyện riêng.",
    tip2: "Nỗi lo mà phụ huynh nào cũng biết: trẻ gặp một từ không hiểu và bỏ cuộc. Gadit giúp trẻ tự hiểu, bằng ngôn ngữ của mình.",
    tip3: "Có cách bắt đầu miễn phí, nên rất dễ giới thiệu mà không có rào cản nào.",
    closing: "Có câu hỏi gì, bạn chỉ cần trả lời email này. Đội ngũ của chúng tôi luôn ở đây.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Nhà sáng lập, Gadit",
  },
  fil: {
    subject: "Kasali ka na. Narito ang Gadit partner link mo 🤝",
    greeting: "Masaya kaming kasama ka sa Gadit Partner Program 🤝",
    opening: "Narito ang lahat ng kailangan mo para magsimula. Ang Gadit ay isang matalino at ligtas na diksiyonaryo para sa mga bata sa 30+ na wika, may mga halimbawa, larawan at personal na notebook na tumutulong sa bata na talagang maunawaan ang mga salita.",
    noteUnderLink: "Lahat ng mag-sign up at magbayad dito ay awtomatikong maikukredito sa iyo. Hindi kailanman ipinapakita ng link ang pangalan mo.",
    commissionLine: "Ang komisyon mo: {pctY1}% ng bawat bayad sa unang taon, {pctAfter}% pagkatapos habang nananatili ang pamilya.",
    commissionExplain: "Halimbawa, ang isang pamilyang sumali sa Family plan at nanatili nang isang taon ay may halagang higit sa {year1} para sa iyo. At habang naka-subscribe ang pamilyang iyon, patuloy ka naming binabayaran sa Gadit ng komisyon mula sa subscription nila, buwan-buwan. Hindi isang beses na bayad, kundi kitang nagpapatuloy.",
    year1Est: "$60",
    dashboardNote: "Makikita mo roon ang mga click, sign-up at kita nang real time. Hindi kailangang mag-log in, pribado sa iyo ang dashboard.",
    tipsHeader: "3 bagay na tutulong sa iyong ikalat ito",
    tip1: "Banggitin ito kung saan nakikinig na sa iyo ang mga magulang. Isang WhatsApp group, isang post, isang personal na usapan.",
    tip2: "Ang problemang alam ng bawat magulang: nakakita ang bata ng salitang hindi niya maintindihan at sumuko. Tinutulungan siya ng Gadit na umunawa nang mag-isa, sa sarili niyang wika.",
    tip3: "May libreng paraan para magsimula, kaya madali itong irekomenda nang walang hadlang.",
    closing: "Kung may tanong, sagutin lang ang email na ito. Narito ang aming team para sa iyo.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Founder, Gadit",
  },
  af: {
    subject: "Jy is in. Hier is jou Gadit-vennootskakel 🤝",
    greeting: "Wonderlik om jou in die Gadit Vennootprogram te hê 🤝",
    opening: "Hier is alles wat jy nodig het om te begin. Gadit is 'n slim, kindveilige woordeboek in 30+ tale, met voorbeelde, prente en 'n persoonlike notaboek wat 'n kind help om woorde werklik te verstaan.",
    noteUnderLink: "Elkeen wat daardeur inteken en betaal, word outomaties aan jou toegeskryf. Die skakel wys nooit jou naam nie.",
    commissionLine: "Jou kommissie: {pctY1}% van elke betaling in die eerste jaar, daarna {pctAfter}% solank die gesin bly.",
    commissionExplain: "Byvoorbeeld, een gesin wat by die Family-plan aansluit en 'n jaar bly, is meer as {year1} vir jou werd. En solank daardie gesin ingeteken bly, betaal ons by Gadit jou steeds kommissie op hul intekening, maand na maand. Nie 'n eenmalige uitbetaling nie, maar inkomste wat aanhou.",
    year1Est: "$60",
    dashboardNote: "Jy kan daar klikke, intekeninge en verdienste intyds sien. Geen aanmelding nodig nie, die paneelbord is privaat vir jou.",
    tipsHeader: "3 dinge wat jou help om die woord te versprei",
    tip1: "Noem dit waar ouers reeds na jou luister. 'n WhatsApp-groep, 'n plasing, 'n persoonlike gesprek.",
    tip2: "Die pyn wat elke ouer ken: 'n kind kry 'n woord wat hy of sy nie verstaan nie en gee op. Gadit laat die kind self verstaan, in hul eie taal.",
    tip3: "Daar is 'n gratis manier om te begin, so dit is maklik om sonder enige hindernis aan te beveel.",
    closing: "Enige vraag, antwoord net op hierdie e-pos. Ons span is hier vir jou.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Stigter, Gadit",
  },
  sw: {
    subject: "Umejiunga. Hiki hapa kiungo chako cha mshirika wa Gadit 🤝",
    greeting: "Tunafurahi kuwa nawe katika Mpango wa Washirika wa Gadit 🤝",
    opening: "Hapa kuna kila kitu unachohitaji ili kuanza. Gadit ni kamusi mahiri na salama kwa watoto katika lugha 30+, yenye mifano, picha na daftari binafsi linalomsaidia mtoto kuelewa maneno kwa kweli.",
    noteUnderLink: "Kila anayejisajili na kulipa kupitia kiungo hiki anahesabiwa kwako moja kwa moja. Kiungo hakionyeshi jina lako kamwe.",
    commissionLine: "Kamisheni yako: {pctY1}% ya kila malipo katika mwaka wa kwanza, kisha {pctAfter}% kwa muda wote familia inapobaki.",
    commissionExplain: "Kwa mfano, familia moja inayojiunga na mpango wa Family na kubaki mwaka mmoja ina thamani ya zaidi ya {year1} kwako. Na kwa muda wote familia hiyo inapoendelea na usajili, sisi wa Gadit tunaendelea kukulipa kamisheni kwa usajili wao, mwezi baada ya mwezi. Si malipo ya mara moja, bali mapato yanayoendelea.",
    year1Est: "$60",
    dashboardNote: "Huko unaweza kuona mibofyo, usajili na mapato kwa wakati halisi. Hakuna haja ya kuingia, dashibodi ni yako binafsi.",
    tipsHeader: "Mambo 3 yanayokusaidia kueneza habari",
    tip1: "Litaje mahali ambapo wazazi tayari wanakusikiliza. Kikundi cha WhatsApp, chapisho, mazungumzo ya ana kwa ana.",
    tip2: "Tatizo analolijua kila mzazi: mtoto anakutana na neno asiloelewa na kukata tamaa. Gadit inamwezesha kuelewa mwenyewe, kwa lugha yake.",
    tip3: "Kuna njia ya bure ya kuanza, kwa hiyo ni rahisi kupendekeza bila kizuizi chochote.",
    closing: "Swali lolote, jibu tu barua pepe hii. Timu yetu iko hapa kwa ajili yako.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Mwanzilishi, Gadit",
  },
  "zh-CN": {
    subject: "加入成功，这是你的 Gadit 合作伙伴链接 🤝",
    greeting: "欢迎加入 Gadit 合作伙伴计划 🤝",
    opening: "开始所需的一切都在这里。Gadit 是一款聪明、对孩子安全的词典，支持 30+ 种语言，配有例句、图片和个人单词本，帮助孩子真正理解每个词。",
    noteUnderLink: "每位通过它注册并付费的人都会自动记在你名下。链接中永远不会显示你的名字。",
    commissionLine: "你的佣金：第一年每笔付款的 {pctY1}%，之后只要这个家庭继续订阅，就是 {pctAfter}%。",
    commissionExplain: "例如，一个加入 Family 方案并留存一年的家庭，能为你带来超过 {year1} 的收益。只要这个家庭继续订阅，我们 Gadit 就会每个月持续为他们的订阅向你支付佣金。这不是一次性报酬，而是持续的收入。",
    year1Est: "$60",
    dashboardNote: "你可以在那里实时查看点击、注册和收益。无需登录，控制台仅你本人可见。",
    tipsHeader: "帮你传播的 3 个方法",
    tip1: "在家长已经信任你的地方提起它。一个 WhatsApp 群、一篇帖子、一次私下聊天。",
    tip2: "每位家长都熟悉的痛点：孩子遇到一个不懂的词，就放弃了。Gadit 让孩子用自己的语言，自己读懂。",
    tip3: "可以免费开始，所以推荐起来毫无门槛。",
    closing: "有任何问题，直接回复这封邮件即可。我们的团队随时在这里。",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Gadit 创始人",
  },
  "zh-TW": {
    subject: "加入成功，這是你的 Gadit 合作夥伴連結 🤝",
    greeting: "歡迎加入 Gadit 合作夥伴計畫 🤝",
    opening: "開始所需的一切都在這裡。Gadit 是一款聰明、對孩子安全的字典，支援 30+ 種語言，附有例句、圖片和個人單字本，幫助孩子真正理解每個詞。",
    noteUnderLink: "每位透過它註冊並付費的人都會自動記在你名下。連結中永遠不會顯示你的名字。",
    commissionLine: "你的佣金：第一年每筆付款的 {pctY1}%，之後只要這個家庭繼續訂閱，就是 {pctAfter}%。",
    commissionExplain: "例如，一個加入 Family 方案並留下一年的家庭，能為你帶來超過 {year1} 的收益。只要這個家庭繼續訂閱，我們 Gadit 就會每個月持續為他們的訂閱向你支付佣金。這不是一次性報酬，而是持續的收入。",
    year1Est: "$60",
    dashboardNote: "你可以在那裡即時查看點擊、註冊和收益。無需登入，控制台僅限你本人查看。",
    tipsHeader: "幫你推廣的 3 個方法",
    tip1: "在家長已經信任你的地方提起它。一個 WhatsApp 群組、一篇貼文、一次私下聊天。",
    tip2: "每位家長都熟悉的痛點：孩子遇到一個看不懂的詞，就放棄了。Gadit 讓孩子用自己的語言，自己讀懂。",
    tip3: "可以免費開始，所以推薦起來毫無門檻。",
    closing: "有任何問題，直接回覆這封郵件即可。我們的團隊隨時都在。",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Gadit 創辦人",
  },
  ko: {
    subject: "가입이 완료되었습니다. Gadit 파트너 링크를 보내드립니다 🤝",
    greeting: "Gadit 파트너 프로그램에 함께해 주셔서 반갑습니다 🤝",
    opening: "시작에 필요한 모든 것을 준비했습니다. Gadit은 30개 이상의 언어를 지원하는 똑똑하고 어린이에게 안전한 사전으로, 예문과 그림, 그리고 아이가 단어를 제대로 이해하도록 돕는 개인 단어장이 있습니다.",
    noteUnderLink: "이 링크로 가입하고 결제한 모든 분은 자동으로 내 실적으로 인정됩니다. 링크에는 이름이 절대 표시되지 않습니다.",
    commissionLine: "수수료: 첫해에는 모든 결제의 {pctY1}%, 이후에는 가족이 구독을 유지하는 동안 {pctAfter}%입니다.",
    commissionExplain: "예를 들어 Family 요금제에 가입해 1년 동안 이용한 한 가족은 {year1} 이상의 수익이 됩니다. 그리고 그 가족이 구독을 유지하는 한, 저희 Gadit은 매달 해당 구독에 대한 수수료를 계속 지급합니다. 한 번으로 끝나는 보상이 아니라 계속 이어지는 수입입니다.",
    year1Est: "$60",
    dashboardNote: "그곳에서 클릭, 가입, 수익을 실시간으로 확인할 수 있습니다. 로그인할 필요 없으며, 대시보드는 본인만 볼 수 있습니다.",
    tipsHeader: "널리 알리는 데 도움이 되는 3가지",
    tip1: "부모님들이 이미 귀 기울이는 곳에서 소개해 주세요. WhatsApp 그룹, 게시물, 개인적인 대화 등.",
    tip2: "모든 부모가 아는 고민, 아이가 모르는 단어를 만나면 포기해 버리는 것. Gadit은 아이가 자기 언어로 스스로 이해하도록 돕습니다.",
    tip3: "무료로 시작하는 방법이 있어서 부담 없이 추천하기 쉽습니다.",
    closing: "궁금한 점이 있으면 이 이메일에 회신만 해 주세요. 저희 팀이 언제나 함께합니다.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Gadit 창립자",
  },
  th: {
    subject: "เข้าร่วมเรียบร้อย นี่คือลิงก์พาร์ทเนอร์ Gadit ของคุณ 🤝",
    greeting: "ยินดีต้อนรับสู่โปรแกรมพาร์ทเนอร์ Gadit 🤝",
    opening: "นี่คือทุกอย่างที่คุณต้องใช้เพื่อเริ่มต้น Gadit คือพจนานุกรมอัจฉริยะที่ปลอดภัยสำหรับเด็กใน 30+ ภาษา พร้อมตัวอย่าง รูปภาพ และสมุดคำศัพท์ส่วนตัวที่ช่วยให้เด็กเข้าใจคำศัพท์ได้อย่างแท้จริง",
    noteUnderLink: "ทุกคนที่สมัครและชำระเงินผ่านลิงก์นี้จะถูกนับเป็นของคุณโดยอัตโนมัติ ลิงก์จะไม่แสดงชื่อของคุณเลย",
    commissionLine: "ค่าคอมมิชชันของคุณ: {pctY1}% ของทุกการชำระเงินในปีแรก จากนั้น {pctAfter}% ตราบเท่าที่ครอบครัวยังเป็นสมาชิก",
    commissionExplain: "ตัวอย่างเช่น ครอบครัวหนึ่งที่สมัครแพ็กเกจ Family และอยู่ครบหนึ่งปี มีค่าสำหรับคุณมากกว่า {year1} และตราบเท่าที่ครอบครัวนั้นยังเป็นสมาชิก เราที่ Gadit จะจ่ายค่าคอมมิชชันจากการสมัครสมาชิกของพวกเขาให้คุณต่อไปทุกเดือน ไม่ใช่การจ่ายครั้งเดียว แต่เป็นรายได้ที่ต่อเนื่อง",
    year1Est: "$60",
    dashboardNote: "คุณดูคลิก การสมัคร และรายได้ได้แบบเรียลไทม์ ไม่ต้องล็อกอิน แดชบอร์ดเป็นของคุณเท่านั้น",
    tipsHeader: "3 สิ่งที่ช่วยให้คุณบอกต่อได้",
    tip1: "พูดถึงในที่ที่พ่อแม่รับฟังคุณอยู่แล้ว เช่น กลุ่ม WhatsApp โพสต์ หรือการคุยส่วนตัว",
    tip2: "ปัญหาที่พ่อแม่ทุกคนรู้ดี คือเด็กเจอคำที่ไม่เข้าใจแล้วก็ถอดใจ Gadit ช่วยให้เด็กเข้าใจได้ด้วยตัวเอง ในภาษาของตัวเอง",
    tip3: "มีวิธีเริ่มต้นฟรี จึงแนะนำได้ง่ายโดยไม่มีอุปสรรค",
    closing: "มีคำถามใดๆ ตอบกลับอีเมลนี้ได้เลย ทีมของเราพร้อมช่วยเหลือเสมอ",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "ผู้ก่อตั้ง Gadit",
  },
  bn: {
    subject: "আপনি যুক্ত হয়েছেন। এই যে আপনার Gadit পার্টনার লিংক 🤝",
    greeting: "Gadit পার্টনার প্রোগ্রামে আপনাকে পেয়ে আমরা আনন্দিত 🤝",
    opening: "শুরু করতে যা যা দরকার, সব এখানে। Gadit হলো 30+ ভাষায় একটি স্মার্ট, শিশুদের জন্য নিরাপদ অভিধান, উদাহরণ, ছবি আর একটি ব্যক্তিগত নোটবুকসহ, যা শিশুকে শব্দ সত্যিই বুঝতে সাহায্য করে।",
    noteUnderLink: "এর মাধ্যমে যে-ই সাইন আপ করে পেমেন্ট করেন, তা স্বয়ংক্রিয়ভাবে আপনার নামে গণ্য হয়। লিংকে কখনো আপনার নাম দেখায় না।",
    commissionLine: "আপনার কমিশন: প্রথম বছরে প্রতিটি পেমেন্টের {pctY1}%, এরপর পরিবারটি যতদিন থাকে ততদিন {pctAfter}%।",
    commissionExplain: "যেমন, Family প্ল্যানে যোগ দিয়ে এক বছর থাকা একটি পরিবার আপনার জন্য {year1}-এর বেশি মূল্যবান। আর সেই পরিবার যতদিন সাবস্ক্রাইব করা থাকে, আমরা Gadit থেকে তাদের সাবস্ক্রিপশনের ওপর মাসের পর মাস আপনাকে কমিশন দিয়ে যাই। এককালীন পেমেন্ট নয়, চলতে থাকা আয়।",
    year1Est: "$60",
    dashboardNote: "সেখানে আপনি ক্লিক, সাইন আপ আর আয় রিয়েল টাইমে দেখতে পাবেন। লগইনের দরকার নেই, ড্যাশবোর্ড শুধু আপনার জন্য।",
    tipsHeader: "প্রচারে সাহায্য করে এমন 3টি বিষয়",
    tip1: "যেখানে অভিভাবকেরা আগে থেকেই আপনার কথা শোনেন, সেখানে এটি উল্লেখ করুন। একটি WhatsApp গ্রুপ, একটি পোস্ট, একটি ব্যক্তিগত আলাপ।",
    tip2: "যে কষ্ট প্রত্যেক অভিভাবক জানেন: শিশু একটি না-বোঝা শব্দে আটকে যায় আর হাল ছেড়ে দেয়। Gadit তাকে নিজের ভাষায়, নিজে নিজে বুঝতে দেয়।",
    tip3: "বিনামূল্যে শুরু করার উপায় আছে, তাই কোনো বাধা ছাড়াই সুপারিশ করা সহজ।",
    closing: "কোনো প্রশ্ন থাকলে শুধু এই ইমেইলের উত্তর দিন। আমাদের টিম আপনার পাশে আছে।",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "প্রতিষ্ঠাতা, Gadit",
  },
  da: {
    subject: "Du er med. Her er dit Gadit-partnerlink 🤝",
    greeting: "Dejligt at have dig med i Gadit Partnerprogram 🤝",
    opening: "Her er alt, hvad du behøver for at komme i gang. Gadit er en smart, børnesikker ordbog på 30+ sprog med eksempler, billeder og en personlig notesbog, der hjælper et barn med virkelig at forstå ord.",
    noteUnderLink: "Alle, der tilmelder sig og betaler via det, krediteres dig automatisk. Linket viser aldrig dit navn.",
    commissionLine: "Din provision: {pctY1}% af hver betaling det første år, derefter {pctAfter}% så længe familien bliver.",
    commissionExplain: "For eksempel er én familie, der tilmelder sig Family-planen og bliver et år, mere end {year1} værd for dig. Og så længe familien forbliver abonnent, bliver vi hos Gadit ved med at betale dig provision af deres abonnement, måned efter måned. Ikke en engangsudbetaling, men en indkomst der fortsætter.",
    year1Est: "$60",
    dashboardNote: "Der kan du se klik, tilmeldinger og indtjening i realtid. Intet login nødvendigt, dashboardet er kun for dig.",
    tipsHeader: "3 ting, der hjælper dig med at sprede budskabet",
    tip1: "Nævn det der, hvor forældre allerede lytter til dig. En WhatsApp-gruppe, et opslag, en personlig snak.",
    tip2: "Den smerte, alle forældre kender: et barn støder på et ord, det ikke forstår, og giver op. Gadit lader barnet forstå selv, på sit eget sprog.",
    tip3: "Der er en gratis måde at starte på, så det er let at anbefale uden nogen barriere.",
    closing: "Har du spørgsmål, så svar bare på denne e-mail. Vores team er her for dig.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Stifter, Gadit",
  },
  hu: {
    subject: "Bent vagy. Itt a Gadit partnerlinked 🤝",
    greeting: "Örülünk, hogy csatlakoztál a Gadit Partnerprogramhoz 🤝",
    opening: "Itt van minden, amire az induláshoz szükséged van. A Gadit egy okos, gyerekek számára biztonságos szótár 30+ nyelven, példákkal, képekkel és egy személyes füzettel, amely segít a gyereknek igazán megérteni a szavakat.",
    noteUnderLink: "Mindenki, aki ezen keresztül regisztrál és fizet, automatikusan a te javadra számít. A link soha nem mutatja a neved.",
    commissionLine: "A jutalékod: az első évben minden fizetés {pctY1}%-a, utána {pctAfter}%, amíg a család marad.",
    commissionExplain: "Például egy család, amely csatlakozik a Family csomaghoz és egy évig marad, több mint {year1} értéket jelent neked. És amíg ez a család előfizető marad, mi a Gaditnál hónapról hónapra tovább fizetjük neked a jutalékot az előfizetésük után. Nem egyszeri kifizetés, hanem folyamatos bevétel.",
    year1Est: "$60",
    dashboardNote: "Ott valós időben láthatod a kattintásokat, regisztrációkat és bevételeket. Nem kell bejelentkezni, az irányítópult csak a tiéd.",
    tipsHeader: "3 dolog, ami segít terjeszteni",
    tip1: "Említsd meg ott, ahol a szülők már most is figyelnek rád. Egy WhatsApp-csoportban, egy bejegyzésben, egy személyes beszélgetésben.",
    tip2: "A fájdalom, amit minden szülő ismer: a gyerek egy számára érthetetlen szóba ütközik, és feladja. A Gadit segít neki, hogy magától megértse, a saját nyelvén.",
    tip3: "Ingyenesen is el lehet kezdeni, így akadály nélkül könnyű ajánlani.",
    closing: "Bármi kérdésed van, csak válaszolj erre az e-mailre. A csapatunk itt van neked.",
    signatureName: "Gadi Ben Lavi",
    signatureRole: "Alapító, Gadit",
  },
};
...
const WELCOME_LABELS: Record<string, WelcomeLabels> = {
  ...
  vi: {
    ...
    codeLabel: "Mã đối tác của bạn",
    ctaLabel: "Mở bảng điều khiển",
    linksHint: "Mỗi sản phẩm một liên kết. Chia sẻ liên kết phù hợp, bằng bất kỳ ngôn ngữ nào từ bảng điều khiển của bạn.",
    productGeneral: "Gadit (chung)",
    productFamilies: "Gia đình",
    productSchools: "Trường học",
  },
  fil: {
    linkLabel: "Ang mga link mo",
    codeLabel: "Ang partner code mo",
    ctaLabel: "Buksan ang dashboard mo",
    linksHint: "Isang link bawat produkto. Ibahagi ang angkop, sa anumang wika mula sa dashboard mo.",
    productGeneral: "Gadit (pangkalahatan)",
    productFamilies: "Mga pamilya",
    productSchools: "Mga paaralan",
  },
  af: {
    linkLabel: "Jou skakels",
    codeLabel: "Jou vennootkode",
    ctaLabel: "Maak jou paneelbord oop",
    linksHint: "Een skakel per produk. Deel wat pas, in enige taal vanaf jou paneelbord.",
    productGeneral: "Gadit (algemeen)",
    productFamilies: "Gesinne",
    productSchools: "Skole",
  },
  sw: {
    linkLabel: "Viungo vyako",
    codeLabel: "Msimbo wako wa mshirika",
    ctaLabel: "Fungua dashibodi yako",
    linksHint: "Kiungo kimoja kwa kila bidhaa. Shiriki kinachofaa, kwa lugha yoyote kutoka kwenye dashibodi yako.",
    productGeneral: "Gadit (jumla)",
    productFamilies: "Familia",
    productSchools: "Shule",
  },
  "zh-CN": {
    linkLabel: "你的链接",
    codeLabel: "你的推荐码",
    ctaLabel: "打开你的控制台",
    linksHint: "每个产品一个链接。选择合适的分享，可在控制台中切换任意语言。",
    productGeneral: "Gadit（通用）",
    productFamilies: "家庭",
    productSchools: "学校",
  },
  "zh-TW": {
    ...
    codeLabel: "你的推薦碼",
    ctaLabel: "開啟你的控制台",
    linksHint: "每個產品一個連結。選擇合適的分享，可在控制台中切換任何語言。",
    productGeneral: "Gadit（通用）",
    productFamilies: "家庭",
    productSchools: "學校",
  },
  ko: {
    ...
    codeLabel: "내 파트너 코드",
    ctaLabel: "대시보드 열기",
    linksHint: "제품마다 링크가 하나씩 있습니다. 알맞은 링크를 공유하세요. 대시보드에서 어떤 언어로든 가능합니다.",
    productGeneral: "Gadit (일반)",
    productFamilies: "가족",
    productSchools: "학교",
  },
  th: {
    linkLabel: "ลิงก์ของคุณ",
    codeLabel: "โค้ดพาร์ทเนอร์ของคุณ",
    ctaLabel: "เปิดแดชบอร์ดของคุณ",
    linksHint: "หนึ่งลิงก์ต่อหนึ่งผลิตภัณฑ์ แชร์ลิงก์ที่เหมาะสม ในภาษาใดก็ได้จากแดชบอร์ดของคุณ",
    productGeneral: "Gadit (ทั่วไป)",
    productFamilies: "ครอบครัว",
    productSchools: "โรงเรียน",
  },
  bn: {
    linkLabel: "আপনার লিংক",
    codeLabel: "আপনার পার্টনার কোড",
    ctaLabel: "আপনার ড্যাশবোর্ড খুলুন",
    linksHint: "প্রতিটি পণ্যের জন্য একটি লিংক। যেটি মানানসই সেটি শেয়ার করুন, ড্যাশবোর্ড থেকে যেকোনো ভাষায়।",
    productGeneral: "Gadit (সাধারণ)",
    productFamilies: "পরিবার",
    productSchools: "স্কুল",
  },
  da: {
    linkLabel: "Dine links",
    codeLabel: "Din partnerkode",
    ctaLabel: "Åbn dit dashboard",
    linksHint: "Ét link pr. produkt. Del det, der passer, på ethvert sprog fra dit dashboard.",
    productGeneral: "Gadit (generelt)",
    productFamilies: "Familier",
    productSchools: "Skoler",
  },
  hu: {
    linkLabel: "A linkjeid",
    codeLabel: "A partnerkódod",
    ctaLabel: "Irányítópult megnyitása",
    linksHint: "Termékenként egy link. Oszd meg azt, amelyik illik, bármilyen nyelven az irányítópultodról.",
    productGeneral: "Gadit (általános)",
    productFamilies: "Családok",
    productSchools: "Iskolák",
  },
};
