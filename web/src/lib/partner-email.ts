...
export const DEFAULT_WELCOME_CONFIG: WelcomeConfig = {
  he: {
    ...
    opening: "הנה כל מה שצריך כדי להתחיל. Gadit הוא מילון חכם ובטוח לילדים ב-20 שפות, עם דוגמאות, תמונות ומחברת אישית שעוזרת לילד באמת להבין מילים.",
  ...
  en: {
    ...
    opening: "Here's everything you need to start. Gadit is a smart, child-safe dictionary in 20 languages, with examples, pictures and a personal notebook that helps a child truly understand words.",
  ...
  nl: {
    ...
    opening: "Hier is alles wat je nodig hebt om te beginnen. Gadit is een slim, kindveilig woordenboek in 20 talen, met voorbeelden, plaatjes en een persoonlijk notitieboek dat een kind helpt woorden echt te begrijpen.",
  ...
  es: {
    ...
    opening: "Aquí tienes todo lo que necesitas para empezar. Gadit es un diccionario inteligente y seguro para niños en 20 idiomas, con ejemplos, imágenes y un cuaderno personal que ayuda a cada niño a entender de verdad las palabras.",
  ...
  pt: {
    ...
    opening: "Aqui está tudo o que você precisa para começar. A Gadit é um dicionário inteligente e seguro para crianças em 20 idiomas, com exemplos, imagens e um caderno pessoal que ajuda a criança a entender de verdade as palavras.",
  ...
  fr: {
    ...
    opening: "Voici tout ce qu'il vous faut pour commencer. Gadit est un dictionnaire intelligent et sûr pour les enfants, en 20 langues, avec des exemples, des images et un carnet personnel qui aide l'enfant à vraiment comprendre les mots.",
  ...
  de: {
    ...
    opening: "Hier ist alles, was du für den Start brauchst. Gadit ist ein smartes, kindersicheres Wörterbuch in 20 Sprachen, mit Beispielen, Bildern und einem persönlichen Notizbuch, das einem Kind hilft, Wörter wirklich zu verstehen.",
  ...
  it: {
    ...
    opening: "Ecco tutto ciò che ti serve per iniziare. Gadit è un dizionario intelligente e sicuro per i bambini in 20 lingue, con esempi, immagini e un quaderno personale che aiuta il bambino a capire davvero le parole.",
  ...
  ja: {
    ...
    opening: "始めるために必要なものをすべてご用意しました。Gadit は 20 言語に対応した、子どもにも安心してお使いいただける賢い辞書です。例文や画像、そして子どもが言葉を本当に理解できるように手助けする専用ノートが備わっています。",
  ...
  hi: {
    ...
    opening: "शुरू करने के लिए जो कुछ आपको चाहिए, वह सब यहाँ है। Gadit 20 भाषाओं में एक स्मार्ट, बच्चों के लिए सुरक्षित डिक्शनरी है, जिसमें उदाहरण, तस्वीरें और एक निजी नोटबुक है, जो बच्चे को शब्दों को सचमुच समझने में मदद करती है।",
  ...
  am: {
    ...
    opening: "ለመጀመር የሚያስፈልግህ ሁሉ ይኸውልህ። Gadit በ20 ቋንቋዎች ብልህና ለልጆች ደህንነቱ የተጠበቀ መዝገበ ቃላት ነው, ከምሳሌዎች, ስዕሎችና ልጅ ቃላትን በእውነት እንዲረዳ ከሚያግዝ የግል ማስታወሻ ደብተር ጋር።",
