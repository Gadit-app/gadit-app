...
export const DEFAULT_WELCOME_CONFIG: WelcomeConfig = {
  ...
  nl: {
    ...
    opening: "Hier is alles wat je nodig hebt om te beginnen. Gadit is een slim, kindveilig woordenboek in 14 talen, met voorbeelden, plaatjes en een persoonlijk notitieboek dat een kind helpt woorden echt te begrijpen.",
    ...
    commissionExplain: "Een gezin dat bijvoorbeeld op het Family-abonnement instapt en een jaar blijft, is meer dan {year1} voor je waard. En zolang dat gezin geabonneerd blijft, blijven wij bij Gadit je commissie op hun abonnement betalen, maand na maand. Geen eenmalige uitbetaling, maar inkomen dat doorloopt.",
    year1Est: "$60",
