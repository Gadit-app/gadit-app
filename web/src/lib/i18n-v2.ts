...
const cs: V2Strings = {
  ...
  reportEyebrow: "Nahlásit problém",
...
const sk: V2Strings = {
  ...
  reportEyebrow: "Nahlásiť problém",
...
const it: Partial<V2Strings> = {
  ...
  // Report modal
  reportEyebrow: "Segnala un problema",
