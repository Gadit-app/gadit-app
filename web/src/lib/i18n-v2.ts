...
const en: V2Strings = {
  ...
  offlinePackDescription: "Download the most-searched words in your language so you can study without WiFi.",
...
const he: V2Strings = {
  ...
  offlinePackDescription: "הורידו את המילים הנפוצות ביותר בשפה שלכם כדי ללמוד בלי אינטרנט.",
...
const ar: V2Strings = {
  ...
  offlinePackDescription: "نزّل الكلمات الأكثر بحثًا بلغتك لتدرس بدون إنترنت.",
...
const ru: Partial<V2Strings> = {
  ...
  offlinePackDescription: "Скачайте самые популярные слова на вашем языке, чтобы учиться без интернета.",
...
const es: Partial<V2Strings> = {
  ...
  offlinePackDescription: "Descarga las palabras más buscadas en tu idioma para estudiar sin internet.",
...
const pt: Partial<V2Strings> = {
  ...
  offlinePackDescription: "Baixe as palavras mais buscadas no seu idioma para estudar sem internet.",
...
const fr: Partial<V2Strings> = {
  ...
  offlinePackDescription: "Téléchargez les mots les plus recherchés dans votre langue pour étudier sans Internet.",
