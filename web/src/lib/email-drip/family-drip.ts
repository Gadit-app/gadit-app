  ...
  if (he) {
    return {
      ...
      html: shell(true, {
        ...
        unsubscribeUrl,
        bodyHtml:
          p(true, 'ב-<span dir="ltr">Gadit Family</span> כל ילד מחפש מילים במכשיר שלו, ואת/ה רואה את כל ההתקדמות במקום אחד.') +
          ...
          p(true, 'במכשיר של הילד (טלפון, טאבלט או מחשב) פותחים את <span dir="ltr">Gadit</span> ומזינים את הקוד. <b>בלי סיסמה ובלי אימייל לילד.</b> המכשיר מחובר, והמילים שהילד מחפש מתחילות להופיע אצלך.') +
    ...
    return {
      ...
      html: shell(true, {
        ...
        bodyHtml:
          ...
          p(true, '<b>איפה את/ה רואה את זה:</b> בלוח הבקרה של המשפחה, בעמוד הראשי. לכל ילד יש כרטיס עם מספר המילים שלמד, כמה נוספו השבוע, והמילים האחרונות שחיפש. יש גם פיד של חיפושים אחרונים עם השעה. ככה <span dir="ltr">Gadit</span> הופך ממילון ל<b>תעודה חיה</b> של אוצר המילים של הילד.') +
