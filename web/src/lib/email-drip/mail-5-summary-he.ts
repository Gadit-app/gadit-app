...
export function summaryHe(opts: { displayName?: string; unsubscribeUrl: string }) {
  ...
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px;">חלק מהיכולות פתוחות לכל משתמש, וחלק נפתחות במסלולים Clear ו-Deep. שם יש חיפושים בלי הגבלה, תמונות, חיבור משפט, ותרגול חכם של חידונים ומשחקי מילים. אם Gadit הפכה לחלק מהיומיום, אלה היכולות שעושות את ההבדל.</p>
