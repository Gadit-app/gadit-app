...
export const FAMILY_CONTENT: Record<string, { he: EmailContent; en: EmailContent }> = {
  "fam-setup": {
    he: {
      ...
      heading: "בוא נקים את המשפחה",
      ctaText: "להוסיף בני משפחה",
      body: `ברוך הבא ל-Gadit Family. שמח שאתה כאן.
...
## למה זה חשוב
זה מה שהופך את Gadit מעוד אפליקציה למשהו שאתה חלק ממנו. אתה רואה איפה הילד סקרן, על מה הוא עובד, ומתי הוא באמת מתקדם. וברגע הנכון, אפשר לפרגן לו על זה.
...
## למה זה יפה
זו לא בקרה, זה חיבור. אתה יודע על מה הילד חשב, ואפשר לפתוח על זה שיחה בערב: "ראיתי שחיפשת את המילה הזאת, מאיפה היא?".
...
It's worth opening the ranks screen with your child and seeing how close the next skin is.`,
  ...
  "fam-rewards": {
    he: {
      ...
      heading: "פרסים",
      ctaText: "לתת פרס",
      body: `יש רגעים שבהם הילד עושה משהו טוב, ואתה רוצה להגיד לו "ראיתי". עכשיו אפשר, במקום.

## איך זה עובד
בלוח ההורים, ליד כל ילד, יש **פרסים**. כשילד מגיע להישג, רצף יפה או שבוע חזק, אתה שולח לו נקודות מתנה בהקשה אחת.
...
## למה זה חשוב
המערכת מתגמלת את המסע הארוך לבד. אתה מתגמל את **הרגע**. ילד מעריך "ההורה שלי שם לב" הרבה יותר מכל פתיחה אוטומטית. זו נקודת חיבור קטנה שנשארת.
...
It's worth going into your family settings to see how to give a reward.`,
  ...
  "fam-more": {
    he: {
      ...
      heading: "בטוח, שלך, ומוכן",
      ctaText: "להגדרות המשפחה",
      body: `הגענו לסוף הסיור. נשארו כמה דברים שכדאי שתכיר, וכולם עניין של שקט נפשי.
...
זהו. עברנו על כל המנוי. אתה מוכן, וכל הכלים כאן. תודה שהצטרפת למשפחת Gadit.`,
    },
    en: {
