/**
 * English email layout — LTR mirror of layout-he.ts. White card on a
 * gray background, Inter font stack, Gadit wordmark header, CTA button,
 * footer with one-click unsubscribe.
 *
 * All inline-styled because every major email client strips classes.
...
<body style="margin:0;padding:0;background:#F9FAFB;font-family:'Inter','Helvetica Neue',Arial,sans-serif;direction:ltr;color:#111827;">
    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:560px;background:#FFFFFF;border-radius:12px;overflow:hidden;border:1px solid #E5E7EB;box-shadow:0 1px 3px rgba(15,23,42,0.04);">
          ...
          <tr>
            <td style="padding:16px 32px 8px;font-size:16px;line-height:1.65;color:#111827;text-align:left;">
              ${opts.bodyHtml}
            </td>
          </tr>
          <tr>
          ...
          ${opts.signature ? `<tr>
            <td style="padding:0 32px 28px;font-size:16px;line-height:1.55;color:#374151;text-align:left;">
              ${opts.signature}
            </td>
          </tr>` : ""}
          <tr>
            <td style="padding:20px 32px;border-top:1px solid #F3F4F6;font-size:12px;color:#9CA3AF;text-align:center;line-height:1.6;">
              You're receiving this because you signed up for Gadit.<br/>
