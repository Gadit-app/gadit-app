...
const COPY: Record<string, {
  ...
  vi: {"heroEyebrow":"Tính năng","heroTitle":"Một từ điển không dừng lại ở định nghĩa.","heroSub":"Gadit hiểu một từ đến tận cùng. Mọi nghĩa, câu thật trong ngữ cảnh, thành ngữ, nguồn gốc và luyện tập. Cho đến khi từ đó thật sự thấm. Chúng tôi gọi đó là GAD một từ.","ctaPrimary":"Bắt đầu miễn phí","ctaSecondary":"Xem bảng giá","signin":"Đăng nhập","pricing":"Bảng giá","search":"Tìm kiếm","features":"Tính năng","sectionLabel":"Bạn nhận được gì","finalCtaTitle":"Sẵn sàng dùng thử?","finalCtaSub":"Bắt đầu với Basic, hoàn toàn miễn phí. Nâng cấp chỉ một chạm, khi nào bạn muốn xem thêm.","finalCtaBtn":"Bắt đầu ngay","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Mọi định nghĩa","body":"Tất cả các nghĩa của từ, kể cả nghĩa hiếm, sắp xếp theo mức độ thường dùng."},{"id":"examples","icon":"examples","tier":"basic","title":"Câu thật trong ngữ cảnh","body":"Ba câu thật cho mỗi nghĩa, để ngữ cảnh hiện ra ngay lập tức."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Thành ngữ và cụm từ","body":"Mọi cụm từ mà từ đó là một phần, kèm nghĩa đầy đủ của cả cụm."},{"id":"origin","icon":"origin","tier":"basic","title":"Từ đến từ đâu","body":"Ngôn ngữ mà từ đó bắt nguồn, và nghĩa gốc ban đầu của nó."},{"id":"kids","icon":"kids","tier":"clear","title":"Giải thích cho trẻ","body":"Một cách diễn đạt rõ ràng, đơn giản mà trẻ có thể đọc mà không cần thuật ngữ khó."},{"id":"image","icon":"image","tier":"clear","title":"Từ dưới dạng hình ảnh","body":"Một hình ảnh riêng cho từ, khớp với đúng nghĩa bạn đang đọc."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Sổ từ cá nhân","body":"Lưu những từ bạn muốn ghi nhớ. Dùng được cả khi không có internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Viết một câu, nhận phản hồi","body":"Tự đặt câu với từ đó và nhận sửa lỗi cùng phản hồi ngay lập tức."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Câu đố được cá nhân hóa","body":"Một câu đố mỗi ngày về những từ bạn đã học, để chúng ở lại với bạn lâu dài."},{"id":"compare","icon":"compare","tier":"deep","title":"Trò chơi từ vựng","body":"Những trò chơi giúp mở rộng vốn từ: ghép cặp, đoán từ, tạo liên kết giữa các từ."}]},
  fil: {"heroEyebrow":"Mga Tampok","heroTitle":"Isang diksyunaryong hindi humihinto sa depinisyon.","heroSub":"Nauunawaan ng Gadit ang isang salita nang buong-buo. Bawat kahulugan, totoong pangungusap sa konteksto, mga idyoma, pinagmulan at pagsasanay. Hanggang tunay na maunawaan ang salita. Iyon ang tinatawag naming pag-GAD sa isang salita.","ctaPrimary":"Magsimula nang libre","ctaSecondary":"Tingnan ang presyo","signin":"Mag-sign in","pricing":"Presyo","search":"Maghanap","features":"Mga Tampok","sectionLabel":"Ang makukuha mo","finalCtaTitle":"Handa nang subukan?","finalCtaSub":"Magsimula sa Basic, ganap na libre. Mag-upgrade sa isang tap, kapag gusto mo nang makakita ng higit pa.","finalCtaBtn":"Magsimula na","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Bawat depinisyon","body":"Lahat ng kahulugan ng salita, pati na ang mga bihira, nakaayos ayon sa dalas ng paggamit."},{"id":"examples","icon":"examples","tier":"basic","title":"Totoong pangungusap sa konteksto","body":"Tatlong totoong pangungusap kada kahulugan, para agad na maunawaan ang konteksto."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Mga idyoma at ekspresyon","body":"Bawat ekspresyong kinabibilangan ng salita, kasama ang buong kahulugan ng parirala."},{"id":"origin","icon":"origin","tier":"basic","title":"Saan nagmula ang salita","body":"Ang wikang pinagmulan ng salita, at ang orihinal nitong kahulugan."},{"id":"kids","icon":"kids","tier":"clear","title":"Paliwanag para sa bata","body":"Isang malinaw at simpleng bersyon na kayang basahin ng bata nang walang mahirap na termino."},{"id":"image","icon":"image","tier":"clear","title":"Ang salita bilang larawan","body":"Isang natatanging larawan para sa salita, tugma sa eksaktong kahulugang binabasa mo."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Personal na kuwaderno ng mga salita","body":"I-save ang mga salitang gusto mong tandaan. Magagamit kahit walang internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Sumulat ng pangungusap, tumanggap ng feedback","body":"Bumuo ng sarili mong pangungusap gamit ang salita at agad na tumanggap ng pagwawasto at feedback."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Mga personalisadong pagsusulit","body":"Araw-araw na pagsusulit sa mga salitang natutunan mo, para manatili sila nang matagal."},{"id":"compare","icon":"compare","tier":"deep","title":"Mga laro ng salita","body":"Mga larong nagpapalago ng bokabularyo: pagtutugma, paghula, pagbuo ng ugnayan sa pagitan ng mga salita."}]},
  af: {"heroEyebrow":"Kenmerke","heroTitle":"'n Woordeboek wat nie by die definisie stop nie.","heroSub":"Gadit verstaan 'n woord heeltemal deur. Elke betekenis, werklike sinne in konteks, idiome, herkoms en oefening. Totdat die woord regtig insink. Dit is wat ons noem om 'n woord te GAD.","ctaPrimary":"Begin gratis","ctaSecondary":"Sien pryse","signin":"Meld aan","pricing":"Pryse","search":"Soek","features":"Kenmerke","sectionLabel":"Wat jy kry","finalCtaTitle":"Gereed om dit te probeer?","finalCtaSub":"Begin met Basic, heeltemal gratis. Gradeer op met een tik, net wanneer jy meer wil sien.","finalCtaBtn":"Begin nou","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Elke definisie","body":"Alle betekenisse van die woord, selfs die seldsame, gerangskik volgens hoe dikwels hulle gebruik word."},{"id":"examples","icon":"examples","tier":"basic","title":"Werklike sinne in konteks","body":"Drie werklike sinne per betekenis, sodat die konteks dadelik duidelik word."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Idiome en uitdrukkings","body":"Elke uitdrukking waarvan die woord deel is, met die volle betekenis van die frase."},{"id":"origin","icon":"origin","tier":"basic","title":"Waar die woord vandaan kom","body":"Die taal waarin die woord begin het, en wat dit oorspronklik beteken het."},{"id":"kids","icon":"kids","tier":"clear","title":"Verduideliking vir kinders","body":"'n Duidelike, eenvoudige weergawe wat 'n kind sonder enige moeilike terme kan lees."},{"id":"image","icon":"image","tier":"clear","title":"Die woord as 'n prent","body":"'n Unieke prent vir die woord, gepas by die presiese betekenis wat jy lees."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Persoonlike woordeboekie","body":"Stoor die woorde wat jy wil onthou. Beskikbaar selfs sonder internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Skryf 'n sin, kry terugvoer","body":"Stel jou eie sin met die woord op en kry onmiddellike korreksie en terugvoer."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Persoonlike vasvrae","body":"'n Daaglikse vasvra oor die woorde wat jy geleer het, sodat hulle op die lang duur by jou bly."},{"id":"compare","icon":"compare","tier":"deep","title":"Woordspeletjies","body":"Speletjies wat jou woordeskat laat groei: pas, raai, bou verbindings tussen woorde."}]},
  sw: {"heroEyebrow":"Vipengele","heroTitle":"Kamusi isiyoishia kwenye maana.","heroSub":"Gadit huelewa neno hadi mwisho kabisa. Kila maana, sentensi halisi katika muktadha, misemo, asili na mazoezi. Hadi neno lieleweke kweli. Hilo ndilo tunaita ku-GAD neno.","ctaPrimary":"Anza bila malipo","ctaSecondary":"Ona bei","signin":"Ingia","pricing":"Bei","search":"Tafuta","features":"Vipengele","sectionLabel":"Utakachopata","finalCtaTitle":"Uko tayari kujaribu?","finalCtaSub":"Anza na Basic, bila malipo kabisa. Boresha kwa mguso mmoja, tu unapotaka kuona zaidi.","finalCtaBtn":"Anza sasa","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Kila maana","body":"Maana zote za neno, hata zile nadra, zimepangwa kulingana na jinsi zinavyotumika mara kwa mara."},{"id":"examples","icon":"examples","tier":"basic","title":"Sentensi halisi katika muktadha","body":"Sentensi tatu halisi kwa kila maana, ili muktadha ueleweke mara moja."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Misemo na semi","body":"Kila usemi ambao neno ni sehemu yake, pamoja na maana kamili ya msemo."},{"id":"origin","icon":"origin","tier":"basic","title":"Neno lilikotoka","body":"Lugha ambayo neno lilianzia, na maana yake ya awali."},{"id":"kids","icon":"kids","tier":"clear","title":"Maelezo kwa watoto","body":"Toleo rahisi na wazi ambalo mtoto anaweza kusoma bila maneno magumu."},{"id":"image","icon":"image","tier":"clear","title":"Neno kama picha","body":"Picha ya kipekee kwa neno, inayolingana na maana kamili unayosoma."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Daftari la maneno la binafsi","body":"Hifadhi maneno unayotaka kukumbuka. Yanapatikana hata bila intaneti."},{"id":"compose","icon":"compose","tier":"clear","title":"Andika sentensi, pata maoni","body":"Tunga sentensi yako mwenyewe na neno kisha upate marekebisho na maoni mara moja."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Maswali yaliyobinafsishwa","body":"Jaribio la kila siku kuhusu maneno uliyojifunza, ili yabaki nawe kwa muda mrefu."},{"id":"compare","icon":"compare","tier":"deep","title":"Michezo ya maneno","body":"Michezo inayokuza msamiati wako: kulinganisha, kubahatisha, kujenga uhusiano kati ya maneno."}]},
  "zh-CN": {"heroEyebrow":"功能","heroTitle":"一本不止步于释义的词典。","heroSub":"Gadit 把一个词彻底讲透。每一层含义、真实语境中的例句、习语、词源和练习。直到这个词真正被理解。我们把这叫做 GAD 一个词。","ctaPrimary":"免费开始","ctaSecondary":"查看价格","signin":"登录","pricing":"价格","search":"搜索","features":"功能","sectionLabel":"你将获得","finalCtaTitle":"准备好试试了吗？","finalCtaSub":"从 Basic 开始，完全免费。想看更多时，一键即可升级。","finalCtaBtn":"立即开始","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"每一条释义","body":"词语的所有含义，包括罕见的用法，按使用频率排列。"},{"id":"examples","icon":"examples","tier":"basic","title":"真实语境例句","body":"每层含义配三个真实例句，让语境立刻清晰。"},{"id":"idioms","icon":"idioms","tier":"basic","title":"习语与固定搭配","body":"这个词参与的每一个表达，以及整个短语的完整含义。"},{"id":"origin","icon":"origin","tier":"basic","title":"词语的由来","body":"这个词最初来自哪种语言，以及它本来的意思。"},{"id":"kids","icon":"kids","tier":"clear","title":"给孩子的解释","body":"清晰、简单的版本，孩子无需任何专业术语就能读懂。"},{"id":"image","icon":"image","tier":"clear","title":"把词变成图像","body":"为词语生成的专属图像，与你正在阅读的确切含义相匹配。"},{"id":"notebook","icon":"notebook","tier":"clear","title":"个人生词本","body":"保存你想记住的词。没有网络也能查看。"},{"id":"compose","icon":"compose","tier":"clear","title":"写一个句子，获得反馈","body":"用这个词造出自己的句子，立即获得批改和反馈。"},{"id":"quiz","icon":"quiz","tier":"deep","title":"个性化测验","body":"针对你学过的词的每日测验，让它们长久留在记忆里。"},{"id":"compare","icon":"compare","tier":"deep","title":"词汇游戏","body":"帮你积累词汇的游戏：配对、猜词、在词与词之间建立联系。"}]},
  "zh-TW": {"heroEyebrow":"功能","heroTitle":"一本不止於釋義的辭典。","heroSub":"Gadit 把一個字徹底講透。每一層含義、真實語境中的例句、慣用語、字源與練習。直到這個字真正被理解。我們把這叫做 GAD 一個字。","ctaPrimary":"免費開始","ctaSecondary":"查看價格","signin":"登入","pricing":"價格","search":"搜尋","features":"功能","sectionLabel":"你將獲得","finalCtaTitle":"準備好試試了嗎？","finalCtaSub":"從 Basic 開始，完全免費。想看更多時，一鍵即可升級。","finalCtaBtn":"立即開始","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"每一條釋義","body":"字詞的所有含義，包括罕見的用法，依使用頻率排列。"},{"id":"examples","icon":"examples","tier":"basic","title":"真實語境例句","body":"每層含義配三個真實例句，讓語境立刻清晰。"},{"id":"idioms","icon":"idioms","tier":"basic","title":"慣用語與固定搭配","body":"這個字參與的每一個表達，以及整個片語的完整含義。"},{"id":"origin","icon":"origin","tier":"basic","title":"字詞的由來","body":"這個字最初來自哪種語言，以及它原本的意思。"},{"id":"kids","icon":"kids","tier":"clear","title":"給孩子的解釋","body":"清晰、簡單的版本，孩子無需任何專業術語就能讀懂。"},{"id":"image","icon":"image","tier":"clear","title":"把字變成圖像","body":"為字詞生成的專屬圖像，與你正在閱讀的確切含義相符。"},{"id":"notebook","icon":"notebook","tier":"clear","title":"個人生字本","body":"儲存你想記住的字。沒有網路也能查看。"},{"id":"compose","icon":"compose","tier":"clear","title":"寫一個句子，獲得回饋","body":"用這個字造出自己的句子，立即獲得批改與回饋。"},{"id":"quiz","icon":"quiz","tier":"deep","title":"個人化測驗","body":"針對你學過的字的每日測驗，讓它們長久留在記憶裡。"},{"id":"compare","icon":"compare","tier":"deep","title":"字詞遊戲","body":"幫你累積詞彙的遊戲：配對、猜字、在字與字之間建立連結。"}]},
  ko: {"heroEyebrow":"기능","heroTitle":"정의에서 멈추지 않는 사전.","heroSub":"Gadit는 한 단어를 끝까지 이해합니다. 모든 의미, 맥락 속 실제 문장, 관용구, 어원 그리고 연습까지. 그 단어가 정말로 와닿을 때까지. 저희는 이것을 단어를 GAD 한다고 부릅니다.","ctaPrimary":"무료로 시작하기","ctaSecondary":"요금 보기","signin":"로그인","pricing":"요금","search":"검색","features":"기능","sectionLabel":"이런 것을 얻어요","finalCtaTitle":"사용해 볼 준비가 되셨나요?","finalCtaSub":"완전히 무료인 Basic으로 시작하세요. 더 보고 싶을 때 한 번의 탭으로 업그레이드하면 됩니다.","finalCtaBtn":"지금 시작하기","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"모든 정의","body":"드문 의미까지 단어의 모든 뜻을, 사용 빈도순으로 정리해 드립니다."},{"id":"examples","icon":"examples","tier":"basic","title":"맥락 속 실제 문장","body":"의미마다 실제 문장 세 개를 제공해, 맥락이 바로 와닿습니다."},{"id":"idioms","icon":"idioms","tier":"basic","title":"관용구와 표현","body":"그 단어가 쓰인 모든 표현을, 구절 전체의 뜻과 함께 보여 줍니다."},{"id":"origin","icon":"origin","tier":"basic","title":"단어의 유래","body":"그 단어가 처음 생겨난 언어와, 본래의 의미를 알려 줍니다."},{"id":"kids","icon":"kids","tier":"clear","title":"아이를 위한 설명","body":"어려운 용어 없이 아이가 읽을 수 있는 명확하고 쉬운 설명입니다."},{"id":"image","icon":"image","tier":"clear","title":"이미지로 보는 단어","body":"읽고 있는 바로 그 의미에 맞춘, 단어만의 고유한 이미지입니다."},{"id":"notebook","icon":"notebook","tier":"clear","title":"나만의 단어장","body":"기억하고 싶은 단어를 저장하세요. 인터넷 없이도 볼 수 있습니다."},{"id":"compose","icon":"compose","tier":"clear","title":"문장을 쓰고 피드백 받기","body":"그 단어로 직접 문장을 만들면 즉시 교정과 피드백을 받습니다."},{"id":"quiz","icon":"quiz","tier":"deep","title":"맞춤형 퀴즈","body":"배운 단어에 대한 매일의 퀴즈로, 오래도록 기억에 남게 합니다."},{"id":"compare","icon":"compare","tier":"deep","title":"단어 게임","body":"어휘를 키워 주는 게임: 짝 맞추기, 추측하기, 단어 사이의 연결 만들기."}]},
  th: {"heroEyebrow":"ฟีเจอร์","heroTitle":"พจนานุกรมที่ไม่หยุดแค่คำนิยาม","heroSub":"Gadit เข้าใจคำหนึ่งคำจนถึงที่สุด ทุกความหมาย ประโยคจริงในบริบท สำนวน ที่มา และการฝึกฝน จนกว่าคำนั้นจะเข้าใจได้อย่างแท้จริง เราเรียกสิ่งนี้ว่าการ GAD คำหนึ่งคำ","ctaPrimary":"เริ่มใช้ฟรี","ctaSecondary":"ดูราคา","signin":"เข้าสู่ระบบ","pricing":"ราคา","search":"ค้นหา","features":"ฟีเจอร์","sectionLabel":"สิ่งที่คุณจะได้รับ","finalCtaTitle":"พร้อมลองแล้วหรือยัง","finalCtaSub":"เริ่มด้วย Basic ฟรีอย่างสมบูรณ์ อัปเกรดได้ในแตะเดียว เมื่อคุณอยากเห็นมากขึ้น","finalCtaBtn":"เริ่มเลย","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"ทุกคำนิยาม","body":"ทุกความหมายของคำ แม้แต่ความหมายที่พบได้ยาก จัดเรียงตามความถี่ในการใช้งาน"},{"id":"examples","icon":"examples","tier":"basic","title":"ประโยคจริงในบริบท","body":"สามประโยคจริงต่อหนึ่งความหมาย เพื่อให้เข้าใจบริบทได้ทันที"},{"id":"idioms","icon":"idioms","tier":"basic","title":"สำนวนและวลี","body":"ทุกสำนวนที่คำนี้เป็นส่วนหนึ่ง พร้อมความหมายเต็มของวลีนั้น"},{"id":"origin","icon":"origin","tier":"basic","title":"ที่มาของคำ","body":"ภาษาที่คำนี้เริ่มต้นขึ้น และความหมายดั้งเดิมของมัน"},{"id":"kids","icon":"kids","tier":"clear","title":"คำอธิบายสำหรับเด็ก","body":"คำอธิบายที่ชัดเจนและเรียบง่าย ที่เด็กอ่านได้โดยไม่ต้องมีศัพท์ยาก"},{"id":"image","icon":"image","tier":"clear","title":"คำในรูปแบบภาพ","body":"ภาพเฉพาะสำหรับคำนั้น ตรงกับความหมายที่คุณกำลังอ่านพอดี"},{"id":"notebook","icon":"notebook","tier":"clear","title":"สมุดคำศัพท์ส่วนตัว","body":"บันทึกคำที่คุณอยากจดจำ ใช้ได้แม้ไม่มีอินเทอร์เน็ต"},{"id":"compose","icon":"compose","tier":"clear","title":"เขียนประโยค รับคำติชม","body":"แต่งประโยคของคุณเองด้วยคำนั้น แล้วรับการแก้ไขและคำติชมทันที"},{"id":"quiz","icon":"quiz","tier":"deep","title":"แบบทดสอบเฉพาะตัว","body":"แบบทดสอบรายวันเกี่ยวกับคำที่คุณเรียนรู้ เพื่อให้คำเหล่านั้นอยู่กับคุณได้ยาวนาน"},{"id":"compare","icon":"compare","tier":"deep","title":"เกมคำศัพท์","body":"เกมที่ช่วยเพิ่มคลังคำศัพท์ของคุณ จับคู่ เดาคำ สร้างความเชื่อมโยงระหว่างคำ"}]},
  bn: {"heroEyebrow":"বৈশিষ্ট্য","heroTitle":"যে অভিধান সংজ্ঞাতেই থেমে থাকে না।","heroSub":"Gadit একটি শব্দকে একেবারে শেষ পর্যন্ত বোঝায়। প্রতিটি অর্থ, প্রসঙ্গে সত্যিকারের বাক্য, বাগধারা, উৎস এবং অনুশীলন। শব্দটি সত্যিই বোধগম্য না হওয়া পর্যন্ত। এটিকেই আমরা বলি একটি শব্দকে GAD করা।","ctaPrimary":"বিনামূল্যে শুরু করুন","ctaSecondary":"মূল্য দেখুন","signin":"সাইন ইন","pricing":"মূল্য","search":"অনুসন্ধান","features":"বৈশিষ্ট্য","sectionLabel":"আপনি যা পাবেন","finalCtaTitle":"চেষ্টা করতে প্রস্তুত?","finalCtaSub":"Basic দিয়ে শুরু করুন, সম্পূর্ণ বিনামূল্যে। আরও দেখতে চাইলে এক টোকায় আপগ্রেড করুন।","finalCtaBtn":"এখনই শুরু করুন","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"প্রতিটি সংজ্ঞা","body":"শব্দের সব অর্থ, এমনকি বিরল অর্থগুলোও, ব্যবহারের ঘনত্ব অনুযায়ী সাজানো।"},{"id":"examples","icon":"examples","tier":"basic","title":"প্রসঙ্গে সত্যিকারের বাক্য","body":"প্রতিটি অর্থের জন্য তিনটি সত্যিকারের বাক্য, যাতে প্রসঙ্গ সঙ্গে সঙ্গে বোঝা যায়।"},{"id":"idioms","icon":"idioms","tier":"basic","title":"বাগধারা ও বাক্যাংশ","body":"যেসব অভিব্যক্তিতে শব্দটি রয়েছে তার প্রতিটি, সম্পূর্ণ বাক্যাংশের অর্থসহ।"},{"id":"origin","icon":"origin","tier":"basic","title":"শব্দটি কোথা থেকে এল","body":"যে ভাষায় শব্দটির উৎপত্তি, এবং মূলে এর অর্থ কী ছিল।"},{"id":"kids","icon":"kids","tier":"clear","title":"শিশুদের জন্য ব্যাখ্যা","body":"একটি স্পষ্ট, সহজ সংস্করণ যা একটি শিশু কোনো কঠিন শব্দ ছাড়াই পড়তে পারে।"},{"id":"image","icon":"image","tier":"clear","title":"ছবিতে শব্দ","body":"শব্দটির জন্য একটি অনন্য ছবি, আপনি যে অর্থটি পড়ছেন ঠিক তার সঙ্গে মিলিয়ে।"},{"id":"notebook","icon":"notebook","tier":"clear","title":"ব্যক্তিগত শব্দখাতা","body":"যেসব শব্দ মনে রাখতে চান সেগুলো সংরক্ষণ করুন। ইন্টারনেট ছাড়াও পাওয়া যায়।"},{"id":"compose","icon":"compose","tier":"clear","title":"একটি বাক্য লিখুন, মতামত পান","body":"শব্দটি দিয়ে নিজের একটি বাক্য রচনা করুন এবং সঙ্গে সঙ্গে সংশোধন ও মতামত পান।"},{"id":"quiz","icon":"quiz","tier":"deep","title":"ব্যক্তিগতকৃত কুইজ","body":"আপনি যেসব শব্দ শিখেছেন তার উপর প্রতিদিনের কুইজ, যাতে সেগুলো দীর্ঘদিন মনে থাকে।"},{"id":"compare","icon":"compare","tier":"deep","title":"শব্দের খেলা","body":"যেসব খেলা আপনার শব্দভাণ্ডার বাড়ায়: মেলানো, অনুমান করা, শব্দের মধ্যে সংযোগ তৈরি করা।"}]},
  da: {"heroEyebrow":"Funktioner","heroTitle":"En ordbog, der ikke stopper ved definitionen.","heroSub":"Gadit forstår et ord hele vejen igennem. Hver betydning, rigtige sætninger i kontekst, idiomer, oprindelse og træning. Indtil ordet virkelig falder på plads. Det kalder vi at GAD et ord.","ctaPrimary":"Start gratis","ctaSecondary":"Se priser","signin":"Log ind","pricing":"Priser","search":"Søg","features":"Funktioner","sectionLabel":"Det får du","finalCtaTitle":"Klar til at prøve det?","finalCtaSub":"Start med Basic, helt gratis. Opgrader med et tryk, kun når du vil se mere.","finalCtaBtn":"Start nu","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Hver definition","body":"Alle ordets betydninger, også de sjældne, sorteret efter hvor ofte de bruges."},{"id":"examples","icon":"examples","tier":"basic","title":"Rigtige sætninger i kontekst","body":"Tre rigtige sætninger pr. betydning, så konteksten falder på plads med det samme."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Idiomer og udtryk","body":"Hvert udtryk, som ordet indgår i, med hele frasens betydning."},{"id":"origin","icon":"origin","tier":"basic","title":"Hvor ordet kommer fra","body":"Det sprog, ordet stammer fra, og hvad det oprindeligt betød."},{"id":"kids","icon":"kids","tier":"clear","title":"Forklaring til børn","body":"En klar og enkel version, som et barn kan læse uden svære fagudtryk."},{"id":"image","icon":"image","tier":"clear","title":"Ordet som et billede","body":"Et unikt billede til ordet, tilpasset præcis den betydning, du læser."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Personlig ordbog","body":"Gem de ord, du vil huske. Tilgængelige selv uden internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Skriv en sætning, få feedback","body":"Skriv din egen sætning med ordet og få øjeblikkelig rettelse og feedback."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Personlige quizzer","body":"En daglig quiz om de ord, du har lært, så de bliver hos dig på den lange bane."},{"id":"compare","icon":"compare","tier":"deep","title":"Ordspil","body":"Spil, der udvider dit ordforråd: matche, gætte, bygge forbindelser mellem ord."}]},
  hu: {"heroEyebrow":"Funkciók","heroTitle":"Egy szótár, amely nem áll meg a meghatározásnál.","heroSub":"A Gadit teljesen a végéig megérti a szót. Minden jelentés, valódi mondatok kontextusban, kifejezések, eredet és gyakorlás. Amíg a szó igazán a helyére kerül. Ezt hívjuk úgy, hogy GAD egy szót.","ctaPrimary":"Kezdd el ingyen","ctaSecondary":"Árak megtekintése","signin":"Bejelentkezés","pricing":"Árak","search":"Keresés","features":"Funkciók","sectionLabel":"Ezt kapod","finalCtaTitle":"Kész kipróbálni?","finalCtaSub":"Kezdd a Basic csomaggal, teljesen ingyen. Egyetlen koppintással bővíthetsz, amikor többet szeretnél látni.","finalCtaBtn":"Kezdés most","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Minden jelentés","body":"A szó összes jelentése, még a ritkák is, a használat gyakorisága szerint rendezve."},{"id":"examples","icon":"examples","tier":"basic","title":"Valódi mondatok kontextusban","body":"Jelentésenként három valódi mondat, hogy a kontextus azonnal érthető legyen."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Kifejezések és szólások","body":"Minden kifejezés, amelynek a szó a része, a teljes szókapcsolat jelentésével együtt."},{"id":"origin","icon":"origin","tier":"basic","title":"Honnan ered a szó","body":"Az a nyelv, amelyből a szó származik, és hogy eredetileg mit jelentett."},{"id":"kids","icon":"kids","tier":"clear","title":"Magyarázat gyerekeknek","body":"Egy világos, egyszerű változat, amelyet egy gyerek szakszavak nélkül is elolvashat."},{"id":"image","icon":"image","tier":"clear","title":"A szó képként","body":"Egyedi kép a szóhoz, pontosan ahhoz a jelentéshez illesztve, amelyet éppen olvasol."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Személyes szófüzet","body":"Mentsd el a szavakat, amelyeket meg akarsz jegyezni. Internet nélkül is elérhető."},{"id":"compose","icon":"compose","tier":"clear","title":"Írj egy mondatot, kapj visszajelzést","body":"Alkoss saját mondatot a szóval, és azonnal kapj javítást és visszajelzést."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Személyre szabott kvízek","body":"Napi kvíz a megtanult szavakból, hogy hosszú távon is veled maradjanak."},{"id":"compare","icon":"compare","tier":"deep","title":"Szójátékok","body":"Játékok, amelyek bővítik a szókincsedet: párosítás, kitalálás, kapcsolatok építése szavak között."}]},
  uk: {"heroEyebrow":"Можливості","heroTitle":"Словник, який не зупиняється на визначенні.","heroSub":"Gadit розуміє слово до кінця. Кожне значення, справжні речення в контексті, ідіоми, походження й практика. Доки слово справді не стане зрозумілим. Ми називаємо це зробити GAD зі словом.","ctaPrimary":"Почати безкоштовно","ctaSecondary":"Переглянути ціни","signin":"Увійти","pricing":"Ціни","search":"Пошук","features":"Можливості","sectionLabel":"Що ви отримаєте","finalCtaTitle":"Готові спробувати?","finalCtaSub":"Почніть із Basic, повністю безкоштовно. Оновлення в один дотик, лише коли захочете більше.","finalCtaBtn":"Почати зараз","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Кожне визначення","body":"Усі значення слова, навіть рідкісні, упорядковані за частотою вживання."},{"id":"examples","icon":"examples","tier":"basic","title":"Справжні речення в контексті","body":"Три справжні речення на кожне значення, щоб контекст став зрозумілим одразу."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Ідіоми та вирази","body":"Кожен вираз, частиною якого є слово, разом із повним значенням фрази."},{"id":"origin","icon":"origin","tier":"basic","title":"Звідки походить слово","body":"Мова, з якої походить слово, і що воно означало спочатку."},{"id":"kids","icon":"kids","tier":"clear","title":"Пояснення для дітей","body":"Чіткий, простий варіант, який дитина може прочитати без складних термінів."},{"id":"image","icon":"image","tier":"clear","title":"Слово як зображення","body":"Унікальне зображення для слова, підібране саме до того значення, яке ви читаєте."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Особистий зошит слів","body":"Зберігайте слова, які хочете запам'ятати. Доступні навіть без інтернету."},{"id":"compose","icon":"compose","tier":"clear","title":"Напишіть речення й отримайте відгук","body":"Складіть власне речення зі словом і отримайте миттєве виправлення та відгук."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Персоналізовані вікторини","body":"Щоденна вікторина зі слів, які ви вивчили, щоб вони залишалися з вами надовго."},{"id":"compare","icon":"compare","tier":"deep","title":"Ігри зі словами","body":"Ігри, що збільшують словниковий запас: зіставлення, вгадування, побудова зв'язків між словами."}]},
  tr: {"heroEyebrow":"Özellikler","heroTitle":"Tanımda durmayan bir sözlük.","heroSub":"Gadit bir kelimeyi sonuna kadar anlar. Her anlam, bağlam içinde gerçek cümleler, deyimler, köken ve pratik. Kelime gerçekten yerine oturana dek. Biz buna bir kelimeyi GAD etmek diyoruz.","ctaPrimary":"Ücretsiz başla","ctaSecondary":"Fiyatları gör","signin":"Giriş yap","pricing":"Fiyatlar","search":"Ara","features":"Özellikler","sectionLabel":"Neler elde edersiniz","finalCtaTitle":"Denemeye hazır mısınız?","finalCtaSub":"Basic ile tamamen ücretsiz başlayın. Daha fazlasını isteyince tek dokunuşla yükseltin.","finalCtaBtn":"Şimdi başla","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Her tanım","body":"Kelimenin tüm anlamları, nadir olanlar dahil, kullanım sıklığına göre sıralanmış."},{"id":"examples","icon":"examples","tier":"basic","title":"Bağlam içinde gerçek cümleler","body":"Her anlam için üç gerçek cümle, böylece bağlam hemen yerine oturur."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Deyimler ve kalıp ifadeler","body":"Kelimenin yer aldığı her ifade, kalıbın tam anlamıyla birlikte."},{"id":"origin","icon":"origin","tier":"basic","title":"Kelime nereden geldi","body":"Kelimenin çıktığı dil ve başlangıçta ne anlama geldiği."},{"id":"kids","icon":"kids","tier":"clear","title":"Çocuklar için açıklama","body":"Bir çocuğun hiç zorlanmadan okuyabileceği net, sade bir anlatım."},{"id":"image","icon":"image","tier":"clear","title":"Görsel olarak kelime","body":"Kelime için okuduğunuz tam anlama uyan benzersiz bir görsel."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Kişisel kelime defteri","body":"Hatırlamak istediğiniz kelimeleri kaydedin. İnternet olmadan da erişilebilir."},{"id":"compose","icon":"compose","tier":"clear","title":"Bir cümle yazın, geri bildirim alın","body":"Kelimeyle kendi cümlenizi kurun, anında düzeltme ve geri bildirim alın."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Kişiye özel sınavlar","body":"Öğrendiğiniz kelimeler üzerine günlük bir sınav, böylece uzun süre aklınızda kalır."},{"id":"compare","icon":"compare","tier":"deep","title":"Kelime oyunları","body":"Kelime dağarcığınızı büyüten oyunlar: eşleştirme, tahmin, kelimeler arası bağ kurma."}]},
  pl: {"heroEyebrow":"Funkcje","heroTitle":"Słownik, który nie kończy się na definicji.","heroSub":"Gadit rozumie słowo do końca. Każde znaczenie, prawdziwe zdania w kontekście, idiomy, pochodzenie i ćwiczenia. Aż słowo naprawdę stanie się jasne. Nazywamy to zrobieniem GAD ze słowa.","ctaPrimary":"Zacznij za darmo","ctaSecondary":"Zobacz cennik","signin":"Zaloguj się","pricing":"Cennik","search":"Szukaj","features":"Funkcje","sectionLabel":"Co otrzymujesz","finalCtaTitle":"Gotowi, żeby spróbować?","finalCtaSub":"Zacznij od Basic, całkowicie za darmo. Ulepszenie jednym dotknięciem, tylko gdy zechcesz więcej.","finalCtaBtn":"Zacznij teraz","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Każda definicja","body":"Wszystkie znaczenia słowa, nawet te rzadkie, uporządkowane według częstości użycia."},{"id":"examples","icon":"examples","tier":"basic","title":"Prawdziwe zdania w kontekście","body":"Trzy prawdziwe zdania na każde znaczenie, aby kontekst od razu był jasny."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Idiomy i wyrażenia","body":"Każde wyrażenie, którego częścią jest słowo, wraz z pełnym znaczeniem zwrotu."},{"id":"origin","icon":"origin","tier":"basic","title":"Skąd pochodzi słowo","body":"Język, z którego słowo się wywodzi, i co pierwotnie oznaczało."},{"id":"kids","icon":"kids","tier":"clear","title":"Wyjaśnienie dla dzieci","body":"Jasna, prosta wersja, którą dziecko przeczyta bez trudnych pojęć."},{"id":"image","icon":"image","tier":"clear","title":"Słowo jako obraz","body":"Wyjątkowy obraz do słowa, dopasowany do dokładnego znaczenia, które czytasz."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Osobisty zeszyt słów","body":"Zapisuj słowa, które chcesz zapamiętać. Dostępne nawet bez internetu."},{"id":"compose","icon":"compose","tier":"clear","title":"Napisz zdanie, otrzymaj informację zwrotną","body":"Ułóż własne zdanie ze słowem i otrzymaj natychmiastową poprawę oraz informację zwrotną."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Spersonalizowane quizy","body":"Codzienny quiz ze słów, których się nauczyłeś, aby zostały z tobą na długo."},{"id":"compare","icon":"compare","tier":"deep","title":"Gry słowne","body":"Gry, które budują słownictwo: dopasowywanie, zgadywanie, tworzenie powiązań między słowami."}]},
  fa: {"heroEyebrow":"ویژگی‌ها","heroTitle":"فرهنگ لغتی که در تعریف متوقف نمی‌شود.","heroSub":"Gadit یک واژه را تا انتها می‌فهمد. هر معنا، جمله‌های واقعی در بافت، اصطلاحات، ریشه و تمرین. تا جایی که واژه واقعاً جا بیفتد. ما به این کار می‌گوییم GAD کردن یک واژه.","ctaPrimary":"رایگان شروع کنید","ctaSecondary":"دیدن قیمت‌ها","signin":"ورود","pricing":"قیمت‌ها","search":"جستجو","features":"ویژگی‌ها","sectionLabel":"چه چیزی به دست می‌آورید","finalCtaTitle":"آماده‌اید امتحان کنید؟","finalCtaSub":"با Basic و کاملاً رایگان شروع کنید. ارتقا با یک لمس، فقط زمانی که بیشتر بخواهید.","finalCtaBtn":"همین حالا شروع کنید","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"هر تعریف","body":"همه معناهای واژه، حتی معناهای نادر، مرتب‌شده بر پایه میزان کاربرد."},{"id":"examples","icon":"examples","tier":"basic","title":"جمله‌های واقعی در بافت","body":"سه جمله واقعی برای هر معنا، تا بافت بی‌درنگ روشن شود."},{"id":"idioms","icon":"idioms","tier":"basic","title":"اصطلاحات و ترکیب‌ها","body":"هر عبارتی که واژه بخشی از آن است، همراه با معنای کامل آن عبارت."},{"id":"origin","icon":"origin","tier":"basic","title":"واژه از کجا آمده است","body":"زبانی که واژه از آن آغاز شده، و اینکه در آغاز چه معنایی داشته است."},{"id":"kids","icon":"kids","tier":"clear","title":"توضیح برای کودکان","body":"روایتی روشن و ساده که کودک بدون هیچ اصطلاح دشواری می‌تواند بخواند."},{"id":"image","icon":"image","tier":"clear","title":"واژه در قالب تصویر","body":"تصویری یگانه برای واژه، هماهنگ با همان معنایی که می‌خوانید."},{"id":"notebook","icon":"notebook","tier":"clear","title":"دفترچه واژگان شخصی","body":"واژه‌هایی را که می‌خواهید به یاد بسپارید ذخیره کنید. حتی بدون اینترنت در دسترس‌اند."},{"id":"compose","icon":"compose","tier":"clear","title":"جمله‌ای بنویسید و بازخورد بگیرید","body":"جمله‌ای از خودتان با واژه بسازید و اصلاح و بازخورد فوری دریافت کنید."},{"id":"quiz","icon":"quiz","tier":"deep","title":"آزمون‌های شخصی‌سازی‌شده","body":"آزمونی روزانه از واژه‌هایی که آموخته‌اید، تا برای مدتی طولانی با شما بمانند."},{"id":"compare","icon":"compare","tier":"deep","title":"بازی‌های واژگانی","body":"بازی‌هایی که دایره واژگان را می‌سازند: تطبیق، حدس زدن، ساختن پیوند میان واژه‌ها."}]},
  id: {"heroEyebrow":"Fitur","heroTitle":"Kamus yang tidak berhenti di definisi.","heroSub":"Gadit memahami sebuah kata sampai tuntas. Setiap makna, kalimat nyata dalam konteks, idiom, asal-usul, dan latihan. Sampai kata itu benar-benar terpahami. Kami menyebutnya meng-GAD sebuah kata.","ctaPrimary":"Mulai gratis","ctaSecondary":"Lihat harga","signin":"Masuk","pricing":"Harga","search":"Cari","features":"Fitur","sectionLabel":"Yang Anda dapatkan","finalCtaTitle":"Siap mencobanya?","finalCtaSub":"Mulai dengan Basic, sepenuhnya gratis. Tingkatkan dengan satu ketuk, hanya saat Anda ingin lebih.","finalCtaBtn":"Mulai sekarang","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Setiap definisi","body":"Semua makna kata, bahkan yang jarang, diurutkan berdasarkan seberapa sering digunakan."},{"id":"examples","icon":"examples","tier":"basic","title":"Kalimat nyata dalam konteks","body":"Tiga kalimat nyata per makna, sehingga konteksnya langsung terasa."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Idiom dan ungkapan","body":"Setiap ungkapan yang memuat kata itu, lengkap dengan makna utuh frasanya."},{"id":"origin","icon":"origin","tier":"basic","title":"Asal kata","body":"Bahasa asal kata itu, dan apa makna awalnya."},{"id":"kids","icon":"kids","tier":"clear","title":"Penjelasan untuk anak","body":"Versi yang jelas dan sederhana, yang bisa dibaca anak tanpa istilah sulit."},{"id":"image","icon":"image","tier":"clear","title":"Kata sebagai gambar","body":"Gambar unik untuk kata itu, dipadankan dengan makna persis yang sedang Anda baca."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Buku catatan kata pribadi","body":"Simpan kata-kata yang ingin Anda ingat. Tersedia bahkan tanpa internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Tulis kalimat, dapatkan umpan balik","body":"Susun kalimat Anda sendiri dengan kata itu dan dapatkan koreksi serta umpan balik seketika."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Kuis yang dipersonalisasi","body":"Kuis harian dari kata-kata yang telah Anda pelajari, agar tetap melekat untuk jangka panjang."},{"id":"compare","icon":"compare","tier":"deep","title":"Permainan kata","body":"Permainan yang menumbuhkan kosakata: mencocokkan, menebak, membangun kaitan antar kata."}]},
  nl: {"heroEyebrow":"Functies","heroTitle":"Een woordenboek dat niet stopt bij de definitie.","heroSub":"Gadit begrijpt een woord tot het einde. Elke betekenis, echte zinnen in context, uitdrukkingen, herkomst en oefening. Tot het woord echt duidelijk wordt. Dat noemen wij een woord GAD-en.","ctaPrimary":"Gratis beginnen","ctaSecondary":"Prijzen bekijken","signin":"Inloggen","pricing":"Prijzen","search":"Zoeken","features":"Functies","sectionLabel":"Wat je krijgt","finalCtaTitle":"Klaar om het te proberen?","finalCtaSub":"Begin met Basic, helemaal gratis. Upgraden met één tik, alleen wanneer je meer wilt.","finalCtaBtn":"Nu beginnen","tierLabel":{"basic":"Basic","clear":"Clear","deep":"Deep"},"list":[{"id":"definitions","icon":"definitions","tier":"basic","title":"Elke definitie","body":"Alle betekenissen van het woord, ook de zeldzame, geordend op hoe vaak ze worden gebruikt."},{"id":"examples","icon":"examples","tier":"basic","title":"Echte zinnen in context","body":"Drie echte zinnen per betekenis, zodat de context meteen duidelijk wordt."},{"id":"idioms","icon":"idioms","tier":"basic","title":"Uitdrukkingen en zegswijzen","body":"Elke uitdrukking waar het woord deel van uitmaakt, met de volledige betekenis van de zin."},{"id":"origin","icon":"origin","tier":"basic","title":"Waar het woord vandaan komt","body":"De taal waarin het woord ontstond en wat het oorspronkelijk betekende."},{"id":"kids","icon":"kids","tier":"clear","title":"Uitleg voor kinderen","body":"Een heldere, eenvoudige versie die een kind zonder moeilijke woorden kan lezen."},{"id":"image","icon":"image","tier":"clear","title":"Het woord als beeld","body":"Een uniek beeld bij het woord, afgestemd op precies de betekenis die je leest."},{"id":"notebook","icon":"notebook","tier":"clear","title":"Persoonlijk woordenschrift","body":"Bewaar de woorden die je wilt onthouden. Ook beschikbaar zonder internet."},{"id":"compose","icon":"compose","tier":"clear","title":"Schrijf een zin, krijg feedback","body":"Stel je eigen zin met het woord op en krijg meteen correctie en feedback."},{"id":"quiz","icon":"quiz","tier":"deep","title":"Persoonlijke quizzen","body":"Een dagelijkse quiz over de woorden die je hebt geleerd, zodat ze lang bij je blijven."},{"id":"compare","icon":"compare","tier":"deep","title":"Woordspellen","body":"Spellen die je woordenschat opbouwen: matchen, raden, verbanden leggen tussen woorden."}]},
};
