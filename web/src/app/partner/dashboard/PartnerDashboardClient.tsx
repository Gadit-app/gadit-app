...
const COPY = {
  he: {
    ...
    notFound: "לא מצאנו את הקישור הזה. ודאו שהעתקתם את כל הכתובת מהמייל, או פנו אלינו.",
    hi: "היי",
    ...
    how1: "שתפו את הקישור האישי שלכם.",
    how2: "כל מי שנרשם ומשלם דרכו משויך אליכם ל-60 יום, גם אם נרשם מאוחר יותר.",
    how3: "אתם מרוויחים על כל חודש שהלקוח משלם בפועל. הרווח משתחרר אחרי 30 יום ומשולם פעם בחודש.",
    back: "לאתר Gadit",
    empty: "עדיין אין רווחים. שתפו את הקישור והתחילו.",
  },
  en: {
    dir: "ltr" as const,
