...
const COPY = {
  ...
  nl: {
    ...
    rateStandard: "25% in jaar één · 10% voor het leven",
    rateFounder: "30% in jaar één · 10% voor het leven",
    ...
    how3: "Je verdient op elke maand dat de klant daadwerkelijk betaalt. Verdiensten worden na 30 dagen vrijgegeven en maandelijks uitbetaald.",
    back: "Gadit home",
