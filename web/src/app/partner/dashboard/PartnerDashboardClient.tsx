...
const S: Record<string, React.CSSProperties> = {
  ...
  tab: { border: "1px solid #E0E4E8", background: "#fff", color: "#6B7280", fontFamily: "inherit", fontSize: 14, fontWeight: 700, padding: "9px 20px", borderRadius: 10, cursor: "pointer", whiteSpace: "nowrap", boxShadow: "0 1px 2px rgba(16,24,40,0.04)" },
  tabActive: { background: "#0EA5A5", color: "#fff", borderColor: "#0EA5A5", boxShadow: "0 2px 6px rgba(14,165,165,0.28)" },
