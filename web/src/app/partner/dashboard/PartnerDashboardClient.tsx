...
const COPY = {
  ...
  el: {
    ...
    notFound: "Δεν βρήκαμε αυτόν τον σύνδεσμο. Βεβαιώσου ότι αντέγραψες ολόκληρη τη διεύθυνση από το email σου ή επικοινώνησε μαζί μας.",
    hi: "Γεια",
    yourLink: "Οι προσωπικοί σου σύνδεσμοι",
    linksHint: "Ένας σύνδεσμος ανά προϊόν. Όποιος μπαίνει μέσω αυτού και εγγράφεται πιστώνεται σε εσένα, σε οποιαδήποτε γλώσσα.",
    linkGeneral: "Gadit (γενικό)",
    linkFamilies: "Οικογένειες",
    linkSchools: "Σχολεία",
    copy: "Αντιγραφή συνδέσμου",
    copied: "Αντιγράφηκε ✓",
    linkLangLabel: "Γλώσσα συνδέσμου",
    clicks: "Κλικ",
    signups: "Εγγραφές",
    paying: "Πελάτες που πληρώνουν",
    earnings: "Τα κέρδη σου",
    pending: "Σε αναμονή",
    available: "Διαθέσιμα",
    paid: "Πληρωμένα",
    pendingNote: "Αποδεσμεύονται 30 ημέρες μετά από κάθε πληρωμή",
    tierStandard: "Συνεργάτης",
    tierFounder: "Ιδρυτικός Συνεργάτης",
    rateStandard: "25% τον πρώτο χρόνο · 10% για πάντα",
    rateFounder: "30% τον πρώτο χρόνο · 10% για πάντα",
    howTitle: "Πώς λειτουργεί",
    how1: "Μοιράσου τον προσωπικό σου σύνδεσμο.",
    how2: "Όποιος εγγράφεται και πληρώνει μέσω αυτού πιστώνεται σε εσένα για 60 ημέρες, ακόμη κι αν εγγραφεί αργότερα.",
    how3: "Κερδίζεις για κάθε μήνα που ο πελάτης πληρώνει πραγματικά. Τα κέρδη αποδεσμεύονται μετά από 30 ημέρες και πληρώνονται μηνιαία.",
    back: "Αρχική Gadit",
    empty: "Δεν υπάρχουν κέρδη ακόμα. Μοιράσου τον σύνδεσμό σου για να ξεκινήσεις.",
  },
  zu: {
    dir: "ltr" as const,
    loading: "Ideshibhodi yakho iyalayisha…",
    notFound: "Asikwazanga ukuthola lesi sixhumanisi. Qiniseka ukuthi ukopishe ikheli eliphelele ku-imeyili yakho, noma uxhumane nathi.",
    hi: "Sawubona",
    yourLink: "Izixhumanisi zakho zomuntu siqu",
    linksHint: "Isixhumanisi esisodwa ngomkhiqizo ngamunye. Noma ubani ongena ngaso futhi abhalise ubalelwa kuwe, nganoma yiluphi ulimi.",
    linkGeneral: "Gadit (jikelele)",
    linkFamilies: "Imindeni",
    linkSchools: "Izikole",
    copy: "Kopisha isixhumanisi",
    copied: "Kukopishiwe ✓",
    linkLangLabel: "Ulimi lwesixhumanisi",
    clicks: "Ukuchofoza",
    signups: "Ukubhalisa",
    paying: "Amakhasimende akhokhayo",
    earnings: "Inzuzo yakho",
    pending: "Kulindile",
    available: "Kuyatholakala",
    paid: "Kukhokhiwe",
    pendingNote: "Kukhululwa ngemva kwezinsuku ezingu-30 ngemva kokukhokha ngakunye",
    tierStandard: "Uzakwethu",
    tierFounder: "Uzakwethu Womsunguli",
    rateStandard: "25% unyaka wokuqala · 10% impilo yonke",
    rateFounder: "30% unyaka wokuqala · 10% impilo yonke",
    howTitle: "Kusebenza kanjani",
    how1: "Yabelana ngesixhumanisi sakho somuntu siqu.",
    how2: "Noma ubani obhalisayo futhi akhokhe ngaso ubalelwa kuwe izinsuku ezingu-60, noma engabhalisa kamuva.",
    how3: "Uzuza njalo ngenyanga ikhasimende elikhokha ngayo ngempela. Inzuzo ikhululwa ngemva kwezinsuku ezingu-30 futhi ikhokhwa nyanga zonke.",
    back: "Ikhaya le-Gadit",
    empty: "Ayikho inzuzo okwamanje. Yabelana ngesixhumanisi sakho ukuze uqale.",
  },
  vi: {
    dir: "ltr" as const,
    loading: "Đang tải bảng điều khiển của bạn…",
    notFound: "Chúng tôi không tìm thấy liên kết này. Hãy chắc chắn bạn đã sao chép đầy đủ địa chỉ từ email, hoặc liên hệ với chúng tôi.",
    hi: "Xin chào",
    yourLink: "Liên kết cá nhân của bạn",
    linksHint: "Mỗi sản phẩm một liên kết. Bất kỳ ai vào qua liên kết và đăng ký đều được ghi nhận cho bạn, ở mọi ngôn ngữ.",
    linkGeneral: "Gadit (chung)",
    linkFamilies: "Gia đình",
    linkSchools: "Trường học",
    copy: "Sao chép liên kết",
    copied: "Đã sao chép ✓",
    linkLangLabel: "Ngôn ngữ liên kết",
    clicks: "Lượt nhấp",
    signups: "Lượt đăng ký",
    paying: "Khách hàng trả phí",
    earnings: "Thu nhập của bạn",
    pending: "Đang chờ",
    available: "Có thể rút",
    paid: "Đã trả",
    pendingNote: "Giải ngân 30 ngày sau mỗi lần thanh toán",
    tierStandard: "Đối tác",
    tierFounder: "Đối tác Sáng lập",
    rateStandard: "25% năm đầu · 10% trọn đời",
    rateFounder: "30% năm đầu · 10% trọn đời",
    howTitle: "Cách hoạt động",
    how1: "Chia sẻ liên kết cá nhân của bạn.",
    how2: "Bất kỳ ai đăng ký và thanh toán qua liên kết đều được ghi nhận cho bạn trong 60 ngày, kể cả khi họ đăng ký sau.",
    how3: "Bạn nhận tiền cho mỗi tháng khách hàng thực sự thanh toán. Thu nhập được giải ngân sau 30 ngày và chi trả hằng tháng.",
    back: "Trang chủ Gadit",
    empty: "Chưa có thu nhập. Hãy chia sẻ liên kết để bắt đầu.",
  },
  fil: {
    dir: "ltr" as const,
    loading: "Nilo-load ang dashboard mo…",
    notFound: "Hindi namin mahanap ang link na ito. Tiyaking nakopya mo ang buong address mula sa email mo, o makipag-ugnayan sa amin.",
    hi: "Kumusta",
    yourLink: "Ang mga personal mong link",
    linksHint: "Isang link bawat produkto. Sinumang pumasok dito at nag-sign up ay maikukredito sa iyo, sa anumang wika.",
    linkGeneral: "Gadit (pangkalahatan)",
    linkFamilies: "Mga pamilya",
    linkSchools: "Mga paaralan",
    copy: "Kopyahin ang link",
    copied: "Nakopya ✓",
    linkLangLabel: "Wika ng link",
    clicks: "Mga click",
    signups: "Mga sign-up",
    paying: "Mga nagbabayad na customer",
    earnings: "Ang kita mo",
    pending: "Nakabinbin",
    available: "Available",
    paid: "Nabayaran",
    pendingNote: "Nare-release 30 araw pagkatapos ng bawat bayad",
    tierStandard: "Partner",
    tierFounder: "Founder Partner",
    rateStandard: "25% sa unang taon · 10% habambuhay",
    rateFounder: "30% sa unang taon · 10% habambuhay",
    howTitle: "Paano ito gumagana",
    how1: "Ibahagi ang personal mong link.",
    how2: "Sinumang mag-sign up at magbayad dito ay maikukredito sa iyo sa loob ng 60 araw, kahit mag-sign up sila mamaya.",
    how3: "Kumikita ka sa bawat buwang talagang nagbabayad ang customer. Nare-release ang kita pagkalipas ng 30 araw at binabayaran buwan-buwan.",
    back: "Home ng Gadit",
    empty: "Wala pang kita. Ibahagi ang link mo para makapagsimula.",
  },
  af: {
    dir: "ltr" as const,
    loading: "Jou paneelbord laai…",
    notFound: "Ons kon nie hierdie skakel vind nie. Maak seker jy het die volledige adres uit jou e-pos gekopieer, of kontak ons.",
    hi: "Hallo",
    yourLink: "Jou persoonlike skakels",
    linksHint: "Een skakel per produk. Enigiemand wat daardeur inkom en inteken, word aan jou toegeskryf, in enige taal.",
    linkGeneral: "Gadit (algemeen)",
    linkFamilies: "Gesinne",
    linkSchools: "Skole",
    copy: "Kopieer skakel",
    copied: "Gekopieer ✓",
    linkLangLabel: "Skakeltaal",
    clicks: "Klikke",
    signups: "Intekeninge",
    paying: "Betalende kliënte",
    earnings: "Jou verdienste",
    pending: "Hangend",
    available: "Beskikbaar",
    paid: "Uitbetaal",
    pendingNote: "Word 30 dae na elke betaling vrygestel",
    tierStandard: "Vennoot",
    tierFounder: "Stigtersvennoot",
    rateStandard: "25% eerste jaar · 10% lewenslank",
    rateFounder: "30% eerste jaar · 10% lewenslank",
    howTitle: "Hoe dit werk",
    how1: "Deel jou persoonlike skakel.",
    how2: "Enigiemand wat daardeur inteken en betaal, word vir 60 dae aan jou toegeskryf, selfs as hulle later inteken.",
    how3: "Jy verdien op elke maand wat die kliënt werklik betaal. Verdienste word na 30 dae vrygestel en maandeliks uitbetaal.",
    back: "Gadit tuis",
    empty: "Nog geen verdienste nie. Deel jou skakel om te begin.",
  },
  sw: {
    dir: "ltr" as const,
    loading: "Dashibodi yako inapakia…",
    notFound: "Hatukuweza kupata kiungo hiki. Hakikisha umenakili anwani kamili kutoka kwenye barua pepe yako, au wasiliana nasi.",
    hi: "Habari",
    yourLink: "Viungo vyako binafsi",
    linksHint: "Kiungo kimoja kwa kila bidhaa. Yeyote anayeingia kupitia kiungo hicho na kujisajili anahesabiwa kwako, kwa lugha yoyote.",
    linkGeneral: "Gadit (jumla)",
    linkFamilies: "Familia",
    linkSchools: "Shule",
    copy: "Nakili kiungo",
    copied: "Imenakiliwa ✓",
    linkLangLabel: "Lugha ya kiungo",
    clicks: "Mibofyo",
    signups: "Usajili",
    paying: "Wateja wanaolipa",
    earnings: "Mapato yako",
    pending: "Inasubiri",
    available: "Inapatikana",
    paid: "Imelipwa",
    pendingNote: "Hutolewa siku 30 baada ya kila malipo",
    tierStandard: "Mshirika",
    tierFounder: "Mshirika Mwanzilishi",
    rateStandard: "25% mwaka wa kwanza · 10% maisha yote",
    rateFounder: "30% mwaka wa kwanza · 10% maisha yote",
    howTitle: "Jinsi inavyofanya kazi",
    how1: "Shiriki kiungo chako binafsi.",
    how2: "Yeyote anayejisajili na kulipa kupitia kiungo hicho anahesabiwa kwako kwa siku 60, hata akijisajili baadaye.",
    how3: "Unapata kwa kila mwezi ambao mteja analipa kweli. Mapato hutolewa baada ya siku 30 na hulipwa kila mwezi.",
    back: "Nyumbani kwa Gadit",
    empty: "Bado hakuna mapato. Shiriki kiungo chako ili kuanza.",
  },
  "zh-CN": {
    dir: "ltr" as const,
    loading: "正在加载你的控制台…",
    notFound: "找不到这个链接。请确认你从邮件中复制了完整地址，或联系我们。",
    hi: "你好",
    yourLink: "你的专属链接",
    linksHint: "每个产品一个链接。任何通过链接进入并注册的人都会记在你名下，任何语言都可以。",
    linkGeneral: "Gadit（通用）",
    linkFamilies: "家庭",
    linkSchools: "学校",
    copy: "复制链接",
    copied: "已复制 ✓",
    ...
    available: "可提取",
    paid: "已支付",
    pendingNote: "每笔付款 30 天后释放",
    tierStandard: "合作伙伴",
    tierFounder: "创始合作伙伴",
    rateStandard: "第一年 25% · 终身 10%",
    rateFounder: "第一年 30% · 终身 10%",
    howTitle: "如何运作",
    how1: "分享你的专属链接。",
    how2: "任何通过链接注册并付费的人，在 60 天内都会记在你名下，即使他们之后才注册。",
    how3: "客户每实际付费一个月，你就获得一个月的佣金。收益在 30 天后释放，按月发放。",
    back: "Gadit 首页",
    empty: "暂无收益。分享你的链接即可开始。",
  },
  "zh-TW": {
    dir: "ltr" as const,
    loading: "正在載入你的控制台…",
    notFound: "找不到這個連結。請確認你從郵件中複製了完整網址，或與我們聯絡。",
    hi: "你好",
    yourLink: "你的專屬連結",
    linksHint: "每個產品一個連結。任何透過連結進入並註冊的人都會記在你名下，任何語言都可以。",
    linkGeneral: "Gadit（通用）",
    linkFamilies: "家庭",
    linkSchools: "學校",
    copy: "複製連結",
    ...
    available: "可提領",
    paid: "已撥款",
    pendingNote: "每筆付款 30 天後釋出",
    tierStandard: "合作夥伴",
    tierFounder: "創始合作夥伴",
    rateStandard: "第一年 25% · 終身 10%",
    rateFounder: "第一年 30% · 終身 10%",
    howTitle: "如何運作",
    how1: "分享你的專屬連結。",
    how2: "任何透過連結註冊並付費的人，在 60 天內都會記在你名下，即使他們之後才註冊。",
    how3: "客戶每實際付費一個月，你就獲得一個月的佣金。收益在 30 天後釋出，按月撥款。",
    back: "Gadit 首頁",
    empty: "目前還沒有收益。分享你的連結即可開始。",
  },
  ko: {
    dir: "ltr" as const,
    loading: "대시보드를 불러오는 중…",
    notFound: "이 링크를 찾을 수 없습니다. 이메일에서 전체 주소를 복사했는지 확인하시거나 저희에게 문의해 주세요.",
    hi: "안녕하세요",
    yourLink: "내 개인 링크",
    linksHint: "제품마다 링크가 하나씩 있습니다. 링크로 들어와 가입한 분은 언어와 관계없이 내 실적으로 인정됩니다.",
    linkGeneral: "Gadit (일반)",
    linkFamilies: "가족",
    linkSchools: "학교",
    copy: "링크 복사",
    copied: "복사됨 ✓",
    ...
    available: "지급 가능",
    paid: "지급 완료",
    pendingNote: "각 결제 30일 후 확정",
    tierStandard: "파트너",
    tierFounder: "창립 파트너",
    rateStandard: "첫해 25% · 평생 10%",
    rateFounder: "첫해 30% · 평생 10%",
    howTitle: "이용 방법",
    how1: "개인 링크를 공유하세요.",
    how2: "링크를 통해 가입하고 결제한 분은 나중에 가입하더라도 60일 동안 내 실적으로 인정됩니다.",
    how3: "고객이 실제로 결제한 매달 수익이 생깁니다. 수익은 30일 후 확정되고 매월 지급됩니다.",
    back: "Gadit 홈",
    empty: "아직 수익이 없습니다. 링크를 공유해 시작해 보세요.",
  },
  th: {
    dir: "ltr" as const,
    loading: "กำลังโหลดแดชบอร์ดของคุณ…",
    notFound: "เราไม่พบลิงก์นี้ โปรดตรวจสอบว่าคัดลอกที่อยู่ครบถ้วนจากอีเมลแล้ว หรือติดต่อเรา",
    hi: "สวัสดี",
    yourLink: "ลิงก์ส่วนตัวของคุณ",
    linksHint: "หนึ่งลิงก์ต่อหนึ่งผลิตภัณฑ์ ใครก็ตามที่เข้ามาผ่านลิงก์และสมัคร จะถูกนับเป็นของคุณ ไม่ว่าภาษาใด",
    linkGeneral: "Gadit (ทั่วไป)",
    linkFamilies: "ครอบครัว",
    linkSchools: "โรงเรียน",
    copy: "คัดลอกลิงก์",
    copied: "คัดลอกแล้ว ✓",
    linkLangLabel: "ภาษาของลิงก์",
    clicks: "คลิก",
    signups: "การสมัคร",
    paying: "ลูกค้าที่ชำระเงิน",
    earnings: "รายได้ของคุณ",
    pending: "รอดำเนินการ",
    available: "พร้อมถอน",
    paid: "จ่ายแล้ว",
    pendingNote: "ยืนยันยอด 30 วันหลังการชำระเงินแต่ละครั้ง",
    tierStandard: "พาร์ทเนอร์",
    tierFounder: "พาร์ทเนอร์ผู้ก่อตั้ง",
    rateStandard: "25% ในปีแรก · 10% ตลอดไป",
    rateFounder: "30% ในปีแรก · 10% ตลอดไป",
    howTitle: "วิธีการทำงาน",
    how1: "แชร์ลิงก์ส่วนตัวของคุณ",
    how2: "ใครก็ตามที่สมัครและชำระเงินผ่านลิงก์ จะถูกนับเป็นของคุณเป็นเวลา 60 วัน แม้จะสมัครภายหลัง",
    how3: "คุณได้รับรายได้ทุกเดือนที่ลูกค้าชำระเงินจริง รายได้จะยืนยันยอดหลัง 30 วันและจ่ายทุกเดือน",
    back: "หน้าแรก Gadit",
    empty: "ยังไม่มีรายได้ แชร์ลิงก์ของคุณเพื่อเริ่มต้น",
  },
  bn: {
    dir: "ltr" as const,
    loading: "আপনার ড্যাশবোর্ড লোড হচ্ছে…",
    notFound: "আমরা এই লিংকটি খুঁজে পাইনি। নিশ্চিত করুন যে ইমেইল থেকে পুরো ঠিকানাটি কপি করেছেন, অথবা আমাদের সঙ্গে যোগাযোগ করুন।",
    hi: "হ্যালো",
    yourLink: "আপনার ব্যক্তিগত লিংক",
    linksHint: "প্রতিটি পণ্যের জন্য একটি লিংক। যে কেউ এর মাধ্যমে এসে সাইন আপ করলে তা আপনার নামে গণ্য হয়, যেকোনো ভাষায়।",
    linkGeneral: "Gadit (সাধারণ)",
    linkFamilies: "পরিবার",
    linkSchools: "স্কুল",
    copy: "লিংক কপি করুন",
    copied: "কপি হয়েছে ✓",
    linkLangLabel: "লিংকের ভাষা",
    clicks: "ক্লিক",
    signups: "সাইন আপ",
    paying: "পেমেন্টকারী গ্রাহক",
    earnings: "আপনার আয়",
    pending: "অপেক্ষমাণ",
    available: "উপলব্ধ",
    paid: "পরিশোধিত",
    pendingNote: "প্রতিটি পেমেন্টের 30 দিন পরে রিলিজ হয়",
    tierStandard: "পার্টনার",
    tierFounder: "ফাউন্ডার পার্টনার",
    rateStandard: "প্রথম বছরে 25% · আজীবন 10%",
    rateFounder: "প্রথম বছরে 30% · আজীবন 10%",
    howTitle: "কীভাবে কাজ করে",
    how1: "আপনার ব্যক্তিগত লিংক শেয়ার করুন।",
    how2: "যে কেউ এর মাধ্যমে সাইন আপ করে পেমেন্ট করলে, পরে সাইন আপ করলেও 60 দিন পর্যন্ত তা আপনার নামে গণ্য হয়।",
    how3: "গ্রাহক সত্যিই যত মাস পেমেন্ট করেন, প্রতিটি মাসে আপনি আয় করেন। আয় 30 দিন পরে রিলিজ হয় এবং প্রতি মাসে পেমেন্ট করা হয়।",
    back: "Gadit হোম",
    empty: "এখনো কোনো আয় নেই। শুরু করতে আপনার লিংক শেয়ার করুন।",
  },
  da: {
    dir: "ltr" as const,
    loading: "Dit dashboard indlæses…",
    notFound: "Vi kunne ikke finde dette link. Sørg for, at du har kopieret hele adressen fra din e-mail, eller kontakt os.",
    hi: "Hej",
    yourLink: "Dine personlige links",
    linksHint: "Ét link pr. produkt. Alle, der kommer ind via det og tilmelder sig, krediteres dig, på alle sprog.",
    linkGeneral: "Gadit (generelt)",
    linkFamilies: "Familier",
    linkSchools: "Skoler",
    copy: "Kopiér link",
    copied: "Kopieret ✓",
    linkLangLabel: "Linkets sprog",
    clicks: "Klik",
    signups: "Tilmeldinger",
    paying: "Betalende kunder",
    earnings: "Din indtjening",
    pending: "Afventer",
    available: "Tilgængelig",
    paid: "Udbetalt",
    pendingNote: "Frigives 30 dage efter hver betaling",
    tierStandard: "Partner",
    tierFounder: "Stifterpartner",
    rateStandard: "25% første år · 10% på livstid",
    rateFounder: "30% første år · 10% på livstid",
    howTitle: "Sådan fungerer det",
    how1: "Del dit personlige link.",
    how2: "Alle, der tilmelder sig og betaler via det, krediteres dig i 60 dage, også hvis de tilmelder sig senere.",
    how3: "Du tjener på hver måned, kunden faktisk betaler. Indtjeningen frigives efter 30 dage og udbetales månedligt.",
    back: "Gadit forside",
    empty: "Ingen indtjening endnu. Del dit link for at komme i gang.",
  },
  hu: {
    dir: "ltr" as const,
    loading: "Az irányítópultod betöltése…",
    notFound: "Nem találjuk ezt a linket. Ellenőrizd, hogy a teljes címet másoltad-e ki az e-mailből, vagy vedd fel velünk a kapcsolatot.",
    hi: "Szia",
    yourLink: "A személyes linkjeid",
    linksHint: "Termékenként egy link. Aki ezen keresztül érkezik és regisztrál, a te javadra számít, bármilyen nyelven.",
    linkGeneral: "Gadit (általános)",
    linkFamilies: "Családok",
    linkSchools: "Iskolák",
    copy: "Link másolása",
    copied: "Másolva ✓",
    linkLangLabel: "A link nyelve",
    clicks: "Kattintások",
    signups: "Regisztrációk",
    paying: "Fizető ügyfelek",
    earnings: "A bevételed",
    pending: "Függőben",
    available: "Elérhető",
    paid: "Kifizetve",
    pendingNote: "Minden fizetés után 30 nappal szabadul fel",
    tierStandard: "Partner",
    tierFounder: "Alapító partner",
    rateStandard: "25% az első évben · 10% egy életen át",
    rateFounder: "30% az első évben · 10% egy életen át",
    howTitle: "Hogyan működik",
    how1: "Oszd meg a személyes linkedet.",
    how2: "Aki ezen keresztül regisztrál és fizet, 60 napig a te javadra számít, akkor is, ha később regisztrál.",
    how3: "Minden hónap után keresel, amikor az ügyfél ténylegesen fizet. A bevétel 30 nap után szabadul fel, és havonta fizetjük ki.",
    back: "Gadit főoldal",
    empty: "Még nincs bevétel. Oszd meg a linkedet, és kezdj bele.",
  },
};
