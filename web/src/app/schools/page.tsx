...
export const SCHOOLS_OG: Record<string, ShareCopy> = {
  he: { title: "Gadit לבתי ספר · כל תלמיד מבין את השיעור", description: "כשתלמיד לא מבין מילה, הוא לא מבין את החומר. Gadit נותן לכל תלמיד להבין כל מילה קשה, בשפה שלו, ב-20 שפות. בלי חשבונות לתלמידים, בלי הקמה. 14 ימי ניסיון חינם." },
  en: { title: "Gadit for Schools · Every student understands the lesson", description: "When a student doesn't understand a word, they don't understand the material. Gadit explains any hard word, in the student's own language, across 20 languages. No student accounts, no setup. 14-day free trial." },
