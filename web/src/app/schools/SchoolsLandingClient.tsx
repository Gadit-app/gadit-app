...
const COPY: Record<string, T> = {
  en: {
    ...
    heroSub: "Any hard word, in any of 21 languages, explained on the spot.",
  ...
  el: {
    ...
    heroSub: "Κάθε δύσκολη λέξη, σε οποιαδήποτε από τις 21 γλώσσες, εξηγείται επιτόπου.",
    ...
    priceIncludes: [
      ...
      "Περιβάλλον μαθητή σε 21 γλώσσες",
  ...
  uk: {
    ...
    heroSub: "Будь-яке складне слово, будь-якою з 21 мов, пояснене одразу.",
  ...
  tr: {
    ...
    heroSub: "Zor herhangi bir kelime, 21 dilden herhangi birinde, anında açıklanır.",
  ...
  pl: {
    ...
    heroSub: "Każde trudne słowo, w dowolnym z 21 języków, wyjaśnione od razu.",
    ...
    priceIncludes: [
      ...
      "Interfejs ucznia w 21 językach",
  ...
  fa: {
    ...
    heroSub: "هر واژه‌ی دشوار، در هر یک از 21 زبان، همان‌جا توضیح داده می‌شود.",
    ...
    priceIncludes: [
      ...
      "کدهای کلاس زمان‌دار",
      "رابط کاربری دانش‌آموز در 21 زبان",
  ...
  id: {
    ...
    heroSub: "Kata sulit apa pun, dalam salah satu dari 21 bahasa, dijelaskan saat itu juga.",
    ...
    priceIncludes: [
      ...
      "Antarmuka murid dalam 21 bahasa",
  ...
  he: {
    ...
    heroSub: "כל מילה קשה, ב-21 שפות, מוסברת מיד.",
  ...
  nl: {
    ...
    heroSub: "Elk moeilijk woord, in een van de 21 talen, meteen uitgelegd.",
  ...
  am: {
    ...
    heroSub: "ማንኛውም አስቸጋሪ ቃል፣ ከ21 ቋንቋዎች በአንዱ፣ ወዲያውኑ ይብራራል።",
  ...
  es: {
    ...
    heroSub: "Cualquier palabra difícil, en cualquiera de 21 idiomas, explicada al instante.",
    ...
    priceIncludes: [
      ...
      "Interfaz del estudiante en 21 idiomas",
  ...
  pt: {
    ...
    heroSub: "Qualquer palavra difícil, em qualquer um dos 21 idiomas, explicada na hora.",
    ...
    priceIncludes: [
      ...
      "Interface do aluno em 21 idiomas",
  ...
  fr: {
    ...
    heroSub: "Chaque mot difficile, dans l'une des 21 langues, expliqué aussitôt.",
  ...
  de: {
    ...
    heroSub: "Jedes schwierige Wort, in einer von 21 Sprachen, sofort erklärt.",
    ...
    priceIncludes: [
      ...
      "Schüler-Oberfläche in 21 Sprachen",
  ...
  it: {
    ...
    heroSub: "Ogni parola difficile, in una delle 21 lingue, spiegata all'istante.",
    ...
    priceIncludes: [
      ...
      "Interfaccia studente in 21 lingue",
...
const XLANG: Record<string, XLang> = {
  en: {
    ...
    note: "This is not only for new immigrants. It is for every student who hits a hard word, in any of 21 languages. The goal is understanding the material; this is the strongest tool for it.",
  },
  he: {
    tag: "חוצה שפות",
    ...
    note: "זה לא רק לעולים חדשים. זה לכל תלמיד שנתקל במילה קשה, בכל אחת מ-21 שפות. המטרה היא הבנת החומר, וזה הכלי החזק ביותר עבורה.",
  },
  ar: {
    tag: "عبر اللغات",
