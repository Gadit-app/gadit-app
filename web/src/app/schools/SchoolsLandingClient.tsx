...
const COPY: Record<string, T> = {
  ...
  vi: {
    heroH1: "Mọi học sinh đều hiểu bài.",
    heroSub: "Bất kỳ từ khó nào, bằng bất kỳ ngôn ngữ nào trong 30+ ngôn ngữ, được giải thích ngay tại chỗ.",
    heroCta: "Xem bảng giá và đặt mua",
    heroPriceChip: "Từ $97 / tháng",
    heroTrust: "Tự đăng ký. Hủy bất cứ lúc nào.",
    probTag: "Vấn đề",
    probH2: "Học sinh không hiểu một từ thì không thể hiểu cả câu.",
    probBody1: "Một học sinh bỏ lỡ một từ. Em không giơ tay. Em nghĩ mình hiểu đại khái. Giáo viên giảng tiếp. Năm từ sau, cả đoạn văn trở nên mờ nhạt. Năm đoạn sau, cả bài học trôi mất.",
    probBody2: "Phần lớn học sinh bị tụt lại không phải vì kém thông minh. Các em có cả một chồng từ chưa bao giờ hiểu trọn vẹn. Mỗi từ mới xây trên nền đó lại làm khoảng cách lớn thêm. Và giáo viên không nhìn thấy nguyên nhân.",
    probCallout1Title: "Khoảng cách tích tụ",
    probCallout1Body: "Những từ chưa hiểu dựng nên một bức tường vô hình trước mọi bài học sau này.",
    probCallout2Title: "Thời gian bị hao hụt",
    probCallout2Body: "Giáo viên mất từ 5 đến 10 phút mỗi tiết chỉ để giải nghĩa từ.",
    probCallout3Title: "Sự bỏ cuộc thầm lặng",
    probCallout3Body: "Học sinh mất tập trung khi một đoạn văn có quá nhiều từ không biết.",
    howTag: "Cách hoạt động",
    howH2: "Thiết lập trong 2 phút. Không cần bộ phận IT.",
    howSub: "Vẫn là cách vào lớp bằng mã đơn giản vốn đã quen thuộc với các trò chơi đố vui, nhưng được xây dựng để giúp hiểu từ.",
    howStep1Title: "Tạo mã lớp học",
    howStep1Body: "Hiệu trưởng hoặc điều phối viên tạo một lớp học trên bảng điều khiển. Hệ thống tạo ra một mã gồm 6 ký tự. In mã lên nhãn dán cho máy tính của lớp.",
    howStep2Title: "Học sinh vào lớp, không cần tài khoản",
    howStep2Body: "Học sinh truy cập gadit.app/c/CODE trên bất kỳ trình duyệt nào, chọn tên mình trong danh sách lớp (một cú nhấp) và bắt đầu gõ từ. Không cài ứng dụng, không email, không mật khẩu.",
    howStep3Title: "Giáo viên thấy lớp đã tra những gì",
    howStep3Body: "Mọi lượt tra từ đều hiện trên bảng điều khiển, kèm tên học sinh. Thầy cô thấy từng em đã tra gì, lúc nào, và những từ nào cả lớp cùng gặp khó.",
    teacherTag: "Góc nhìn của giáo viên",
    teacherH2: "Bảng điều khiển mà thầy cô vẫn mong đợi.",
    teacherSub: "Không phải những chỉ số tương tác mơ hồ. Mà là từ cụ thể, học sinh cụ thể, thời điểm cụ thể.",
    teacherB1: "Lịch sử tra từ của từng học sinh, kèm thời gian",
    teacherB2: "Những từ được cả lớp tra nhiều nhất tuần này",
    teacherB3: "Các lượt tra lặp lại, báo hiệu chỗ hiểu còn chưa vững",
    teacherB4: "Lọc theo ngày, học sinh hoặc từ",
    privTag: "Quyền riêng tư ngay từ thiết kế",
    privH2: "Giáo viên thấy mọi thứ. Nhà trường không gặp rủi ro dữ liệu nào.",
    privSub: "Chúng tôi không thu thập bất kỳ thông tin cá nhân nào của học sinh. Không phải vì chúng tôi giấu kỹ, mà vì chúng tôi chưa bao giờ thu thập. Chính kiến trúc hệ thống đã đảm bảo tuân thủ.",
    privPoint1: "Không có tài khoản học sinh. Không email, không mật khẩu, không mã định danh.",
    privPoint2: "Không dữ liệu cá nhân nào rời khỏi trường. Lượt tra chỉ gắn với tên trong danh sách lớp.",
    privPoint3: "Mã lớp học chỉ hoạt động trong giờ học. Mỗi trường có thể tự điều chỉnh.",
    privPoint4: "Đáp ứng thoải mái COPPA, GDPR-K và luật bảo vệ quyền riêng tư học sinh của Israel.",
    privKahoot: "Vào lớp dễ như một trò chơi đố vui trên lớp. Được xây dựng để hiểu từ và để giáo viên nắm bắt được.",
    priceTag: "Bảng giá",
    priceH2: "Giá theo năm, tùy quy mô trường.",
    priceSub: "Tự đăng ký qua Stripe. Không cuộc gọi bán hàng, không buổi demo, không đơn đặt hàng.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Tối đa 100 học sinh",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Tối đa 500 học sinh",
    priceIncludesTitle: "Cả hai gói đều bao gồm",
    priceIncludes: [
      "Không giới hạn số lớp học",
      "Bảng điều khiển đầy đủ cho giáo viên",
      "Danh sách lớp để học sinh chọn tên",
      "Mã lớp học có giới hạn thời gian",
      "Giao diện học sinh bằng 30+ ngôn ngữ",
      "Đơn hàng năm đơn giản, dưới ngưỡng phải đấu thầu",
      "Luyện phát âm: nghe và nói bất kỳ từ nào",
    ],
    priceCta: "Xem bảng giá và đặt mua",
    priceLarger: "Trường có hơn 1,000 học sinh? Liên hệ với chúng tôi về gói cho cả khu học chánh.",
    faqTag: "Câu hỏi thường gặp",
    faqH2: "Những câu hiệu trưởng thường hỏi trước khi đặt mua.",
    faq: [
      {
        q: "Nếu không có đăng nhập, làm sao tôi biết học sinh nào đã tra gì?",
        a: "Giáo viên nạp sẵn danh sách tên của học sinh vào bảng điều khiển. Khi học sinh mở đường dẫn của lớp, các em chọn tên mình bằng một cú nhấp. Mọi lượt tra đều gắn với tên đó. Không email, không mật khẩu, không thu thập thông tin cá nhân nào.",
      },
      {
        q: "Có an toàn theo COPPA không? Tôi có bị phụ huynh khiếu nại không?",
        a: "Có. Gadit hoàn toàn không thu thập thông tin cá nhân của học sinh. Không tạo tài khoản, không thu email, không ngày sinh, không mã định danh. Không có dữ liệu nào để bị lạm dụng. Kiến trúc này vượt xa yêu cầu của COPPA, GDPR-K và luật bảo vệ quyền riêng tư học sinh của Israel.",
      },
      {
        q: "Học sinh có cần cài ứng dụng không?",
        a: "Không. Trình duyệt nào cũng dùng được. Học sinh vào gadit.app/c/CODE trên máy tính của lớp (hoặc bất kỳ thiết bị nào có trình duyệt). Không cần kho ứng dụng, không cần bộ phận IT.",
      },
      {
        q: "Có cần thiết lập IT hoặc SSO không?",
        a: "Không. Hiệu trưởng hoặc điều phối viên khối lớp tạo lớp học trong hai phút và chia sẻ mã cho giáo viên. Bộ phận IT không phải tham gia ở bất kỳ bước nào.",
      },
      {
        q: "Bảng điều khiển thực sự cho thấy gì?",
        a: "Các lượt tra từ của từng học sinh kèm thời gian, những từ cả lớp tra nhiều nhất tuần này, và các mẫu tra lặp lại cho thấy chỗ hiểu còn chưa vững. Thầy cô thấy dữ liệu thật về mức độ hiểu bài trong lớp, không phải những chỉ số tương tác mơ hồ.",
      },
      {
        q: "Có dùng được ngoài giờ học không?",
        a: "Mã lớp học gắn với giờ hoạt động của trường (mặc định từ Chủ nhật đến thứ Năm, 7:30 đến 15:00, có thể điều chỉnh). Ngoài khung giờ đó, mã chỉ cho phép tra từ cơ bản, không có các tính năng mở rộng. Điều này giúp mã của trường không trở thành một bản thay thế miễn phí 24/7 cho gói Family.",
      },
      {
        q: "Nếu trường tôi có hơn 500 học sinh thì sao?",
        a: "Chọn theo số học sinh: tối đa 100 học sinh là $97/tháng, tối đa 500 là $297/tháng, và tối đa 1,000 là $497/tháng. Với hơn 1,000 học sinh hoặc khu học chánh nhiều cơ sở, hãy liên hệ để chúng tôi thiết kế gói riêng.",
      },
      {
        q: "Gadit giải thích từ như thế nào? Có phải chỉ là dịch không?",
        a: "Gadit không phải từ điển dịch. Gadit định nghĩa và giải thích từ. Với mỗi từ, Gadit đưa ra mọi nghĩa, ba câu ví dụ cho mỗi nghĩa, nguồn gốc của từ, và một chế độ theo ngữ cảnh: học sinh dán câu vào và Gadit chọn đúng nghĩa. Giao diện của học sinh bằng ngôn ngữ của các em, nhưng độ sâu của phần giải thích là như nhau ở mọi ngôn ngữ giao diện.",
      },
    ],
    finalH2: "Chấm dứt thất bại trong im lặng.",
    finalBody: "Hãy trao cho giáo viên công cụ để thấy chính xác lớp mình chưa hiểu điều gì. Bắt đầu chỉ mất 2 phút. Không cần IT, không thủ tục mua sắm, không giấy tờ cho phụ huynh.",
    finalCta: "Xem bảng giá và đặt mua",
    finalNote: "Thanh toán theo năm bằng chuyển khoản ngân hàng theo hóa đơn thuế. Không cần đấu thầu.",
    mockupRoster: "Danh sách lớp, 22 học sinh",
    mockupSearches: "Tra nhiều nhất tuần này",
    mockupStudent1: "Maya đã tra quang hợp",
    mockupStudent2: "Yossi đã tra ty thể ×2",
    mockupStudent3: "Noa đã tra dân chủ",
    mockupWordExample: "quang hợp",
    mockupExampleDef: "Quá trình cây xanh dùng ánh sáng mặt trời để biến nước và khí cacbonic thành chất dinh dưỡng.",
    mockupExampleEx: "Quang hợp diễn ra chủ yếu ở lá cây.",
  },
  fil: {
    heroH1: "Naiintindihan ng bawat estudyante ang aralin.",
    heroSub: "Anumang mahirap na salita, sa alinman sa 30+ na wika, ipinapaliwanag agad-agad.",
    heroCta: "Tingnan ang presyo at mag-order",
    heroPriceChip: "Mula $97 / buwan",
    heroTrust: "Self-serve. Puwedeng kanselahin anumang oras.",
    probTag: "Ang Problema",
    probH2: "Ang estudyanteng hindi nakakaintindi ng isang salita ay hindi makakaintindi ng pangungusap.",
    probBody1: "May isang salitang hindi nakuha ng estudyante. Hindi siya nagtaas ng kamay. Akala niya ay halos naiintindihan niya. Nagpatuloy ang guro. Pagkalipas ng limang salita, malabo na ang talata. Pagkalipas ng limang talata, nawala na ang aralin.",
    probBody2: "Karamihan sa mga estudyanteng naiiwan ay hindi kulang sa talino. May tambak silang mga salitang hindi nila lubos na naintindihan. Bawat bagong salitang nakapatong doon ay lalong nagpapalaki ng agwat. Hindi ito nakikita ng guro.",
    probCallout1Title: "Ang lumalaking agwat",
    probCallout1Body: "Ang mga salitang hindi natutunan ay nagiging di-nakikitang harang sa bawat susunod na aralin.",
    probCallout2Title: "Ang nasasayang na oras",
    probCallout2Body: "Nauubos ang 5 hanggang 10 minuto ng guro bawat aralin sa pagpapaliwanag ng mga kahulugan.",
    probCallout3Title: "Ang tahimik na pag-ayaw",
    probCallout3Body: "Nawawalan ng pokus ang mga estudyante kapag napakaraming di-kilalang salita sa isang talata.",
    howTag: "Paano Ito Gumagana",
    howH2: "Handa sa loob ng 2 minuto. Walang IT.",
    howSub: "Ang parehong madaling classroom code na gumagana na sa mga quiz game, pero ginawa para sa pag-unawa ng mga salita.",
    howStep1Title: "Gumawa ng classroom code",
    howStep1Body: "Gumagawa ang punong-guro o coordinator ng classroom sa dashboard. Gagawa ang system ng 6-character na code. I-print ito sa sticker para sa computer ng klase.",
    howStep2Title: "Sumasali ang mga estudyante, walang account",
    howStep2Body: "Bibisitahin ng mga estudyante ang gadit.app/c/CODE sa kahit anong browser, pipiliin ang pangalan nila sa roster (isang click), at magsisimulang mag-type ng mga salita. Walang ini-install na app, walang email, walang password.",
    howStep3Title: "Nakikita ng mga guro ang hinanap ng klase",
    howStep3Body: "Bawat paghahanap ay pumapasok sa dashboard, may kasamang pangalan ng estudyante. Makikita ninyo kung ano ang hinanap ng bawat estudyante, kailan, at aling mga salita ang pinahirapan ng buong klase.",
    teacherTag: "Ang View ng Guro",
    teacherH2: "Ang dashboard na matagal na ninyong hinihiling.",
    teacherSub: "Hindi malalabong engagement metric. Tiyak na mga salita, tiyak na mga estudyante, tiyak na mga sandali.",
    teacherB1: "Search history ng bawat estudyante, may oras",
    teacherB2: "Mga salitang pinakamadalas hinanap ng buong klase ngayong linggo",
    teacherB3: "Mga paulit-ulit na paghahanap na nagpapakita ng marupok na pag-unawa",
    teacherB4: "Puwedeng i-filter ayon sa petsa, estudyante, o salita",
    privTag: "Privacy Mula sa Disenyo",
    privH2: "Buong visibility para sa mga guro. Walang panganib sa data para sa paaralan.",
    privSub: "Hindi kami nangongolekta ng personal na impormasyon ng estudyante. Hindi dahil mahusay naming itinatago ito, kundi dahil hindi namin ito kailanman kinokolekta. Ang arkitektura mismo ang compliance.",
    privPoint1: "Walang account ng estudyante. Walang email, walang password, walang ID.",
    privPoint2: "Walang personal na data na lumalabas sa paaralan. Ang mga paghahanap ay naka-tag lang sa pangalan sa roster.",
    privPoint3: "Gumagana lang ang classroom code sa oras ng klase. Puwedeng i-configure bawat paaralan.",
    privPoint4: "Kumportableng natutugunan ang COPPA, GDPR-K, at ang batas ng Israel sa privacy ng estudyante.",
    privKahoot: "Kasindali ng pagsali sa quiz game sa klase. Ginawa para sa pag-unawa ng salita at visibility ng guro.",
    priceTag: "Presyo",
    priceH2: "Taunang presyo, ayon sa laki ng paaralan.",
    priceSub: "Self-serve sa pamamagitan ng Stripe. Walang sales call, walang demo, walang purchase order.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Hanggang 100 estudyante",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Hanggang 500 estudyante",
    priceIncludesTitle: "Kasama sa parehong plano",
    priceIncludes: [
      "Walang limitasyong classroom",
      "Buong dashboard ng guro",
      "Roster na pinipilian ng estudyante",
      "Classroom code na may takdang oras",
      "Student UI sa 30+ na wika",
      "Simpleng taunang order, mas mababa sa procurement threshold",
      "Pagsasanay sa pagbigkas: pakinggan at sabihin ang anumang salita",
    ],
    priceCta: "Tingnan ang presyo at mag-order",
    priceLarger: "Higit sa 1,000 estudyante? Makipag-ugnayan sa amin tungkol sa mga plano para sa buong distrito.",
    faqTag: "FAQ",
    faqH2: "Mga tanong ng mga punong-guro bago sila mag-order.",
    faq: [
      {
        q: "Kung walang login, paano ko malalaman kung aling estudyante ang naghanap ng ano?",
        a: "Naglalagay ang guro ng roster ng mga pangalan sa dashboard. Kapag binisita ng estudyante ang URL ng classroom, pipiliin niya ang pangalan niya sa isang click. Bawat paghahanap ay naka-tag sa pangalang iyon. Walang email, walang password, walang personal na impormasyong kinokolekta.",
      },
      {
        q: "Ligtas ba ito sa COPPA? Magkakaroon ba ako ng reklamo mula sa magulang?",
        a: "Oo. Hindi nangongolekta ang Gadit ng anumang personal na impormasyon ng estudyante. Walang paggawa ng account, walang pagkolekta ng email, walang kaarawan, walang ID. Walang data na puwedeng maabuso. Kumportableng nahihigitan ng arkitektura ang COPPA, GDPR-K, at ang batas ng Israel sa privacy ng estudyante.",
      },
      {
        q: "Kailangan bang mag-install ng app ang mga estudyante?",
        a: "Hindi. Gumagana ang kahit anong browser. Bibisitahin ng mga estudyante ang gadit.app/c/CODE sa computer ng klase (o sa kahit anong device na may browser). Walang app store, walang kailangang IT.",
      },
      {
        q: "Kailangan ba ng IT o SSO setup?",
        a: "Hindi. Gagawa ang punong-guro o grade coordinator ng classroom sa loob ng dalawang minuto at ibabahagi ang code sa mga guro. Walang papel ang IT sa anumang hakbang.",
      },
      {
        q: "Ano talaga ang ipinapakita ng dashboard?",
        a: "Ang mga paghahanap ng bawat estudyante na may oras, ang mga salitang pinakamadalas hinanap ng klase ngayong linggo, at ang mga pattern ng paulit-ulit na paghahanap na nagpapakita ng marupok na pag-unawa. Makikita ninyo ang totoong data ng pag-unawa sa klase, hindi malalabong engagement metric.",
      },
      {
        q: "Puwede ba itong gamitin sa labas ng oras ng klase?",
        a: "Nakatali ang classroom code sa aktibong oras ng paaralan (default ay Linggo hanggang Huwebes, 7:30 hanggang 15:00, puwedeng baguhin). Sa labas ng oras na iyon, basic na dictionary access lang ang ibinibigay ng code at walang extended feature. Pinipigilan nito na maging libreng 24/7 na pamalit sa Family tier ang code ng paaralan.",
      },
      {
        q: "Paano kung higit sa 500 ang estudyante ng paaralan ko?",
        a: "Pumili ayon sa bilang ng estudyante: hanggang 100 estudyante ay $97/buwan, hanggang 500 ay $297/buwan, at hanggang 1,000 ay $497/buwan. Para sa higit sa 1,000 estudyante o distritong may maraming site, makipag-ugnayan sa amin para sa custom na plano.",
      },
      {
        q: "Paano ipinapaliwanag ng Gadit ang isang salita? Pagsasalin lang ba ito?",
        a: "Hindi translation dictionary ang Gadit. Binibigyang-kahulugan at ipinapaliwanag ng Gadit ang mga salita. Para sa bawat salita, ibinibigay nito ang lahat ng kahulugan, tatlong halimbawang pangungusap bawat kahulugan, etimolohiya, at context mode kung saan idinidikit ng estudyante ang pangungusap at pinipili ng Gadit ang tamang kahulugan. Nasa wika ng estudyante ang UI, pero pareho ang lalim ng paliwanag sa bawat wika ng UI.",
      },
    ],
    finalH2: "Itigil ang tahimik na pagkabigo.",
    finalBody: "Bigyan ang inyong mga guro ng kasangkapan para makita nang eksakto kung ano ang hindi naiintindihan ng klase nila. 2 minuto lang ang pagsisimula. Walang IT, walang procurement, walang form para sa magulang.",
    finalCta: "Tingnan ang presyo at mag-order",
    finalNote: "Magbayad taun-taon sa bank transfer laban sa tax invoice. Hindi kailangan ng tender.",
    mockupRoster: "Roster ng klase, 22 estudyante",
    mockupSearches: "Pinakamadalas hinanap ngayong linggo",
    mockupStudent1: "Hinanap ni Maya ang potosintesis",
    mockupStudent2: "Hinanap ni Yossi ang mitochondria ×2",
    mockupStudent3: "Hinanap ni Noa ang demokrasya",
    mockupWordExample: "potosintesis",
    mockupExampleDef: "Ang proseso kung saan ginagamit ng mga luntiang halaman ang sikat ng araw para gawing pagkain ang tubig at carbon dioxide.",
    mockupExampleEx: "Kadalasang nangyayari ang potosintesis sa mga dahon ng halaman.",
  },
  af: {
    heroH1: "Elke leerder verstaan die les.",
    heroSub: "Enige moeilike woord, in enige van 30+ tale, dadelik verduidelik.",
    heroCta: "Sien pryse en bestel",
    heroPriceChip: "Vanaf $97 / maand",
    heroTrust: "Selfdiens. Kanselleer enige tyd.",
    probTag: "Die Probleem",
    probH2: "'n Leerder wat 'n woord nie verstaan nie, kan die sin nie verstaan nie.",
    probBody1: "'n Leerder mis een woord. Hulle steek nie hul hand op nie. Hulle dink hulle verstaan min of meer. Die onderwyser gaan aan. Vyf woorde later is die paragraaf vaag. Vyf paragrawe later is die les verlore.",
    probBody2: "Die meeste leerders wat agterraak, is nie onintelligent nie. Hulle het 'n stapel woorde wat hulle nooit ten volle verstaan het nie. Elke nuwe woord wat daarop bou, vergroot die gaping. Die oorsaak is onsigbaar vir die onderwyser.",
    probCallout1Title: "Die groeiende gaping",
    probCallout1Body: "Ongeleerde woorde bou 'n onsigbare versperring vir elke toekomstige les.",
    probCallout2Title: "Die tydverlies",
    probCallout2Body: "Onderwysers verloor 5 tot 10 minute per les aan definisies.",
    probCallout3Title: "Die stil uitvaller",
    probCallout3Body: "Leerders skakel af wanneer 'n paragraaf te veel onbekende woorde het.",
    howTag: "Hoe Dit Werk",
    howH2: "Opgestel in 2 minute. Geen IT nie.",
    howSub: "Dieselfde moeitelose klaskamerkode wat reeds vir vasvrae-speletjies werk, maar gebou vir woordbegrip.",
    howStep1Title: "Skep 'n klaskamerkode",
    howStep1Body: "Die skoolhoof of koördineerder skep 'n klaskamer in die paneelbord. Die stelsel genereer 'n kode van 6 karakters. Druk dit op 'n plakker vir die klaskamerrekenaar.",
    howStep2Title: "Leerders sluit aan, geen rekeninge nie",
    howStep2Body: "Leerders besoek gadit.app/c/CODE in enige blaaier, kies hul naam van die klaslys (een klik) en begin woorde tik. Geen toepassing om te installeer nie, geen e-pos nie, geen wagwoord nie.",
    howStep3Title: "Onderwysers sien wat die klas gesoek het",
    howStep3Body: "Elke soektog beland in die paneelbord, gemerk met die leerder se naam. Jy sien wat elke leerder opgesoek het, wanneer, en met watter woorde die klas saam gesukkel het.",
    teacherTag: "Die Onderwyser se Blik",
    teacherH2: "Die paneelbord waarvoor jy al lank vra.",
    teacherSub: "Nie vae betrokkenheidsyfers nie. Spesifieke woorde, spesifieke leerders, spesifieke oomblikke.",
    teacherB1: "Soekgeskiedenis per leerder, met tydstempels",
    teacherB2: "Die klas se mees gesoekte woorde hierdie week",
    teacherB3: "Herhaalde soektogte wat brose begrip uitlig",
    teacherB4: "Filtreer volgens datum, leerder of woord",
    privTag: "Privaatheid Ingebou",
    privH2: "Volle sigbaarheid vir onderwysers. Geen datarisiko vir skole nie.",
    privSub: "Ons versamel geen persoonlike inligting van leerders nie. Nie omdat ons dit goed wegsteek nie, maar omdat ons dit nooit versamel nie. Die argitektuur self is die nakoming.",
    privPoint1: "Geen leerderrekeninge nie. Geen e-posse, geen wagwoorde, geen ID's nie.",
    privPoint2: "Geen persoonlike data verlaat die skool nie. Soektogte word slegs met die naam op die klaslys gemerk.",
    privPoint3: "Klaskamerkodes werk slegs gedurende skoolure. Aanpasbaar per skool.",
    privPoint4: "COPPA, GDPR-K en Israeliese wetgewing oor leerderprivaatheid word gemaklik nagekom.",
    privKahoot: "Sluit so maklik aan soos 'n vasvra-speletjie in die klas. Gebou vir woordbegrip en sigbaarheid vir onderwysers.",
    priceTag: "Pryse",
    priceH2: "Jaarlikse pryse, volgens skoolgrootte.",
    priceSub: "Selfdiens via Stripe. Geen verkoopsoproepe, geen demonstrasies, geen aankoopbestellings nie.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Tot 100 leerders",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Tot 500 leerders",
    priceIncludesTitle: "Albei planne sluit in",
    priceIncludes: [
      "Onbeperkte klaskamers",
      "Volledige paneelbord vir onderwysers",
      "Klaslys waaruit leerders hul naam kies",
      "Tydgebonde klaskamerkodes",
      "Leerderkoppelvlak in 30+ tale",
      "Eenvoudige jaarlikse bestelling, onder die aankoopdrempel",
      "Uitspraakoefening: hoor en sê enige woord",
    ],
    priceCta: "Sien pryse en bestel",
    priceLarger: "Meer as 1,000 leerders? Kontak ons oor planne vir hele distrikte.",
    faqTag: "Vrae",
    faqH2: "Vrae wat skoolhoofde vra voordat hulle bestel.",
    faq: [
      {
        q: "As daar geen aanmeldings is nie, hoe weet ek watter leerder wat gesoek het?",
        a: "Die onderwyser laai vooraf 'n klaslys met voorname in die paneelbord. Wanneer 'n leerder die klaskamer se URL besoek, kies hulle hul naam met een klik. Elke soektog word aan daardie naam gekoppel. Geen e-pos, geen wagwoord, geen persoonlike inligting word versamel nie.",
      },
      {
        q: "Is dit COPPA-veilig? Gaan ek 'n klagte van 'n ouer kry?",
        a: "Ja. Gadit versamel glad geen persoonlike inligting van leerders nie. Geen rekeninge, geen e-posadresse, geen verjaardae, geen ID's nie. Daar is geen data om te misbruik nie. Die argitektuur oortref gemaklik COPPA, GDPR-K en Israeliese wetgewing oor leerderprivaatheid.",
      },
      {
        q: "Moet leerders 'n toepassing installeer?",
        a: "Nee. Enige blaaier werk. Leerders besoek gadit.app/c/CODE op die klaskamerrekenaar (of enige toestel met 'n blaaier). Geen toepassingswinkel, geen IT-betrokkenheid nie.",
      },
      {
        q: "Is IT- of SSO-opstelling nodig?",
        a: "Nee. 'n Skoolhoof of graadkoördineerder skep die klaskamer in twee minute en deel die kode met onderwysers. IT is by geen stap betrokke nie.",
      },
      {
        q: "Wat wys die paneelbord eintlik?",
        a: "Elke leerder se woordsoektogte met tydstempels, die woorde wat die klas hierdie week die meeste gesoek het, en patrone van herhaalde soektogte wat op brose begrip dui. Jy sien die werklike data oor begrip in die klas, nie vae betrokkenheidsyfers nie.",
      },
      {
        q: "Kan dit buite klastyd gebruik word?",
        a: "Klaskamerkodes is gekoppel aan die skool se aktiewe ure (by verstek Sondag tot Donderdag, 7:30 tot 15:00, aanpasbaar). Buite daardie venster gee die kode basiese woordeboektoegang, maar geen uitgebreide funksies nie. Dit keer dat die skoolkode 'n gratis 24/7 plaasvervanger vir die Family-vlak word.",
      },
      {
        q: "Wat as my skool meer as 500 leerders het?",
        a: "Kies volgens die aantal leerders: tot 100 leerders is $97/maand, tot 500 is $297/maand, en tot 1,000 is $497/maand. Vir meer as 1,000 leerders of distrikte met verskeie terreine, kontak ons vir 'n pasgemaakte plan.",
      },
      {
        q: "Hoe verduidelik Gadit 'n woord? Is dit net 'n vertaling?",
        a: "Gadit is nie 'n vertaalwoordeboek nie. Gadit definieer en verduidelik woorde. Vir elke woord gee dit elke betekenis, drie voorbeeldsinne per betekenis, etimologie, en 'n konteksmodus waar leerders die sin plak en Gadit die regte betekenis kies. Die leerder se koppelvlak is in hul taal, maar die diepte van die verduideliking is dieselfde in elke koppelvlaktaal.",
      },
    ],
    finalH2: "Keer die stil mislukking.",
    finalBody: "Gee jou onderwysers die hulpmiddel om presies te sien wat hul klas nie verstaan nie. Om te begin neem 2 minute. Geen IT, geen aankoopprosesse, geen ouervorms nie.",
    finalCta: "Sien pryse en bestel",
    finalNote: "Betaal jaarliks per bankoorplasing teen 'n belastingfaktuur. Geen tender nodig nie.",
    mockupRoster: "Klaslys, 22 leerders",
    mockupSearches: "Mees gesoek hierdie week",
    mockupStudent1: "Maya het fotosintese gesoek",
    mockupStudent2: "Yossi het mitochondria gesoek ×2",
    mockupStudent3: "Noa het demokrasie gesoek",
    mockupWordExample: "fotosintese",
    mockupExampleDef: "Die proses waardeur groen plante sonlig gebruik om water en koolstofdioksied in voedsel om te skakel.",
    mockupExampleEx: "Fotosintese vind meestal in die blare van die plant plaas.",
  },
  sw: {
    heroH1: "Kila mwanafunzi anaelewa somo.",
    heroSub: "Neno lolote gumu, katika lugha yoyote kati ya 30+, linaelezwa papo hapo.",
    heroCta: "Tazama bei na uagize",
    heroPriceChip: "Kuanzia $97 / mwezi",
    heroTrust: "Jihudumie mwenyewe. Ghairi wakati wowote.",
    probTag: "Tatizo",
    probH2: "Mwanafunzi asiyeelewa neno hawezi kuelewa sentensi.",
    probBody1: "Mwanafunzi anakosa neno moja. Hainui mkono. Anadhani anaelewa kwa kiasi. Mwalimu anaendelea. Maneno matano baadaye, aya inakuwa na ukungu. Aya tano baadaye, somo limepotea.",
    probBody2: "Wanafunzi wengi wanaobaki nyuma si kwamba hawana akili. Wana rundo la maneno ambayo hawakuwahi kuyaelewa kikamilifu. Kila neno jipya linalojengwa juu yake linapanua pengo. Chanzo hakionekani kwa mwalimu.",
    probCallout1Title: "Pengo linalokua",
    probCallout1Body: "Maneno yasiyoeleweka hujenga kizuizi kisichoonekana kwa kila somo lijalo.",
    probCallout2Title: "Muda unaopotea",
    probCallout2Body: "Walimu hupoteza dakika 5 hadi 10 kwa kila kipindi wakieleza maana za maneno.",
    probCallout3Title: "Kujiondoa kimya kimya",
    probCallout3Body: "Wanafunzi hupoteza umakini aya inapokuwa na maneno mengi wasiyoyajua.",
    howTag: "Jinsi Inavyofanya Kazi",
    howH2: "Iko tayari kwa dakika 2. Bila IT.",
    howSub: "Mfumo uleule rahisi wa msimbo wa darasa unaofanya kazi tayari kwa michezo ya maswali, lakini umejengwa kwa ajili ya kuelewa maneno.",
    howStep1Title: "Unda msimbo wa darasa",
    howStep1Body: "Mkuu wa shule au mratibu anaunda darasa kwenye dashibodi. Mfumo unatengeneza msimbo wa herufi 6. Uchapishe kwenye stika kwa ajili ya kompyuta ya darasa.",
    howStep2Title: "Wanafunzi wanajiunga, bila akaunti",
    howStep2Body: "Wanafunzi wanatembelea gadit.app/c/CODE kwenye kivinjari chochote, wanachagua majina yao kwenye orodha (mbofyo mmoja), na kuanza kuandika maneno. Hakuna programu ya kusakinisha, hakuna barua pepe, hakuna nenosiri.",
    howStep3Title: "Walimu wanaona darasa lilitafuta nini",
    howStep3Body: "Kila utafutaji unaingia kwenye dashibodi, ukiwa na jina la mwanafunzi. Unaona kila mwanafunzi alitafuta nini, lini, na maneno gani yaliyolitatiza darasa zima.",
    teacherTag: "Mtazamo wa Mwalimu",
    teacherH2: "Dashibodi ambayo umekuwa ukiiomba.",
    teacherSub: "Si takwimu za jumla zisizo wazi. Maneno mahususi, wanafunzi mahususi, nyakati mahususi.",
    teacherB1: "Historia ya utafutaji ya kila mwanafunzi, pamoja na muda",
    teacherB2: "Maneno yaliyotafutwa zaidi na darasa wiki hii",
    teacherB3: "Utafutaji unaorudiwa unaoonyesha uelewa dhaifu",
    teacherB4: "Chuja kwa tarehe, mwanafunzi au neno",
    privTag: "Faragha Tangu Mwanzo",
    privH2: "Mwalimu anaona kila kitu. Shule haina hatari yoyote ya data.",
    privSub: "Hatukusanyi taarifa binafsi za wanafunzi. Si kwa sababu tunazificha vizuri, bali kwa sababu hatuzikusanyi kabisa. Muundo wenyewe ndio utiifu.",
    privPoint1: "Hakuna akaunti za wanafunzi. Hakuna barua pepe, hakuna nenosiri, hakuna vitambulisho.",
    privPoint2: "Hakuna data binafsi inayotoka shuleni. Utafutaji unahusishwa na jina la orodha tu.",
    privPoint3: "Misimbo ya darasa inafanya kazi saa za shule tu. Kila shule inaweza kuirekebisha.",
    privPoint4: "COPPA, GDPR-K na sheria ya Israeli ya faragha ya wanafunzi zinatimizwa kwa urahisi.",
    privKahoot: "Kujiunga ni rahisi kama mchezo wa maswali darasani. Umejengwa kwa ajili ya kuelewa maneno na kumwonyesha mwalimu picha kamili.",
    priceTag: "Bei",
    priceH2: "Bei ya mwaka, kulingana na ukubwa wa shule.",
    priceSub: "Jihudumie kupitia Stripe. Hakuna simu za mauzo, hakuna maonyesho, hakuna oda za ununuzi.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Hadi wanafunzi 100",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Hadi wanafunzi 500",
    priceIncludesTitle: "Mipango yote miwili inajumuisha",
    priceIncludes: [
      "Madarasa bila kikomo",
      "Dashibodi kamili ya mwalimu",
      "Orodha ya wanafunzi ya kuchagua jina",
      "Misimbo ya darasa yenye muda maalum",
      "Kiolesura cha mwanafunzi katika lugha 30+",
      "Oda rahisi ya mwaka, chini ya kiwango cha zabuni",
      "Mazoezi ya matamshi: sikia na utamke neno lolote",
    ],
    priceCta: "Tazama bei na uagize",
    priceLarger: "Una zaidi ya wanafunzi 1,000? Wasiliana nasi kuhusu mipango ya wilaya.",
    faqTag: "Maswali",
    faqH2: "Maswali ambayo wakuu wa shule huuliza kabla ya kuagiza.",
    faq: [
      {
        q: "Ikiwa hakuna kuingia kwa akaunti, nitajuaje mwanafunzi gani alitafuta nini?",
        a: "Mwalimu anaweka mapema orodha ya majina ya kwanza kwenye dashibodi. Mwanafunzi anapotembelea anwani ya darasa, anachagua jina lake kwa mbofyo mmoja. Kila utafutaji unahusishwa na jina hilo. Hakuna barua pepe, hakuna nenosiri, hakuna taarifa binafsi zinazokusanywa.",
      },
      {
        q: "Je, ni salama kwa COPPA? Nitapata malalamiko kutoka kwa mzazi?",
        a: "Ndiyo. Gadit haikusanyi taarifa binafsi za mwanafunzi hata kidogo. Hakuna kuunda akaunti, hakuna barua pepe, hakuna tarehe za kuzaliwa, hakuna vitambulisho. Hakuna data ya kutumiwa vibaya. Muundo huu unazidi kwa urahisi COPPA, GDPR-K na sheria ya Israeli ya faragha ya wanafunzi.",
      },
      {
        q: "Je, wanafunzi wanahitaji kusakinisha programu?",
        a: "Hapana. Kivinjari chochote kinafanya kazi. Wanafunzi wanatembelea gadit.app/c/CODE kwenye kompyuta ya darasa (au kifaa chochote chenye kivinjari). Hakuna duka la programu, hakuna kuhusisha IT.",
      },
      {
        q: "Je, inahitaji usanidi wa IT au SSO?",
        a: "Hapana. Mkuu wa shule au mratibu wa darasa anaunda darasa kwa dakika mbili na kuwapa walimu msimbo. IT haihusiki katika hatua yoyote.",
      },
      {
        q: "Dashibodi inaonyesha nini hasa?",
        a: "Utafutaji wa maneno wa kila mwanafunzi pamoja na muda, maneno ambayo darasa lilitafuta zaidi wiki hii, na mifumo ya utafutaji unaorudiwa inayoashiria uelewa dhaifu. Unaona data halisi ya uelewa darasani, si takwimu za jumla zisizo wazi.",
      },
      {
        q: "Je, inaweza kutumika nje ya saa za darasa?",
        a: "Misimbo ya darasa imefungwa kwa saa za kazi za shule (kwa chaguo-msingi Jumapili hadi Alhamisi, 7:30 hadi 15:00, inaweza kurekebishwa). Nje ya muda huo msimbo unatoa kamusi ya msingi tu bila vipengele vya ziada. Hii inazuia msimbo wa shule kuwa mbadala wa bure wa 24/7 wa kiwango cha Family.",
      },
      {
        q: "Itakuwaje ikiwa shule yangu ina zaidi ya wanafunzi 500?",
        a: "Chagua kwa idadi ya wanafunzi: hadi wanafunzi 100 ni $97/mwezi, hadi 500 ni $297/mwezi, na hadi 1,000 ni $497/mwezi. Kwa zaidi ya wanafunzi 1,000 au wilaya zenye vituo vingi, wasiliana nasi kwa mpango maalum.",
      },
      {
        q: "Gadit inaelezaje neno? Je, ni tafsiri tu?",
        a: "Gadit si kamusi ya tafsiri. Gadit inafafanua na kueleza maneno. Kwa kila neno inatoa kila maana, sentensi tatu za mfano kwa kila maana, asili ya neno, na hali ya muktadha ambapo mwanafunzi anabandika sentensi na Gadit inachagua maana sahihi. Kiolesura cha mwanafunzi kiko katika lugha yake, lakini kina cha maelezo ni kilekile katika kila lugha ya kiolesura.",
      },
    ],
    finalH2: "Komesha kushindwa kwa kimya.",
    finalBody: "Wape walimu wako chombo cha kuona hasa kile ambacho darasa lao halielewi. Kuanza kunachukua dakika 2. Bila IT, bila taratibu za ununuzi, bila fomu za wazazi.",
    finalCta: "Tazama bei na uagize",
    finalNote: "Lipa kila mwaka kwa uhamisho wa benki dhidi ya ankara ya kodi. Hakuna haja ya zabuni.",
    mockupRoster: "Orodha ya darasa, wanafunzi 22",
    mockupSearches: "Yaliyotafutwa zaidi wiki hii",
    mockupStudent1: "Maya alitafuta usanisinuru",
    mockupStudent2: "Yossi alitafuta mitokondria ×2",
    mockupStudent3: "Noa alitafuta demokrasia",
    mockupWordExample: "usanisinuru",
    mockupExampleDef: "Mchakato ambao mimea ya kijani hutumia mwanga wa jua kubadilisha maji na kaboni dioksidi kuwa chakula.",
    mockupExampleEx: "Usanisinuru hufanyika hasa kwenye majani ya mmea.",
  },
  "zh-CN": {
    heroH1: "让每个学生都听懂课堂。",
    heroSub: "任何难词，30+ 种语言中的任何一种，当场讲解清楚。",
    heroCta: "查看价格并订购",
    heroPriceChip: "低至 $97 / 月",
    heroTrust: "自助开通。随时可取消。",
    probTag: "问题所在",
    probH2: "学生不懂一个词，就读不懂整句话。",
    probBody1: "学生漏掉了一个词。他没有举手。他以为自己大概懂了。老师继续往下讲。五个词之后，整段话变得模糊。五段之后，整节课就听不懂了。",
    probBody2: "大多数掉队的学生并不笨。他们积压了一堆从未真正弄懂的词。每一个建立在这些词之上的新词，都会让差距越拉越大。而老师看不到这个原因。",
    probCallout1Title: "不断累积的差距",
    probCallout1Body: "没弄懂的词，会在以后的每一节课前筑起一道看不见的墙。",
    probCallout2Title: "被耗掉的时间",
    probCallout2Body: "老师每节课要花 5 到 10 分钟解释词义。",
    probCallout3Title: "无声的掉队",
    probCallout3Body: "一段文字里生词太多时，学生就会走神。",
    howTag: "使用方式",
    howH2: "2 分钟完成设置。无需 IT。",
    howSub: "沿用课堂问答游戏里早已验证、零门槛的班级代码方式，专为理解词语而打造。",
    howStep1Title: "创建班级代码",
    howStep1Body: "校长或协调员在管理后台创建一个班级。系统会生成一个 6 位代码。把它打印成贴纸，贴在班级电脑上。",
    howStep2Title: "学生直接加入，无需账号",
    howStep2Body: "学生在任意浏览器中打开 gadit.app/c/CODE，从名单中选择自己的名字（点一下即可），就能开始输入词语。无需安装应用，无需邮箱，无需密码。",
    howStep3Title: "老师能看到全班查了什么",
    howStep3Body: "每一次查询都会进入管理后台，并标注学生的名字。您可以看到每个学生查了什么、什么时候查的，以及全班共同卡在了哪些词上。",
    teacherTag: "教师视图",
    teacherH2: "您一直想要的管理后台。",
    teacherSub: "不是笼统的参与度指标。而是具体的词、具体的学生、具体的时刻。",
    teacherB1: "每个学生的查询记录，附带时间",
    teacherB2: "本周全班查询最多的词",
    teacherB3: "反复查询，提示理解尚不牢固",
    teacherB4: "可按日期、学生或词语筛选",
    privTag: "从设计上保护隐私",
    privH2: "老师看得一清二楚。学校零数据风险。",
    privSub: "我们不收集任何学生个人信息。不是因为我们藏得好，而是因为我们从不收集。架构本身就是合规。",
    privPoint1: "没有学生账号。没有邮箱，没有密码，没有身份编号。",
    privPoint2: "个人数据不会离开学校。查询只与名单上的名字关联。",
    privPoint3: "班级代码只在上课时间有效。每所学校可自行设置。",
    privPoint4: "轻松满足 COPPA、GDPR-K 以及以色列学生隐私法的要求。",
    privKahoot: "加入方式和课堂问答游戏一样简单。专为理解词语和让老师掌握情况而打造。",
    priceTag: "价格",
    priceH2: "按年计价，依学校规模而定。",
    priceSub: "通过 Stripe 自助开通。无需销售电话，无需演示，无需采购单。",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "最多 100 名学生",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "最多 500 名学生",
    priceIncludesTitle: "两个方案均包含",
    priceIncludes: [
      "不限班级数量",
      "完整的教师管理后台",
      "学生选名名单",
    ...
    priceCta: "查看价格并订购",
    priceLarger: "学生超过 1,000 名？请联系我们了解学区方案。",
    faqTag: "常见问题",
    faqH2: "校长们在订购前常问的问题。",
    faq: [
      {
        q: "没有登录，我怎么知道哪个学生查了什么？",
        a: "老师事先在管理后台录入学生名字的名单。学生打开班级网址后，点一下选择自己的名字。每次查询都会标注这个名字。不收集邮箱、密码或任何个人信息。",
      },
      {
        q: "这符合 COPPA 吗？会不会收到家长投诉？",
        a: "符合。Gadit 完全不收集学生的个人信息。不创建账号，不收集邮箱，不收集生日，不收集身份编号。没有任何可被滥用的数据。这一架构轻松超越 COPPA、GDPR-K 以及以色列学生隐私法的要求。",
      },
      {
        q: "学生需要安装应用吗？",
        a: "不需要。任何浏览器都可以使用。学生在班级电脑（或任何有浏览器的设备）上打开 gadit.app/c/CODE 即可。无需应用商店，无需 IT 参与。",
      },
      {
        q: "需要 IT 或 SSO 设置吗？",
        a: "不需要。校长或年级协调员两分钟即可创建班级，并把代码分享给老师。任何环节都不需要 IT 参与。",
      },
      {
        q: "管理后台具体显示什么？",
        a: "每个学生带时间记录的查词情况、本周全班查询最多的词，以及提示理解尚不牢固的反复查询规律。您看到的是真实的课堂理解数据，而不是笼统的参与度指标。",
      },
      {
        q: "课外时间可以使用吗？",
        a: "班级代码与学校的上课时间绑定（默认周日至周四，7:30 至 15:00，可调整）。在这一时段之外，代码只提供基础词典功能，不含扩展功能。这样可以防止学校代码变成 Family 方案的免费全天候替代品。",
      },
      {
        q: "如果我们学校超过 500 名学生怎么办？",
        a: "按学生人数选择：最多 100 名学生为 $97/月，最多 500 名为 $297/月，最多 1,000 名为 $497/月。超过 1,000 名学生或多校区的学区，请联系我们定制方案。",
      },
      {
        q: "Gadit 如何解释一个词？只是翻译吗？",
        a: "Gadit 不是翻译词典。Gadit 对词语进行定义和讲解。每个词都会给出所有词义、每个词义三个例句、词源，以及语境模式：学生粘贴句子，Gadit 选出正确的词义。学生界面使用学生自己的语言，但在每种界面语言中，讲解的深度都一样。",
      },
    ],
    finalH2: "终结无声的掉队。",
    finalBody: "给老师一个工具，准确看到全班哪里没听懂。开始使用只需 2 分钟。无需 IT，无需采购流程，无需家长表格。",
    finalCta: "查看价格并订购",
    finalNote: "凭税务发票通过银行转账按年付款。无需招标。",
    mockupRoster: "班级名单，22 名学生",
    mockupSearches: "本周查询最多",
    mockupStudent1: "Maya 查了 光合作用",
    mockupStudent2: "Yossi 查了 线粒体 ×2",
    mockupStudent3: "Noa 查了 民主",
    mockupWordExample: "光合作用",
    mockupExampleDef: "绿色植物利用阳光把水和二氧化碳转化为养分的过程。",
    mockupExampleEx: "光合作用主要发生在植物的叶子里。",
  },
  "zh-TW": {
    heroH1: "讓每位學生都聽懂課堂。",
    heroSub: "任何難詞，30+ 種語言中的任何一種，當場講解清楚。",
    heroCta: "查看價格並訂購",
    heroPriceChip: "低至 $97 / 月",
    heroTrust: "自助開通。隨時可取消。",
    probTag: "問題所在",
    probH2: "學生不懂一個詞，就讀不懂整句話。",
    probBody1: "學生漏掉了一個詞。他沒有舉手。他以為自己大概懂了。老師繼續往下講。五個詞之後，整段話變得模糊。五段之後，整堂課就聽不懂了。",
    probBody2: "大多數落後的學生並不笨。他們累積了一堆從未真正弄懂的詞。每一個建立在這些詞之上的新詞，都讓差距越拉越大。而老師看不到這個原因。",
    probCallout1Title: "不斷累積的差距",
    probCallout1Body: "沒弄懂的詞，會在往後每一堂課前築起一道看不見的牆。",
    probCallout2Title: "被耗掉的時間",
    probCallout2Body: "老師每堂課要花 5 到 10 分鐘解釋詞義。",
    probCallout3Title: "無聲的落後",
    probCallout3Body: "一段文字裡生詞太多時，學生就會分心。",
    howTag: "使用方式",
    howH2: "2 分鐘完成設定。無需 IT。",
    howSub: "沿用課堂問答遊戲早已驗證、零門檻的班級代碼方式，專為理解詞語而打造。",
    howStep1Title: "建立班級代碼",
    howStep1Body: "校長或協調人員在管理後台建立一個班級。系統會產生一組 6 碼代碼。把它印成貼紙，貼在班級電腦上。",
    howStep2Title: "學生直接加入，無需帳號",
    howStep2Body: "學生在任何瀏覽器開啟 gadit.app/c/CODE，從名單中選擇自己的名字（點一下即可），就能開始輸入詞語。無需安裝 App，無需電子郵件，無需密碼。",
    howStep3Title: "老師能看到全班查了什麼",
    howStep3Body: "每一次查詢都會進入管理後台，並標註學生的名字。您可以看到每位學生查了什麼、什麼時候查的，以及全班共同卡在哪些詞上。",
    teacherTag: "教師檢視",
    teacherH2: "您一直想要的管理後台。",
    teacherSub: "不是籠統的參與度指標。而是具體的詞、具體的學生、具體的時刻。",
    teacherB1: "每位學生的查詢紀錄，附上時間",
    teacherB2: "本週全班查詢最多的詞",
    teacherB3: "重複查詢，提示理解尚不穩固",
    teacherB4: "可依日期、學生或詞語篩選",
    privTag: "從設計上保護隱私",
    privH2: "老師看得一清二楚。學校零資料風險。",
    privSub: "我們不蒐集任何學生個人資料。不是因為我們藏得好，而是因為我們從不蒐集。架構本身就是合規。",
    privPoint1: "沒有學生帳號。沒有電子郵件，沒有密碼，沒有身分編號。",
    privPoint2: "個人資料不會離開學校。查詢只與名單上的名字連結。",
    privPoint3: "班級代碼只在上課時間有效。每所學校可自行設定。",
    privPoint4: "輕鬆符合 COPPA、GDPR-K 以及以色列學生隱私法的要求。",
    privKahoot: "加入方式和課堂問答遊戲一樣簡單。專為理解詞語和讓老師掌握狀況而打造。",
    priceTag: "價格",
    priceH2: "按年計價，依學校規模而定。",
    priceSub: "透過 Stripe 自助開通。無需業務電話，無需展示，無需採購單。",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "最多 100 名學生",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "最多 500 名學生",
    priceIncludesTitle: "兩個方案皆包含",
    priceIncludes: [
      "不限班級數量",
      "完整的教師管理後台",
      "學生選名名單",
    ...
    priceCta: "查看價格並訂購",
    priceLarger: "學生超過 1,000 名？請與我們聯繫，了解學區方案。",
    faqTag: "常見問題",
    faqH2: "校長們在訂購前常問的問題。",
    faq: [
      {
        q: "沒有登入，我怎麼知道哪位學生查了什麼？",
        a: "老師事先在管理後台輸入學生名字的名單。學生開啟班級網址後，點一下選擇自己的名字。每次查詢都會標註這個名字。不蒐集電子郵件、密碼或任何個人資料。",
      },
      {
        q: "這符合 COPPA 嗎？會不會收到家長投訴？",
        a: "符合。Gadit 完全不蒐集學生的個人資料。不建立帳號，不蒐集電子郵件，不蒐集生日，不蒐集身分編號。沒有任何可被濫用的資料。這個架構輕鬆超越 COPPA、GDPR-K 以及以色列學生隱私法的要求。",
      },
      {
        q: "學生需要安裝 App 嗎？",
        a: "不需要。任何瀏覽器都能使用。學生在班級電腦（或任何有瀏覽器的裝置）上開啟 gadit.app/c/CODE 即可。無需 App 商店，無需 IT 參與。",
      },
      {
        q: "需要 IT 或 SSO 設定嗎？",
        a: "不需要。校長或年級協調人員兩分鐘就能建立班級，並把代碼分享給老師。任何步驟都不需要 IT 參與。",
      },
      {
        q: "管理後台實際顯示什麼？",
        a: "每位學生附時間紀錄的查詞情況、本週全班查詢最多的詞，以及提示理解尚不穩固的重複查詢模式。您看到的是真實的課堂理解資料，而不是籠統的參與度指標。",
      },
      {
        q: "課後時間可以使用嗎？",
        a: "班級代碼與學校的上課時間綁定（預設週日至週四，7:30 至 15:00，可調整）。在這段時間之外，代碼只提供基本字典功能，不含進階功能。這可避免學校代碼變成 Family 方案的免費全天候替代品。",
      },
      {
        q: "如果我們學校超過 500 名學生怎麼辦？",
        a: "依學生人數選擇：最多 100 名學生為 $97/月，最多 500 名為 $297/月，最多 1,000 名為 $497/月。超過 1,000 名學生或多校區的學區，請與我們聯繫以規劃客製方案。",
      },
      {
        q: "Gadit 如何解釋一個詞？只是翻譯嗎？",
        a: "Gadit 不是翻譯字典。Gadit 為詞語下定義並加以講解。每個詞都會提供所有詞義、每個詞義三個例句、詞源，以及語境模式：學生貼上句子，Gadit 選出正確的詞義。學生介面使用學生自己的語言，但在每種介面語言中，講解的深度都一樣。",
      },
    ],
    finalH2: "終結無聲的落後。",
    finalBody: "給老師一個工具，精確看到全班哪裡沒聽懂。開始使用只需 2 分鐘。無需 IT，無需採購流程，無需家長表單。",
    finalCta: "查看價格並訂購",
    finalNote: "憑稅務發票以銀行轉帳按年付款。無需招標。",
    mockupRoster: "班級名單，22 名學生",
    mockupSearches: "本週查詢最多",
    mockupStudent1: "Maya 查了 光合作用",
    mockupStudent2: "Yossi 查了 粒線體 ×2",
    mockupStudent3: "Noa 查了 民主",
    mockupWordExample: "光合作用",
    mockupExampleDef: "綠色植物利用陽光把水和二氧化碳轉化為養分的過程。",
    mockupExampleEx: "光合作用主要發生在植物的葉子裡。",
  },
  ko: {
    heroH1: "모든 학생이 수업을 이해합니다.",
    heroSub: "어떤 어려운 단어든, 30+개 언어 중 어느 언어로든, 그 자리에서 설명합니다.",
    heroCta: "요금 보기 및 주문",
    heroPriceChip: "월 $97부터",
    heroTrust: "직접 가입. 언제든지 해지 가능.",
    probTag: "문제",
    probH2: "단어 하나를 모르는 학생은 문장을 이해할 수 없습니다.",
    probBody1: "학생이 단어 하나를 놓칩니다. 손을 들지 않습니다. 대충은 안다고 생각합니다. 선생님은 다음으로 넘어갑니다. 다섯 단어 뒤에는 문단이 흐릿해집니다. 다섯 문단 뒤에는 수업 전체를 놓칩니다.",
    probBody2: "뒤처지는 학생 대부분은 머리가 나쁜 것이 아닙니다. 제대로 이해하지 못한 단어가 쌓여 있을 뿐입니다. 그 위에 새 단어가 얹힐 때마다 격차는 더 커집니다. 그리고 선생님에게는 그 원인이 보이지 않습니다.",
    probCallout1Title: "커지는 격차",
    probCallout1Body: "이해하지 못한 단어는 앞으로의 모든 수업 앞에 보이지 않는 벽을 쌓습니다.",
    probCallout2Title: "새어 나가는 시간",
    probCallout2Body: "교사는 수업마다 5분에서 10분을 단어 뜻 설명에 씁니다.",
    probCallout3Title: "조용한 이탈",
    probCallout3Body: "모르는 단어가 너무 많은 문단 앞에서 학생들은 집중을 놓습니다.",
    howTag: "이용 방법",
    howH2: "2분이면 설정 완료. IT 부서가 필요 없습니다.",
    howSub: "퀴즈 게임에서 이미 검증된 간편한 학급 코드 방식을, 단어 이해를 위해 새로 만들었습니다.",
    howStep1Title: "학급 코드 만들기",
    howStep1Body: "교장이나 코디네이터가 대시보드에서 학급을 만듭니다. 시스템이 6자리 코드를 생성합니다. 스티커로 출력해 교실 컴퓨터에 붙여 두세요.",
    howStep2Title: "학생은 계정 없이 참여",
    howStep2Body: "학생은 아무 브라우저에서나 gadit.app/c/CODE에 접속해 명단에서 자기 이름을 고르고(클릭 한 번) 단어를 입력하기 시작합니다. 앱 설치도, 이메일도, 비밀번호도 필요 없습니다.",
    howStep3Title: "교사는 학급이 무엇을 찾았는지 봅니다",
    howStep3Body: "모든 검색은 학생 이름과 함께 대시보드에 기록됩니다. 학생마다 무엇을, 언제 찾았는지, 그리고 학급 전체가 어떤 단어에서 막혔는지 확인할 수 있습니다.",
    teacherTag: "교사 화면",
    teacherH2: "그동안 원하시던 바로 그 대시보드.",
    teacherSub: "막연한 참여 지표가 아닙니다. 구체적인 단어, 구체적인 학생, 구체적인 순간입니다.",
    teacherB1: "학생별 검색 기록과 시간",
    teacherB2: "이번 주 학급에서 가장 많이 검색한 단어",
    teacherB3: "불안정한 이해를 알려 주는 반복 검색",
    teacherB4: "날짜, 학생, 단어별 필터",
    privTag: "설계 단계부터 개인정보 보호",
    privH2: "교사에게는 완전한 가시성. 학교에는 데이터 위험 제로.",
    privSub: "저희는 학생의 개인정보를 전혀 수집하지 않습니다. 잘 숨겨서가 아니라, 애초에 수집하지 않기 때문입니다. 구조 자체가 규정 준수입니다.",
    privPoint1: "학생 계정이 없습니다. 이메일도, 비밀번호도, ID도 없습니다.",
    privPoint2: "개인 데이터는 학교 밖으로 나가지 않습니다. 검색은 명단의 이름으로만 기록됩니다.",
    privPoint3: "학급 코드는 수업 시간에만 작동합니다. 학교별로 설정할 수 있습니다.",
    privPoint4: "COPPA, GDPR-K, 이스라엘 학생 개인정보 보호법을 무리 없이 충족합니다.",
    privKahoot: "교실 퀴즈 게임만큼 쉽게 참여합니다. 단어 이해와 교사의 파악을 위해 만들었습니다.",
    priceTag: "요금",
    priceH2: "학교 규모별 연간 요금.",
    priceSub: "Stripe로 직접 가입. 영업 전화도, 데모도, 구매 주문서도 없습니다.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "최대 100명 학생",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "최대 500명 학생",
    priceIncludesTitle: "두 요금제 모두 포함",
    priceIncludes: [
      "학급 수 무제한",
      "전체 교사 대시보드",
      "학생 이름 선택 명단",
      "시간 제한 학급 코드",
      "30+개 언어의 학생 화면",
      "구매 기준 금액 이하의 간단한 연간 주문",
      "발음 연습: 어떤 단어든 듣고 말하기",
    ],
    priceCta: "요금 보기 및 주문",
    priceLarger: "학생이 1,000명 이상인가요? 교육청 단위 요금제는 문의해 주세요.",
    faqTag: "자주 묻는 질문",
    faqH2: "교장 선생님들이 주문 전에 묻는 질문.",
    faq: [
      {
        q: "로그인이 없다면, 어떤 학생이 무엇을 검색했는지 어떻게 알 수 있나요?",
        a: "교사가 대시보드에 학생 이름 명단을 미리 입력합니다. 학생이 학급 주소에 접속하면 클릭 한 번으로 자기 이름을 고릅니다. 모든 검색은 그 이름으로 기록됩니다. 이메일, 비밀번호, 개인정보는 전혀 수집하지 않습니다.",
      },
      {
        q: "COPPA 기준에 안전한가요? 학부모 민원이 생기지는 않을까요?",
        a: "안전합니다. Gadit은 학생의 개인정보를 전혀 수집하지 않습니다. 계정 생성도, 이메일 수집도, 생년월일도, ID도 없습니다. 악용될 데이터 자체가 없습니다. 이 구조는 COPPA, GDPR-K, 이스라엘 학생 개인정보 보호법의 기준을 여유 있게 넘어섭니다.",
      },
      {
        q: "학생이 앱을 설치해야 하나요?",
        a: "아니요. 어떤 브라우저든 됩니다. 학생은 교실 컴퓨터(또는 브라우저가 있는 어떤 기기든)에서 gadit.app/c/CODE에 접속합니다. 앱 스토어도, IT 부서의 개입도 필요 없습니다.",
      },
      {
        q: "IT나 SSO 설정이 필요한가요?",
        a: "아니요. 교장이나 학년 코디네이터가 2분 만에 학급을 만들고 교사들에게 코드를 공유합니다. 어느 단계에서도 IT 부서가 관여하지 않습니다.",
      },
      {
        q: "대시보드에는 실제로 무엇이 보이나요?",
        a: "학생별 단어 검색과 시간, 이번 주 학급에서 가장 많이 검색한 단어, 불안정한 이해를 보여 주는 반복 검색 패턴입니다. 막연한 참여 지표가 아니라, 교실의 실제 이해도 데이터를 보게 됩니다.",
      },
      {
        q: "수업 시간 외에도 사용할 수 있나요?",
        a: "학급 코드는 학교 운영 시간에 묶여 있습니다(기본값 일요일부터 목요일, 7:30부터 15:00까지, 변경 가능). 그 시간 외에는 기본 사전 기능만 제공되고 확장 기능은 제공되지 않습니다. 학교 코드가 Family 요금제의 무료 24시간 대체품이 되는 것을 막기 위해서입니다.",
      },
      {
        q: "학교 학생 수가 500명을 넘으면요?",
        a: "학생 수에 따라 선택하세요: 최대 100명은 $97/월, 최대 500명은 $297/월, 최대 1,000명은 $497/월입니다. 1,000명 이상이거나 여러 캠퍼스가 있는 교육청은 맞춤 요금제를 위해 문의해 주세요.",
      },
      {
        q: "Gadit은 단어를 어떻게 설명하나요? 그냥 번역인가요?",
        a: "Gadit은 번역 사전이 아닙니다. Gadit은 단어를 정의하고 설명합니다. 단어마다 모든 뜻, 뜻마다 예문 세 개, 어원, 그리고 학생이 문장을 붙여 넣으면 Gadit이 알맞은 뜻을 골라 주는 문맥 모드를 제공합니다. 학생 화면은 학생의 언어로 표시되지만, 설명의 깊이는 모든 화면 언어에서 똑같습니다.",
      },
    ],
    finalH2: "조용한 실패를 멈추세요.",
    finalBody: "학급이 정확히 무엇을 이해하지 못하는지 볼 수 있는 도구를 선생님들께 드리세요. 시작하는 데 2분이면 됩니다. IT도, 구매 절차도, 학부모 동의서도 필요 없습니다.",
    finalCta: "요금 보기 및 주문",
    finalNote: "세금계산서에 따라 은행 송금으로 연간 결제합니다. 입찰이 필요 없습니다.",
    mockupRoster: "학급 명단, 학생 22명",
    mockupSearches: "이번 주 최다 검색",
    mockupStudent1: "Maya가 광합성을 검색함",
    mockupStudent2: "Yossi가 미토콘드리아를 검색함 ×2",
    mockupStudent3: "Noa가 민주주의를 검색함",
    mockupWordExample: "광합성",
    mockupExampleDef: "녹색 식물이 햇빛을 이용해 물과 이산화탄소를 양분으로 바꾸는 과정.",
    mockupExampleEx: "광합성은 주로 식물의 잎에서 일어납니다.",
  },
  th: {
    heroH1: "นักเรียนทุกคนเข้าใจบทเรียน",
    heroSub: "คำยากทุกคำ ในภาษาใดก็ได้จาก 30+ ภาษา อธิบายให้เข้าใจได้ทันที",
    heroCta: "ดูราคาและสั่งซื้อ",
    heroPriceChip: "เริ่มต้น $97 / เดือน",
    heroTrust: "สมัครใช้เองได้ ยกเลิกได้ทุกเมื่อ",
    probTag: "ปัญหา",
    probH2: "นักเรียนที่ไม่เข้าใจคำหนึ่งคำ จะไม่เข้าใจทั้งประโยค",
    probBody1: "นักเรียนพลาดคำไปหนึ่งคำ ไม่ยกมือถาม คิดว่าพอเข้าใจคร่าวๆ ครูสอนต่อไป ผ่านไปห้าคำ ย่อหน้าก็เริ่มเลือนลาง ผ่านไปห้าย่อหน้า บทเรียนก็หลุดมือไป",
    probBody2: "นักเรียนส่วนใหญ่ที่เรียนตามไม่ทันไม่ได้ไม่ฉลาด แต่พวกเขามีคำกองหนึ่งที่ไม่เคยเข้าใจอย่างแท้จริง ทุกคำใหม่ที่ต่อยอดบนคำเหล่านั้นยิ่งทำให้ช่องว่างกว้างขึ้น และครูมองไม่เห็นสาเหตุนี้",
    probCallout1Title: "ช่องว่างที่สะสม",
    probCallout1Body: "คำที่ไม่เข้าใจจะสร้างกำแพงที่มองไม่เห็นกั้นทุกบทเรียนในอนาคต",
    probCallout2Title: "เวลาที่รั่วไหล",
    probCallout2Body: "ครูเสียเวลา 5 ถึง 10 นาทีต่อคาบไปกับการอธิบายความหมายของคำ",
    probCallout3Title: "การหลุดออกอย่างเงียบๆ",
    probCallout3Body: "นักเรียนเลิกตั้งใจเมื่อย่อหน้ามีคำที่ไม่รู้จักมากเกินไป",
    howTag: "วิธีการทำงาน",
    howH2: "ตั้งค่าเสร็จใน 2 นาที ไม่ต้องใช้ฝ่าย IT",
    howSub: "ใช้รูปแบบรหัสห้องเรียนที่ง่ายและได้ผลอยู่แล้วกับเกมตอบคำถาม แต่สร้างมาเพื่อความเข้าใจคำศัพท์",
    howStep1Title: "สร้างรหัสห้องเรียน",
    howStep1Body: "ผู้อำนวยการหรือผู้ประสานงานสร้างห้องเรียนในแดชบอร์ด ระบบจะสร้างรหัส 6 ตัวอักษร พิมพ์ลงสติกเกอร์ติดไว้ที่คอมพิวเตอร์ของห้องเรียน",
    howStep2Title: "นักเรียนเข้าร่วมได้เลย ไม่ต้องมีบัญชี",
    howStep2Body: "นักเรียนเข้า gadit.app/c/CODE ผ่านเบราว์เซอร์ใดก็ได้ เลือกชื่อตัวเองจากรายชื่อ (คลิกเดียว) แล้วเริ่มพิมพ์คำได้ทันที ไม่ต้องติดตั้งแอป ไม่ต้องใช้อีเมล ไม่ต้องมีรหัสผ่าน",
    howStep3Title: "ครูเห็นว่าชั้นเรียนค้นหาอะไร",
    howStep3Body: "ทุกการค้นหาจะปรากฏในแดชบอร์ดพร้อมชื่อนักเรียน คุณจะเห็นว่านักเรียนแต่ละคนค้นหาอะไร เมื่อไร และคำไหนที่ทั้งชั้นติดขัดร่วมกัน",
    teacherTag: "มุมมองของครู",
    teacherH2: "แดชบอร์ดที่คุณรอคอยมานาน",
    teacherSub: "ไม่ใช่ตัวชี้วัดการมีส่วนร่วมแบบคลุมเครือ แต่เป็นคำที่ชัดเจน นักเรียนที่ชัดเจน และช่วงเวลาที่ชัดเจน",
    teacherB1: "ประวัติการค้นหาของนักเรียนแต่ละคน พร้อมเวลา",
    teacherB2: "คำที่ทั้งชั้นค้นหามากที่สุดในสัปดาห์นี้",
    teacherB3: "การค้นหาซ้ำที่บ่งบอกถึงความเข้าใจที่ยังไม่มั่นคง",
    teacherB4: "กรองตามวันที่ นักเรียน หรือคำ",
    privTag: "ความเป็นส่วนตัวตั้งแต่การออกแบบ",
    privH2: "ครูมองเห็นทุกอย่าง โรงเรียนไม่มีความเสี่ยงด้านข้อมูลเลย",
    privSub: "เราไม่เก็บข้อมูลส่วนบุคคลของนักเรียน ไม่ใช่เพราะเราซ่อนไว้อย่างดี แต่เพราะเราไม่เคยเก็บเลย สถาปัตยกรรมของระบบคือการปฏิบัติตามข้อกำหนดในตัว",
    privPoint1: "ไม่มีบัญชีนักเรียน ไม่มีอีเมล ไม่มีรหัสผ่าน ไม่มีเลขประจำตัว",
    privPoint2: "ไม่มีข้อมูลส่วนบุคคลออกนอกโรงเรียน การค้นหาผูกกับชื่อในรายชื่อเท่านั้น",
    privPoint3: "รหัสห้องเรียนใช้ได้เฉพาะในเวลาเรียน แต่ละโรงเรียนตั้งค่าเองได้",
    privPoint4: "รองรับ COPPA, GDPR-K และกฎหมายความเป็นส่วนตัวของนักเรียนของอิสราเอลได้อย่างสบาย",
    privKahoot: "เข้าร่วมง่ายเหมือนเกมตอบคำถามในห้องเรียน สร้างมาเพื่อความเข้าใจคำศัพท์และให้ครูมองเห็นภาพรวม",
    priceTag: "ราคา",
    priceH2: "ราคารายปี ตามขนาดโรงเรียน",
    priceSub: "สมัครเองผ่าน Stripe ไม่มีการโทรขาย ไม่มีการสาธิต ไม่ต้องมีใบสั่งซื้อ",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "สูงสุด 100 คน",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "สูงสุด 500 คน",
    priceIncludesTitle: "ทั้งสองแผนรวม",
    priceIncludes: [
      "ห้องเรียนไม่จำกัด",
      "แดชบอร์ดครูครบถ้วน",
      "รายชื่อให้นักเรียนเลือกชื่อ",
      "รหัสห้องเรียนที่จำกัดเวลา",
      "หน้าจอนักเรียนใน 30+ ภาษา",
      "สั่งซื้อรายปีแบบง่าย ต่ำกว่าเกณฑ์การจัดซื้อ",
      "ฝึกออกเสียง: ฟังและพูดคำใดก็ได้",
    ],
    priceCta: "ดูราคาและสั่งซื้อ",
    priceLarger: "มีนักเรียนมากกว่า 1,000 คน? ติดต่อเราเรื่องแผนสำหรับเขตพื้นที่การศึกษา",
    faqTag: "คำถามที่พบบ่อย",
    faqH2: "คำถามที่ผู้อำนวยการถามก่อนสั่งซื้อ",
    faq: [
      {
        q: "ถ้าไม่มีการล็อกอิน จะรู้ได้อย่างไรว่านักเรียนคนไหนค้นหาอะไร?",
        a: "ครูใส่รายชื่อชื่อจริงของนักเรียนไว้ล่วงหน้าในแดชบอร์ด เมื่อนักเรียนเข้า URL ของห้องเรียน ก็เลือกชื่อตัวเองด้วยคลิกเดียว ทุกการค้นหาจะผูกกับชื่อนั้น ไม่มีการเก็บอีเมล รหัสผ่าน หรือข้อมูลส่วนบุคคลใดๆ",
      },
      {
        q: "ปลอดภัยตาม COPPA ไหม? จะมีผู้ปกครองร้องเรียนหรือเปล่า?",
        a: "ปลอดภัย Gadit ไม่เก็บข้อมูลส่วนบุคคลของนักเรียนเลย ไม่มีการสร้างบัญชี ไม่เก็บอีเมล ไม่เก็บวันเกิด ไม่เก็บเลขประจำตัว จึงไม่มีข้อมูลให้นำไปใช้ในทางที่ผิด สถาปัตยกรรมนี้เกินมาตรฐานของ COPPA, GDPR-K และกฎหมายความเป็นส่วนตัวของนักเรียนของอิสราเอลได้อย่างสบาย",
      },
      {
        q: "นักเรียนต้องติดตั้งแอปไหม?",
        a: "ไม่ต้อง ใช้เบราว์เซอร์ใดก็ได้ นักเรียนเข้า gadit.app/c/CODE บนคอมพิวเตอร์ของห้องเรียน (หรืออุปกรณ์ใดก็ได้ที่มีเบราว์เซอร์) ไม่ต้องใช้แอปสโตร์ ไม่ต้องพึ่งฝ่าย IT",
      },
      {
        q: "ต้องตั้งค่า IT หรือ SSO ไหม?",
        a: "ไม่ต้อง ผู้อำนวยการหรือผู้ประสานงานระดับชั้นสร้างห้องเรียนได้ในสองนาที แล้วแชร์รหัสให้ครู ฝ่าย IT ไม่ต้องเกี่ยวข้องในขั้นตอนใดเลย",
      },
      {
        q: "แดชบอร์ดแสดงอะไรบ้าง?",
        a: "การค้นหาคำของนักเรียนแต่ละคนพร้อมเวลา คำที่ทั้งชั้นค้นหามากที่สุดในสัปดาห์นี้ และรูปแบบการค้นหาซ้ำที่บ่งบอกถึงความเข้าใจที่ยังไม่มั่นคง คุณจะเห็นข้อมูลความเข้าใจจริงในห้องเรียน ไม่ใช่ตัวชี้วัดการมีส่วนร่วมแบบคลุมเครือ",
      },
      {
        q: "ใช้นอกเวลาเรียนได้ไหม?",
        a: "รหัสห้องเรียนผูกกับเวลาทำการของโรงเรียน (ค่าเริ่มต้นวันอาทิตย์ถึงวันพฤหัสบดี 7:30 ถึง 15:00 ปรับได้) นอกช่วงเวลานั้น รหัสจะให้ใช้พจนานุกรมพื้นฐานเท่านั้น ไม่มีฟีเจอร์เพิ่มเติม เพื่อไม่ให้รหัสของโรงเรียนกลายเป็นตัวแทนฟรีตลอด 24/7 ของแผน Family",
      },
      {
        q: "ถ้าโรงเรียนมีนักเรียนมากกว่า 500 คนล่ะ?",
        a: "เลือกตามจำนวนนักเรียน: สูงสุด 100 คน $97/เดือน สูงสุด 500 คน $297/เดือน และสูงสุด 1,000 คน $497/เดือน หากมีนักเรียนมากกว่า 1,000 คนหรือเป็นเขตที่มีหลายวิทยาเขต ติดต่อเราเพื่อจัดแผนเฉพาะ",
      },
      {
        q: "Gadit อธิบายคำอย่างไร? เป็นแค่การแปลหรือเปล่า?",
        a: "Gadit ไม่ใช่พจนานุกรมแปลภาษา Gadit นิยามและอธิบายคำ สำหรับแต่ละคำจะให้ทุกความหมาย ประโยคตัวอย่างสามประโยคต่อความหมาย รากศัพท์ และโหมดบริบทที่นักเรียนวางประโยคลงไปแล้ว Gadit จะเลือกความหมายที่ถูกต้อง หน้าจอของนักเรียนเป็นภาษาของนักเรียนเอง แต่ความลึกของคำอธิบายเท่ากันในทุกภาษา",
      },
    ],
    finalH2: "หยุดความล้มเหลวที่เงียบงัน",
    finalBody: "มอบเครื่องมือให้ครูได้เห็นชัดๆ ว่าชั้นเรียนไม่เข้าใจอะไร เริ่มต้นใช้เวลาเพียง 2 นาที ไม่ต้องใช้ IT ไม่ต้องผ่านการจัดซื้อ ไม่ต้องมีแบบฟอร์มผู้ปกครอง",
    finalCta: "ดูราคาและสั่งซื้อ",
    finalNote: "ชำระรายปีด้วยการโอนเงินผ่านธนาคารตามใบกำกับภาษี ไม่ต้องประมูล",
    mockupRoster: "รายชื่อนักเรียน 22 คน",
    mockupSearches: "ค้นหามากที่สุดสัปดาห์นี้",
    mockupStudent1: "Maya ค้นหา การสังเคราะห์ด้วยแสง",
    mockupStudent2: "Yossi ค้นหา ไมโทคอนเดรีย ×2",
    mockupStudent3: "Noa ค้นหา ประชาธิปไตย",
    mockupWordExample: "การสังเคราะห์ด้วยแสง",
    mockupExampleDef: "กระบวนการที่พืชสีเขียวใช้แสงอาทิตย์เปลี่ยนน้ำและคาร์บอนไดออกไซด์ให้เป็นอาหาร",
    mockupExampleEx: "การสังเคราะห์ด้วยแสงเกิดขึ้นที่ใบของพืชเป็นส่วนใหญ่",
  },
  bn: {
    heroH1: "প্রত্যেক শিক্ষার্থী পাঠ বোঝে।",
    heroSub: "যেকোনো কঠিন শব্দ, 30+ ভাষার যেকোনোটিতে, সঙ্গে সঙ্গে ব্যাখ্যা করা হয়।",
    heroCta: "মূল্য দেখুন ও অর্ডার করুন",
    heroPriceChip: "$97 / মাস থেকে",
    heroTrust: "নিজেই শুরু করুন। যেকোনো সময় বাতিল করুন।",
    probTag: "সমস্যা",
    probH2: "যে শিক্ষার্থী একটি শব্দ বোঝে না, সে পুরো বাক্যটি বুঝতে পারে না।",
    probBody1: "একজন শিক্ষার্থী একটি শব্দ মিস করে। সে হাত তোলে না। ভাবে মোটামুটি বুঝেছে। শিক্ষক এগিয়ে যান। পাঁচটি শব্দ পরে অনুচ্ছেদটি ঝাপসা হয়ে যায়। পাঁচটি অনুচ্ছেদ পরে পুরো পাঠটাই হারিয়ে যায়।",
    probBody2: "পিছিয়ে পড়া বেশিরভাগ শিক্ষার্থী মেধাহীন নয়। তাদের কাছে এমন অনেক শব্দ জমে আছে যা তারা কখনো পুরোপুরি বোঝেনি। তার ওপর গড়ে ওঠা প্রতিটি নতুন শব্দ ব্যবধান আরও বাড়ায়। আর শিক্ষক এই কারণটি দেখতে পান না।",
    probCallout1Title: "জমতে থাকা ব্যবধান",
    probCallout1Body: "না-বোঝা শব্দ ভবিষ্যতের প্রতিটি পাঠের সামনে এক অদৃশ্য দেয়াল তৈরি করে।",
    probCallout2Title: "সময়ের অপচয়",
    probCallout2Body: "প্রতি ক্লাসে শিক্ষকের 5 থেকে 10 মিনিট চলে যায় শব্দের অর্থ বোঝাতে।",
    probCallout3Title: "নীরবে সরে যাওয়া",
    probCallout3Body: "একটি অনুচ্ছেদে অচেনা শব্দ বেশি হলে শিক্ষার্থীরা মনোযোগ হারায়।",
    howTag: "কীভাবে কাজ করে",
    howH2: "2 মিনিটে সেটআপ। IT লাগবে না।",
    howSub: "কুইজ গেমে যে সহজ ক্লাসরুম কোড পদ্ধতি ইতিমধ্যে কাজ করছে, সেটাই, তবে শব্দ বোঝার জন্য তৈরি।",
    howStep1Title: "একটি ক্লাসরুম কোড তৈরি করুন",
    howStep1Body: "প্রধান শিক্ষক বা সমন্বয়ক ড্যাশবোর্ডে একটি ক্লাসরুম তৈরি করেন। সিস্টেম একটি 6 অক্ষরের কোড তৈরি করে। ক্লাসরুমের কম্পিউটারের জন্য এটি একটি স্টিকারে প্রিন্ট করুন।",
    howStep2Title: "শিক্ষার্থীরা যোগ দেয়, কোনো অ্যাকাউন্ট ছাড়াই",
    howStep2Body: "শিক্ষার্থীরা যেকোনো ব্রাউজারে gadit.app/c/CODE-এ যায়, তালিকা থেকে নিজের নাম বেছে নেয় (এক ক্লিকে), আর শব্দ লিখতে শুরু করে। কোনো অ্যাপ ইনস্টল নেই, ইমেল নেই, পাসওয়ার্ড নেই।",
    howStep3Title: "শিক্ষক দেখেন ক্লাস কী খুঁজেছে",
    howStep3Body: "প্রতিটি অনুসন্ধান শিক্ষার্থীর নামসহ ড্যাশবোর্ডে জমা হয়। আপনি দেখতে পান প্রত্যেক শিক্ষার্থী কী খুঁজেছে, কখন খুঁজেছে, আর কোন শব্দগুলোতে পুরো ক্লাস আটকে গেছে।",
    teacherTag: "শিক্ষকের দৃষ্টি",
    teacherH2: "যে ড্যাশবোর্ড আপনি এতদিন চাইছিলেন।",
    teacherSub: "অস্পষ্ট অংশগ্রহণের পরিসংখ্যান নয়। নির্দিষ্ট শব্দ, নির্দিষ্ট শিক্ষার্থী, নির্দিষ্ট মুহূর্ত।",
    teacherB1: "প্রত্যেক শিক্ষার্থীর অনুসন্ধানের ইতিহাস, সময়সহ",
    teacherB2: "এই সপ্তাহে পুরো ক্লাসের সবচেয়ে বেশি খোঁজা শব্দ",
    teacherB3: "বারবার খোঁজা শব্দ, যা দুর্বল বোঝাপড়ার সংকেত দেয়",
    teacherB4: "তারিখ, শিক্ষার্থী বা শব্দ অনুযায়ী ফিল্টার",
    privTag: "নকশা থেকেই গোপনীয়তা",
    privH2: "শিক্ষকের জন্য পূর্ণ দৃশ্যমানতা। স্কুলের জন্য শূন্য ডেটা ঝুঁকি।",
    privSub: "আমরা শিক্ষার্থীর কোনো ব্যক্তিগত তথ্য সংগ্রহ করি না। ভালোভাবে লুকিয়ে রাখি বলে নয়, বরং আমরা কখনো তা সংগ্রহই করি না। কাঠামোটিই নিয়ম মেনে চলার নিশ্চয়তা।",
    privPoint1: "শিক্ষার্থীর কোনো অ্যাকাউন্ট নেই। ইমেল নেই, পাসওয়ার্ড নেই, আইডি নেই।",
    privPoint2: "কোনো ব্যক্তিগত ডেটা স্কুলের বাইরে যায় না। অনুসন্ধান শুধু তালিকার নামের সঙ্গে যুক্ত থাকে।",
    privPoint3: "ক্লাসরুম কোড শুধু স্কুলের সময়ে কাজ করে। প্রতিটি স্কুল নিজের মতো ঠিক করতে পারে।",
    privPoint4: "COPPA, GDPR-K এবং ইসরায়েলের শিক্ষার্থী গোপনীয়তা আইন সহজেই মেনে চলে।",
    privKahoot: "ক্লাসের কুইজ গেমের মতোই সহজে যোগ দেওয়া যায়। শব্দ বোঝা আর শিক্ষকের স্পষ্ট দৃষ্টির জন্য তৈরি।",
    priceTag: "মূল্য",
    priceH2: "বার্ষিক মূল্য, স্কুলের আকার অনুযায়ী।",
    priceSub: "Stripe-এর মাধ্যমে নিজেই শুরু করুন। কোনো বিক্রয় কল নেই, ডেমো নেই, ক্রয়াদেশ নেই।",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "সর্বোচ্চ 100 শিক্ষার্থী",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "সর্বোচ্চ 500 শিক্ষার্থী",
    priceIncludesTitle: "দুটি প্ল্যানেই রয়েছে",
    priceIncludes: [
      "সীমাহীন ক্লাসরুম",
      "পূর্ণাঙ্গ শিক্ষক ড্যাশবোর্ড",
      "শিক্ষার্থীর নাম বেছে নেওয়ার তালিকা",
      "সময়সীমাবদ্ধ ক্লাসরুম কোড",
      "30+ ভাষায় শিক্ষার্থীর ইন্টারফেস",
      "সহজ বার্ষিক অর্ডার, ক্রয় সীমার নিচে",
      "উচ্চারণ অনুশীলন: যেকোনো শব্দ শুনুন ও বলুন",
    ],
    priceCta: "মূল্য দেখুন ও অর্ডার করুন",
    priceLarger: "1,000-এর বেশি শিক্ষার্থী? জেলা পর্যায়ের প্ল্যানের জন্য আমাদের সঙ্গে যোগাযোগ করুন।",
    faqTag: "প্রশ্নোত্তর",
    faqH2: "অর্ডার দেওয়ার আগে প্রধান শিক্ষকেরা যে প্রশ্নগুলো করেন।",
    faq: [
      {
        q: "লগইন না থাকলে কোন শিক্ষার্থী কী খুঁজেছে তা কীভাবে জানব?",
        a: "শিক্ষক আগে থেকেই ড্যাশবোর্ডে শিক্ষার্থীদের নামের তালিকা যোগ করেন। শিক্ষার্থী ক্লাসরুমের URL-এ গেলে এক ক্লিকে নিজের নাম বেছে নেয়। প্রতিটি অনুসন্ধান সেই নামের সঙ্গে যুক্ত হয়। কোনো ইমেল, পাসওয়ার্ড বা ব্যক্তিগত তথ্য সংগ্রহ করা হয় না।",
      },
      {
        q: "এটি কি COPPA অনুযায়ী নিরাপদ? অভিভাবকের অভিযোগ আসবে কি?",
        a: "হ্যাঁ, নিরাপদ। Gadit শিক্ষার্থীর কোনো ব্যক্তিগত তথ্যই সংগ্রহ করে না। অ্যাকাউন্ট তৈরি নেই, ইমেল সংগ্রহ নেই, জন্মতারিখ নেই, আইডি নেই। অপব্যবহার করার মতো কোনো ডেটাই নেই। এই কাঠামো COPPA, GDPR-K এবং ইসরায়েলের শিক্ষার্থী গোপনীয়তা আইনের চেয়েও অনেক বেশি সুরক্ষা দেয়।",
      },
      {
        q: "শিক্ষার্থীদের কি কোনো অ্যাপ ইনস্টল করতে হবে?",
        a: "না। যেকোনো ব্রাউজারেই চলে। শিক্ষার্থীরা ক্লাসরুমের কম্পিউটারে (বা ব্রাউজার আছে এমন যেকোনো ডিভাইসে) gadit.app/c/CODE-এ যায়। অ্যাপ স্টোর লাগে না, IT-এর সাহায্য লাগে না।",
      },
      {
        q: "IT বা SSO সেটআপ কি দরকার?",
        a: "না। প্রধান শিক্ষক বা শ্রেণি সমন্বয়ক দুই মিনিটে ক্লাসরুম তৈরি করে শিক্ষকদের সঙ্গে কোড শেয়ার করেন। কোনো ধাপেই IT-এর প্রয়োজন হয় না।",
      },
      {
        q: "ড্যাশবোর্ডে আসলে কী দেখা যায়?",
        a: "প্রত্যেক শিক্ষার্থীর সময়সহ শব্দ অনুসন্ধান, এই সপ্তাহে পুরো ক্লাসের সবচেয়ে বেশি খোঁজা শব্দ, আর বারবার খোঁজার ধরন যা দুর্বল বোঝাপড়ার সংকেত দেয়। আপনি ক্লাসের বোঝাপড়ার আসল ডেটা দেখেন, অস্পষ্ট অংশগ্রহণের পরিসংখ্যান নয়।",
      },
      {
        q: "ক্লাসের সময়ের বাইরে কি ব্যবহার করা যায়?",
        a: "ক্লাসরুম কোড স্কুলের সক্রিয় সময়ের সঙ্গে বাঁধা (ডিফল্ট রবিবার থেকে বৃহস্পতিবার, 7:30 থেকে 15:00, পরিবর্তনযোগ্য)। সেই সময়ের বাইরে কোডটি শুধু মৌলিক অভিধান সুবিধা দেয়, বাড়তি ফিচার নয়। এতে স্কুলের কোড Family প্ল্যানের বিনামূল্যের 24/7 বিকল্প হয়ে ওঠে না।",
      },
      {
        q: "আমার স্কুলে 500-এর বেশি শিক্ষার্থী থাকলে?",
        a: "শিক্ষার্থীর সংখ্যা অনুযায়ী বেছে নিন: সর্বোচ্চ 100 শিক্ষার্থী $97/মাস, সর্বোচ্চ 500 $297/মাস, আর সর্বোচ্চ 1,000 $497/মাস। 1,000-এর বেশি শিক্ষার্থী বা একাধিক ক্যাম্পাসের জেলার জন্য কাস্টম প্ল্যানের বিষয়ে আমাদের সঙ্গে যোগাযোগ করুন।",
      },
      {
        q: "Gadit কীভাবে একটি শব্দ ব্যাখ্যা করে? এটা কি শুধু অনুবাদ?",
        a: "Gadit অনুবাদ অভিধান নয়। Gadit শব্দের সংজ্ঞা দেয় ও ব্যাখ্যা করে। প্রতিটি শব্দের জন্য এটি সব অর্থ, প্রতিটি অর্থের তিনটি উদাহরণ বাক্য, শব্দের উৎস, আর একটি প্রসঙ্গ মোড দেয় যেখানে শিক্ষার্থী বাক্যটি পেস্ট করলে Gadit সঠিক অর্থটি বেছে নেয়। শিক্ষার্থীর ইন্টারফেস তার নিজের ভাষায়, কিন্তু প্রতিটি ইন্টারফেস ভাষায় ব্যাখ্যার গভীরতা একই।",
      },
    ],
    finalH2: "নীরব ব্যর্থতা থামান।",
    finalBody: "আপনার শিক্ষকদের এমন একটি হাতিয়ার দিন যাতে তাঁরা ঠিক দেখতে পান ক্লাস কী বুঝছে না। শুরু করতে লাগে মাত্র 2 মিনিট। IT নেই, ক্রয় প্রক্রিয়া নেই, অভিভাবকের ফর্ম নেই।",
    finalCta: "মূল্য দেখুন ও অর্ডার করুন",
    finalNote: "ট্যাক্স ইনভয়েসের বিপরীতে ব্যাংক ট্রান্সফারে বার্ষিক পেমেন্ট করুন। টেন্ডারের প্রয়োজন নেই।",
    mockupRoster: "ক্লাসের তালিকা, 22 শিক্ষার্থী",
    mockupSearches: "এই সপ্তাহে সবচেয়ে বেশি খোঁজা",
    mockupStudent1: "Maya খুঁজেছে সালোকসংশ্লেষণ",
    mockupStudent2: "Yossi খুঁজেছে মাইটোকন্ড্রিয়া ×2",
    mockupStudent3: "Noa খুঁজেছে গণতন্ত্র",
    mockupWordExample: "সালোকসংশ্লেষণ",
    mockupExampleDef: "যে প্রক্রিয়ায় সবুজ উদ্ভিদ সূর্যের আলো ব্যবহার করে পানি ও কার্বন ডাই অক্সাইডকে খাদ্যে রূপান্তর করে।",
    mockupExampleEx: "সালোকসংশ্লেষণ প্রধানত উদ্ভিদের পাতায় ঘটে।",
  },
  da: {
    heroH1: "Hver elev forstår undervisningen.",
    heroSub: "Ethvert svært ord, på et hvilket som helst af 30+ sprog, forklaret med det samme.",
    heroCta: "Se priser og bestil",
    heroPriceChip: "Fra $97 / måned",
    heroTrust: "Selvbetjening. Opsig når som helst.",
    probTag: "Problemet",
    probH2: "En elev, der ikke forstår et ord, kan ikke forstå sætningen.",
    probBody1: "En elev misser et ord. Eleven rækker ikke hånden op. Eleven tror, det nogenlunde giver mening. Læreren går videre. Fem ord senere er afsnittet sløret. Fem afsnit senere er timen tabt.",
    probBody2: "De fleste elever, der sakker bagud, er ikke uintelligente. De har en stak ord, de aldrig helt har forstået. Hvert nyt ord, der bygger på dem, gør hullet større. Årsagen er usynlig for læreren.",
    probCallout1Title: "Hullet, der vokser",
    probCallout1Body: "Ord, der aldrig blev forstået, bygger en usynlig mur foran hver fremtidig lektion.",
    probCallout2Title: "Tiden, der forsvinder",
    probCallout2Body: "Lærere bruger 5 til 10 minutter pr. lektion på at forklare ord.",
    probCallout3Title: "Det stille frafald",
    probCallout3Body: "Elever falder fra, når et afsnit har for mange ukendte ord.",
    howTag: "Sådan virker det",
    howH2: "Klar på 2 minutter. Ingen IT.",
    howSub: "Den samme gnidningsfri klassekode, som allerede virker til quizspil, bygget til ordforståelse i stedet.",
    howStep1Title: "Opret en klassekode",
    howStep1Body: "Skolelederen eller koordinatoren opretter et klasserum i dashboardet. Systemet laver en kode på 6 tegn. Print den på et klistermærke til klassens computer.",
    howStep2Title: "Eleverne går med, uden konti",
    howStep2Body: "Eleverne går ind på gadit.app/c/CODE i en hvilken som helst browser, vælger deres navn på klasselisten (ét klik) og begynder at skrive ord. Ingen app at installere, ingen e-mail, ingen adgangskode.",
    howStep3Title: "Lærerne ser, hvad klassen søgte på",
    howStep3Body: "Hver søgning lander i dashboardet, mærket med elevens navn. I ser, hvad hver elev slog op, hvornår, og hvilke ord klassen samlet kæmpede med.",
    teacherTag: "Lærerens overblik",
    teacherH2: "Det dashboard, I har efterspurgt.",
    teacherSub: "Ikke vage engagementstal. Konkrete ord, konkrete elever, konkrete øjeblikke.",
    teacherB1: "Søgehistorik pr. elev med tidsstempler",
    teacherB2: "Klassens mest søgte ord i denne uge",
    teacherB3: "Gentagne opslag, der viser skrøbelig forståelse",
    teacherB4: "Kan filtreres efter dato, elev eller ord",
    privTag: "Privatliv indbygget",
    privH2: "Fuldt overblik for lærerne. Nul datarisiko for skolen.",
    privSub: "Vi indsamler ingen personoplysninger om elever. Ikke fordi vi gemmer dem godt, men fordi vi aldrig indsamler dem. Arkitekturen er selve overholdelsen.",
    privPoint1: "Ingen elevkonti. Ingen e-mails, ingen adgangskoder, ingen ID'er.",
    privPoint2: "Ingen personlige data forlader skolen. Søgninger mærkes kun med navnet på klasselisten.",
    privPoint3: "Klassekoder virker kun i skoletiden. Kan indstilles for hver skole.",
    privPoint4: "COPPA, GDPR-K og israelsk lovgivning om elevers privatliv overholdes uden besvær.",
    privKahoot: "Lige så nemt at gå med i som et quizspil i klassen. Bygget til ordforståelse og overblik for lærerne.",
    priceTag: "Priser",
    priceH2: "Årlige priser efter skolens størrelse.",
    priceSub: "Selvbetjening via Stripe. Ingen salgsopkald, ingen demoer, ingen indkøbsordrer.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Op til 100 elever",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Op til 500 elever",
    priceIncludesTitle: "Begge planer omfatter",
    priceIncludes: [
      "Ubegrænset antal klasser",
      "Fuldt lærerdashboard",
      "Klasseliste, hvor eleven vælger sit navn",
      "Tidsbegrænsede klassekoder",
      "Elevflade på 30+ sprog",
      "Enkel årlig bestilling under udbudsgrænsen",
      "Udtaletræning: hør og sig ethvert ord",
    ],
    priceCta: "Se priser og bestil",
    priceLarger: "Mere end 1,000 elever? Kontakt os om planer for hele kommuner.",
    faqTag: "Spørgsmål",
    faqH2: "Spørgsmål, skoleledere stiller, før de bestiller.",
    faq: [
      {
        q: "Hvis der ikke er noget login, hvordan ved jeg så, hvilken elev der søgte på hvad?",
        a: "Læreren lægger på forhånd en liste med fornavne ind i dashboardet. Når en elev åbner klassens URL, vælger eleven sit navn med ét klik. Hver søgning mærkes med det navn. Der indsamles ingen e-mail, ingen adgangskode og ingen personoplysninger.",
      },
      {
        q: "Er det COPPA-sikkert? Får jeg klager fra forældre?",
        a: "Ja. Gadit indsamler slet ingen personoplysninger om elever. Ingen oprettelse af konti, ingen e-mails, ingen fødselsdage, ingen ID'er. Der er ingen data at misbruge. Arkitekturen går et godt stykke ud over kravene i COPPA, GDPR-K og israelsk lovgivning om elevers privatliv.",
      },
      {
        q: "Skal eleverne installere en app?",
        a: "Nej. Enhver browser virker. Eleverne går ind på gadit.app/c/CODE på klassens computer (eller enhver enhed med en browser). Ingen app-butik, ingen IT-involvering.",
      },
      {
        q: "Kræver det IT- eller SSO-opsætning?",
        a: "Nej. En skoleleder eller årgangskoordinator opretter klassen på to minutter og deler koden med lærerne. IT er ikke involveret i noget trin.",
      },
      {
        q: "Hvad viser dashboardet egentlig?",
        a: "Hver elevs ordsøgninger med tidsstempler, de ord klassen har søgt mest på i denne uge, og mønstre af gentagne opslag, der viser skrøbelig forståelse. I ser de reelle data om klassens forståelse, ikke vage engagementstal.",
      },
      {
        q: "Kan det bruges uden for skoletiden?",
        a: "Klassekoder er bundet til skolens aktive timer (som standard søndag til torsdag, 7:30 til 15:00, kan ændres). Uden for det tidsrum giver koden kun adgang til den grundlæggende ordbog uden de udvidede funktioner. Det forhindrer, at skolekoden bliver en gratis erstatning for Family-planen døgnet rundt, 24/7.",
      },
      {
        q: "Hvad hvis vores skole har mere end 500 elever?",
        a: "Vælg efter antal elever: op til 100 elever koster $97/måned, op til 500 koster $297/måned, og op til 1,000 koster $497/måned. Ved mere end 1,000 elever eller kommuner med flere skoler kan I kontakte os om en skræddersyet plan.",
      },
      {
        q: "Hvordan forklarer Gadit et ord? Er det bare en oversættelse?",
        a: "Gadit er ikke en oversættelsesordbog. Gadit definerer og forklarer ord. For hvert ord giver den alle betydninger, tre eksempelsætninger pr. betydning, etymologi og en konteksttilstand, hvor eleven indsætter sætningen, og Gadit vælger den rigtige betydning. Elevens skærm er på elevens eget sprog, men forklaringerne er lige grundige på alle skærmsprog.",
      },
    ],
    finalH2: "Stop de stille nederlag.",
    finalBody: "Giv jeres lærere værktøjet til at se præcis, hvad klassen ikke forstår. Det tager 2 minutter at komme i gang. Ingen IT, intet indkøb, ingen forældreblanketter.",
    finalCta: "Se priser og bestil",
    finalNote: "Betal årligt via bankoverførsel mod en faktura med moms. Intet udbud nødvendigt.",
    mockupRoster: "Klasseliste, 22 elever",
    mockupSearches: "Mest søgt i denne uge",
    mockupStudent1: "Maya søgte på fotosyntese",
    mockupStudent2: "Yossi søgte på mitokondrier ×2",
    mockupStudent3: "Noa søgte på demokrati",
    mockupWordExample: "fotosyntese",
    mockupExampleDef: "Den proces, hvor grønne planter bruger sollys til at omdanne vand og kuldioxid til næring.",
    mockupExampleEx: "Fotosyntesen foregår mest i plantens blade.",
  },
  hu: {
    heroH1: "Minden diák megérti az órát.",
    heroSub: "Bármilyen nehéz szó, a 30+ nyelv bármelyikén, azonnal elmagyarázva.",
    heroCta: "Árak és megrendelés",
    heroPriceChip: "$97 / hó-tól",
    heroTrust: "Önkiszolgáló. Bármikor lemondható.",
    probTag: "A probléma",
    probH2: "Aki nem ért egy szót, az a mondatot sem érti.",
    probBody1: "Egy diák elszalaszt egy szót. Nem jelentkezik. Úgy érzi, nagyjából érti. A tanár halad tovább. Öt szóval később a bekezdés elmosódik. Öt bekezdéssel később az óra elveszett.",
    probBody2: "A lemaradó diákok többsége nem buta. Csak felgyűlt náluk egy halom szó, amelyet sosem értettek meg teljesen. Minden új szó, amely ezekre épül, tovább növeli a szakadékot. Az ok a tanár számára láthatatlan.",
    probCallout1Title: "A halmozódó lemaradás",
    probCallout1Body: "A meg nem értett szavak láthatatlan falat építenek minden későbbi óra elé.",
    probCallout2Title: "Az elfolyó idő",
    probCallout2Body: "A tanárok óránként 5-10 percet töltenek szómagyarázattal.",
    probCallout3Title: "A csendes lemorzsolódás",
    probCallout3Body: "A diákok elkalandoznak, ha egy bekezdésben túl sok az ismeretlen szó.",
    howTag: "Hogyan működik",
    howH2: "2 perc alatt beállítható. IT nélkül.",
    howSub: "Ugyanaz a súrlódásmentes osztálykódos belépés, ami a kvízjátékoknál már bevált, csak a szavak megértésére építve.",
    howStep1Title: "Hozzon létre osztálykódot",
    howStep1Body: "Az igazgató vagy a koordinátor létrehoz egy osztályt az irányítópulton. A rendszer 6 karakteres kódot generál. Nyomtassa ki matricára az osztály számítógépéhez.",
    howStep2Title: "A diákok belépnek, fiók nélkül",
    howStep2Body: "A diákok bármilyen böngészőben megnyitják a gadit.app/c/CODE címet, kiválasztják a nevüket a névsorból (egy kattintás), és elkezdik beírni a szavakat. Nincs alkalmazástelepítés, nincs e-mail, nincs jelszó.",
    howStep3Title: "A tanárok látják, mit keresett az osztály",
    howStep3Body: "Minden keresés megjelenik az irányítópulton, a diák nevével jelölve. Látható, hogy melyik diák mit keresett, mikor, és mely szavakkal küzdött az egész osztály.",
    teacherTag: "A tanári nézet",
    teacherH2: "Az irányítópult, amire régóta vártak.",
    teacherSub: "Nem homályos aktivitási mutatók. Konkrét szavak, konkrét diákok, konkrét pillanatok.",
    teacherB1: "Diákonkénti keresési előzmények időbélyeggel",
    teacherB2: "Az osztály e heti legtöbbet keresett szavai",
    teacherB3: "Ismételt keresések, amelyek bizonytalan megértést jeleznek",
    teacherB4: "Szűrhető dátum, diák vagy szó szerint",
    privTag: "Beépített adatvédelem",
    privH2: "Teljes rálátás a tanároknak. Nulla adatkockázat az iskolának.",
    privSub: "Nem gyűjtünk személyes adatot a diákokról. Nem azért, mert jól elrejtjük, hanem mert soha nem is gyűjtjük. Maga a felépítés a megfelelés.",
    privPoint1: "Nincs diákfiók. Nincs e-mail, nincs jelszó, nincs azonosító.",
    privPoint2: "Személyes adat nem hagyja el az iskolát. A keresések csak a névsorban szereplő névvel vannak jelölve.",
    privPoint3: "Az osztálykódok csak tanítási időben működnek. Iskolánként beállítható.",
    privPoint4: "A COPPA, a GDPR-K és az izraeli diákadatvédelmi törvény előírásainak kényelmesen megfelel.",
    privKahoot: "Olyan könnyű belépni, mint egy osztálytermi kvízjátékba. A szavak megértésére és a tanári rálátásra építve.",
    priceTag: "Árak",
    priceH2: "Éves árak, az iskola méretétől függően.",
    priceSub: "Önkiszolgáló a Stripe-on keresztül. Nincs értékesítési hívás, nincs bemutató, nincs beszerzési megrendelő.",
    priceSmallName: "Schools",
    priceSmallAmount: "$69",
    priceSmallStudents: "Legfeljebb 100 diák",
    priceLargeName: "Schools Large",
    priceLargeAmount: "$149",
    priceLargeStudents: "Legfeljebb 500 diák",
    priceIncludesTitle: "Mindkét csomag tartalmazza",
    priceIncludes: [
      "Korlátlan számú osztály",
      "Teljes tanári irányítópult",
      "Névsor, amelyből a diák kiválasztja a nevét",
      "Időhöz kötött osztálykódok",
      "Diákfelület 30+ nyelven",
      "Egyszerű éves megrendelés, a beszerzési értékhatár alatt",
      "Kiejtésgyakorlás: bármely szó meghallgatása és kimondása",
    ],
    priceCta: "Árak és megrendelés",
    priceLarger: "Több mint 1,000 diák? Keressen minket tankerületi csomagokért.",
    faqTag: "GYIK",
    faqH2: "Kérdések, amelyeket az igazgatók a megrendelés előtt feltesznek.",
    faq: [
      {
        q: "Ha nincs bejelentkezés, honnan tudom, melyik diák mit keresett?",
        a: "A tanár előre feltölt egy keresztnevekből álló névsort az irányítópultra. Amikor a diák megnyitja az osztály címét, egy kattintással kiválasztja a nevét. Minden keresés ehhez a névhez kapcsolódik. Nem gyűjtünk e-mailt, jelszót vagy személyes adatot.",
      },
      {
        q: "Megfelel ez a COPPA-nak? Nem kapok szülői panaszt?",
        a: "Igen, megfelel. A Gadit egyáltalán nem gyűjt személyes adatot a diákokról. Nincs fióklétrehozás, nincs e-mail-gyűjtés, nincs születésnap, nincs azonosító. Nincs olyan adat, amivel vissza lehetne élni. A felépítés bőven túlteljesíti a COPPA, a GDPR-K és az izraeli diákadatvédelmi törvény követelményeit.",
      },
      {
        q: "Kell a diákoknak alkalmazást telepíteniük?",
        a: "Nem. Bármilyen böngésző megfelel. A diákok az osztály számítógépén (vagy bármilyen böngészős eszközön) megnyitják a gadit.app/c/CODE címet. Nincs alkalmazásbolt, nincs szükség az informatikusokra.",
      },
      {
        q: "Szükség van IT- vagy SSO-beállításra?",
        a: "Nem. Az igazgató vagy az évfolyam-koordinátor két perc alatt létrehozza az osztályt, és megosztja a kódot a tanárokkal. Az informatikusoknak egyetlen lépésben sincs dolga.",
      },
      {
        q: "Mit mutat valójában az irányítópult?",
        a: "Minden diák szókereséseit időbélyeggel, az osztály e heti legtöbbet keresett szavait, és az ismételt keresések mintázatait, amelyek bizonytalan megértést jeleznek. A valódi osztálytermi megértési adatokat látják, nem homályos aktivitási mutatókat.",
      },
      {
        q: "Használható tanítási időn kívül is?",
        a: "Az osztálykódok az iskola aktív óráihoz kötöttek (alapértelmezésként vasárnaptól csütörtökig, 7:30 és 15:00 között, módosítható). Ezen kívül a kód csak alap szótári hozzáférést ad, bővített funkciók nélkül. Így az iskolai kód nem válik a Family csomag ingyenes, 24/7 elérhető helyettesítőjévé.",
      },
      {
        q: "Mi van, ha az iskolánkba több mint 500 diák jár?",
        a: "Válasszon a diáklétszám alapján: legfeljebb 100 diákig $97/hó, legfeljebb 500-ig $297/hó, legfeljebb 1,000-ig $497/hó. Több mint 1,000 diák vagy több telephelyes tankerület esetén keressen minket egyedi csomagért.",
      },
      {
        q: "Hogyan magyaráz el a Gadit egy szót? Csak fordítás?",
        a: "A Gadit nem fordítószótár. A Gadit meghatározza és elmagyarázza a szavakat. Minden szóhoz megadja az összes jelentést, jelentésenként három példamondatot, a szó eredetét, valamint egy szövegkörnyezeti módot, amelyben a diák bemásolja a mondatot, és a Gadit kiválasztja a helyes jelentést. A diák felülete a saját nyelvén jelenik meg, de a magyarázat mélysége minden felületi nyelven ugyanaz.",
      },
    ],
    finalH2: "Vessenek véget a csendes kudarcnak.",
    finalBody: "Adják meg a tanároknak az eszközt, amellyel pontosan látják, mit nem ért az osztály. Az indulás 2 percet vesz igénybe. Nincs IT, nincs beszerzési eljárás, nincsenek szülői nyomtatványok.",
    finalCta: "Árak és megrendelés",
    finalNote: "Éves fizetés banki átutalással, adószámla ellenében. Nincs szükség közbeszerzésre.",
    mockupRoster: "Osztálynévsor, 22 diák",
    mockupSearches: "A hét legtöbbet keresett szavai",
    mockupStudent1: "Maya rákeresett: fotoszintézis",
    mockupStudent2: "Yossi rákeresett: mitokondrium ×2",
    mockupStudent3: "Noa rákeresett: demokrácia",
    mockupWordExample: "fotoszintézis",
    mockupExampleDef: "Az a folyamat, amelynek során a zöld növények a napfény segítségével vízből és szén-dioxidból tápanyagot állítanak elő.",
    mockupExampleEx: "A fotoszintézis főként a növény leveleiben megy végbe.",
  },
};
...
const USD_PRICING_UI: Record<string, UsdPricingUI> = {
  ...
  vi: { h2: "Một mức giá, cho mọi trường, ở mọi nơi.",
        billedMonthly: "Hằng tháng", billedYearly: "Hằng năm", yearlySave: "Miễn phí 2 tháng",
        perMonth: "/ tháng", perYear: "/ năm",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Tối đa 100 học sinh", largeStudents: "Tối đa 500 học sinh",
        cta: "Bắt đầu dùng thử miễn phí", afterTrial: "Dùng thử miễn phí 14 ngày, hủy bất cứ lúc nào." },
  fil: { h2: "Iisang presyo, para sa bawat paaralan, saanman.",
        billedMonthly: "Buwanan", billedYearly: "Taunan", yearlySave: "2 buwang libre",
        perMonth: "/ buwan", perYear: "/ taon",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Hanggang 100 estudyante", largeStudents: "Hanggang 500 estudyante",
        cta: "Simulan ang libreng trial", afterTrial: "14 na araw na libreng trial, puwedeng kanselahin anumang oras." },
  af: { h2: "Een prys, vir elke skool, oral.",
        billedMonthly: "Maandeliks", billedYearly: "Jaarliks", yearlySave: "2 maande gratis",
        perMonth: "/ maand", perYear: "/ jaar",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Tot 100 leerders", largeStudents: "Tot 500 leerders",
        cta: "Begin gratis proeftydperk", afterTrial: "14 dae gratis proeftydperk, kanselleer enige tyd." },
  sw: { h2: "Bei moja, kwa kila shule, kila mahali.",
        billedMonthly: "Kila mwezi", billedYearly: "Kila mwaka", yearlySave: "Miezi 2 bure",
        perMonth: "/ mwezi", perYear: "/ mwaka",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Hadi wanafunzi 100", largeStudents: "Hadi wanafunzi 500",
        cta: "Anza jaribio la bure", afterTrial: "Jaribio la bure la siku 14, ghairi wakati wowote." },
  "zh-CN": { h2: "一个价格，适用于每所学校，无论身在何处。",
        billedMonthly: "按月", billedYearly: "按年", yearlySave: "免费 2 个月",
        perMonth: "/ 月", perYear: "/ 年",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "最多 100 名学生", largeStudents: "最多 500 名学生",
        cta: "开始免费试用", afterTrial: "14 天免费试用，可随时取消。" },
  "zh-TW": { h2: "一個價格，適用於每所學校，無論身在何處。",
        billedMonthly: "按月", billedYearly: "按年", yearlySave: "免費 2 個月",
        perMonth: "/ 月", perYear: "/ 年",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "最多 100 名學生", largeStudents: "最多 500 名學生",
        cta: "開始免費試用", afterTrial: "14 天免費試用，可隨時取消。" },
  ko: { h2: "모든 학교, 어디서나 같은 가격.",
        billedMonthly: "월간", billedYearly: "연간", yearlySave: "2개월 무료",
        perMonth: "/ 월", perYear: "/ 년",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "최대 100명 학생", largeStudents: "최대 500명 학생",
        cta: "무료 체험 시작", afterTrial: "14일 무료 체험, 언제든지 해지 가능." },
  th: { h2: "ราคาเดียว สำหรับทุกโรงเรียน ทุกที่",
        billedMonthly: "รายเดือน", billedYearly: "รายปี", yearlySave: "ฟรี 2 เดือน",
        perMonth: "/ เดือน", perYear: "/ ปี",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "สูงสุด 100 คน", largeStudents: "สูงสุด 500 คน",
        cta: "เริ่มทดลองใช้ฟรี", afterTrial: "ทดลองใช้ฟรี 14 วัน ยกเลิกได้ทุกเมื่อ" },
  bn: { h2: "একটিই দাম, প্রতিটি স্কুলের জন্য, সব জায়গায়।",
        billedMonthly: "মাসিক", billedYearly: "বার্ষিক", yearlySave: "2 মাস বিনামূল্যে",
        perMonth: "/ মাস", perYear: "/ বছর",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "সর্বোচ্চ 100 শিক্ষার্থী", largeStudents: "সর্বোচ্চ 500 শিক্ষার্থী",
        cta: "বিনামূল্যে ট্রায়াল শুরু করুন", afterTrial: "14 দিনের বিনামূল্যে ট্রায়াল, যেকোনো সময় বাতিল করা যায়।" },
  da: { h2: "Én pris, for hver skole, overalt.",
        billedMonthly: "Månedlig", billedYearly: "Årlig", yearlySave: "2 måneder gratis",
        perMonth: "/ måned", perYear: "/ år",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Op til 100 elever", largeStudents: "Op til 500 elever",
        cta: "Start gratis prøveperiode", afterTrial: "14 dages gratis prøveperiode, opsig når som helst." },
  hu: { h2: "Egy ár, minden iskolának, bárhol.",
        billedMonthly: "Havi", billedYearly: "Éves", yearlySave: "2 hónap ingyen",
        perMonth: "/ hó", perYear: "/ év",
        smallName: "Schools", largeName: "Schools Large",
        smallStudents: "Legfeljebb 100 diák", largeStudents: "Legfeljebb 500 diák",
        cta: "Ingyenes próba indítása", afterTrial: "14 napos ingyenes próba, bármikor lemondható." },
};
...
const XLANG: Record<string, XLang> = {
  ...
  es: {
    tag: "Entre idiomas",
    h2: "¿Y si la palabra está en un idioma que el alumno todavía no domina?",
    body1: "Un niño lee la lección en el idioma de enseñanza, pero sigue pensando en ruso, amárico o árabe. Se encuentra con una palabra que no conoce, no levanta la mano y se hunde en silencio mientras la clase sigue avanzando.",
    body2: "Con Gadit, ese alumno busca la palabra, recibe el significado completo en su propio idioma y sigue leyendo la lección. La barrera de comprensión desaparece con un toque.",
    keyline: "Tus alumnos multilingües dejan de quedarse atrás en todas las demás asignaturas, porque por fin pueden leer el material.",
    demoWordLabel: "La lección dice",
    demoMeaningLabel: "El alumno entiende",
    note: "No es solo para quienes acaban de llegar al país. Es para cada alumno que se topa con una palabra difícil, en cualquiera de 30+ idiomas. El objetivo es entender el material, y esta es la herramienta más poderosa para lograrlo.",
  },
  pt: {
    tag: "Entre idiomas",
    h2: "E quando a palavra está num idioma que o aluno ainda não domina?",
    body1: "Uma criança lê a lição no idioma de ensino, mas ainda pensa em russo, amárico ou árabe. Encontra uma palavra que não conhece, não levanta a mão e afunda em silêncio enquanto a turma segue em frente.",
    body2: "No Gadit, esse aluno procura a palavra, recebe o significado completo no próprio idioma e continua lendo a lição. A barreira de compreensão some com um toque.",
    keyline: "Seus alunos multilíngues param de ficar para trás em todas as outras matérias, porque finalmente conseguem ler o conteúdo.",
    demoWordLabel: "A lição diz",
    demoMeaningLabel: "O aluno entende",
    note: "Não é só para quem acabou de chegar ao país. É para todo aluno que encontra uma palavra difícil, em qualquer um de 30+ idiomas. O objetivo é entender o conteúdo, e esta é a ferramenta mais forte para isso.",
  },
  fr: {
    tag: "Entre les langues",
    h2: "Et quand le mot est dans une langue que l'élève ne maîtrise pas encore ?",
    body1: "Un enfant lit la leçon dans la langue d'enseignement, mais pense encore en russe, en amharique ou en arabe. Il tombe sur un mot inconnu, ne lève pas la main et décroche en silence pendant que la classe avance.",
    body2: "Avec Gadit, cet élève cherche le mot, obtient le sens complet dans sa propre langue, puis reprend la lecture de la leçon. La barrière de compréhension disparaît en un geste.",
    keyline: "Vos élèves multilingues cessent de prendre du retard dans toutes les autres matières, parce qu'ils peuvent enfin lire les contenus.",
    demoWordLabel: "La leçon dit",
    demoMeaningLabel: "L'élève comprend",
    note: "Ce n'est pas seulement pour les élèves nouvellement arrivés. C'est pour chaque élève qui bute sur un mot difficile, dans l'une des 30+ langues. L'objectif est de comprendre la matière, et c'est l'outil le plus puissant pour y parvenir.",
  },
  de: {
    tag: "Sprachübergreifend",
    h2: "Und wenn das Wort in einer Sprache steht, die das Kind noch nicht ganz beherrscht?",
    body1: "Ein Kind liest die Lektion in der Unterrichtssprache, denkt aber noch auf Russisch, Amharisch oder Arabisch. Es stößt auf ein unbekanntes Wort, meldet sich nicht und geht still unter, während die Klasse weitermacht.",
    body2: "Mit Gadit schlägt das Kind das Wort nach, bekommt die volle Bedeutung in der eigenen Sprache und liest die Lektion weiter. Die Verständnishürde ist mit einem Tippen weg.",
    keyline: "Ihre mehrsprachigen Schülerinnen und Schüler fallen in keinem anderen Fach mehr zurück, weil sie den Stoff endlich lesen können.",
    demoWordLabel: "In der Lektion steht",
    demoMeaningLabel: "Das Kind versteht",
    note: "Das ist nicht nur für neu Zugewanderte. Es ist für alle, die auf ein schweres Wort stoßen, in jeder von 30+ Sprachen. Das Ziel ist, den Stoff zu verstehen, und dafür ist das hier das stärkste Werkzeug.",
  },
  cs: {
    tag: "Napříč jazyky",
    h2: "A co když je slovo v jazyce, který žák ještě plně neovládá?",
    body1: "Dítě čte lekci v jazyce výuky, ale pořád myslí rusky, amharsky nebo arabsky. Narazí na slovo, které nezná, nepřihlásí se a tiše se ztrácí, zatímco třída pokračuje dál.",
    body2: "V Gadit si takový žák slovo vyhledá, dostane jeho úplný význam ve svém jazyce a čte lekci dál. Bariéra porozumění zmizí jedním klepnutím.",
    keyline: "Vaši vícejazyční žáci přestanou zaostávat ve všech ostatních předmětech, protože konečně dokážou číst učivo.",
    demoWordLabel: "V lekci stojí",
    demoMeaningLabel: "Žák rozumí",
    note: "Není to jen pro nově příchozí. Je to pro každého žáka, který narazí na těžké slovo, v kterémkoli z 30+ jazyků. Cílem je porozumět učivu a tohle je k tomu nejsilnější nástroj.",
  },
  sk: {
    tag: "Naprieč jazykmi",
    h2: "A čo ak je slovo v jazyku, ktorý žiak ešte úplne neovláda?",
    body1: "Dieťa číta lekciu v jazyku vyučovania, no stále myslí po rusky, amharsky alebo arabsky. Narazí na slovo, ktoré nepozná, neprihlási sa a potichu sa stráca, kým trieda pokračuje ďalej.",
    body2: "V Gadit si taký žiak slovo vyhľadá, dostane jeho úplný význam vo svojom jazyku a číta lekciu ďalej. Bariéra porozumenia zmizne jedným ťuknutím.",
    keyline: "Vaši viacjazyční žiaci prestanú zaostávať vo všetkých ostatných predmetoch, pretože konečne dokážu čítať učivo.",
    demoWordLabel: "V lekcii stojí",
    demoMeaningLabel: "Žiak rozumie",
    note: "Nie je to len pre novoprišlých. Je to pre každého žiaka, ktorý narazí na ťažké slovo, v ktoromkoľvek z 30+ jazykov. Cieľom je porozumieť učivu a toto je na to najsilnejší nástroj.",
  },
  it: {
    tag: "Tra le lingue",
    h2: "E quando la parola è in una lingua che lo studente non padroneggia ancora?",
    body1: "Un bambino legge la lezione nella lingua di insegnamento, ma pensa ancora in russo, amarico o arabo. Incontra una parola che non conosce, non alza la mano e affonda in silenzio mentre la classe va avanti.",
    body2: "Con Gadit, quello studente cerca la parola, ottiene il significato completo nella propria lingua e continua a leggere la lezione. La barriera della comprensione sparisce con un tocco.",
    keyline: "I vostri studenti multilingui smettono di restare indietro in tutte le altre materie, perché finalmente riescono a leggere i contenuti.",
    demoWordLabel: "La lezione dice",
    demoMeaningLabel: "Lo studente capisce",
    note: "Non è solo per chi è appena arrivato nel paese. È per ogni studente che incontra una parola difficile, in una qualsiasi di 30+ lingue. L'obiettivo è capire la materia, e questo è lo strumento più forte per riuscirci.",
  },
  ja: {
    tag: "言語をこえて",
    h2: "その単語が、生徒がまだ十分に身につけていない言語で書かれていたら?",
    body1: "子どもは授業の言語で教科書を読んでいても、頭の中ではまだロシア語やアムハラ語、アラビア語で考えています。知らない単語に出会っても手を挙げず、クラスが先へ進む間、静かに取り残されていきます。",
    body2: "Gaditなら、その生徒は単語を調べて自分の言語で意味をしっかり理解し、そのまま授業を読み進められます。理解の壁はワンタップで消えます。",
    keyline: "多言語の生徒たちが、ほかのすべての教科でも遅れなくなります。ようやく教材を読めるようになるからです。",
    demoWordLabel: "授業の文章",
    demoMeaningLabel: "生徒の理解",
    note: "これは来日したばかりの生徒だけのものではありません。30+の言語のどれであっても、難しい単語にぶつかるすべての生徒のためのものです。目的は教材を理解すること。そのための最も強力な道具です。",
  },
  hi: {
    tag: "भाषाओं के पार",
    h2: "और अगर शब्द ऐसी भाषा में हो जिसमें छात्र अभी पूरी तरह माहिर नहीं है?",
    body1: "एक बच्चा पाठ को पढ़ाई की भाषा में पढ़ता है, लेकिन अब भी रूसी, अम्हारिक या अरबी में सोचता है। उसे एक अनजान शब्द मिलता है, वह हाथ नहीं उठाता, और कक्षा आगे बढ़ती रहती है जबकि वह चुपचाप पीछे छूट जाता है।",
    body2: "Gadit में वह छात्र शब्द खोजता है, अपनी भाषा में उसका पूरा अर्थ पाता है, और फिर पाठ पढ़ना जारी रखता है। समझ की रुकावट एक टैप में दूर हो जाती है।",
    keyline: "आपके बहुभाषी छात्र बाकी हर विषय में पिछड़ना बंद कर देते हैं, क्योंकि आखिरकार वे पाठ्य सामग्री पढ़ पाते हैं।",
    demoWordLabel: "पाठ में लिखा है",
    demoMeaningLabel: "छात्र समझता है",
    note: "यह सिर्फ नए आए प्रवासियों के लिए नहीं है। यह हर उस छात्र के लिए है जो किसी कठिन शब्द पर अटकता है, 30+ भाषाओं में से किसी में भी। लक्ष्य है सामग्री को समझना, और इसके लिए यह सबसे मजबूत साधन है।",
  },
  am: {
    tag: "በቋንቋዎች መካከል",
    h2: "ቃሉ ተማሪው ገና ሙሉ በሙሉ ባልተካነው ቋንቋ ቢሆንስ?",
    body1: "አንድ ልጅ ትምህርቱን በማስተማሪያ ቋንቋ ያነባል፣ ነገር ግን አሁንም በሩሲያኛ፣ በአማርኛ ወይም በዓረብኛ ያስባል። የማያውቀው ቃል ያጋጥመዋል፣ እጁን አያነሳም፣ ክፍሉም ወደ ፊት ሲቀጥል በዝምታ ወደ ኋላ ይቀራል።",
    body2: "በGadit ያ ተማሪ ቃሉን ይፈልጋል፣ ሙሉ ትርጉሙን በራሱ ቋንቋ ያገኛል፣ ከዚያም ትምህርቱን ማንበቡን ይቀጥላል። የመረዳት እንቅፋቱ በአንድ ንክኪ ይጠፋል።",
    keyline: "ብዙ ቋንቋ የሚናገሩ ተማሪዎችዎ በሌሎች የትምህርት ዓይነቶች ሁሉ ወደ ኋላ መቅረታቸውን ያቆማሉ፣ ምክንያቱም በመጨረሻ ትምህርቱን ማንበብ ይችላሉ።",
    demoWordLabel: "ትምህርቱ እንዲህ ይላል",
    demoMeaningLabel: "ተማሪው ይረዳል",
    note: "ይህ ለአዲስ መጤዎች ብቻ አይደለም። ከ30+ ቋንቋዎች በማንኛውም ከባድ ቃል ለሚያጋጥመው ተማሪ ሁሉ ነው። ግቡ ትምህርቱን መረዳት ነው፣ ለዚህም ይህ በጣም ጠንካራው መሣሪያ ነው።",
  },
  uk: {
    tag: "Між мовами",
    h2: "А якщо слово мовою, якою учень ще не володіє повністю?",
    body1: "Дитина читає урок мовою навчання, але досі думає російською, амхарською чи арабською. Вона натрапляє на незнайоме слово, не піднімає руку й мовчки відстає, поки клас рухається далі.",
    body2: "У Gadit цей учень шукає слово, отримує повне значення своєю мовою і читає урок далі. Бар'єр розуміння зникає одним дотиком.",
    keyline: "Ваші багатомовні учні перестають відставати з усіх інших предметів, бо нарешті можуть читати матеріал.",
    demoWordLabel: "В уроці написано",
    demoMeaningLabel: "Учень розуміє",
    note: "Це не лише для тих, хто щойно переїхав. Це для кожного учня, який натрапляє на складне слово, будь-якою з 30+ мов. Мета полягає в розумінні матеріалу, і це найсильніший інструмент для неї.",
  },
  tr: {
    tag: "Diller arası",
    h2: "Peki kelime, öğrencinin henüz tam hâkim olmadığı bir dildeyse?",
    body1: "Bir çocuk dersi öğretim dilinde okur ama hâlâ Rusça, Amharca ya da Arapça düşünür. Bilmediği bir kelimeye takılır, parmak kaldırmaz ve sınıf ilerlerken sessizce geride kalır.",
    body2: "Gadit ile o öğrenci kelimeye bakar, tam anlamını kendi dilinde öğrenir ve dersi okumaya devam eder. Anlama engeli tek dokunuşla ortadan kalkar.",
    keyline: "Çok dilli öğrencileriniz diğer tüm derslerde geride kalmayı bırakır, çünkü sonunda materyali okuyabilirler.",
    demoWordLabel: "Derste yazan",
    demoMeaningLabel: "Öğrencinin anladığı",
    note: "Bu yalnızca yeni gelenler için değil. 30+ dilin herhangi birinde zor bir kelimeye takılan her öğrenci için. Amaç konuyu anlamak ve bunun için en güçlü araç bu.",
  },
  pl: {
    tag: "Między językami",
    h2: "A co, jeśli słowo jest w języku, którego uczeń jeszcze w pełni nie opanował?",
    body1: "Dziecko czyta lekcję w języku nauczania, ale wciąż myśli po rosyjsku, amharsku albo arabsku. Trafia na nieznane słowo, nie podnosi ręki i po cichu się gubi, a klasa idzie dalej.",
    body2: "W Gadit taki uczeń sprawdza słowo, dostaje jego pełne znaczenie we własnym języku i czyta lekcję dalej. Bariera zrozumienia znika jednym dotknięciem.",
    keyline: "Twoi wielojęzyczni uczniowie przestają zostawać w tyle na wszystkich innych przedmiotach, bo wreszcie mogą czytać materiał.",
    demoWordLabel: "W lekcji jest napisane",
    demoMeaningLabel: "Uczeń rozumie",
    note: "To nie tylko dla nowo przybyłych. To dla każdego ucznia, który trafia na trudne słowo, w dowolnym z 30+ języków. Celem jest zrozumienie materiału, a to najmocniejsze narzędzie, by to osiągnąć.",
  },
  fa: {
    tag: "میان زبان‌ها",
    h2: "و اگر واژه به زبانی باشد که دانش‌آموز هنوز کاملاً بر آن مسلط نیست؟",
    body1: "کودکی درس را به زبان آموزش می‌خواند، اما هنوز به روسی، امهری یا عربی فکر می‌کند. به واژه‌ای ناآشنا برمی‌خورد، دستش را بالا نمی‌برد و در سکوت عقب می‌ماند، در حالی که کلاس جلو می‌رود.",
    body2: "در Gadit همان دانش‌آموز واژه را جست‌وجو می‌کند، معنای کامل آن را به زبان خودش می‌گیرد و خواندن درس را ادامه می‌دهد. مانع فهم با یک لمس از میان می‌رود.",
    keyline: "دانش‌آموزان چندزبانهٔ شما دیگر در هیچ درس دیگری عقب نمی‌مانند، چون بالاخره می‌توانند مطالب را بخوانند.",
    demoWordLabel: "در درس آمده",
    demoMeaningLabel: "دانش‌آموز می‌فهمد",
    note: "این فقط برای تازه‌واردان نیست. برای هر دانش‌آموزی است که به واژه‌ای دشوار برمی‌خورد، در هر یک از 30+ زبان. هدف فهمیدن مطالب است و این قوی‌ترین ابزار برای آن است.",
  },
  id: {
    tag: "Lintas bahasa",
    h2: "Bagaimana jika kata itu dalam bahasa yang belum sepenuhnya dikuasai siswa?",
    body1: "Seorang anak membaca pelajaran dalam bahasa pengantar, tetapi masih berpikir dalam bahasa Rusia, Amharik, atau Arab. Ia menemukan kata yang tidak dikenalnya, tidak mengangkat tangan, dan diam-diam tertinggal saat kelas terus berjalan.",
    body2: "Di Gadit, siswa itu mencari kata tersebut, mendapatkan makna lengkapnya dalam bahasanya sendiri, lalu lanjut membaca pelajaran. Hambatan pemahaman hilang dengan satu ketukan.",
    keyline: "Siswa multibahasa Anda berhenti tertinggal di semua mata pelajaran lain, karena akhirnya mereka bisa membaca materinya.",
    demoWordLabel: "Pelajaran menulis",
    demoMeaningLabel: "Siswa memahami",
    note: "Ini bukan hanya untuk pendatang baru. Ini untuk setiap siswa yang menemukan kata sulit, dalam salah satu dari 30+ bahasa. Tujuannya adalah memahami materi, dan inilah alat terkuat untuk itu.",
  },
  nl: {
    tag: "Over taalgrenzen heen",
    h2: "En als het woord in een taal staat die de leerling nog niet helemaal beheerst?",
    body1: "Een kind leest de les in de instructietaal, maar denkt nog in het Russisch, Amhaars of Arabisch. Het stuit op een onbekend woord, steekt geen vinger op en raakt stilletjes achter terwijl de klas verdergaat.",
    body2: "In Gadit zoekt die leerling het woord op, krijgt de volledige betekenis in de eigen taal en leest daarna de les verder. De begripsdrempel verdwijnt met één tik.",
    keyline: "Je meertalige leerlingen raken niet langer achter in alle andere vakken, omdat ze de lesstof eindelijk kunnen lezen.",
    demoWordLabel: "In de les staat",
    demoMeaningLabel: "De leerling begrijpt",
    note: "Dit is niet alleen voor nieuwkomers. Het is voor elke leerling die op een moeilijk woord stuit, in elk van 30+ talen. Het doel is de lesstof begrijpen, en dit is daar het sterkste hulpmiddel voor.",
  },
  el: {
    tag: "Ανάμεσα στις γλώσσες",
    h2: "Κι αν η λέξη είναι σε μια γλώσσα που ο μαθητής δεν έχει κατακτήσει ακόμη;",
    body1: "Ένα παιδί διαβάζει το μάθημα στη γλώσσα διδασκαλίας, αλλά ακόμη σκέφτεται στα ρωσικά, στα αμχαρικά ή στα αραβικά. Συναντά μια λέξη που δεν ξέρει, δεν σηκώνει χέρι και χάνεται σιωπηλά ενώ η τάξη προχωρά.",
    body2: "Στο Gadit, αυτός ο μαθητής αναζητά τη λέξη, παίρνει την πλήρη σημασία της στη δική του γλώσσα και συνεχίζει να διαβάζει το μάθημα. Το εμπόδιο της κατανόησης φεύγει με ένα άγγιγμα.",
    keyline: "Οι πολύγλωσσοι μαθητές σας σταματούν να μένουν πίσω σε όλα τα άλλα μαθήματα, γιατί επιτέλους μπορούν να διαβάσουν την ύλη.",
    demoWordLabel: "Το μάθημα γράφει",
    demoMeaningLabel: "Ο μαθητής καταλαβαίνει",
    note: "Δεν είναι μόνο για όσους μόλις ήρθαν στη χώρα. Είναι για κάθε μαθητή που συναντά μια δύσκολη λέξη, σε οποιαδήποτε από 30+ γλώσσες. Ο στόχος είναι η κατανόηση της ύλης, και αυτό είναι το πιο δυνατό εργαλείο γι' αυτήν.",
  },
  zu: {
    tag: "Ngaphesheya kwezilimi",
    h2: "Kuthiwani uma igama lisolimini umfundi angakalwazi ngokuphelele?",
    body1: "Ingane ifunda isifundo ngolimi lokufundisa, kodwa isacabanga ngesiRashiya, ngesi-Amharic noma ngesi-Arabhu. Ihlangana negama engalazi, ayiphakamisi isandla, futhi icwila buthule ngenkathi ikilasi liqhubeka.",
    body2: "Ku-Gadit, lowo mfundi ucinga igama, athole incazelo yalo ephelele ngolimi lwakhe, bese eqhubeka nokufunda isifundo. Isithiyo sokuqonda siyanyamalala ngokuthinta kanye.",
    keyline: "Abafundi bakho abakhuluma izilimi eziningi bayayeka ukusalela emuva kuzo zonke ezinye izifundo, ngoba ekugcineni bayakwazi ukufunda izinto zesifundo.",
    demoWordLabel: "Isifundo sithi",
    demoMeaningLabel: "Umfundi uyaqonda",
    note: "Lokhu akwenzelwe abafika kabusha kuphela. Kwenzelwe wonke umfundi ohlangana negama elinzima, kunoma yiluphi ulimi kwezingu-30+. Inhloso ukuqonda okufundwayo, futhi leli yithuluzi elinamandla kakhulu lokukwenza.",
  },
  vi: {
    tag: "Vượt rào ngôn ngữ",
    h2: "Còn khi từ đó thuộc một ngôn ngữ học sinh chưa thành thạo thì sao?",
    body1: "Một em đọc bài bằng ngôn ngữ giảng dạy nhưng vẫn suy nghĩ bằng tiếng Nga, tiếng Amhara hay tiếng Ả Rập. Em gặp một từ không biết, không giơ tay, và lặng lẽ tụt lại phía sau trong khi cả lớp vẫn tiếp tục.",
    body2: "Với Gadit, học sinh đó tra từ, nhận được nghĩa đầy đủ bằng chính ngôn ngữ của mình, rồi đọc tiếp bài học. Rào cản hiểu bài biến mất chỉ với một lần chạm.",
    keyline: "Học sinh đa ngôn ngữ của trường không còn bị tụt lại ở mọi môn học khác, vì cuối cùng các em đã đọc được tài liệu.",
    demoWordLabel: "Bài học viết",
    demoMeaningLabel: "Học sinh hiểu",
    note: "Điều này không chỉ dành cho học sinh mới nhập cư. Nó dành cho mọi học sinh gặp một từ khó, ở bất kỳ ngôn ngữ nào trong 30+ ngôn ngữ. Mục tiêu là hiểu bài, và đây là công cụ mạnh nhất để làm được điều đó.",
  },
  fil: {
    tag: "Tawid-wika",
    h2: "Paano kung ang salita ay nasa wikang hindi pa lubos na kabisado ng estudyante?",
    body1: "Binabasa ng isang bata ang aralin sa wikang panturo, pero nag-iisip pa rin siya sa Russian, Amharic, o Arabic. May makikita siyang salitang hindi niya alam, hindi siya magtataas ng kamay, at tahimik siyang maiiwan habang tuloy ang klase.",
    body2: "Sa Gadit, hinahanap ng estudyanteng iyon ang salita, nakukuha ang buong kahulugan nito sa sarili niyang wika, at itinutuloy ang pagbasa ng aralin. Nawawala ang hadlang sa pag-unawa sa isang tap lang.",
    keyline: "Hindi na naiiwan ang inyong mga multilingual na estudyante sa lahat ng iba pang asignatura, dahil sa wakas ay nababasa na nila ang aralin.",
    demoWordLabel: "Sabi ng aralin",
    demoMeaningLabel: "Naiintindihan ng estudyante",
    note: "Hindi lang ito para sa mga bagong dating na imigrante. Para ito sa bawat estudyanteng nakakakita ng mahirap na salita, sa alinman sa 30+ na wika. Ang layunin ay maunawaan ang aralin, at ito ang pinakamalakas na kasangkapan para roon.",
  },
  af: {
    tag: "Oor tale heen",
    h2: "En wanneer die woord in 'n taal is wat die leerder nog nie ten volle bemeester het nie?",
    body1: "'n Kind lees die les in die onderrigtaal, maar dink steeds in Russies, Amharies of Arabies. Die kind kom 'n onbekende woord teë, steek nie 'n hand op nie en raak stil-stil agter terwyl die klas aanbeweeg.",
    body2: "In Gadit soek daardie leerder die woord op, kry die volle betekenis in die eie taal en lees dan die les verder. Die begripsversperring is met een tik weg.",
    keyline: "Jou veeltalige leerders raak nie meer in al die ander vakke agter nie, want hulle kan uiteindelik die leerstof lees.",
    demoWordLabel: "Die les sê",
    demoMeaningLabel: "Die leerder verstaan",
    note: "Dit is nie net vir nuwe immigrante nie. Dit is vir elke leerder wat 'n moeilike woord teëkom, in enige van 30+ tale. Die doel is om die leerstof te verstaan, en dit is die sterkste hulpmiddel daarvoor.",
  },
  sw: {
    tag: "Kuvuka lugha",
    h2: "Na je, neno likiwa katika lugha ambayo mwanafunzi bado hajaimudu kikamilifu?",
    body1: "Mtoto anasoma somo kwa lugha ya kufundishia, lakini bado anafikiri kwa Kirusi, Kiamhari au Kiarabu. Anakutana na neno asilolijua, hainui mkono, na anabaki nyuma kimya huku darasa likiendelea.",
    body2: "Kwenye Gadit, mwanafunzi huyo anatafuta neno, anapata maana yake kamili kwa lugha yake mwenyewe, kisha anaendelea kusoma somo. Kizuizi cha kuelewa kinaondoka kwa mguso mmoja.",
    keyline: "Wanafunzi wako wanaozungumza lugha nyingi wanaacha kubaki nyuma katika masomo mengine yote, kwa sababu hatimaye wanaweza kusoma maudhui.",
    demoWordLabel: "Somo linasema",
    demoMeaningLabel: "Mwanafunzi anaelewa",
    note: "Hii si kwa wahamiaji wapya pekee. Ni kwa kila mwanafunzi anayekutana na neno gumu, katika lugha yoyote kati ya 30+. Lengo ni kuelewa somo, na hiki ndicho chombo chenye nguvu zaidi kwa hilo.",
  },
  "zh-CN": {
    tag: "跨越语言",
    h2: "如果这个词所用的语言，学生还没有完全掌握呢？",
    body1: "孩子用教学语言阅读课文，脑子里却仍在用俄语、阿姆哈拉语或阿拉伯语思考。遇到不认识的词，不举手，全班继续往前走，孩子就在沉默中掉队。",
    body2: "在 Gadit 里，这名学生查一下这个词，就能用自己的语言获得完整的词义，然后接着读课文。理解障碍一点即消。",
    keyline: "您的多语种学生不再在其他各门学科中掉队，因为他们终于能读懂教材了。",
    demoWordLabel: "课文里写的是",
    demoMeaningLabel: "学生理解为",
    note: "这不只是为新移民准备的。它面向每一位遇到难词的学生，覆盖 30+ 种语言中的任何一种。目标是理解学习内容，而这是实现它最有力的工具。",
  },
  "zh-TW": {
    tag: "跨越語言",
    h2: "如果這個詞所用的語言，學生還沒有完全掌握呢？",
    body1: "孩子用教學語言閱讀課文，腦中卻仍以俄語、阿姆哈拉語或阿拉伯語思考。遇到不認識的詞，不舉手，全班繼續往前，孩子就在沉默中落後。",
    body2: "在 Gadit 裡，這位學生查一下這個詞，就能以自己的語言得到完整的詞義，然後接著讀課文。理解障礙一點即消。",
    keyline: "您的多語學生不再在其他各科落後，因為他們終於能讀懂教材了。",
    demoWordLabel: "課文寫的是",
    demoMeaningLabel: "學生理解為",
    note: "這不只是為新移民準備的。它適用於每一位遇到難詞的學生，涵蓋 30+ 種語言中的任何一種。目標是理解學習內容，而這是達成目標最有力的工具。",
  },
  ko: {
    tag: "언어를 넘어",
    h2: "그 단어가 학생이 아직 완전히 익히지 못한 언어로 되어 있다면?",
    body1: "아이는 수업 언어로 교재를 읽지만, 여전히 러시아어나 암하라어, 아랍어로 생각합니다. 모르는 단어를 만나도 손을 들지 않고, 수업이 계속되는 동안 조용히 뒤처집니다.",
    body2: "Gadit에서 그 학생은 단어를 찾아 자신의 언어로 온전한 뜻을 얻고, 바로 수업 읽기를 이어갑니다. 이해의 장벽이 한 번의 탭으로 사라집니다.",
    keyline: "다언어 학생들이 다른 모든 과목에서도 더 이상 뒤처지지 않습니다. 마침내 교재를 읽을 수 있게 되니까요.",
    demoWordLabel: "수업 내용",
    demoMeaningLabel: "학생이 이해한 뜻",
    note: "이것은 새로 이주한 학생만을 위한 것이 아닙니다. 30+개 언어 중 어떤 언어로든 어려운 단어를 만나는 모든 학생을 위한 것입니다. 목표는 학습 내용을 이해하는 것이고, 이것이 그 목표를 위한 가장 강력한 도구입니다.",
  },
  th: {
    tag: "ข้ามภาษา",
    h2: "แล้วถ้าคำนั้นเป็นภาษาที่นักเรียนยังไม่คล่องล่ะ?",
    body1: "เด็กคนหนึ่งอ่านบทเรียนด้วยภาษาที่ใช้สอน แต่ยังคิดเป็นภาษารัสเซีย ภาษาอัมฮาริก หรือภาษาอาหรับ เมื่อเจอคำที่ไม่รู้จัก ก็ไม่ยกมือถาม และค่อยๆ ตามไม่ทันอย่างเงียบๆ ขณะที่ชั้นเรียนเดินหน้าต่อไป",
    body2: "ใน Gadit นักเรียนคนนั้นค้นหาคำ ได้ความหมายครบถ้วนในภาษาของตัวเอง แล้วอ่านบทเรียนต่อได้ทันที อุปสรรคในการเข้าใจหายไปในการแตะครั้งเดียว",
    keyline: "นักเรียนที่ใช้หลายภาษาของคุณจะไม่ตามหลังในวิชาอื่นๆ อีกต่อไป เพราะในที่สุดพวกเขาก็อ่านเนื้อหาได้",
    demoWordLabel: "บทเรียนเขียนว่า",
    demoMeaningLabel: "นักเรียนเข้าใจว่า",
    note: "สิ่งนี้ไม่ได้มีไว้สำหรับผู้ย้ายถิ่นใหม่เท่านั้น แต่สำหรับนักเรียนทุกคนที่เจอคำยาก ในภาษาใดก็ได้จาก 30+ ภาษา เป้าหมายคือการเข้าใจเนื้อหา และนี่คือเครื่องมือที่ทรงพลังที่สุดสำหรับเป้าหมายนั้น",
  },
  bn: {
    tag: "ভাষার সীমা পেরিয়ে",
    h2: "আর শব্দটি যদি এমন ভাষায় হয় যা শিক্ষার্থী এখনো পুরোপুরি আয়ত্ত করেনি?",
    body1: "একটি শিশু পাঠদানের ভাষায় পাঠ পড়ে, কিন্তু এখনো রুশ, আমহারিক বা আরবিতে ভাবে। অচেনা একটি শব্দে আটকে যায়, হাত তোলে না, আর ক্লাস এগিয়ে চলার সময় নীরবে পিছিয়ে পড়ে।",
    body2: "Gadit-এ সেই শিক্ষার্থী শব্দটি খোঁজে, নিজের ভাষায় তার পূর্ণ অর্থ পায়, তারপর পাঠ পড়া চালিয়ে যায়। বোঝার বাধা এক ট্যাপেই দূর হয়।",
    keyline: "আপনার বহুভাষী শিক্ষার্থীরা আর অন্য কোনো বিষয়ে পিছিয়ে পড়ে না, কারণ অবশেষে তারা পাঠ্যবস্তু পড়তে পারে।",
    demoWordLabel: "পাঠে লেখা আছে",
    demoMeaningLabel: "শিক্ষার্থী বোঝে",
    note: "এটি শুধু নতুন অভিবাসীদের জন্য নয়। 30+ ভাষার যেকোনোটিতে কঠিন শব্দে আটকে যাওয়া প্রত্যেক শিক্ষার্থীর জন্য। লক্ষ্য হলো বিষয়বস্তু বোঝা, আর এর জন্য এটিই সবচেয়ে শক্তিশালী হাতিয়ার।",
  },
  da: {
    tag: "På tværs af sprog",
    h2: "Og når ordet står på et sprog, eleven endnu ikke mestrer fuldt ud?",
    body1: "Et barn læser lektien på undervisningssproget, men tænker stadig på russisk, amharisk eller arabisk. Barnet støder på et ukendt ord, rækker ikke hånden op og sakker stille bagud, mens klassen går videre.",
    body2: "I Gadit slår eleven ordet op, får den fulde betydning på sit eget sprog og læser derefter videre i lektien. Forståelsesbarrieren forsvinder med ét tryk.",
    keyline: "Jeres flersprogede elever holder op med at sakke bagud i alle de andre fag, fordi de endelig kan læse stoffet.",
    demoWordLabel: "Lektien siger",
    demoMeaningLabel: "Eleven forstår",
    note: "Det er ikke kun for nyankomne. Det er for hver elev, der støder på et svært ord, på et hvilket som helst af 30+ sprog. Målet er at forstå stoffet, og dette er det stærkeste redskab til det.",
  },
  hu: {
    tag: "Nyelveken át",
    h2: "És ha a szó olyan nyelven van, amelyet a diák még nem sajátított el teljesen?",
    body1: "Egy gyerek a tanítás nyelvén olvassa a leckét, de még mindig oroszul, amharául vagy arabul gondolkodik. Ismeretlen szóba botlik, nem jelentkezik, és csendben lemarad, miközben az osztály halad tovább.",
    body2: "A Gaditban ez a diák rákeres a szóra, megkapja a teljes jelentését a saját nyelvén, majd tovább olvassa a leckét. A megértés akadálya egyetlen koppintással eltűnik.",
    keyline: "Többnyelvű diákjaik többé nem maradnak le a többi tantárgyból sem, mert végre el tudják olvasni a tananyagot.",
    demoWordLabel: "A leckében ez áll",
    demoMeaningLabel: "A diák ezt érti",
    note: "Ez nem csak az újonnan érkezetteknek szól. Minden diáknak szól, aki nehéz szóba botlik, a 30+ nyelv bármelyikén. A cél a tananyag megértése, és ehhez ez a legerősebb eszköz.",
  },
};
