...
const COPY: Record<string, T> = {
  ...
  es: {
    ...
    priceIncludes: [
      ...
      "Interfaz del estudiante en 13 idiomas",
  ...
  pt: {
    ...
    priceIncludes: [
      ...
      "Interface do aluno em 13 idiomas",
  ...
  de: {
    ...
    priceIncludes: [
      ...
      "Schüler-Oberfläche in 13 Sprachen",
  ...
  it: {
    ...
    priceIncludes: [
      ...
      "Interfaccia studente in 13 lingue",
