...
const COPY: Record<string, T> = {
  ...
  he: {
    ...
    heroTrust: "Self-serve. אפשר לבטל בכל רגע.",
    probTag: "הבעיה",
    ...
    finalBody: "המורים שלך מקבלים את הכלי לראות בדיוק מה הכיתה לא מבינה. הניסיון מתחיל ב-2 דקות. בלי IT, בלי רכש, בלי טפסי הורים.",
