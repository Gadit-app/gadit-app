...
const COPY = {
  uk: {
    ...
    why: [
      { t: "Продукт, який люблять батьки", d: "Безпечний для дітей словник 21 мовами, з прикладами, картинками та особистим зошитом. Легко рекомендувати те, що справді допомагає." },
  ...
  tr: {
    ...
    why: [
      { t: "Velilerin sevdiği bir ürün", d: "Örnekler, resimler ve kişisel bir defterle 21 dilde, çocuklar için güvenli bir sözlük. Gerçekten faydalı bir şeyi önermek kolaydır." },
  ...
  pl: {
    ...
    why: [
      { t: "Produkt, który kochają rodzice", d: "Bezpieczny dla dzieci słownik w 21 językach, z przykładami, obrazkami i osobistym zeszytem. Łatwo polecać coś, co naprawdę pomaga." },
  ...
  fa: {
    ...
    why: [
      { t: "محصولی که والدین دوستش دارند", d: "فرهنگ لغتی امن برای کودکان در 21 زبان، با مثال‌ها، تصویرها و یک دفترچه‌ی شخصی. توصیه‌ی چیزی که واقعاً کمک می‌کند آسان است." },
  ...
  id: {
    ...
    why: [
      { t: "Produk yang disukai orang tua", d: "Kamus aman untuk anak dalam 21 bahasa, dengan contoh, gambar, dan buku catatan pribadi. Mudah merekomendasikan sesuatu yang benar-benar membantu." },
  ...
  he: {
    ...
    why: [
      { t: "מוצר שהורים אוהבים", d: "מילון בטוח לילדים ב-21 שפות, עם דוגמאות, תמונות ומחברת אישית. קל להמליץ על משהו שבאמת עוזר." },
  ...
  en: {
    ...
    why: [
      { t: "A product parents love", d: "A child-safe dictionary in 21 languages, with examples, pictures and a personal notebook. Easy to recommend something that genuinely helps." },
  ...
  el: {
    ...
    why: [
      { t: "Ένα προϊόν που οι γονείς αγαπούν", d: "Ένα ασφαλές για παιδιά λεξικό σε 21 γλώσσες, με παραδείγματα, εικόνες και ένα προσωπικό τετράδιο. Είναι εύκολο να συστήσεις κάτι που πραγματικά βοηθάει." },
  ...
  nl: {
    ...
    why: [
      { t: "Een product waar ouders van houden", d: "Een kindveilig woordenboek in 21 talen, met voorbeelden, afbeeldingen en een persoonlijk notitieboek. Makkelijk om iets aan te bevelen dat echt helpt." },
  ...
  es: {
    ...
    why: [
      { t: "Un producto que las familias adoran", d: "Un diccionario seguro para niños en 21 idiomas, con ejemplos, imágenes y un cuaderno personal. Es fácil recomendar algo que de verdad ayuda." },
  ...
  pt: {
    ...
    why: [
      { t: "Um produto que os pais amam", d: "Um dicionário seguro para crianças em 21 idiomas, com exemplos, imagens e um caderno pessoal. É fácil recomendar algo que realmente ajuda." },
  ...
  fr: {
    ...
    why: [
      { t: "Un produit que les parents adorent", d: "Un dictionnaire sûr pour les enfants en 21 langues, avec des exemples, des images et un carnet personnel. Facile de recommander quelque chose qui aide vraiment." },
  ...
  de: {
    ...
    why: [
      { t: "Ein Produkt, das Eltern lieben", d: "Ein kindersicheres Wörterbuch in 21 Sprachen, mit Beispielen, Bildern und einem persönlichen Notizbuch. Etwas, das wirklich hilft, empfiehlt sich leicht." },
  ...
  it: {
    ...
    why: [
      { t: "Un prodotto che i genitori amano", d: "Un dizionario sicuro per i bambini in 21 lingue, con esempi, immagini e un quaderno personale. È facile consigliare qualcosa che aiuta davvero." },
  ...
  ja: {
    ...
    why: [
      { t: "保護者に愛される製品", d: "21言語対応の子どもに安全な辞書。例文、画像、そして自分だけのノートブック付き。本当に役立つものだから、自信を持っておすすめできます。" },
  ...
  hi: {
    ...
    why: [
      { t: "एक प्रोडक्ट जो माता-पिता को पसंद है", d: "21 भाषाओं में एक बच्चों के लिए सुरक्षित शब्दकोश, जिसमें उदाहरण, तस्वीरें और एक निजी नोटबुक है। जो सचमुच मदद करता है उसकी सिफारिश करना आसान है।" },
  ...
  am: {
    ...
    why: [
      { t: "ወላጆች የሚወዱት ምርት", d: "በ21 ቋንቋዎች የቀረበ ለልጆች ደኅንነቱ የተጠበቀ መዝገበ ቃላት፣ ከምሳሌዎች፣ ስዕሎች እና ከግል ማስታወሻ ደብተር ጋር። በእውነት የሚጠቅም ነገር መምከር ቀላል ነው።" },
