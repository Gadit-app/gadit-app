...
const COPY = {
  he: {
    ...
    nav: "לאתר",
    heroTitle: "המליצו על Gadit. קבלו הכנסה חוזרת.",
    heroSub: "כל מי שנרשם ומשלם דרך הקישור האישי שלכם מזכה אתכם ב-25% עמלה חוזרת בשנה הראשונה, ו-10% לכל החיים.",
    ...
    why: [
      ...
      { t: "הכנסה חוזרת אמיתית", d: "לא תגמול חד-פעמי. כל חודש שהלקוח משלם, אתם מקבלים עמלה. לקוח שנשאר שנה שווה לכם שנה שלמה." },
      { t: "אפס סיכון", d: "ההצטרפות חינם, אין יעדים ואין מינימום. משתפים קישור, ומרוויחים." },
    ],
    howTitle: "איך זה עובד",
    how: [
      { t: "נרשמים", d: "ממלאים שם ומייל, ותוך שניות מקבלים קוד וקישור אישי." },
      { t: "משתפים", d: "שולחים את הקישור לקהל שלכם. כל מי שלוחץ משויך אליכם ל-60 יום, גם אם נרשם מאוחר יותר." },
      { t: "מרוויחים", d: "על כל חודש שהלקוח משלם בפועל אתם מקבלים עמלה. משתחרר אחרי 30 יום ומשולם פעם בחודש." },
    ],
    ratesTitle: "כמה מרוויחים",
    standardName: "שותף",
    standardRate: "25%",
    ...
    calcLead: "כמה לקוחות פעילים תביאו?",
    calcMonthly: "בחודש",
    calcYearly: "בשנה הראשונה",
    calcNote: "הערכה על בסיס מנוי Deep ועמלת 25%. לקוחות שנתיים ומנויי משפחה/בית ספר מגדילים את הסכום.",
    formTitle: "הצטרפו לתוכנית",
    formName: "שם מלא",
    formEmail: "אימייל",
    formAudience: "איפה הקהל שלכם? (רשות)",
    formCta: "קבלת קוד שותף",
    formSending: "רגע…",
    successTitle: "אתם בפנים 🎉",
    successBody: "שלחנו לכם את הקוד והקישור למייל. הנה גם כאן:",
    successLinkLabel: "הקישור האישי שלכם",
    successDash: "פתיחת האזור האישי",
    errEmail: "נא להזין אימייל תקין.",
    errGeneric: "משהו השתבש. נסו שוב.",
    faqTitle: "שאלות נפוצות",
    faq: [
      { q: "אני צריך להיות לקוח משלם?", a: "לא. ההצטרפות פתוחה לכולם, בחינם." },
      { q: "מתי מקבלים את הכסף?", a: "כל עמלה משתחררת 30 יום אחרי התשלום, והתשלום מתבצע פעם בחודש." },
      { q: "מה קורה אם לקוח מבטל?", a: "קיבלתם עמלה על כל חודש ששולם בפועל. אם ביטל אחרי 4 חודשים, קיבלתם 4 חודשים. הוגן לשני הצדדים." },
      { q: "יש תקרה?", a: "אין. תביאו כמה לקוחות שתרצו." },
    ],
  },
  en: {
    dir: "ltr" as const,
