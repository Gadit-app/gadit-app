...
> = {
  he: { tagline: "להבין מילים עד הסוף", placeholder: "הקלידו מילה",       tryLabel: "לדוגמה", signin: "התחברות",     pricing: "תמחור", search: "חיפוש", features: "פיצ'רים", addSentence: "הוסיפו את המשפט שבו מופיעה המילה כדי לקבל הגדרה אחת מדויקת", sentencePlaceholder: "(אופציונלי) הקלידו את המשפט שבו מופיעה המילה כדי לקבל הגדרה אחת מדויקת", optional: "אופציונלי", founderNote: "בכל פעם שמשהו לא ברור, יש שם מילה אחת. תפסת אותה, הבנת הכל.", founderSign: "גדי, מייסד Gadit" },
