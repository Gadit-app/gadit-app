...
> = {
  ...
  vi: {"tagline":"Hiểu từ ngữ đến tận cùng","placeholder":"Nhập một từ","tryLabel":"Thử","signin":"Đăng nhập","pricing":"Bảng giá","search":"Tìm kiếm","features":"Tính năng","addSentence":"Thêm câu chứa từ đó để nhận một định nghĩa chính xác","sentencePlaceholder":"(Tùy chọn) Nhập câu chứa từ đó để nhận một định nghĩa chính xác","optional":"Tùy chọn","founderNote":"Mỗi khi có điều gì đó không thông, luôn có một từ cản đường. Nắm được nó, mọi thứ sẽ mở ra.","founderSign":"Gadi, người sáng lập Gadit"},
  fil: {"tagline":"Unawain ang mga salita hanggang dulo","placeholder":"Mag-type ng salita","tryLabel":"Subukan","signin":"Mag-sign in","pricing":"Presyo","search":"Maghanap","features":"Mga feature","addSentence":"Idagdag ang pangungusap kung saan lumalabas ang salita para makakuha ng isang tiyak na kahulugan","sentencePlaceholder":"(Opsyonal) I-type ang pangungusap kung saan lumalabas ang salita para makakuha ng isang tiyak na kahulugan","optional":"Opsyonal","founderNote":"Sa tuwing may hindi maintindihan, may isang salitang humaharang. Mahuli mo lang ito, at magbubukas ang lahat.","founderSign":"Si Gadi, tagapagtatag ng Gadit"},
  af: {"tagline":"Verstaan woorde tot op die einde","placeholder":"Tik 'n woord","tryLabel":"Probeer","signin":"Meld aan","pricing":"Pryse","search":"Soek","features":"Kenmerke","addSentence":"Voeg die sin by waar die woord voorkom om een presiese definisie te kry","sentencePlaceholder":"(Opsioneel) Tik die sin waar die woord voorkom om een presiese definisie te kry","optional":"Opsioneel","founderNote":"Elke keer as iets nie klik nie, staan daar een woord in die pad. Vang dit, en alles maak oop.","founderSign":"Gadi, stigter van Gadit"},
  sw: {"tagline":"Elewa maneno hadi mwisho","placeholder":"Andika neno","tryLabel":"Jaribu","signin":"Ingia","pricing":"Bei","search":"Tafuta","features":"Vipengele","addSentence":"Ongeza sentensi ambapo neno linapatikana ili upate maana moja sahihi","sentencePlaceholder":"(Si lazima) Andika sentensi ambapo neno linapatikana ili upate maana moja sahihi","optional":"Si lazima","founderNote":"Kila mara jambo linaposhindwa kueleweka, kuna neno moja linalozuia. Likamate, na kila kitu kitafunguka.","founderSign":"Gadi, mwanzilishi wa Gadit"},
  "zh-CN": {"tagline":"把每个词彻底读懂","placeholder":"输入一个词","tryLabel":"试试","signin":"登录","pricing":"定价","search":"搜索","features":"功能","addSentence":"添加这个词所在的句子，获得一个精准的释义","sentencePlaceholder":"（可选）输入这个词所在的句子，获得一个精准的释义","optional":"可选","founderNote":"每当有什么读不通的时候，总有一个词挡在中间。抓住它，一切就豁然开朗。","founderSign":"Gadi，Gadit 创始人"},
  "zh-TW": {"tagline":"把每個詞徹底讀懂","placeholder":"輸入一個詞","tryLabel":"試試","signin":"登入","pricing":"定價","search":"搜尋","features":"功能","addSentence":"加入這個詞所在的句子，獲得一個精準的釋義","sentencePlaceholder":"（選填）輸入這個詞所在的句子，獲得一個精準的釋義","optional":"選填","founderNote":"每當有什麼讀不通的時候，總有一個詞擋在中間。抓住它，一切就豁然開朗。","founderSign":"Gadi，Gadit 創辦人"},
  ko: {"tagline":"단어를 끝까지 이해하기","placeholder":"단어를 입력하세요","tryLabel":"예시","signin":"로그인","pricing":"요금제","search":"검색","features":"기능","addSentence":"단어가 나오는 문장을 추가하면 정확한 뜻 하나를 알려드립니다","sentencePlaceholder":"(선택) 단어가 나오는 문장을 입력하면 정확한 뜻 하나를 알려드립니다","optional":"선택","founderNote":"무언가 이해되지 않을 때는 늘 가로막는 단어 하나가 있습니다. 그 단어를 붙잡으면 모든 것이 열립니다.","founderSign":"Gadit 창립자, 가디"},
  th: {"tagline":"เข้าใจทุกคำจนถึงที่สุด","placeholder":"พิมพ์คำ","tryLabel":"ลองดู","signin":"เข้าสู่ระบบ","pricing":"ราคา","search":"ค้นหา","features":"ฟีเจอร์","addSentence":"เพิ่มประโยคที่มีคำนั้นอยู่ เพื่อรับความหมายที่ตรงที่สุดเพียงหนึ่งเดียว","sentencePlaceholder":"(ไม่บังคับ) พิมพ์ประโยคที่มีคำนั้นอยู่ เพื่อรับความหมายที่ตรงที่สุดเพียงหนึ่งเดียว","optional":"ไม่บังคับ","founderNote":"ทุกครั้งที่มีอะไรไม่เข้าใจ มักมีคำหนึ่งขวางอยู่ จับคำนั้นให้ได้ แล้วทุกอย่างจะเปิดออก","founderSign":"กาดี ผู้ก่อตั้ง Gadit"},
  bn: {"tagline":"প্রতিটি শব্দ শেষ পর্যন্ত বুঝুন","placeholder":"একটি শব্দ লিখুন","tryLabel":"চেষ্টা করুন","signin":"সাইন ইন","pricing":"মূল্য","search":"খুঁজুন","features":"বৈশিষ্ট্য","addSentence":"শব্দটি যে বাক্যে আছে সেটি যোগ করুন, একটি নির্ভুল অর্থ পেতে","sentencePlaceholder":"(ঐচ্ছিক) শব্দটি যে বাক্যে আছে সেটি লিখুন, একটি নির্ভুল অর্থ পেতে","optional":"ঐচ্ছিক","founderNote":"যখনই কিছু বোঝা যায় না, তখন একটি শব্দ পথ আটকে থাকে। সেটি ধরতে পারলেই সব খুলে যায়।","founderSign":"গাদি, Gadit-এর প্রতিষ্ঠাতা"},
  da: {"tagline":"Forstå ord helt til bunds","placeholder":"Skriv et ord","tryLabel":"Prøv","signin":"Log ind","pricing":"Priser","search":"Søg","features":"Funktioner","addSentence":"Tilføj sætningen, hvor ordet optræder, for at få én præcis betydning","sentencePlaceholder":"(Valgfrit) Skriv sætningen, hvor ordet optræder, for at få én præcis betydning","optional":"Valgfrit","founderNote":"Hver gang noget ikke giver mening, står der ét ord i vejen. Fang det, og alt åbner sig.","founderSign":"Gadi, grundlægger af Gadit"},
  hu: {"tagline":"Értsd meg a szavakat, a végükig","placeholder":"Írj be egy szót","tryLabel":"Kipróbálás","signin":"Bejelentkezés","pricing":"Árak","search":"Keresés","features":"Funkciók","addSentence":"Add meg a mondatot, amelyben a szó szerepel, hogy egyetlen pontos jelentést kapj","sentencePlaceholder":"(Nem kötelező) Írd be a mondatot, amelyben a szó szerepel, hogy egyetlen pontos jelentést kapj","optional":"Nem kötelező","founderNote":"Valahányszor valami nem áll össze, mindig egyetlen szó áll az útban. Kapd el, és minden megnyílik.","founderSign":"Gadi, a Gadit alapítója"},
};
