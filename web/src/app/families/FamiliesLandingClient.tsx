...
const COPY: Record<string, Copy> = {
  ...
  el: {
    ...
    stats: ["20 γλώσσες", "Μια εικόνα ανά σημασία", "Έως 5 παιδιά", "Ακύρωση με ένα κλικ"],
    ...
    stackItems: [
      ...
      "20 γλώσσες με πλήρη υποστήριξη",
    ],
    priceKicker: "Τιμές",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Πάρα πολύ. Ένα παιδί μπορεί να ψάξει μια λέξη στα αγγλικά και να πάρει μια απλή εξήγηση στη δική του γλώσσα, με εικόνα και παραδείγματα, ακριβώς ο βοηθός που λείπει στο σπίτι. Και λειτουργεί σε 20 γλώσσες, οπότε το παιδί μπορεί να πάρει την εξήγηση και στη γλώσσα που μιλάτε στο σπίτι.",
      },
      {
        q: "Πόσο κοστίζει;",
