...
const COPY: Record<string, Copy> = {
  uk: {
    ...
    howBlocks: [
      ...
      { t: "Почуй і вимов", b: "Ваша дитина чує будь-яке слово й тренується вимовляти його вголос, тож говорити стає так само природно, як і читати." },
    ],
    chainCost: "",
  ...
  tr: {
    ...
    howBlocks: [
      ...
      { t: "Duy ve söyle", b: "Çocuğunuz herhangi bir kelimeyi duyar ve yüksek sesle söylemeyi çalışır, böylece konuşmak da okumak kadar doğal gelir." },
    ],
    chainCost: "",
  ...
  pl: {
    ...
    howBlocks: [
      ...
      { t: "Usłysz i powiedz", b: "Twoje dziecko słyszy każde słowo i ćwiczy wymawianie go na głos, dzięki czemu mówienie staje się tak naturalne jak czytanie." },
    ],
    chainCost: "",
  ...
  fa: {
    ...
    howBlocks: [
      ...
      { t: "بشنو و بگو", b: "کودک شما هر واژه را می‌شنود و بلند گفتن آن را تمرین می‌کند، تا حرف زدن به همان اندازه خواندن برایش طبیعی شود." },
    ],
    chainCost: "",
  ...
  id: {
    ...
    howBlocks: [
      ...
      { t: "Dengar, lalu ucapkan", b: "Anak Anda mendengar setiap kata dan berlatih mengucapkannya dengan lantang, sehingga berbicara terasa sealami membaca." },
    ],
    chainCost: "",
  ...
  en: {
    ...
    howBlocks: [
      ...
      { t: "Hear it, and say it", b: "Your child hears any word and practices saying it out loud, so it feels natural to speak, not just to read." },
    ],
    chainCost: "",
  ...
  zu: {
    ...
    howBlocks: [
      ...
      { t: "Lizwe, bese ulisho", b: "Ingane yakho izwa noma yiliphi igama iphinde izejwayeze ukulisho ngokuzwakalayo, ukuze ukukhuluma kuzizwe kungokwemvelo njengokufunda." },
    ],
    chainCost: "",
  ...
  el: {
    ...
    howBlocks: [
      ...
      { t: "Άκουσέ το και πες το", b: "Το παιδί σας ακούει οποιαδήποτε λέξη και εξασκείται να την προφέρει δυνατά, ώστε το να μιλάει να γίνεται τόσο φυσικό όσο και το να διαβάζει." },
    ],
    chainCost: "",
  ...
  nl: {
    ...
    howBlocks: [
      ...
      { t: "Hoor het en zeg het", b: "Je kind hoort elk woord en oefent het hardop uit te spreken, zodat praten net zo vanzelf gaat als lezen." },
    ],
    chainCost: "",
  ...
  ru: {
    ...
    howBlocks: [
      ...
      { t: "Услышать и произнести", b: "Ваш ребёнок слышит любое слово и тренируется произносить его вслух, поэтому говорить становится так же естественно, как читать." },
    ],
    chainCost: "",
  ...
  ar: {
    ...
    howBlocks: [
      ...
      { t: "اسمعها، ثم انطقها", b: "يسمع طفلك أي كلمة ويتدرّب على نطقها بصوت عالٍ، فيصبح الكلام طبيعيًا لا مجرد قراءة." },
    ],
    chainCost: "",
  ...
  es: {
    ...
    howBlocks: [
      ...
      { t: "Escúchala y dila", b: "Tu hijo escucha cualquier palabra y practica decirla en voz alta, para que hablar le resulte natural, no solo leer." },
    ],
    chainCost: "",
  ...
  pt: {
    ...
    howBlocks: [
      ...
      { t: "Ouça e diga", b: "Seu filho ouve qualquer palavra e pratica dizê-la em voz alta, para que falar fique natural, não só ler." },
    ],
    chainCost: "",
  ...
  fr: {
    ...
    howBlocks: [
      ...
      { t: "L'entendre, et la dire", b: "Votre enfant entend n'importe quel mot et s'entraîne à le dire à voix haute, pour que parler devienne naturel, pas seulement lire." },
    ],
    chainCost: "",
  ...
  de: {
    ...
    howBlocks: [
      ...
      { t: "Hören und aussprechen", b: "Ihr Kind hört jedes Wort und übt, es laut auszusprechen, damit Sprechen genauso selbstverständlich wird wie Lesen." },
    ],
    chainCost: "",
  ...
  cs: {
    ...
    howBlocks: [
      ...
      { t: "Slyšet a vyslovit", b: "Vaše dítě slyší jakékoli slovo a procvičuje si, jak ho vyslovit nahlas, takže mluvení je stejně přirozené jako čtení." },
    ],
    chainCost: "",
  ...
  sk: {
    ...
    howBlocks: [
      ...
      { t: "Počuť a vysloviť", b: "Vaše dieťa počuje akékoľvek slovo a precvičuje si, ako ho vysloviť nahlas, takže rozprávanie je rovnako prirodzené ako čítanie." },
    ],
    chainCost: "",
  ...
  it: {
    ...
    howBlocks: [
      ...
      { t: "Ascoltala e dilla", b: "Tuo figlio ascolta qualsiasi parola e si allena a pronunciarla ad alta voce, così parlare diventa naturale, non solo leggere." },
    ],
    chainCost: "",
  ...
  ja: {
    ...
    howBlocks: [
      ...
      { t: "聞いて、声に出す", b: "お子さんはどんな言葉でも聞いて、声に出して言う練習ができます。だから読むだけでなく、話すことも自然に身につきます。" },
    ],
    chainCost: "",
  ...
  hi: {
    ...
    howBlocks: [
      ...
      { t: "सुनें और बोलें", b: "आपका बच्चा कोई भी शब्द सुनता है और उसे ज़ोर से बोलने का अभ्यास करता है, ताकि बोलना पढ़ने जितना ही स्वाभाविक लगे।" },
    ],
    chainCost: "",
  ...
  am: {
    ...
    howBlocks: [
      ...
      { t: "ስማው፣ ተናገረው", b: "ልጅዎ ማንኛውንም ቃል ይሰማል፣ ጮክ ብሎ መናገርንም ይለማመዳል፣ ስለዚህ ማንበብ እንደሚቀለው ሁሉ መናገርም ተፈጥሯዊ ይሆንለታል።" },
    ],
    chainCost: "",
...
Object.assign(COPY, {
  "af": {"heroBadge":"'n Visuele, slim woordeboek vir die hele gesin","whatIs":"Gadit is 'n slim, visuele woordeboek vir kinders: elke woord kry 'n verduideliking op kindervlak, 'n prent, voorbeelde, en speletjies en vasvrae wat woorde leer lekker maak. Woordeskat groei, leesbegrip verbeter, en jou kind vaar beter op skool.","ctaMicro":"","trustLine":"Tot 5 kinders, elkeen op sy eie vlak","credLine":"Gebou op 15 jaar se ondervinding met meer as 15,000 ouers, leerders en opvoeders","credKicker":"Wie ons is","credTitle":"15 jaar in onderwys. Nou in een hulpmiddel vir jou kind.","credBody":"Gadit is gebou deur 'n span met 15 jaar se ondervinding in onderwys, wat met meer as 15,000 ouers, leerders en opvoeders gewerk het. Wat ons keer op keer sien werk het, in die klaskamer en by die huis, het ons in een eenvoudige hulpmiddel gesit wat 'n kind op sy eie kan gebruik.","proofTitle":"Woordeboekie · voorbeeld","proofBig":"12 nuwe woorde hierdie week","proofWords":["droom","helder","huiwerig"],"angles":{"vocab":{"h1":"Jou kind se woordeskat groei. Woord vir woord.","sub":"Elke woord waaroor jou kind wonder, land in hul persoonlike woordeboekie in Gadit: met 'n prent, 'n verduideliking op kindervlak, en kort oefening wat dit terugbring totdat dit hulle eie is. Maak die boekie aan die einde van die maand oop en kyk hoe die woordeskat groei, woord vir woord."},"relief":{"h1":"Hou op om die gesin se woordeboek te wees","sub":"Van vandag af, wanneer jou kind vra \"wat beteken dit?\", het hulle een plek om die antwoord op hul eie te kry: elke betekenis, 'n prent vir elkeen, en 'n verduideliking op kindervlak. Geen oop kletsvenster nie, geen advertensies nie."},"anxiety":{"h1":"Jou kind lees elke woord reg, maar verstaan nie regtig nie","sub":"Hulle stop nie altyd om te vra nie. Hulle spring 'n woord oor wat hulle nie verstaan nie, gaan aan, en die werk sink nie in nie. Mettertyd word dit frustrasie met skool en 'n gevoel van \"ek kan dit nie doen nie\". Gadit gee jou kind een plek om te stop, regtig te verstaan, en terug te gaan na die les met die woord in die hand."},"safe":{"h1":"Die een skerm wat jy sonder kommer vir 'n kind kan gee","sub":"Geen oop kletsvenster nie. Geen eindelose voer nie. Geen advertensies nie. Een skoon plek waar 'n kind 'n woord tik, dit ten volle verstaan, en teruggaan na huiswerk."}},"heroCta":"Begin jou 14-dae gratis proeftydperk","heroTrust":"Geen oop kletsvenster · Geen advertensies · Kanselleer met een klik","ownerCta":"Gaan na jou gesinsruimte","stats":["30+ tale","'n Prent per betekenis","Tot 5 kinders","Kanselleer met een klik"],"demoKicker":"Die resultaat","demoTitle":"Jou kind verstaan elke woord, en hul woordeskat groei elke dag","painKicker":"Die werklike pyn","painTitle":"Jou kind lees, maar verstaan nie altyd regtig nie","painBody1":"Jy is eintlik bly wanneer jou kind stop om te vra wat 'n woord beteken. Die probleem is al die woorde waaroor hulle nie stop om te vra nie. Hulle spring dit oor, lees aan, en die werk sink nie in nie. Woordeskat bly dun, en begrip breek woord na woord.","painBody2":"En dit raak veel meer as net 'n punt. 'n Kind wat nie verstaan nie voel nie goed genoeg nie, raak gefrustreerd met skool, en verloor selfvertroue. En dit gebeur stil, sonder dat iemand kan aandui waar die draad gebreek het.","reframe":"En dit is presies waar Gadit inkom.","puzzleKicker":"Wat in 'n kind se kop gebeur","puzzleTitle":"Teks is 'n legkaart. Elke woord is 'n stukkie.","puzzleBody":"Wanneer 'n kind lees, bou hul gedagtes 'n hele prentjie uit die woorde. Elke woord wat hulle verstaan is 'n stukkie wat op sy plek klik. Elke ontbrekende woord is 'n gat in die prentjie. Net drie of vier gate, en die kind sien nie meer die prentjie nie, selfs al het hulle elke letter uitgeklank.","puzzleBefore":"'n Paragraaf met ontbrekende woorde","puzzleAfter":"Met Gadit, elke stukkie op sy plek","puzzleLine":"Wanneer elke woord duidelik is, sien die kind die hele prentjie.","chainKicker":"Hoe dit werk","chainTitle":"Alles wat jou kind kry, by elke woord","chainSteps":["Jou kind tik 'n woord wat hulle nie verstaan nie","Hulle kry 'n verduideliking op hul ooghoogte, 'n prent en drie voorbeelde","Die woord word in hul persoonlike boekie gestoor","En kom terug in kort oefening, totdat dit regtig hulle eie is"],"howBlocks":[{"t":"Tik die woord","b":"Jou kind tik enige woord wat hulle nie verstaan nie, in Kindermodus, in 'n skoon en veilige plek."},{"t":"'n Duidelike definisie","b":"'n Verduideliking op die kind se ooghoogte, geen moeilike woorde wat moeilike woorde verduidelik nie."},{"t":"Drie voorbeelde","b":"Regte sinne wat wys hoe die woord binne 'n teks leef, met 'n prent, nie net 'n definisie nie."},{"t":"'n Prent vir elke betekenis","b":"Want kinders onthou wat hulle sien baie beter as wat vir hulle geskryf word."},{"t":"Konteks","b":"Plak 'n sin uit die boek en Gadit merk presies die betekenis wat daarby pas."},{"t":"'n Persoonlike boekie","b":"Elke woord wat jou kind opgesoek het word in hul boekie gestoor, en hardloop nie weg nie."},{"t":"'n Kort vasvra","b":"'n Vinnige vraag wat die woord terugbring net voordat dit wegglip."},{"t":"'n Speletjie","b":"Leer deur te speel, met die woorde wat jou kind self opgesoek het."},{"t":"Hoor dit, en sê dit","b":"Jou kind hoor enige woord en oefen om dit hardop te sê, sodat dit natuurlik voel om te praat, nie net te lees nie."}],"chainCost":"","chainTurnTitle":"En dit is wat jy kry","chainTurnBody":"Elke woord waarby jou kind vasgehaak het, word 'n woord wat hulle ken, en jy sien dit swart op wit: hoeveel woorde hulle afgehandel het, week na week. In plaas daarvan om te hoop dat iets verbeter, kyk jy net hoe dit gebeur.","dashKicker":"Die ouerpaneel","dashTitle":"Jy sien presies hoeveel elke kind geleer het","dashBody":"Elke kind het 'n persoonlike woordeboekie wat groei. In jou paneel sien jy, met een oogopslag, hoeveel woorde elke kind geleer het, hoeveel hierdie week bygevoeg is, en hul mees onlangse woorde. Enige ander hulpmiddel antwoord jou kind en vergeet. Gadit onthou, en jy sien die vordering week na week.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"woorde in boekie","dashWeekLabel":"hierdie week","featuresKicker":"Wat binne is","features":[{"kicker":"Elke betekenis","title":"Een woord. Elke betekenis. 'n Prent vir elkeen.","body":"Een woord het dikwels verskeie verskillende betekenisse, en dit is waar kinders deurmekaar raak. Gadit wys hulle almal op een plek, elkeen met drie regte voorbeelde en sy eie prent, want 'n kind se brein onthou beelde baie beter as woorde."},{"kicker":"Kindermodus","title":"Verduidelikings op jou kind se ooghoogte","body":"Een skakelaar, en elke verduideliking word taal wat 'n 8-jarige werklik verstaan. Geen moeilike woorde wat moeilike woorde verduidelik nie, geen sirkulêre definisies nie. Net begrip."},{"kicker":"Konteks","title":"Plak 'n sin, kry die regte betekenis","body":"Die meeste woorde het meer as een betekenis, en dit is waar kinders verdwaal. Plak die sin uit die boek of werkkaart, en Gadit merk presies watter betekenis pas."},{"kicker":"Persoonlike boekie","title":"Die woorde hardloop nie weg nie","body":"Elke woord wat jou kind opsoek land in hul persoonlike boekie, en kort slim oefening bring dit terug net voordat dit wegglip. Dis hoe woordeskat werklik gebou word, een woord op 'n slag."},{"kicker":"'n Profiel per kind","title":"Elke kind kry hul eie ruimte","body":"Elke kind in die gesin kry 'n aparte profiel: hul boekie, hul oefening, hul geskiedenis. Kindermodus pas die verduideliking aan, eenvoudig en duidelik vir die kleintjies en voller vir die ouer kinders, en niemand trap op iemand anders se woorde nie."},{"kicker":"Woordspeletjies","title":"Leerspeletjies met jou kind se woorde","body":"Kort vasvrae en speletjies gebou uit die woorde wat jou kind werklik opgesoek het. 'n Paar minute se speel, en woordeskat groei sonder moeite."},{"kicker":"Tweede taal","title":"Die beste huiswerkhulp vir 'n tweede taal","body":"Jou kind tik 'n woord in Engels en kry 'n eenvoudige verduideliking in hul eie taal, met 'n prent en voorbeelde. Geen ronddwaal tussen 'n woordeboek, 'n vertaler en YouTube nie."}],"midCtaTitle":"Begin nou, en kyk hoe jou kind se woordeskat dag vir dag groei","midCta":"Begin jou 14-dae gratis proeftydperk","compareKicker":"Die verskil","compareTitle":"Waarom nie net Google dit of vra 'n kletsbot nie?","compareGadit":"Gadit","compareOther":"Die oop internet","compareRows":[{"label":"Een skoon bladsy per woord","gadit":true,"other":false},{"label":"Verduidelikings op kindervlak","gadit":true,"other":false},{"label":"'n Prent vir elke betekenis","gadit":true,"other":false},{"label":"'n Boekie en oefening wat bly vashou","gadit":true,"other":false},{"label":"Advertensies en skakels in elke rigting","gadit":false,"other":true},{"label":"Oop kletsvenster sonder grense","gadit":false,"other":true}],"safeTitle":"'n Aparte, skoon sone. Nie 'n deurgang na enige ander plek nie.","safeBody":"Gadit is 'n heeltemal geslote ruimte: geen oop kletsvenster nie, geen voer nie, geen advertensies nie, geen uitgaande skakels nie. 'n Kind word nie van hier na TikTok of enige ander toepassing getrek nie. Daar is een ding om hier te doen: 'n woord verstaan, en teruggaan na studeer.","safeLine":"Een skerm wat jy met 'n gerus hart vir 'n kind kan gee.","stackTitle":"Wat die Gesinsplan insluit","stackItems":["Onbeperkte soektogte vir die hele gesin","Elke betekenis, met 'n prent vir elkeen","Kindermodus vir elke ouderdom","Sinkontrolering met onmiddellike terugvoer","'n Persoonlike boekie en slim oefening per kind","Woordspeletjies en vasvrae","Tot 5 kinders met aparte profiele","30+ tale met volle ondersteuning"],"priceKicker":"Pryse","priceTitle":"Die Gesinsplan","trialBadge":"14-dae gratis proeftydperk","yearly":"$59 / jaar","yearlyNote":"dit is $4.92 per maand vir die hele gesin, en spaar jou byna twee maande teenoor maandeliks betaal","priceAnchor":"Minder as een privaat bykleslessie, vir 'n hele jaar, vir elke kind by die huis","monthly":"$5.99 / maand","billedYearly":"Jaarliks","billedMonthly":"Maandeliks","yearlySave":"-18%","priceCta":"Begin die proeftydperk","cancelNote":"Eerste heffing eers na die 14 dae. Kanselleer enige tyd vanaf jou rekeningbladsy, een klik.","singleChild":"Net een leerder by die huis? Deep is $4.99/maand. Vir 'n bietjie meer kan jy tot 5 kinders byvoeg.","guaranteeTitle":"Jou toets: twee weke","guaranteeBody":"Gee dit twee weke van werklike gebruik, gratis. As jou kind se boekie teen dag 14 nie ten minste 20 nuwe woorde versamel het nie, kanselleer met een klik en jy het niks betaal nie.","faqTitle":"Vrae wat ouers vra","faq":[{"q":"Wat kry ek met Gadit?","a":"Elke woord wat jou kind opsoek kry een skoon bladsy: elke betekenis, 'n verduideliking op kindervlak (Kindermodus), drie regte voorbeelde, en 'n prent per betekenis. Plus konteks (plak 'n sin en kry die regte betekenis), 'n persoonlike woordeboekie met slim oefening, woordspeletjies en vasvrae, 'n ouerpaneel wat wys hoeveel elke kind geleer het, tot 5 kinders op aparte profiele, alles in 30+ tale, in 'n geslote, veilige ruimte sonder oop kletsvenster en sonder advertensies."},{"q":"Waarom nie net 'n kletsbot vra of Google nie?","a":"Want daardie is hulpmiddels vir volwassenes. Google gee advertensies en skakels in elke rigting terug, en 'n oop kletsbot is 'n grenslose gesprek waarin geen ouer 'n kind alleen los nie. Gadit is andersom gebou: een geslote, skoon bladsy per woord, op kindervlak, sonder enige manier om te verdwaal."},{"q":"Hoe weet ek my kind vorder werklik?","a":"Jy kry 'n ouerpaneel. Met een oogopslag sien jy hoeveel woorde elke kind geleer het, hoeveel hierdie week bygevoeg is, en hul jongste woorde. Elke ander hulpmiddel antwoord die kind en vergeet; Gadit stoor elke woord in die kind se persoonlike boekie, sodat jy die woordeskat week na week sien groei."},{"q":"Vir watter ouderdomme is dit?","a":"Die hart van Gadit is skoolgaande kinders, van graad een tot hoërskool. Kindermodus verduidelik eenvoudig vir die jonges, en die volledige verduidelikings dien tieners en ouers ook. Die ouer maak die rekening oop."},{"q":"Help dit met Engels en ander tale?","a":"Baie beslis. 'n Kind kan 'n woord in Engels opsoek en 'n eenvoudige verduideliking in hul eie taal kry, met 'n prent en voorbeelde, presies die hulp wat by die huis ontbreek. En dit werk in 30+ tale, sodat die kind die verduideliking ook in die taal wat julle by die huis praat kan kry."},{"q":"Hoeveel kos dit?","a":"$59 per jaar of $5.99 per maand, na die 14-dae proeftydperk. Geen versteekte fooie nie, en jy kanselleer enige tyd met een klik."},{"q":"Hoeveel kinders kan ek byvoeg?","a":"Tot 5 kinders op een Gesinsplan, elkeen met hul eie profiel, boekie en oefening."},{"q":"Kan ons dit probeer sonder om ons te verbind?","a":"Ja. Die proeftydperk begin met 'n kaart, maar die eerste heffing gebeur eers wanneer die 14 dae eindig. Kanselleer enige tyd voor dit, een klik, en jy betaal niks."}],"finalTitle":"Begin vandag, en kyk hoe die woordeskat groei","finalSub":"Twee weke gratis. Een-klik kansellasie. En 'n kind wat leer om woorde op hul eie te verstaan.","finalCta":"Begin jou 14-dae gratis proeftydperk","footerTerms":"Bepalings","footerPrivacy":"Privaatheid"},
  "bn": {"heroBadge":"গোটা পরিবারের জন্য একটি ভিজ্যুয়াল, স্মার্ট অভিধান","whatIs":"Gadit হলো বাচ্চাদের জন্য একটি স্মার্ট, ভিজ্যুয়াল অভিধান: প্রতিটি শব্দ পায় বাচ্চাদের উপযোগী ব্যাখ্যা, একটি ছবি, উদাহরণ, আর এমন খেলা ও কুইজ যা শব্দ শেখাকে আনন্দময় করে তোলে। শব্দভাণ্ডার বাড়ে, পড়া বোঝার ক্ষমতা উন্নত হয়, আর আপনার সন্তান স্কুলে আরও ভালো করে।","ctaMicro":"","trustLine":"৫ জন পর্যন্ত সন্তান, প্রত্যেকে নিজের স্তরে","credLine":"১৫,০০০-এর বেশি অভিভাবক, শিক্ষার্থী ও শিক্ষকের সঙ্গে ১৫ বছরের অভিজ্ঞতার ওপর তৈরি","credKicker":"আমরা কারা","credTitle":"শিক্ষায় ১৫ বছর। এবার আপনার সন্তানের জন্য একটি টুলে।","credBody":"Gadit তৈরি করেছে এমন একটি দল, যাদের শিক্ষায় ১৫ বছরের অভিজ্ঞতা এবং যারা ১৫,০০০-এর বেশি অভিভাবক, শিক্ষার্থী ও শিক্ষকের সঙ্গে কাজ করেছে। শ্রেণিকক্ষে আর ঘরে যা বারবার কাজ করতে দেখেছি, সেটাকেই আমরা একটি সহজ টুলে গড়ে তুলেছি, যা একটি বাচ্চা নিজে নিজেই ব্যবহার করতে পারে।","proofTitle":"শব্দের খাতা · উদাহরণ","proofBig":"এই সপ্তাহে ১২টি নতুন শব্দ","proofWords":["স্বপ্ন","প্রাণবন্ত","অনিচ্ছুক"],"angles":{"vocab":{"h1":"আপনার সন্তানের শব্দভাণ্ডার বাড়ে। শব্দে শব্দে।","sub":"আপনার সন্তান যে শব্দটি নিয়ে প্রশ্ন করে, সেটি জমা হয় Gadit-এ তার নিজের শব্দের খাতায়: একটি ছবি, বাচ্চাদের উপযোগী ব্যাখ্যা, আর ছোট্ট অনুশীলনসহ, যা শব্দটিকে বারবার ফিরিয়ে আনে যতক্ষণ না সেটি সত্যিই তার হয়ে যায়। মাসের শেষে খাতাটি খুলুন আর দেখুন শব্দভাণ্ডার কেমন বাড়ছে, শব্দে শব্দে।"},"relief":{"h1":"পরিবারের অভিধান হওয়া বন্ধ করুন","sub":"আজ থেকে, আপনার সন্তান যখন জিজ্ঞেস করে \"এর মানে কী?\", তখন উত্তরটি একা খুঁজে পাওয়ার একটি জায়গা তার আছে: প্রতিটি অর্থ, প্রতিটির জন্য একটি ছবি, আর বাচ্চার স্তরে একটি ব্যাখ্যা। কোনো খোলা চ্যাট নেই, কোনো বিজ্ঞাপন নেই।"},"anxiety":{"h1":"আপনার সন্তান প্রতিটি শব্দ ঠিকমতো পড়ে, কিন্তু সত্যিকারভাবে বোঝে না","sub":"তারা সবসময় থেমে জিজ্ঞেস করে না। না বোঝা একটি শব্দ এড়িয়ে যায়, পড়া চালিয়ে যায়, আর বিষয়টি মাথায় বসে না। সময়ের সঙ্গে এটি স্কুল নিয়ে হতাশা আর \"আমি পারি না\" এই অনুভূতিতে পরিণত হয়। Gadit আপনার সন্তানকে একটি জায়গা দেয় যেখানে সে থামতে পারে, সত্যিকারভাবে বুঝতে পারে, আর শব্দটি হাতে নিয়ে পাঠে ফিরে আসতে পারে।"},"safe":{"h1":"একমাত্র স্ক্রিন যা আপনি নিশ্চিন্তে সন্তানের হাতে দিতে পারেন","sub":"কোনো খোলা চ্যাট নেই। অন্তহীন ফিড নেই। বিজ্ঞাপন নেই। একটিমাত্র পরিচ্ছন্ন জায়গা যেখানে বাচ্চা একটি শব্দ টাইপ করে, পুরোপুরি বোঝে, আর হোমওয়ার্কে ফিরে যায়।"}},"heroCta":"আপনার ১৪ দিনের বিনামূল্যের ট্রায়াল শুরু করুন","heroTrust":"খোলা চ্যাট নেই · বিজ্ঞাপন নেই · এক ক্লিকে বাতিল করুন","ownerCta":"আপনার পরিবারের জায়গায় যান","stats":["৩০+ ভাষা","প্রতিটি অর্থের জন্য একটি ছবি","৫ জন পর্যন্ত সন্তান","এক ক্লিকে বাতিল"],"demoKicker":"ফলাফল","demoTitle":"আপনার সন্তান প্রতিটি শব্দ বোঝে, আর তার শব্দভাণ্ডার প্রতিদিন বাড়ে","painKicker":"আসল কষ্ট","painTitle":"আপনার সন্তান পড়ে, কিন্তু সবসময় সত্যিকারভাবে বোঝে না","painBody1":"আপনার সন্তান যখন একটি শব্দের মানে জিজ্ঞেস করতে থামে, তখন আসলে আপনি খুশিই হন। সমস্যা হলো সেসব শব্দ, যেগুলো নিয়ে সে থেমে জিজ্ঞেস করে না। সেগুলো এড়িয়ে যায়, পড়া চালিয়ে যায়, আর বিষয়টি মাথায় বসে না। শব্দভাণ্ডার দুর্বল থেকে যায়, আর বোঝাটা শব্দে শব্দে ভেঙে পড়ে।","painBody2":"আর এটি একটি নম্বরের চেয়ে অনেক বেশি কিছুকে ছুঁয়ে যায়। যে সন্তান বোঝে না, সে নিজেকে যথেষ্ট ভালো মনে করে না, স্কুল নিয়ে হতাশ হয়, আর আত্মবিশ্বাস হারায়। আর এটি নীরবে ঘটে, সুতোটা কোথায় ছিঁড়ল তা কেউ দেখাতে পারে না।","reframe":"আর ঠিক এখানেই Gadit আসে।","puzzleKicker":"একটি বাচ্চার মাথায় যা ঘটে","puzzleTitle":"লেখা একটি ধাঁধা। প্রতিটি শব্দ একটি টুকরো।","puzzleBody":"একটি বাচ্চা যখন পড়ে, তখন তার মন শব্দগুলো থেকে একটি পূর্ণ ছবি গড়ে তোলে। যে প্রতিটি শব্দ সে বোঝে, সেটি একটি টুকরো যা জায়গামতো বসে যায়। যে প্রতিটি শব্দ বাদ পড়ে, সেটি ছবিতে একটি ফাঁক। মাত্র তিন-চারটি ফাঁক, আর বাচ্চা আর ছবিটা দেখতে পায় না, এমনকি যদি সে প্রতিটি অক্ষর সঠিকভাবে উচ্চারণও করে।","puzzleBefore":"কিছু শব্দ বাদ পড়া একটি অনুচ্ছেদ","puzzleAfter":"Gadit-এর সঙ্গে, প্রতিটি টুকরো জায়গামতো","puzzleLine":"প্রতিটি শব্দ পরিষ্কার হলে, বাচ্চা পুরো ছবিটা দেখতে পায়।","chainKicker":"এটি কীভাবে কাজ করে","chainTitle":"প্রতিটি শব্দে আপনার সন্তান যা কিছু পায়","chainSteps":["আপনার সন্তান এমন একটি শব্দ টাইপ করে যা সে বোঝে না","সে তার চোখের স্তরে একটি ব্যাখ্যা, একটি ছবি আর তিনটি উদাহরণ পায়","শব্দটি তার নিজের খাতায় জমা হয়","আর ছোট্ট অনুশীলনে ফিরে আসে, যতক্ষণ না সেটি সত্যিই তার হয়"],"howBlocks":[{"t":"শব্দটি টাইপ করুন","b":"আপনার সন্তান যে-কোনো না বোঝা শব্দ টাইপ করে, Kids Mode-এ, একটি পরিচ্ছন্ন ও নিরাপদ জায়গায়।"},{"t":"একটি পরিষ্কার সংজ্ঞা","b":"বাচ্চার চোখের স্তরে একটি ব্যাখ্যা, কঠিন শব্দ দিয়ে কঠিন শব্দ ব্যাখ্যা করা নয়।"},{"t":"তিনটি উদাহরণ","b":"আসল বাক্য যা দেখায় একটি শব্দ কীভাবে লেখার ভেতরে বাঁচে, একটি ছবিসহ, শুধু সংজ্ঞা নয়।"},{"t":"প্রতিটি অর্থের জন্য একটি ছবি","b":"কারণ বাচ্চারা যা দেখে তা লেখা কথার চেয়ে অনেক ভালো মনে রাখে।"},{"t":"প্রসঙ্গ","b":"বই থেকে একটি বাক্য পেস্ট করুন আর Gadit ঠিক যে অর্থটি সেখানে মানায় সেটি চিহ্নিত করে দেয়।"},{"t":"একটি ব্যক্তিগত খাতা","b":"আপনার সন্তান যে প্রতিটি শব্দ খুঁজেছে তা তার খাতায় জমা থাকে, আর হারিয়ে যায় না।"},{"t":"একটি ছোট্ট কুইজ","b":"একটি দ্রুত প্রশ্ন যা শব্দটি হারিয়ে যাওয়ার ঠিক আগে সেটিকে ফিরিয়ে আনে।"},{"t":"একটি খেলা","b":"খেলার মাধ্যমে শেখা, আপনার সন্তান নিজে যে শব্দগুলো খুঁজেছে সেগুলোর ওপর।"},{"t":"শুনুন, আর বলুন","b":"আপনার সন্তান যে-কোনো শব্দ শোনে আর জোরে বলার অনুশীলন করে, যাতে বলাটা স্বাভাবিক মনে হয়, শুধু পড়া নয়।"}],"chainCost":"","chainTurnTitle":"আর এটাই আপনি পান","chainTurnBody":"আপনার সন্তান যে প্রতিটি শব্দে আটকে যেত, সেটি হয়ে ওঠে একটি জানা শব্দ, আর আপনি তা কালো-সাদায় দেখতে পান: সে সপ্তাহের পর সপ্তাহ কতগুলো শব্দ আয়ত্ত করেছে। কিছু একটা উন্নত হচ্ছে বলে আশা করার বদলে, আপনি সরাসরি সেটা ঘটতে দেখেন।","dashKicker":"অভিভাবক ড্যাশবোর্ড","dashTitle":"প্রতিটি সন্তান কতটা শিখেছে তা আপনি ঠিকঠাক দেখতে পান","dashBody":"প্রতিটি সন্তানের একটি নিজস্ব শব্দের খাতা আছে যা বাড়তে থাকে। আপনার ড্যাশবোর্ডে আপনি এক নজরে দেখতে পান, প্রতিটি সন্তান কতগুলো শব্দ শিখেছে, এই সপ্তাহে কতগুলো যুক্ত হয়েছে, আর তাদের সাম্প্রতিকতম শব্দগুলো কী। অন্য যে-কোনো টুল আপনার সন্তানকে উত্তর দিয়ে ভুলে যায়। Gadit মনে রাখে, আর আপনি সপ্তাহের পর সপ্তাহ অগ্রগতি দেখেন।","dashKids":[{"name":"নোয়া","total":47,"week":12},{"name":"ইদো","total":31,"week":8},{"name":"মায়া","total":63,"week":15}],"dashWordsLabel":"খাতায় থাকা শব্দ","dashWeekLabel":"এই সপ্তাহে","featuresKicker":"ভেতরে যা আছে","features":[{"kicker":"প্রতিটি অর্থ","title":"একটি শব্দ। প্রতিটি অর্থ। প্রত্যেকটির জন্য একটি ছবি।","body":"একটি শব্দের প্রায়ই বেশ কয়েকটি ভিন্ন অর্থ থাকে, আর সেখানেই বাচ্চারা গুলিয়ে ফেলে। Gadit সবগুলো এক জায়গায় দেখায়, প্রত্যেকটির সঙ্গে তিনটি আসল উদাহরণ আর নিজস্ব ছবি, কারণ বাচ্চার মস্তিষ্ক ছবি অনেক ভালো মনে রাখে শব্দের চেয়ে।"},{"kicker":"Kids Mode","title":"আপনার সন্তানের চোখের স্তরে ব্যাখ্যা","body":"একটি সুইচ, আর প্রতিটি ব্যাখ্যা এমন ভাষায় পরিণত হয় যা একটি ৮ বছরের শিশু সত্যিই বোঝে। কঠিন শব্দ দিয়ে কঠিন শব্দ ব্যাখ্যা নয়, ঘুরপথের সংজ্ঞা নয়। শুধু বোঝা।"},{"kicker":"প্রসঙ্গ","title":"একটি বাক্য পেস্ট করুন, সঠিক অর্থটি পান","body":"বেশিরভাগ শব্দের একাধিক অর্থ থাকে, আর সেখানেই বাচ্চারা পথ হারায়। বই বা ওয়ার্কশিট থেকে বাক্যটি পেস্ট করুন, আর Gadit ঠিক কোন অর্থটি মানায় সেটি চিহ্নিত করে দেয়।"},{"kicker":"ব্যক্তিগত খাতা","title":"শব্দগুলো হারিয়ে যায় না","body":"আপনার সন্তান যে প্রতিটি শব্দ খোঁজে তা তার ব্যক্তিগত খাতায় জমা হয়, আর ছোট্ট স্মার্ট অনুশীলন সেটিকে হারিয়ে যাওয়ার ঠিক আগে ফিরিয়ে আনে। এভাবেই সত্যিকারের শব্দভাণ্ডার গড়ে ওঠে, একটি করে শব্দ।"},{"kicker":"প্রতিটি সন্তানের জন্য প্রোফাইল","title":"প্রতিটি সন্তান পায় নিজের জায়গা","body":"পরিবারের প্রতিটি সন্তান পায় একটি আলাদা প্রোফাইল: তার খাতা, তার অনুশীলন, তার ইতিহাস। Kids Mode ব্যাখ্যাকে মানিয়ে নেয়, ছোটদের জন্য সহজ ও পরিষ্কার আর বড়দের জন্য আরও পূর্ণ, আর কেউ কারও শব্দের ওপর হস্তক্ষেপ করে না।"},{"kicker":"শব্দের খেলা","title":"আপনার সন্তানের শব্দের ওপর শেখার খেলা","body":"আপনার সন্তান আসলে যে শব্দগুলো খুঁজেছে সেগুলো থেকে তৈরি ছোট্ট কুইজ আর খেলা। কয়েক মিনিটের খেলা, আর শব্দভাণ্ডার বাড়ে অনায়াসে।"},{"kicker":"দ্বিতীয় ভাষা","title":"দ্বিতীয় ভাষার সেরা হোমওয়ার্ক সহায়ক","body":"আপনার সন্তান ইংরেজিতে একটি শব্দ টাইপ করে আর নিজের ভাষায় একটি সহজ ব্যাখ্যা পায়, একটি ছবি আর উদাহরণসহ। অভিধান, অনুবাদক আর YouTube-এর মধ্যে ঘোরাঘুরি করতে হয় না।"}],"midCtaTitle":"এখনই শুরু করুন, আর দেখুন আপনার সন্তানের শব্দভাণ্ডার দিনে দিনে বাড়ছে","midCta":"আপনার ১৪ দিনের বিনামূল্যের ট্রায়াল শুরু করুন","compareKicker":"পার্থক্য","compareTitle":"শুধু Google করলে বা চ্যাটবটকে জিজ্ঞেস করলে হয় না কেন?","compareGadit":"Gadit","compareOther":"খোলা ইন্টারনেট","compareRows":[{"label":"প্রতিটি শব্দের জন্য একটি পরিচ্ছন্ন পৃষ্ঠা","gadit":true,"other":false},{"label":"বাচ্চার স্তরে ব্যাখ্যা","gadit":true,"other":false},{"label":"প্রতিটি অর্থের জন্য একটি ছবি","gadit":true,"other":false},{"label":"একটি খাতা আর অনুশীলন যা টিকে থাকে","gadit":true,"other":false},{"label":"প্রতিদিকে বিজ্ঞাপন আর লিঙ্ক","gadit":false,"other":true},{"label":"সীমাহীন খোলা চ্যাট","gadit":false,"other":true}],"safeTitle":"একটি আলাদা, পরিচ্ছন্ন জায়গা। অন্য কোথাও যাওয়ার দরজা নয়।","safeBody":"Gadit একটি পুরোপুরি বন্ধ জায়গা: কোনো খোলা চ্যাট নেই, ফিড নেই, বিজ্ঞাপন নেই, বাইরের লিঙ্ক নেই। একটি বাচ্চাকে এখান থেকে TikTok বা অন্য কোনো অ্যাপে টেনে নেওয়া হয় না। এখানে করার একটিই জিনিস আছে: একটি শব্দ বোঝা, আর পড়াশোনায় ফিরে যাওয়া।","safeLine":"একটি স্ক্রিন যা আপনি নিশ্চিন্ত মনে সন্তানের হাতে দিতে পারেন।","stackTitle":"Family প্ল্যানে যা যা আছে","stackItems":["গোটা পরিবারের জন্য সীমাহীন অনুসন্ধান","প্রতিটি অর্থ, প্রত্যেকটির জন্য একটি ছবিসহ","প্রতিটি বয়সের জন্য Kids Mode","তাৎক্ষণিক ফিডব্যাকসহ বাক্য যাচাই","প্রতিটি সন্তানের জন্য একটি ব্যক্তিগত খাতা আর স্মার্ট অনুশীলন","শব্দের খেলা আর কুইজ","আলাদা প্রোফাইলসহ ৫ জন পর্যন্ত সন্তান","পূর্ণ সমর্থনসহ ৩০+ ভাষা"],"priceKicker":"মূল্য","priceTitle":"Family প্ল্যান","trialBadge":"১৪ দিনের বিনামূল্যের ট্রায়াল","yearly":"$59 / বছর","yearlyNote":"অর্থাৎ গোটা পরিবারের জন্য মাসে $4.92, আর মাসিক দেওয়ার তুলনায় প্রায় দুই মাস সাশ্রয়","priceAnchor":"একটি প্রাইভেট টিউশন ক্লাসের চেয়েও কম, পুরো এক বছরের জন্য, ঘরের প্রতিটি সন্তানের জন্য","monthly":"$5.99 / মাস","billedYearly":"বার্ষিক","billedMonthly":"মাসিক","yearlySave":"-18%","priceCta":"ট্রায়াল শুরু করুন","cancelNote":"প্রথম চার্জ শুধু ১৪ দিন পরে। যে-কোনো সময় আপনার অ্যাকাউন্ট পৃষ্ঠা থেকে বাতিল করুন, এক ক্লিকে।","singleChild":"ঘরে শুধু একজন শিক্ষার্থী? Deep-এর দাম $4.99/মাস। সামান্য বেশি দিয়ে আপনি ৫ জন পর্যন্ত সন্তান যোগ করতে পারেন।","guaranteeTitle":"আপনার পরীক্ষা: দুই সপ্তাহ","guaranteeBody":"এটিকে দুই সপ্তাহ সত্যিকারভাবে ব্যবহার করে দেখুন, বিনামূল্যে। যদি ১৪ দিনের মধ্যে আপনার সন্তানের খাতায় অন্তত ২০টি নতুন শব্দ জমা না হয়, এক ক্লিকে বাতিল করুন আর আপনি কিছুই দিলেন না।","faqTitle":"অভিভাবকদের প্রশ্ন","faq":[{"q":"Gadit-এ আমি কী পাই?","a":"আপনার সন্তান যে প্রতিটি শব্দ খোঁজে তা একটি পরিচ্ছন্ন পৃষ্ঠা পায়: প্রতিটি অর্থ, বাচ্চার স্তরের ব্যাখ্যা (Kids Mode), তিনটি আসল উদাহরণ, আর প্রতিটি অর্থের জন্য একটি ছবি। এর সঙ্গে প্রসঙ্গ (একটি বাক্য পেস্ট করে সঠিক অর্থ পান), স্মার্ট অনুশীলনসহ একটি ব্যক্তিগত শব্দের খাতা, শব্দের খেলা আর কুইজ, একটি অভিভাবক ড্যাশবোর্ড যা দেখায় প্রতিটি সন্তান কতটা শিখেছে, আলাদা প্রোফাইলে ৫ জন পর্যন্ত সন্তান, সবই ৩০+ ভাষায়, খোলা চ্যাট আর বিজ্ঞাপনহীন একটি বন্ধ, নিরাপদ জায়গায়।"},{"q":"শুধু চ্যাটবট বা Google-কে জিজ্ঞেস করলে হয় না কেন?","a":"কারণ সেগুলো বড়দের জন্য টুল। Google প্রতিদিকে বিজ্ঞাপন আর লিঙ্ক ফেরত দেয়, আর একটি খোলা চ্যাটবট একটি সীমাহীন কথোপকথন যেখানে কোনো অভিভাবক সন্তানকে একা রেখে যান না। Gadit উল্টো ভাবে তৈরি: প্রতিটি শব্দের জন্য একটি বন্ধ, পরিচ্ছন্ন পৃষ্ঠা, বাচ্চার স্তরে, পথ হারানোর কোনো উপায় ছাড়াই।"},{"q":"আমার সন্তান সত্যিই এগোচ্ছে কিনা তা আমি কীভাবে জানব?","a":"আপনি একটি অভিভাবক ড্যাশবোর্ড পান। এক নজরে আপনি দেখতে পান প্রতিটি সন্তান কতগুলো শব্দ শিখেছে, এই সপ্তাহে কতগুলো যুক্ত হয়েছে, আর তাদের সর্বশেষ শব্দগুলো কী। অন্য প্রতিটি টুল বাচ্চাকে উত্তর দিয়ে ভুলে যায়; Gadit প্রতিটি শব্দ সন্তানের ব্যক্তিগত খাতায় জমা রাখে, তাই আপনি সপ্তাহের পর সপ্তাহ শব্দভাণ্ডার বাড়তে দেখেন।"},{"q":"এটি কোন বয়সের জন্য?","a":"Gadit-এর মূল হলো স্কুল-বয়সী বাচ্চারা, প্রথম শ্রেণি থেকে হাই স্কুল পর্যন্ত। Kids Mode ছোটদের জন্য সহজভাবে ব্যাখ্যা করে, আর পূর্ণ ব্যাখ্যাগুলো কিশোর ও অভিভাবকদেরও কাজে লাগে। অ্যাকাউন্টটি অভিভাবক খোলেন।"},{"q":"এটি কি ইংরেজি ও অন্যান্য ভাষায় সাহায্য করে?","a":"খুবই। একটি বাচ্চা ইংরেজিতে একটি শব্দ খুঁজে নিজের ভাষায় একটি সহজ ব্যাখ্যা পেতে পারে, একটি ছবি আর উদাহরণসহ, ঠিক যে সহায়কটি ঘরে অভাব ছিল। আর এটি ৩০+ ভাষায় কাজ করে, তাই বাচ্চা আপনি ঘরে যে ভাষায় কথা বলেন সে ভাষায়ও ব্যাখ্যাটি পেতে পারে।"},{"q":"এর দাম কত?","a":"১৪ দিনের ট্রায়ালের পরে বছরে $59 বা মাসে $5.99। কোনো লুকানো খরচ নেই, আর আপনি যে-কোনো সময় এক ক্লিকে বাতিল করেন।"},{"q":"আমি কতজন সন্তান যোগ করতে পারি?","a":"একটি Family প্ল্যানে ৫ জন পর্যন্ত সন্তান, প্রত্যেকের নিজের প্রোফাইল, খাতা আর অনুশীলনসহ।"},{"q":"প্রতিশ্রুতি ছাড়াই কি আমরা এটি চেষ্টা করতে পারি?","a":"হ্যাঁ। ট্রায়াল একটি কার্ড দিয়ে শুরু হয়, কিন্তু প্রথম চার্জ শুধু ১৪ দিন শেষ হলে হয়। তার আগে যে-কোনো সময় এক ক্লিকে বাতিল করুন, আর আপনি কিছুই দেবেন না।"}],"finalTitle":"আজই শুরু করুন, আর দেখুন শব্দভাণ্ডার বাড়ছে","finalSub":"দুই সপ্তাহ বিনামূল্যে। এক ক্লিকে বাতিল। আর একটি সন্তান যে নিজে নিজে শব্দ বুঝতে শেখে।","finalCta":"আপনার ১৪ দিনের বিনামূল্যের ট্রায়াল শুরু করুন","footerTerms":"শর্তাবলী","footerPrivacy":"গোপনীয়তা"},
  "da": {"heroBadge":"En visuel, smart ordbog for hele familien","whatIs":"Gadit er en smart, visuel ordbog for børn: hvert ord får en forklaring i børnehøjde, et billede, eksempler og spil og quizzer, der gør det sjovt at lære ord. Ordforrådet vokser, læseforståelsen bliver bedre, og dit barn klarer sig bedre i skolen.","ctaMicro":"","trustLine":"Op til 5 børn, hver på deres eget niveau","credLine":"Bygget på 15 års erfaring med mere end 15.000 forældre, elever og undervisere","credKicker":"Hvem vi er","credTitle":"15 år i uddannelse. Nu samlet i ét værktøj til dit barn.","credBody":"Gadit er skabt af et team med 15 års erfaring inden for uddannelse, som har arbejdet med mere end 15.000 forældre, elever og undervisere. Det, vi så virke igen og igen, i klasseværelset og derhjemme, samlede vi i ét enkelt værktøj, som et barn kan bruge helt selv.","proofTitle":"Ordbog · eksempel","proofBig":"12 nye ord i denne uge","proofWords":["drøm","levende","tøvende"],"angles":{"vocab":{"h1":"Dit barns ordforråd vokser. Ord for ord.","sub":"Hvert ord, dit barn spørger om, lander i deres personlige ordbog i Gadit: med et billede, en forklaring i børnehøjde og korte øvelser, der bringer ordet tilbage, indtil det sidder fast. Åbn ordbogen ved månedens slutning og se ordforrådet vokse, ord for ord."},"relief":{"h1":"Slip for at være familiens ordbog","sub":"Fra i dag har dit barn ét sted at finde svaret selv, når de spørger \"hvad betyder det?\": hver betydning, et billede til hver enkelt og en forklaring i børnehøjde. Ingen åben chat, ingen reklamer."},"anxiety":{"h1":"Dit barn læser hvert ord rigtigt, men forstår ikke helt","sub":"De stopper ikke altid op for at spørge. De springer et ord over, som de ikke forstår, læser videre, og stoffet sætter sig ikke. Med tiden bliver det til frustration over skolen og en følelse af \"det her kan jeg ikke\". Gadit giver dit barn ét sted at stoppe op, forstå ordet helt og komme tilbage til lektien med ordet på plads."},"safe":{"h1":"Den ene skærm, du trygt kan give et barn i hånden","sub":"Ingen åben chat. Intet uendeligt feed. Ingen reklamer. Ét rent sted, hvor et barn skriver et ord, forstår det fuldt ud og går tilbage til lektierne."}},"heroCta":"Start din 14-dages gratis prøveperiode","heroTrust":"Ingen åben chat · Ingen reklamer · Opsig med ét klik","ownerCta":"Gå til dit familierum","stats":["30+ sprog","Et billede pr. betydning","Op til 5 børn","Opsig med ét klik"],"demoKicker":"Resultatet","demoTitle":"Dit barn forstår hvert ord, og ordforrådet vokser hver dag","painKicker":"Den virkelige smerte","painTitle":"Dit barn læser, men forstår ikke altid rigtigt","painBody1":"Du er faktisk glad, når dit barn stopper op for at spørge, hvad et ord betyder. Problemet er alle de ord, de ikke stopper op for at spørge om. De springer dem over, læser videre, og stoffet sætter sig ikke. Ordforrådet forbliver tyndt, og forståelsen brydes ord efter ord.","painBody2":"Og det handler om langt mere end en karakter. Et barn, der ikke forstår, føler sig ikke godt nok, bliver frustreret over skolen og mister selvtilliden. Og det sker i stilhed, uden at nogen kan pege på, hvor tråden knækkede.","reframe":"Og det er lige præcis her, Gadit kommer ind.","puzzleKicker":"Hvad der sker i et barns hoved","puzzleTitle":"En tekst er et puslespil. Hvert ord er en brik.","puzzleBody":"Når et barn læser, samler hjernen et helt billede ud af ordene. Hvert ord, de forstår, er en brik, der falder på plads. Hvert manglende ord er et hul i billedet. Bare tre eller fire huller, og barnet ser ikke længere billedet, selv om de læste hvert bogstav.","puzzleBefore":"Et afsnit med manglende ord","puzzleAfter":"Med Gadit falder hver brik på plads","puzzleLine":"Når hvert ord er klart, ser barnet hele billedet.","chainKicker":"Sådan virker det","chainTitle":"Alt, dit barn får, på hvert eneste ord","chainSteps":["Dit barn skriver et ord, de ikke forstår","De får en forklaring i øjenhøjde, et billede og tre eksempler","Ordet gemmes i deres personlige ordbog","Og kommer tilbage i korte øvelser, indtil det sidder helt fast"],"howBlocks":[{"t":"Skriv ordet","b":"Dit barn skriver et hvilket som helst ord, de ikke forstår, i Børnetilstand, på et rent og trygt sted."},{"t":"En klar forklaring","b":"En forklaring i barnets øjenhøjde, ingen svære ord der forklarer svære ord."},{"t":"Tre eksempler","b":"Rigtige sætninger, der viser, hvordan ordet lever inde i en tekst, med et billede, ikke bare en definition."},{"t":"Et billede til hver betydning","b":"Fordi børn husker det, de ser, langt bedre end det, der bliver skrevet til dem."},{"t":"Kontekst","b":"Indsæt en sætning fra bogen, og Gadit markerer præcis den betydning, der passer."},{"t":"En personlig ordbog","b":"Hvert ord, dit barn har slået op, gemmes i deres ordbog og løber ikke væk."},{"t":"En kort quiz","b":"Et hurtigt spørgsmål, der bringer ordet tilbage, lige før det glider væk."},{"t":"Et spil","b":"Læring gennem leg, med de ord dit barn selv har slået op."},{"t":"Hør det, og sig det","b":"Dit barn hører et hvilket som helst ord og øver sig i at sige det højt, så det bliver naturligt at tale, ikke kun at læse."}],"chainCost":"","chainTurnTitle":"Og det er det, du får","chainTurnBody":"Hvert ord, dit barn gik i stå på, bliver til et ord, de kan, og du ser det sort på hvidt: hvor mange ord de lukkede, uge efter uge. I stedet for at håbe på, at noget bliver bedre, ser du det simpelthen ske.","dashKicker":"Forældreoversigten","dashTitle":"Du ser præcis, hvor meget hvert barn har lært","dashBody":"Hvert barn har en personlig ordbog, der vokser. I din oversigt ser du med et blik, hvor mange ord hvert barn har lært, hvor mange der kom til i denne uge, og deres seneste ord. Ethvert andet værktøj svarer dit barn og glemmer. Gadit husker, og du ser fremgangen uge efter uge.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"ord i ordbogen","dashWeekLabel":"denne uge","featuresKicker":"Hvad der er indeni","features":[{"kicker":"Hver betydning","title":"Ét ord. Hver betydning. Et billede til hver.","body":"Ét ord har ofte flere forskellige betydninger, og det er dér, børn bliver forvirrede. Gadit viser dem alle samlet ét sted, hver med tre rigtige eksempler og sit eget billede, fordi et barns hjerne husker billeder langt bedre end ord."},{"kicker":"Børnetilstand","title":"Forklaringer i dit barns øjenhøjde","body":"Ét klik, og hver forklaring bliver til et sprog, som en 8-årig faktisk forstår. Ingen svære ord der forklarer svære ord, ingen cirkulære definitioner. Bare forståelse."},{"kicker":"Kontekst","title":"Indsæt en sætning, få den rigtige betydning","body":"De fleste ord har mere end én betydning, og det er dér, børn farer vild. Indsæt sætningen fra bogen eller arbejdsarket, og Gadit markerer præcis, hvilken betydning der passer."},{"kicker":"Personlig ordbog","title":"Ordene løber ikke væk","body":"Hvert ord, dit barn slår op, lander i deres personlige ordbog, og korte, smarte øvelser bringer det tilbage, lige før det glider væk. Det er sådan, ordforråd virkelig bygges, ét ord ad gangen."},{"kicker":"En profil pr. barn","title":"Hvert barn får sit eget rum","body":"Hvert barn i familien får en separat profil: deres ordbog, deres øvelser, deres historik. Børnetilstand tilpasser forklaringen, enkel og klar for de mindste og fyldigere for de større, og ingen træder på hinandens ord."},{"kicker":"Ordspil","title":"Læringsspil med dit barns egne ord","body":"Korte quizzer og spil bygget på de ord, dit barn faktisk slog op. Et par minutters leg, og ordforrådet vokser uden anstrengelse."},{"kicker":"Andetsprog","title":"Den bedste lektiehjælper til et andetsprog","body":"Dit barn skriver et ord på engelsk og får en enkel forklaring på deres eget sprog, med et billede og eksempler. Ingen vandren mellem ordbog, oversætter og YouTube."}],"midCtaTitle":"Start nu, og se dit barns ordforråd vokse dag for dag","midCta":"Start din 14-dages gratis prøveperiode","compareKicker":"Forskellen","compareTitle":"Hvorfor ikke bare google det eller spørge en chatbot?","compareGadit":"Gadit","compareOther":"Det åbne internet","compareRows":[{"label":"Én ren side pr. ord","gadit":true,"other":false},{"label":"Forklaringer i børnehøjde","gadit":true,"other":false},{"label":"Et billede til hver betydning","gadit":true,"other":false},{"label":"En ordbog og øvelser der bliver hængende","gadit":true,"other":false},{"label":"Reklamer og links i alle retninger","gadit":false,"other":true},{"label":"Åben chat uden grænser","gadit":false,"other":true}],"safeTitle":"En separat, ren zone. Ikke en dør til noget andet.","safeBody":"Gadit er et fuldstændig lukket rum: ingen åben chat, intet feed, ingen reklamer, ingen udgående links. Et barn bliver ikke trukket herfra ind i TikTok eller nogen anden app. Der er én ting at gøre her: forstå et ord og komme tilbage til lektierne.","safeLine":"Én skærm, du kan give et barn med god samvittighed.","stackTitle":"Hvad Familie-abonnementet indeholder","stackItems":["Ubegrænsede opslag for hele familien","Hver betydning, med et billede til hver","Børnetilstand til alle aldre","Sætningstjek med øjeblikkelig feedback","En personlig ordbog og smarte øvelser pr. barn","Ordspil og quizzer","Op til 5 børn med separate profiler","30+ sprog med fuld understøttelse"],"priceKicker":"Priser","priceTitle":"Familie-abonnementet","trialBadge":"14-dages gratis prøveperiode","yearly":"59 USD / år","yearlyNote":"det er 4,92 USD om måneden for hele familien og sparer dig næsten to måneder i forhold til at betale månedligt","priceAnchor":"Mindre end én privat undervisningstime, for et helt år, for hvert barn derhjemme","monthly":"5,99 USD / måned","billedYearly":"Årligt","billedMonthly":"Månedligt","yearlySave":"-18%","priceCta":"Start prøveperioden","cancelNote":"Første betaling først efter de 14 dage. Opsig når som helst fra din kontoside, med ét klik.","singleChild":"Kun én elev derhjemme? Deep koster 4,99 USD/måned. For lidt mere kan du tilføje op til 5 børn.","guaranteeTitle":"Din test: to uger","guaranteeBody":"Giv det to ugers rigtig brug, gratis. Hvis dit barns ordbog ikke har samlet mindst 20 nye ord inden dag 14, så opsig med ét klik, og du har ikke betalt noget.","faqTitle":"Spørgsmål forældre stiller","faq":[{"q":"Hvad får jeg med Gadit?","a":"Hvert ord, dit barn slår op, får én ren side: hver betydning, en forklaring i børnehøjde (Børnetilstand), tre rigtige eksempler og et billede pr. betydning. Plus kontekst (indsæt en sætning og få den rigtige betydning), en personlig ordbog med smarte øvelser, ordspil og quizzer, en forældreoversigt der viser, hvor meget hvert barn har lært, op til 5 børn på separate profiler, alt sammen på 30+ sprog, i et lukket, trygt rum uden åben chat og uden reklamer."},{"q":"Hvorfor ikke bare spørge en chatbot eller google?","a":"Fordi det er værktøjer til voksne. Google giver reklamer og links i alle retninger, og en åben chatbot er en grænseløs samtale, som ingen forælder lader et barn være alene i. Gadit er bygget den modsatte vej: én lukket, ren side pr. ord, i børnehøjde, uden mulighed for at fare vild."},{"q":"Hvordan ved jeg, at mit barn faktisk gør fremskridt?","a":"Du får en forældreoversigt. Med et blik ser du, hvor mange ord hvert barn har lært, hvor mange der kom til i denne uge, og deres seneste ord. Alle andre værktøjer svarer barnet og glemmer; Gadit gemmer hvert ord i barnets personlige ordbog, så du ser ordforrådet vokse uge efter uge."},{"q":"Hvilke aldre er det til?","a":"Kernen i Gadit er børn i skolealderen, fra første klasse til gymnasiet. Børnetilstand forklarer enkelt for de yngste, og de fulde forklaringer passer også til teenagere og forældre. Forælderen opretter kontoen."},{"q":"Hjælper det med engelsk og andre sprog?","a":"I høj grad. Et barn kan slå et ord op på engelsk og få en enkel forklaring på deres eget sprog, med et billede og eksempler, præcis den hjælper der mangler derhjemme. Og det virker på 30+ sprog, så barnet også kan få forklaringen på det sprog, I taler hjemme."},{"q":"Hvad koster det?","a":"59 USD om året eller 5,99 USD om måneden, efter den 14-dages prøveperiode. Ingen skjulte gebyrer, og du opsiger når som helst med ét klik."},{"q":"Hvor mange børn kan jeg tilføje?","a":"Op til 5 børn på ét Familie-abonnement, hver med deres egen profil, ordbog og øvelser."},{"q":"Kan vi prøve det uden at binde os?","a":"Ja. Prøveperioden starter med et kort, men første betaling sker først, når de 14 dage er slut. Opsig når som helst inden da, med ét klik, og du betaler ikke noget."}],"finalTitle":"Start i dag, og se ordforrådet vokse","finalSub":"To uger gratis. Opsig med ét klik. Og et barn, der lærer at forstå ord på egen hånd.","finalCta":"Start din 14-dages gratis prøveperiode","footerTerms":"Vilkår","footerPrivacy":"Privatliv"},
  "fil": {"heroBadge":"Isang visual at matalinong diksyunaryo para sa buong pamilya","whatIs":"Ang Gadit ay isang matalino at visual na diksyunaryo para sa mga bata: bawat salita ay may paliwanag na angkop sa bata, may larawan, mga halimbawa, at mga laro at pagsusulit na ginagawang masaya ang pagkatuto ng mga salita. Lumalawak ang bokabularyo, gumaganda ang pag-unawa sa pagbasa, at mas mahusay ang anak mo sa paaralan.","ctaMicro":"","trustLine":"Hanggang 5 bata, bawat isa ayon sa sariling antas nila","credLine":"Nakabatay sa 15 taong karanasan kasama ang mahigit 15,000 magulang, mag-aaral at guro","credKicker":"Sino kami","credTitle":"15 taon sa edukasyon. Ngayon nasa iisang tool para sa anak mo.","credBody":"Binuo ang Gadit ng isang team na may 15 taong karanasan sa edukasyon, na nakatrabaho ang mahigit 15,000 magulang, mag-aaral at guro. Ang nakita naming paulit-ulit na umuubra, sa silid-aralan at sa tahanan, inilagay namin sa iisang simpleng tool na kayang gamitin ng bata nang mag-isa.","proofTitle":"Kuwaderno ng mga salita, halimbawa","proofBig":"12 bagong salita ngayong linggo","proofWords":["panaginip","malinaw","nag-aatubili"],"angles":{"vocab":{"h1":"Lumalawak ang bokabularyo ng anak mo. Salita bawat salita.","sub":"Bawat salitang tinatanong ng anak mo ay napupunta sa personal niyang kuwaderno ng mga salita sa Gadit: may larawan, paliwanag na angkop sa bata, at maikling pagsasanay na nagbabalik nito hanggang maging kanya na talaga. Buksan ang kuwaderno sa katapusan ng buwan at pagmasdan ang paglago ng bokabularyo, salita bawat salita."},"relief":{"h1":"Tigilan na ang pagiging diksyunaryo ng pamilya","sub":"Simula ngayon, kapag tinanong ng anak mo na \"ano ba ang ibig sabihin nito?\", may iisang lugar na sila mismo ang makakahanap ng sagot: bawat kahulugan, may larawan sa bawat isa, at paliwanag na angkop sa bata. Walang bukas na chat, walang ads."},"anxiety":{"h1":"Nababasa ng anak mo ang bawat salita nang tama, pero hindi talaga naiintindihan","sub":"Hindi sila laging humihinto para magtanong. Nilalaktawan nila ang salitang hindi nila naiintindihan, nagpapatuloy, at hindi tumitimo ang aralin. Sa paglipas ng panahon nagiging pagkabigo ito sa paaralan at pakiramdam na \"hindi ko kaya\". Binibigyan ng Gadit ang anak mo ng iisang lugar para huminto, tunay na maunawaan, at bumalik sa aralin dala ang salita."},"safe":{"h1":"Ang iisang screen na maibibigay mo sa bata nang walang alala","sub":"Walang bukas na chat. Walang walang katapusang feed. Walang ads. Iisang malinis na lugar kung saan nagta-type ang bata ng salita, lubos itong naiintindihan, at bumabalik sa homework."}},"heroCta":"Simulan ang 14-araw na libreng subok","heroTrust":"Walang bukas na chat · Walang ads · Kanselahin sa isang click","ownerCta":"Pumunta sa espasyo ng pamilya mo","stats":["30+ na wika","Larawan sa bawat kahulugan","Hanggang 5 bata","Kanselahin sa isang click"],"demoKicker":"Ang resulta","demoTitle":"Nauunawaan ng anak mo ang bawat salita, at lumalawak ang bokabularyo nila araw-araw","painKicker":"Ang tunay na sakit","painTitle":"Nakakabasa ang anak mo, pero hindi laging tunay na nauunawaan","painBody1":"Masaya ka nga kapag humihinto ang anak mo para magtanong kung ano ang ibig sabihin ng isang salita. Ang problema ay ang lahat ng salitang hindi nila hinihinto para tanungin. Nilalaktawan nila, nagpapatuloy sa pagbasa, at hindi tumitimo ang aralin. Nananatiling manipis ang bokabularyo, at nasisira ang pag-unawa salita bawat salita.","painBody2":"At mas malalim ito kaysa sa grado lang. Ang batang hindi nakakaunawa ay nararamdamang hindi sapat, nabibigo sa paaralan, at nawawalan ng tiwala sa sarili. At nangyayari ito nang tahimik, na walang makakaturo kung saan naputol ang sinulid.","reframe":"At dito mismo pumapasok ang Gadit.","puzzleKicker":"Ano ang nangyayari sa isip ng bata","puzzleTitle":"Ang teksto ay isang palaisipan. Bawat salita ay isang piraso.","puzzleBody":"Kapag nagbabasa ang bata, binubuo ng isip nila ang buong larawan mula sa mga salita. Bawat salitang nauunawaan nila ay isang pirasong pumupwesto. Bawat nawawalang salita ay isang butas sa larawan. Tatlo o apat na butas lang, at hindi na nakikita ng bata ang larawan, kahit binaybay nila ang bawat titik.","puzzleBefore":"Isang talata na may nawawalang mga salita","puzzleAfter":"Sa Gadit, bawat piraso nasa lugar","puzzleLine":"Kapag malinaw ang bawat salita, nakikita ng bata ang buong larawan.","chainKicker":"Paano ito gumagana","chainTitle":"Lahat ng nakukuha ng anak mo, sa bawat salita","chainSteps":["Nagta-type ang anak mo ng salitang hindi nila naiintindihan","Nakukuha nila ang paliwanag sa antas nila, isang larawan at tatlong halimbawa","Naka-save ang salita sa personal nilang kuwaderno","At bumabalik sa maikling pagsasanay, hanggang maging kanya na talaga"],"howBlocks":[{"t":"I-type ang salita","b":"Nagta-type ang anak mo ng anumang salitang hindi nila naiintindihan, sa Kids Mode, sa isang malinis at ligtas na lugar."},{"t":"Isang malinaw na kahulugan","b":"Isang paliwanag sa antas ng bata, walang mahihirap na salitang nagpapaliwanag ng mahihirap na salita."},{"t":"Tatlong halimbawa","b":"Totoong pangungusap na nagpapakita kung paano nabubuhay ang salita sa loob ng teksto, may larawan, hindi lang kahulugan."},{"t":"Larawan sa bawat kahulugan","b":"Dahil mas naaalala ng mga bata ang kanilang nakikita kaysa sa nakasulat sa kanila."},{"t":"Konteksto","b":"I-paste ang pangungusap mula sa libro at minamarkahan ng Gadit nang eksakto ang kahulugang tumutugma dito."},{"t":"Isang personal na kuwaderno","b":"Bawat salitang hinanap ng anak mo ay naka-save sa kuwaderno nila, at hindi natatakas."},{"t":"Isang mabilis na pagsusulit","b":"Isang mabilis na tanong na nagbabalik ng salita bago pa ito makalimutan."},{"t":"Isang laro","b":"Pagkatuto sa pamamagitan ng laro, gamit ang mga salitang hinanap mismo ng anak mo."},{"t":"Pakinggan, at bigkasin","b":"Naririnig ng anak mo ang anumang salita at nagsasanay bigkasin ito nang malakas, para maging natural itong sabihin, hindi lang basahin."}],"chainCost":"","chainTurnTitle":"At ito ang nakukuha mo","chainTurnBody":"Bawat salitang hindi malampasan ng anak mo ay nagiging salitang alam nila, at nakikita mo ito nang malinaw: ilang salita ang nasara nila, linggo bawat linggo. Sa halip na umasa na may gumaganda, pinapanood mo lang itong mangyari.","dashKicker":"Ang dashboard ng magulang","dashTitle":"Nakikita mo nang eksakto kung gaano na natutunan ng bawat anak","dashBody":"Bawat bata ay may personal na kuwaderno ng mga salita na lumalago. Sa dashboard mo, nakikita mo sa isang tingin kung ilang salita ang natutunan ng bawat anak, ilan ang naidagdag ngayong linggo, at ang pinakabago nilang mga salita. Ang ibang tool ay sumasagot sa anak mo at nakakalimot. Naaalala ng Gadit, at nakikita mo ang pag-unlad linggo bawat linggo.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"mga salita sa kuwaderno","dashWeekLabel":"ngayong linggo","featuresKicker":"Ano ang nasa loob","features":[{"kicker":"Bawat kahulugan","title":"Isang salita. Bawat kahulugan. Larawan sa bawat isa.","body":"Ang isang salita ay kadalasang may ilang magkakaibang kahulugan, at doon nalilito ang mga bata. Ipinapakita ng Gadit ang lahat sa iisang lugar, bawat isa may tatlong totoong halimbawa at sariling larawan, dahil mas naaalala ng utak ng bata ang mga larawan kaysa sa mga salita."},{"kicker":"Kids Mode","title":"Mga paliwanag sa antas ng anak mo","body":"Isang switch, at bawat paliwanag ay nagiging wikang talagang nauunawaan ng batang 8-taong-gulang. Walang mahihirap na salitang nagpapaliwanag ng mahihirap na salita, walang paikot-ikot na kahulugan. Pag-unawa lang."},{"kicker":"Konteksto","title":"I-paste ang pangungusap, kunin ang tamang kahulugan","body":"Karamihan sa mga salita ay may higit sa isang kahulugan, at doon naliligaw ang mga bata. I-paste ang pangungusap mula sa libro o worksheet, at minamarkahan ng Gadit nang eksakto kung aling kahulugan ang tumutugma."},{"kicker":"Personal na kuwaderno","title":"Hindi natatakas ang mga salita","body":"Bawat salitang hinanap ng anak mo ay napupunta sa personal nilang kuwaderno, at ang maikli at matalinong pagsasanay ang nagbabalik nito bago pa ito makalimutan. Ganito talaga nabubuo ang bokabularyo, isang salita sa bawat pagkakataon."},{"kicker":"Isang profile bawat bata","title":"Bawat bata ay may sariling espasyo","body":"Bawat bata sa pamilya ay may hiwalay na profile: ang kuwaderno nila, ang pagsasanay nila, ang kasaysayan nila. Iniaangkop ng Kids Mode ang paliwanag, simple at malinaw para sa maliliit at mas malalim para sa mas malalaki, at walang nagkakagulo sa mga salita ng isa't isa."},{"kicker":"Mga laro ng salita","title":"Mga larong pang-aral gamit ang mga salita ng anak mo","body":"Mga mabilis na pagsusulit at laro na binuo mula sa mga salitang talagang hinanap ng anak mo. Ilang minuto ng laro, at lumalago ang bokabularyo nang walang hirap."},{"kicker":"Pangalawang wika","title":"Ang pinakamahusay na katulong sa homework para sa pangalawang wika","body":"Nagta-type ang anak mo ng salita sa Ingles at nakukuha ang simpleng paliwanag sa sariling wika nila, may larawan at mga halimbawa. Walang pagpapalipat-lipat sa pagitan ng diksyunaryo, translator at YouTube."}],"midCtaTitle":"Magsimula na ngayon, at pagmasdan ang paglago ng bokabularyo ng anak mo araw-araw","midCta":"Simulan ang 14-araw na libreng subok","compareKicker":"Ang pagkakaiba","compareTitle":"Bakit hindi na lang i-Google o magtanong sa chatbot?","compareGadit":"Gadit","compareOther":"Ang bukas na internet","compareRows":[{"label":"Isang malinis na pahina bawat salita","gadit":true,"other":false},{"label":"Mga paliwanag sa antas ng bata","gadit":true,"other":false},{"label":"Larawan sa bawat kahulugan","gadit":true,"other":false},{"label":"Kuwaderno at pagsasanay na tumatatak","gadit":true,"other":false},{"label":"Ads at link sa bawat direksyon","gadit":false,"other":true},{"label":"Bukas na chat na walang hangganan","gadit":false,"other":true}],"safeTitle":"Isang hiwalay at malinis na lugar. Hindi pintuan papunta sa iba.","safeBody":"Ang Gadit ay isang lubos na saradong espasyo: walang bukas na chat, walang feed, walang ads, walang panlabas na link. Hindi nahihila ang bata mula rito papunta sa TikTok o iba pang app. Iisa lang ang gagawin dito: unawain ang salita, at bumalik sa pag-aaral.","safeLine":"Isang screen na maibibigay mo sa bata nang malinis ang isip.","stackTitle":"Ano ang kasama sa plano ng Pamilya","stackItems":["Walang limitasyong paghahanap para sa buong pamilya","Bawat kahulugan, may larawan sa bawat isa","Kids Mode para sa lahat ng edad","Pagsusuri ng pangungusap na may agarang feedback","Isang personal na kuwaderno at matalinong pagsasanay bawat bata","Mga laro at pagsusulit ng salita","Hanggang 5 bata na may hiwalay na profile","30+ na wika na may buong suporta"],"priceKicker":"Presyo","priceTitle":"Ang plano ng Pamilya","trialBadge":"14-araw na libreng subok","yearly":"$59 / taon","yearlyNote":"iyon ay $4.92 kada buwan para sa buong pamilya, at nakakatipid ka ng halos dalawang buwan kumpara sa buwanang bayad","priceAnchor":"Mas mura pa sa isang session ng pribadong tutoring, para sa buong taon, para sa bawat batang nasa bahay","monthly":"$5.99 / buwan","billedYearly":"Taunan","billedMonthly":"Buwanan","yearlySave":"-18%","priceCta":"Simulan ang subok","cancelNote":"Unang bayad lang pagkatapos ng 14 araw. Kanselahin anumang oras mula sa account page mo, isang click.","singleChild":"Iisa lang ang mag-aaral sa bahay? Ang Deep ay $4.99/buwan. Sa kaunting dagdag, kaya mong magdagdag hanggang 5 bata.","guaranteeTitle":"Ang subok mo: dalawang linggo","guaranteeBody":"Bigyan mo ito ng dalawang linggo ng tunay na paggamit, libre. Kung sa ika-14 na araw ay hindi pa nakaipon ang kuwaderno ng anak mo ng kahit 20 bagong salita, kanselahin sa isang click at wala kang binayaran.","faqTitle":"Mga tanong ng mga magulang","faq":[{"q":"Ano ang makukuha ko sa Gadit?","a":"Bawat salitang hinanap ng anak mo ay nakukuha ang iisang malinis na pahina: bawat kahulugan, isang paliwanag na angkop sa bata (Kids Mode), tatlong totoong halimbawa, at larawan bawat kahulugan. Kasama ang konteksto (i-paste ang pangungusap at kunin ang tamang kahulugan), isang personal na kuwaderno ng mga salita na may matalinong pagsasanay, mga laro at pagsusulit ng salita, isang dashboard ng magulang na nagpapakita kung gaano na natutunan ng bawat anak, hanggang 5 bata sa hiwalay na profile, lahat sa 30+ na wika, sa isang sarado at ligtas na espasyo na walang bukas na chat at walang ads."},{"q":"Bakit hindi na lang magtanong sa chatbot o mag-Google?","a":"Dahil mga tool iyon para sa mga adulto. Nagbabalik ang Google ng ads at link sa bawat direksyon, at ang bukas na chatbot ay isang walang hangganang usapan na walang magulang na mag-iiwan ng bata mag-isa doon. Binuo ang Gadit sa kabaligtaran: iisang sarado at malinis na pahina bawat salita, sa antas ng bata, na walang paraan para maligaw."},{"q":"Paano ko malalaman na talagang umuunlad ang anak ko?","a":"Nakukuha mo ang isang dashboard ng magulang. Sa isang tingin nakikita mo kung ilang salita ang natutunan ng bawat anak, ilan ang naidagdag ngayong linggo, at ang pinakabago nilang mga salita. Bawat ibang tool ay sumasagot sa bata at nakakalimot; nine-save ng Gadit ang bawat salita sa personal na kuwaderno ng bata, kaya pinapanood mo ang paglago ng bokabularyo linggo bawat linggo."},{"q":"Para saang mga edad ito?","a":"Ang puso ng Gadit ay mga batang nasa edad-paaralan, mula unang grado hanggang high school. Nagpapaliwanag nang simple ang Kids Mode para sa maliliit, at ang buong paliwanag ay para rin sa mga tin-edyer at magulang. Ang magulang ang nagbubukas ng account."},{"q":"Nakakatulong ba ito sa Ingles at iba pang wika?","a":"Napakalaki. Kayang hanapin ng bata ang salita sa Ingles at makuha ang simpleng paliwanag sa sariling wika nila, may larawan at mga halimbawa, mismong ang katulong na kulang sa bahay. At gumagana ito sa 30+ na wika, kaya makukuha rin ng bata ang paliwanag sa wikang ginagamit ninyo sa bahay."},{"q":"Magkano ang halaga nito?","a":"$59 kada taon o $5.99 kada buwan, pagkatapos ng 14-araw na subok. Walang nakatagong bayad, at kanselahin anumang oras sa isang click."},{"q":"Ilang bata ang kaya kong idagdag?","a":"Hanggang 5 bata sa iisang plano ng Pamilya, bawat isa may sariling profile, kuwaderno at pagsasanay."},{"q":"Puwede ba naming subukan nang hindi mangangako?","a":"Oo. Nagsisimula ang subok gamit ang card, pero ang unang bayad ay nangyayari lang kapag natapos na ang 14 araw. Kanselahin anumang oras bago iyon, isang click, at wala kang babayaran."}],"finalTitle":"Magsimula ngayon, at pagmasdan ang paglago ng bokabularyo","finalSub":"Dalawang linggong libre. Isang-click na kanselasyon. At isang batang natututong umunawa ng mga salita nang mag-isa.","finalCta":"Simulan ang 14-araw na libreng subok","footerTerms":"Mga Tuntunin","footerPrivacy":"Privacy"},
  "hu": {"heroBadge":"Vizuális, okos szótár az egész családnak","whatIs":"A Gadit okos, vizuális szótár gyerekeknek: minden szóhoz gyerekbarát magyarázat, kép, példák, valamint játékok és kvízek járnak, amelyek élménnyé teszik a szavak tanulását. A szókincs bővül, a szövegértés javul, és a gyereked jobban teljesít az iskolában.","ctaMicro":"","trustLine":"Akár 5 gyerek, mindegyik a saját szintjén","credLine":"15 év tapasztalatra építve, több mint 15 000 szülővel, diákkal és pedagógussal","credKicker":"Kik vagyunk","credTitle":"15 év az oktatásban. Most egyetlen eszközben a gyerekednek.","credBody":"A Gaditot egy olyan csapat építette, amely 15 év oktatási tapasztalattal rendelkezik, és több mint 15 000 szülővel, diákkal és pedagógussal dolgozott együtt. Amit újra és újra működni láttunk, az osztályteremben és otthon egyaránt, azt egyetlen egyszerű eszközbe sűrítettük, amelyet a gyerek egyedül is használhat.","proofTitle":"Szófüzet · példa","proofBig":"12 új szó ezen a héten","proofWords":["álom","élénk","vonakodó"],"angles":{"vocab":{"h1":"A gyereked szókincse bővül. Szóról szóra.","sub":"Minden szó, amiről a gyereked kérdez, bekerül a személyes szófüzetébe a Gaditban: képpel, gyerekbarát magyarázattal és rövid gyakorlással, amely addig hozza vissza, amíg igazán a sajátjává nem válik. Nyisd meg a füzetet a hónap végén, és nézd, ahogy a szókincs gyarapszik, szóról szóra."},"relief":{"h1":"Ne te légy tovább a család szótára","sub":"Mostantól, amikor a gyereked azt kérdezi, hogy \"ez mit jelent?\", egyetlen helye van, ahol egyedül megtalálja a választ: minden jelentés, mindegyikhez kép, és gyerekszinten megfogalmazott magyarázat. Nyílt chat nélkül, reklámok nélkül."},"anxiety":{"h1":"A gyereked minden szót helyesen olvas, mégsem érti igazán","sub":"Nem mindig áll meg megkérdezni. Átugrik egy szót, amit nem ért, olvas tovább, és az anyag nem ragad meg. Idővel ez az iskolával szembeni frusztrációvá és egy \"ez nekem nem megy\" érzéssé válik. A Gadit egyetlen helyet ad a gyerekednek, ahol megállhat, valóban megértheti, és a szóval a kezében térhet vissza a tananyaghoz."},"safe":{"h1":"Az egyetlen képernyő, amit nyugodtan a gyerek kezébe adhatsz","sub":"Nincs nyílt chat. Nincs végtelen feed. Nincsenek reklámok. Egyetlen letisztult hely, ahol a gyerek beír egy szót, teljesen megérti, és visszatér a házi feladathoz."}},"heroCta":"Kezdd el a 14 napos ingyenes próbát","heroTrust":"Nincs nyílt chat · Nincs reklám · Lemondás egy kattintással","ownerCta":"Ugrás a családi teredhez","stats":["30+ nyelv","Kép minden jelentéshez","Akár 5 gyerek","Lemondás egy kattintással"],"demoKicker":"Az eredmény","demoTitle":"A gyereked minden szót megért, és a szókincse napról napra bővül","painKicker":"Az igazi fájdalom","painTitle":"A gyereked olvas, de nem mindig érti igazán","painBody1":"Valójában örülsz, amikor a gyereked megáll megkérdezni, mit jelent egy szó. A gond az összes szóval van, amiről nem áll meg kérdezni. Átugorja őket, olvas tovább, és az anyag nem ragad meg. A szókincs vékony marad, a szövegértés pedig szóról szóra megbicsaklik.","painBody2":"És ez sokkal többet érint, mint egy jegyet. Az a gyerek, aki nem érti, úgy érzi, nem elég jó, elkeseredik az iskolától, és elveszíti az önbizalmát. Mindez csendben történik, és senki sem tudja megmutatni, hol szakadt el a fonál.","reframe":"És pontosan itt lép be a Gadit.","puzzleKicker":"Mi történik a gyerek fejében","puzzleTitle":"A szöveg egy kirakós. Minden szó egy darab.","puzzleBody":"Amikor a gyerek olvas, az elméje a szavakból rakja össze a teljes képet. Minden szó, amit megért, egy darab, ami a helyére kattan. Minden hiányzó szó egy lyuk a képen. Elég három vagy négy lyuk, és a gyerek már nem látja a képet, még ha minden betűt ki is silabizált.","puzzleBefore":"Egy bekezdés hiányzó szavakkal","puzzleAfter":"A Gadittal minden darab a helyén","puzzleLine":"Amikor minden szó világos, a gyerek látja a teljes képet.","chainKicker":"Hogyan működik","chainTitle":"Mindent megkap a gyereked, minden szónál","chainSteps":["A gyereked beír egy szót, amit nem ért","Megkapja a magyarázatot a saját szintjén, egy képet és három példát","A szó elmentődik a személyes füzetébe","És visszatér rövid gyakorlásban, amíg igazán a sajátjává nem válik"],"howBlocks":[{"t":"Írd be a szót","b":"A gyereked beír bármilyen szót, amit nem ért, Gyerek módban, letisztult és biztonságos helyen."},{"t":"Világos definíció","b":"Magyarázat a gyerek szemmagasságában, nehéz szavak nélkül, amelyek nehéz szavakat magyaráznának."},{"t":"Három példa","b":"Valódi mondatok, amelyek megmutatják, hogyan él a szó egy szövegben, képpel, nem csak egy definícióval."},{"t":"Kép minden jelentéshez","b":"Mert a gyerekek sokkal jobban megjegyzik, amit látnak, mint amit leírnak nekik."},{"t":"Kontextus","b":"Illessz be egy mondatot a könyvből, és a Gadit pontosan azt a jelentést jelöli meg, amelyik illik hozzá."},{"t":"Személyes füzet","b":"Minden szó, amit a gyereked megkeresett, elmentődik a füzetébe, és nem szökik el."},{"t":"Rövid kvíz","b":"Egy gyors kérdés, amely visszahozza a szót épp mielőtt elillanna."},{"t":"Egy játék","b":"Tanulás játékon keresztül, azokból a szavakból, amelyeket a gyereked maga keresett meg."},{"t":"Halld, és mondd ki","b":"A gyereked meghall bármely szót, és hangosan gyakorolja a kimondását, hogy természetes legyen beszélni, ne csak olvasni."}],"chainCost":"","chainTurnTitle":"És ezt kapod","chainTurnBody":"Minden szó, amin a gyereked elakadt, olyan szóvá válik, amit ismer, és ezt feketén-fehéren látod: hány szót zárt le, hétről hétre. Ahelyett, hogy csak reménykednél, hogy valami javul, egyszerűen nézed, ahogy megtörténik.","dashKicker":"A szülői irányítópult","dashTitle":"Pontosan látod, mennyit tanult minden gyerek","dashBody":"Minden gyereknek van egy személyes szófüzete, amely gyarapszik. Az irányítópultodon egy pillantással látod, hány szót tanult meg minden gyerek, hány került hozzá ezen a héten, és melyek a legutóbbi szavai. Minden más eszköz válaszol a gyereknek, aztán elfelejti. A Gadit emlékszik, és te látod a fejlődést hétről hétre.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"szó a füzetben","dashWeekLabel":"ezen a héten","featuresKicker":"Mi van benne","features":[{"kicker":"Minden jelentés","title":"Egy szó. Minden jelentés. Mindegyikhez kép.","body":"Egy szónak gyakran több különböző jelentése van, és itt keverednek össze a gyerekek. A Gadit egy helyen mutatja meg mindet, mindegyiket három valódi példával és saját képpel, mert a gyerek agya sokkal jobban megjegyzi a képeket, mint a szavakat."},{"kicker":"Gyerek mód","title":"Magyarázatok a gyereked szemmagasságában","body":"Egy kapcsoló, és minden magyarázat olyan nyelvre vált, amit egy 8 éves valóban megért. Nincsenek nehéz szavak, amelyek nehéz szavakat magyaráznak, nincsenek körkörös definíciók. Csak megértés."},{"kicker":"Kontextus","title":"Illessz be egy mondatot, kapd meg a helyes jelentést","body":"A legtöbb szónak több jelentése van, és itt vesznek el a gyerekek. Illeszd be a mondatot a könyvből vagy a feladatlapról, és a Gadit pontosan megjelöli, melyik jelentés illik hozzá."},{"kicker":"Személyes füzet","title":"A szavak nem szöknek el","body":"Minden szó, amit a gyereked megkeres, bekerül a személyes füzetébe, és rövid, okos gyakorlás hozza vissza épp mielőtt elillanna. Így épül fel valójában a szókincs, egyszerre egy szóval."},{"kicker":"Profil minden gyereknek","title":"Minden gyerek megkapja a saját terét","body":"A család minden gyereke külön profilt kap: a saját füzetét, a saját gyakorlását, a saját előzményeit. A Gyerek mód igazítja a magyarázatot, egyszerűen és tisztán a kicsiknek, és bővebben a nagyobbaknak, és senki sem lép a másik szavaira."},{"kicker":"Szójátékok","title":"Tanulójátékok a gyereked szavaiból","body":"Rövid kvízek és játékok azokból a szavakból, amelyeket a gyereked valóban megkeresett. Néhány perc játék, és a szókincs erőfeszítés nélkül bővül."},{"kicker":"Második nyelv","title":"A legjobb házifeladat-segítő a második nyelvhez","body":"A gyereked beír egy szót angolul, és egyszerű magyarázatot kap a saját nyelvén, képpel és példákkal. Nincs több bolyongás szótár, fordító és YouTube között."}],"midCtaTitle":"Kezdd el most, és nézd, ahogy a gyereked szókincse napról napra bővül","midCta":"Kezdd el a 14 napos ingyenes próbát","compareKicker":"A különbség","compareTitle":"Miért ne csak rákeressünk a Google-ben vagy kérdezzünk egy chatbotot?","compareGadit":"Gadit","compareOther":"A nyílt internet","compareRows":[{"label":"Egy letisztult oldal szavanként","gadit":true,"other":false},{"label":"Magyarázatok gyerekszinten","gadit":true,"other":false},{"label":"Kép minden jelentéshez","gadit":true,"other":false},{"label":"Füzet és gyakorlás, ami megmarad","gadit":true,"other":false},{"label":"Reklámok és linkek minden irányba","gadit":false,"other":true},{"label":"Végtelen chat, korlátok nélkül","gadit":false,"other":true}],"safeTitle":"Külön, letisztult zóna. Nem átjáró máshová.","safeBody":"A Gadit teljesen zárt tér: nincs nyílt chat, nincs feed, nincsenek reklámok, nincsenek kifelé mutató linkek. A gyereket nem rántja el innen a TikTok vagy bármely más alkalmazás. Egyetlen dolog van, amit itt tenni lehet: megérteni egy szót, és visszatérni a tanuláshoz.","safeLine":"Egy képernyő, amit nyugodt lélekkel a gyerek kezébe adhatsz.","stackTitle":"Mit tartalmaz a Család csomag","stackItems":["Korlátlan keresés az egész családnak","Minden jelentés, mindegyikhez képpel","Gyerek mód minden korosztálynak","Mondatellenőrzés azonnali visszajelzéssel","Személyes füzet és okos gyakorlás minden gyereknek","Szójátékok és kvízek","Akár 5 gyerek külön profillal","30+ nyelv teljes támogatással"],"priceKicker":"Árazás","priceTitle":"A Család csomag","trialBadge":"14 napos ingyenes próba","yearly":"59 $ / év","yearlyNote":"ez havi 4,92 $ az egész családnak, és közel két hónapot megtakarít a havi fizetéshez képest","priceAnchor":"Kevesebb, mint egyetlen magánóra, egy egész évre, otthon minden gyereknek","monthly":"5,99 $ / hó","billedYearly":"Éves","billedMonthly":"Havi","yearlySave":"-18%","priceCta":"Kezdd el a próbát","cancelNote":"Az első terhelés csak a 14 nap után. Bármikor lemondható a fiókoldalról, egy kattintással.","singleChild":"Csak egy diák otthon? A Deep havi 4,99 $. Kicsivel többért akár 5 gyereket is hozzáadhatsz.","guaranteeTitle":"A te próbád: két hét","guaranteeBody":"Adj neki két hét valódi használatot, ingyen. Ha a 14. napra a gyereked füzetében nem gyűlt össze legalább 20 új szó, mondd le egy kattintással, és semmit sem fizettél.","faqTitle":"Kérdések, amelyeket a szülők feltesznek","faq":[{"q":"Mit kapok a Gadittal?","a":"Minden szó, amit a gyereked megkeres, egy letisztult oldalt kap: minden jelentést, gyerekszintű magyarázatot (Gyerek mód), három valódi példát és jelentésenként egy képet. Ráadásul kontextust (illessz be egy mondatot, és megkapod a helyes jelentést), személyes szófüzetet okos gyakorlással, szójátékokat és kvízeket, szülői irányítópultot, amely megmutatja, mennyit tanult minden gyerek, akár 5 gyereket külön profilon, mindezt 30+ nyelven, egy zárt, biztonságos térben, nyílt chat és reklámok nélkül."},{"q":"Miért ne kérdezzünk egyszerűen egy chatbotot vagy a Google-t?","a":"Mert azok felnőtteknek szóló eszközök. A Google reklámokat és linkeket ad minden irányba, egy nyílt chatbot pedig határok nélküli beszélgetés, amelyben egyetlen szülő sem hagy egyedül egy gyereket. A Gadit fordítva épül fel: egy zárt, letisztult oldal szavanként, gyerekszinten, ahol nincs mód eltévedni."},{"q":"Honnan tudom, hogy a gyerekem valóban halad?","a":"Kapsz egy szülői irányítópultot. Egy pillantással látod, hány szót tanult meg minden gyerek, hány került hozzá ezen a héten, és melyek a legutóbbi szavai. Minden más eszköz válaszol a gyereknek, aztán elfelejti; a Gadit minden szót elment a gyerek személyes füzetébe, így hétről hétre nézheted, ahogy a szókincs bővül."},{"q":"Milyen korosztálynak való?","a":"A Gadit szíve az iskoláskorú gyerekek, az első osztálytól a középiskoláig. A Gyerek mód egyszerűen magyaráz a kicsiknek, a teljes magyarázatok pedig a tinédzsereknek és a szülőknek is szólnak. A fiókot a szülő nyitja meg."},{"q":"Segít az angolban és más nyelvekben?","a":"Nagyon is. A gyerek megkereshet egy szót angolul, és egyszerű magyarázatot kap a saját nyelvén, képpel és példákkal, pontosan azt a segítőt, ami otthon hiányzik. És 30+ nyelven működik, így a gyerek azon a nyelven is megkaphatja a magyarázatot, amelyet otthon beszéltek."},{"q":"Mennyibe kerül?","a":"59 $ évente vagy 5,99 $ havonta, a 14 napos próba után. Nincsenek rejtett díjak, és bármikor lemondhatod egy kattintással."},{"q":"Hány gyereket adhatok hozzá?","a":"Akár 5 gyereket egy Család csomagban, mindegyiknek saját profillal, füzettel és gyakorlással."},{"q":"Kipróbálhatjuk elköteleződés nélkül?","a":"Igen. A próba kártyával indul, de az első terhelés csak a 14 nap végén történik. Mondd le bármikor előtte, egy kattintással, és semmit sem fizetsz."}],"finalTitle":"Kezdd el ma, és nézd, ahogy a szókincs bővül","finalSub":"Két hét ingyen. Lemondás egy kattintással. És egy gyerek, aki megtanulja egyedül megérteni a szavakat.","finalCta":"Kezdd el a 14 napos ingyenes próbát","footerTerms":"Feltételek","footerPrivacy":"Adatvédelem"},
  "ko": {"heroBadge":"온 가족을 위한 시각적이고 똑똑한 사전","whatIs":"Gadit은 아이들을 위한 똑똑하고 시각적인 사전입니다. 모든 단어를 아이 눈높이로 설명하고, 그림과 예문, 그리고 단어 학습을 즐겁게 만드는 게임과 퀴즈까지 함께 제공합니다. 어휘력이 늘고, 독해력이 좋아지고, 아이가 학교에서 더 잘 해냅니다.","ctaMicro":"","trustLine":"최대 5명의 아이, 각자의 수준에 맞게","credLine":"15년의 경험과 15,000명이 넘는 학부모, 학생, 교육자와 함께 쌓아 올린 결과물","credKicker":"우리는 누구인가요","credTitle":"교육 현장에서의 15년. 이제 아이를 위한 하나의 도구로.","credBody":"Gadit은 교육 분야에서 15년의 경험을 쌓고 15,000명이 넘는 학부모, 학생, 교육자와 함께한 팀이 만들었습니다. 교실에서도 가정에서도 몇 번이고 효과를 확인한 것들을, 아이가 스스로 사용할 수 있는 하나의 간단한 도구에 담았습니다.","proofTitle":"단어 노트 · 예시","proofBig":"이번 주에 새로 익힌 단어 12개","proofWords":["꿈","생생한","머뭇거리는"],"angles":{"vocab":{"h1":"아이의 어휘력이 자랍니다. 한 단어씩.","sub":"아이가 궁금해한 모든 단어가 Gadit 속 자기만의 단어 노트에 담깁니다. 그림과 아이 눈높이 설명, 그리고 그 단어가 온전히 아이의 것이 될 때까지 되짚어 주는 짧은 연습과 함께요. 한 달이 끝날 때 노트를 열어 보면, 한 단어씩 자라난 어휘가 눈에 보입니다."},"relief":{"h1":"이제 가족 사전 노릇은 그만","sub":"오늘부터 아이가 \"이게 무슨 뜻이야?\"라고 물을 때, 스스로 답을 찾을 수 있는 한 곳이 생깁니다. 모든 의미와 의미마다의 그림, 그리고 아이 눈높이의 설명. 열린 채팅도, 광고도 없습니다."},"anxiety":{"h1":"아이가 모든 단어를 정확히 읽지만, 정작 제대로 이해하지는 못합니다","sub":"아이는 늘 멈춰서 묻지 않습니다. 모르는 단어를 그냥 지나치고 계속 읽어 나가다 보면 내용이 머릿속에 남지 않습니다. 시간이 지나면 그것이 학교에 대한 좌절과 \"난 못 하겠어\"라는 마음으로 바뀝니다. Gadit은 아이가 멈춰서 제대로 이해하고, 그 단어를 손에 쥔 채 다시 수업으로 돌아갈 수 있는 하나의 공간을 줍니다."},"safe":{"h1":"걱정 없이 아이에게 건네줄 수 있는 단 하나의 화면","sub":"열린 채팅도, 끝없는 피드도, 광고도 없습니다. 아이가 단어를 입력하고, 온전히 이해한 뒤, 다시 숙제로 돌아가는 깔끔한 한 공간입니다."}},"heroCta":"14일 무료 체험 시작하기","heroTrust":"열린 채팅 없음 · 광고 없음 · 클릭 한 번으로 해지","ownerCta":"우리 가족 공간으로 이동","stats":["30+ 언어","의미마다 그림 한 장","최대 5명의 아이","클릭 한 번으로 해지"],"demoKicker":"그 결과","demoTitle":"아이가 모든 단어를 이해하고, 어휘력이 날마다 자랍니다","painKicker":"진짜 고민","painTitle":"아이가 읽기는 하지만, 늘 제대로 이해하는 것은 아닙니다","painBody1":"아이가 단어의 뜻을 물어보려고 멈출 때, 사실 반가운 일입니다. 문제는 멈춰서 묻지 않는 모든 단어들이죠. 아이는 그냥 지나치고 계속 읽어 나가고, 내용은 머릿속에 남지 않습니다. 어휘는 빈약한 채로 머물고, 독해는 단어마다 무너집니다.","painBody2":"그리고 이것은 성적 그 이상의 문제입니다. 이해하지 못하는 아이는 스스로 부족하다고 느끼고, 학교에 좌절하며, 자신감을 잃습니다. 게다가 그 일은 조용히 일어나서, 어디서 실이 끊어졌는지 아무도 짚어내지 못합니다.","reframe":"바로 이 지점에서 Gadit이 함께합니다.","puzzleKicker":"아이의 머릿속에서 벌어지는 일","puzzleTitle":"글은 퍼즐입니다. 단어 하나하나가 조각이죠.","puzzleBody":"아이가 글을 읽을 때, 머릿속에서는 단어들로 하나의 온전한 그림을 맞춰 갑니다. 이해한 단어 하나하나가 제자리에 딱 들어맞는 조각입니다. 빠진 단어 하나하나는 그림에 뚫린 구멍이죠. 겨우 서너 개의 구멍만 생겨도, 아이는 모든 글자를 소리 내어 읽었더라도 더는 그 그림을 보지 못합니다.","puzzleBefore":"단어가 빠진 문단","puzzleAfter":"Gadit과 함께라면, 모든 조각이 제자리에","puzzleLine":"모든 단어가 명확할 때, 아이는 전체 그림을 봅니다.","chainKicker":"이렇게 작동합니다","chainTitle":"모든 단어에서 아이가 받는 모든 것","chainSteps":["아이가 이해하지 못한 단어를 입력합니다","눈높이에 맞는 설명과 그림, 그리고 예문 세 개를 받습니다","그 단어가 자기만의 노트에 저장됩니다","그리고 온전히 아이의 것이 될 때까지 짧은 연습으로 되돌아옵니다"],"howBlocks":[{"t":"단어를 입력하세요","b":"아이가 이해하지 못한 어떤 단어든 키즈 모드에서, 깔끔하고 안전한 공간에 입력합니다."},{"t":"명확한 정의","b":"아이 눈높이의 설명. 어려운 단어를 또 다른 어려운 단어로 풀지 않습니다."},{"t":"예문 세 개","b":"단어가 글 속에서 어떻게 살아 있는지 보여 주는 실제 문장. 정의뿐 아니라 그림까지 함께입니다."},{"t":"의미마다 그림 한 장","b":"아이는 글로 설명받은 것보다 눈으로 본 것을 훨씬 잘 기억하니까요."},{"t":"문맥","b":"책에서 문장 하나를 붙여넣으면, Gadit이 그 문장에 딱 맞는 의미를 정확히 짚어 줍니다."},{"t":"개인 노트","b":"아이가 찾아본 모든 단어가 노트에 저장되어 달아나지 않습니다."},{"t":"짧은 퀴즈","b":"단어가 기억에서 사라지기 직전에 다시 불러오는 짧은 질문."},{"t":"게임","b":"아이가 직접 찾아본 단어로 놀이하며 배웁니다."},{"t":"듣고, 말하기","b":"아이가 어떤 단어든 듣고 소리 내어 말하는 연습을 합니다. 읽기만이 아니라 말하기도 자연스러워지도록요."}],"chainCost":"","chainTurnTitle":"그리고 이것이 바로 얻게 되는 것입니다","chainTurnBody":"아이가 막혔던 모든 단어가 아는 단어가 되고, 그 과정이 눈앞에 또렷이 보입니다. 아이가 매주 몇 개의 단어를 완성했는지 말이죠. 무언가 나아지고 있기를 바라는 대신, 그냥 그 일이 일어나는 것을 지켜보세요.","dashKicker":"학부모 대시보드","dashTitle":"아이마다 얼마나 배웠는지 정확히 확인하세요","dashBody":"아이마다 자라나는 자기만의 단어 노트가 있습니다. 대시보드에서는 아이별로 몇 개의 단어를 익혔는지, 이번 주에 몇 개가 추가되었는지, 그리고 가장 최근 단어들을 한눈에 볼 수 있습니다. 다른 도구는 아이에게 답해 주고 잊어버립니다. Gadit은 기억하고, 여러분은 주마다 성장을 지켜봅니다.","dashKids":[{"name":"노아","total":47,"week":12},{"name":"이도","total":31,"week":8},{"name":"마야","total":63,"week":15}],"dashWordsLabel":"노트 속 단어","dashWeekLabel":"이번 주","featuresKicker":"안에 담긴 것","features":[{"kicker":"모든 의미","title":"한 단어. 모든 의미. 각각의 그림.","body":"한 단어에는 서로 다른 여러 의미가 있을 때가 많고, 바로 그 지점에서 아이들이 헷갈립니다. Gadit은 그 모든 의미를 한곳에서 보여 줍니다. 각각 실제 예문 세 개와 자기만의 그림과 함께요. 아이의 뇌는 글보다 이미지를 훨씬 잘 기억하니까요."},{"kicker":"키즈 모드","title":"아이 눈높이의 설명","body":"스위치 하나면, 모든 설명이 여덟 살 아이가 실제로 이해하는 말로 바뀝니다. 어려운 단어를 또 다른 어려운 단어로 풀지도, 빙빙 도는 정의도 없습니다. 그저 이해뿐입니다."},{"kicker":"문맥","title":"문장을 붙여넣으면, 맞는 의미를 알려 드려요","body":"대부분의 단어에는 하나 이상의 의미가 있고, 바로 그 지점에서 아이들이 길을 잃습니다. 책이나 학습지의 문장을 붙여넣으면, Gadit이 어떤 의미가 맞는지 정확히 짚어 줍니다."},{"kicker":"개인 노트","title":"단어가 달아나지 않습니다","body":"아이가 찾아본 모든 단어가 자기만의 노트에 담기고, 짧고 똑똑한 연습이 단어가 사라지기 직전에 다시 불러옵니다. 어휘력은 바로 이렇게, 한 단어씩 쌓입니다."},{"kicker":"아이마다 프로필","title":"아이마다 자기만의 공간","body":"가족의 아이마다 각자의 프로필이 있습니다. 자기 노트, 자기 연습, 자기 기록까지요. 키즈 모드는 설명을 맞춰 줍니다. 어린 아이에게는 쉽고 명확하게, 큰 아이에게는 더 풍부하게. 그리고 누구도 서로의 단어를 건드리지 않습니다."},{"kicker":"단어 게임","title":"아이의 단어로 하는 학습 게임","body":"아이가 실제로 찾아본 단어로 만든 짧은 퀴즈와 게임. 몇 분의 놀이만으로 어휘력이 힘들이지 않고 자랍니다."},{"kicker":"제2 언어","title":"제2 언어를 위한 최고의 숙제 도우미","body":"아이가 영어 단어를 입력하면 자기 언어로 된 쉬운 설명을 그림과 예문과 함께 받습니다. 사전과 번역기와 유튜브 사이를 헤맬 필요가 없습니다."}],"midCtaTitle":"지금 시작하세요. 아이의 어휘력이 날마다 자라는 것을 지켜보세요","midCta":"14일 무료 체험 시작하기","compareKicker":"그 차이","compareTitle":"그냥 구글에서 검색하거나 챗봇에 물어보면 안 될까요?","compareGadit":"Gadit","compareOther":"열린 인터넷","compareRows":[{"label":"단어마다 깔끔한 한 페이지","gadit":true,"other":false},{"label":"아이 눈높이의 설명","gadit":true,"other":false},{"label":"의미마다 그림 한 장","gadit":true,"other":false},{"label":"머릿속에 남는 노트와 연습","gadit":true,"other":false},{"label":"사방으로 향하는 광고와 링크","gadit":false,"other":true},{"label":"경계 없는 열린 채팅","gadit":false,"other":true}],"safeTitle":"분리된 깨끗한 공간. 다른 어디로도 통하지 않는 문.","safeBody":"Gadit은 완전히 닫힌 공간입니다. 열린 채팅도, 피드도, 광고도, 바깥으로 향하는 링크도 없습니다. 아이가 여기서 틱톡이나 다른 앱으로 끌려가지 않습니다. 여기서 할 일은 단 하나, 단어를 이해하고 다시 공부로 돌아가는 것입니다.","safeLine":"마음 놓고 아이에게 건넬 수 있는 화면 하나.","stackTitle":"패밀리 플랜에 담긴 것","stackItems":["온 가족을 위한 무제한 검색","모든 의미, 각각의 그림과 함께","모든 연령을 위한 키즈 모드","즉각적인 피드백이 있는 문장 확인","아이마다 개인 노트와 똑똑한 연습","단어 게임과 퀴즈","각자 프로필을 가진 최대 5명의 아이","30+ 언어 완전 지원"],"priceKicker":"요금","priceTitle":"패밀리 플랜","trialBadge":"14일 무료 체험","yearly":"연 $59","yearlyNote":"온 가족이 월 $4.92인 셈이고, 매달 내는 것보다 거의 두 달 치를 아낄 수 있습니다","priceAnchor":"개인 과외 한 번 값도 안 되는 금액으로, 집안의 모든 아이가 일 년 내내","monthly":"월 $5.99","billedYearly":"연간","billedMonthly":"월간","yearlySave":"-18%","priceCta":"체험 시작하기","cancelNote":"첫 결제는 14일이 지난 뒤에만 이루어집니다. 계정 페이지에서 언제든 클릭 한 번으로 해지하세요.","singleChild":"집에 학생이 한 명뿐인가요? Deep은 월 $4.99입니다. 조금만 더하면 최대 5명의 아이를 추가할 수 있습니다.","guaranteeTitle":"여러분의 시험 기간: 2주","guaranteeBody":"실제로 2주 동안 무료로 써 보세요. 14일째까지 아이의 노트에 새 단어가 최소 20개 모이지 않았다면, 클릭 한 번으로 해지하시고 한 푼도 내지 마세요.","faqTitle":"학부모들이 묻는 질문","faq":[{"q":"Gadit으로 무엇을 얻나요?","a":"아이가 찾아본 모든 단어에 깔끔한 한 페이지가 생깁니다. 모든 의미, 아이 눈높이 설명(키즈 모드), 실제 예문 세 개, 그리고 의미마다의 그림. 여기에 문맥(문장을 붙여넣으면 맞는 의미를 알려 줍니다), 똑똑한 연습이 있는 개인 단어 노트, 단어 게임과 퀴즈, 아이마다 얼마나 배웠는지 보여 주는 학부모 대시보드, 각자 프로필을 가진 최대 5명의 아이까지. 이 모든 것이 30+ 언어로, 열린 채팅도 광고도 없는 닫힌 안전한 공간에서 제공됩니다."},{"q":"그냥 챗봇에 물어보거나 구글에서 검색하면 안 될까요?","a":"그것들은 어른을 위한 도구이기 때문입니다. 구글은 사방으로 향하는 광고와 링크를 내놓고, 열린 챗봇은 어떤 부모도 아이를 홀로 두지 않을 경계 없는 대화입니다. Gadit은 정반대로 만들어졌습니다. 단어마다 닫히고 깔끔한 한 페이지를, 아이 눈높이로, 길을 잃을 여지 없이 제공합니다."},{"q":"아이가 정말로 나아지고 있는지 어떻게 알 수 있나요?","a":"학부모 대시보드를 받게 됩니다. 아이별로 몇 개의 단어를 익혔는지, 이번 주에 몇 개가 추가되었는지, 그리고 가장 최근 단어들을 한눈에 볼 수 있습니다. 다른 도구들은 아이에게 답해 주고 잊어버리지만, Gadit은 모든 단어를 아이의 개인 노트에 저장하기 때문에 주마다 자라나는 어휘를 지켜볼 수 있습니다."},{"q":"몇 살을 위한 것인가요?","a":"Gadit의 핵심은 초등학교 1학년부터 고등학생까지 학령기 아이들입니다. 키즈 모드는 어린 아이에게 쉽게 설명하고, 자세한 설명은 청소년과 학부모에게도 도움이 됩니다. 계정은 부모가 엽니다."},{"q":"영어나 다른 언어 학습에도 도움이 되나요?","a":"물론입니다. 아이가 영어 단어를 찾아 자기 언어로 된 쉬운 설명을 그림과 예문과 함께 받을 수 있습니다. 바로 집에 없던 그 도우미죠. 그리고 30+ 언어로 작동하기 때문에, 집에서 쓰는 언어로도 설명을 받을 수 있습니다."},{"q":"비용은 얼마인가요?","a":"14일 체험이 끝난 뒤 연 $59 또는 월 $5.99입니다. 숨은 비용은 없고, 언제든 클릭 한 번으로 해지할 수 있습니다."},{"q":"아이를 몇 명까지 추가할 수 있나요?","a":"하나의 패밀리 플랜에 최대 5명까지, 각자 자기 프로필과 노트와 연습을 가집니다."},{"q":"부담 없이 먼저 써 볼 수 있나요?","a":"네. 체험은 카드로 시작하지만, 첫 결제는 14일이 끝날 때에만 이루어집니다. 그 전에 언제든 클릭 한 번으로 해지하시면 한 푼도 내지 않습니다."}],"finalTitle":"오늘 시작하고, 어휘가 자라나는 것을 지켜보세요","finalSub":"2주 무료. 클릭 한 번 해지. 그리고 스스로 단어를 이해하는 법을 배우는 아이.","finalCta":"14일 무료 체험 시작하기","footerTerms":"이용약관","footerPrivacy":"개인정보 처리방침"},
  "sw": {"heroBadge":"Kamusi ya kuona na yenye akili kwa familia nzima","whatIs":"Gadit ni kamusi yenye akili na ya kuona kwa watoto: kila neno hupata maelezo yanayofaa kiwango cha mtoto, picha, mifano, pamoja na michezo na maswali yanayofanya kujifunza maneno kuwa jambo la kufurahisha. Msamiati unaongezeka, uelewa wa kusoma unaimarika, na mtoto wako anafanya vizuri zaidi shuleni.","ctaMicro":"","trustLine":"Hadi watoto 5, kila mmoja kwenye kiwango chake","credLine":"Imejengwa juu ya uzoefu wa miaka 15 na zaidi ya wazazi, wanafunzi na waelimishaji 15,000","credKicker":"Sisi ni nani","credTitle":"Miaka 15 katika elimu. Sasa katika zana moja kwa mtoto wako.","credBody":"Gadit ilijengwa na timu yenye uzoefu wa miaka 15 katika elimu, iliyofanya kazi na zaidi ya wazazi, wanafunzi na waelimishaji 15,000. Kile tulichokiona kikifanya kazi tena na tena, darasani na nyumbani, tulikiweka katika zana moja rahisi ambayo mtoto anaweza kuitumia peke yake.","proofTitle":"Daftari la maneno · mfano","proofBig":"Maneno mapya 12 wiki hii","proofWords":["ndoto","wazi","kusitasita"],"angles":{"vocab":{"h1":"Msamiati wa mtoto wako unakua. Neno kwa neno.","sub":"Kila neno ambalo mtoto wako anauliza kuhusu huingia katika daftari lake binafsi la maneno ndani ya Gadit: pamoja na picha, maelezo yanayofaa kiwango cha mtoto, na mazoezi mafupi yanayolirudisha hadi liwe lake kabisa. Fungua daftari mwishoni mwa mwezi na uangalie msamiati ukikua, neno kwa neno."},"relief":{"h1":"Acha kuwa kamusi ya familia","sub":"Kuanzia leo, mtoto wako anapouliza \"hili lina maana gani?\", ana mahali pamoja pa kupata jibu peke yake: kila maana, picha kwa kila moja, na maelezo yanayofaa kiwango cha mtoto. Hakuna gumzo la wazi, hakuna matangazo."},"anxiety":{"h1":"Mtoto wako anasoma kila neno vizuri, lakini hakielewi kweli","sub":"Hawasimami kila mara kuuliza. Wanaruka neno wasiloelewa, wanaendelea, na masomo hayaingii kichwani. Baada ya muda hili linakuwa uchungu kuhusu shule na hisia ya \"siwezi\". Gadit humpa mtoto wako mahali pamoja pa kusimama, kuelewa kweli, na kurudi kwenye somo akiwa na neno mkononi."},"safe":{"h1":"Skrini pekee unayoweza kumpa mtoto bila wasiwasi","sub":"Hakuna gumzo la wazi. Hakuna mkondo usiokwisha. Hakuna matangazo. Mahali pamoja safi ambapo mtoto anaandika neno, analielewa kikamilifu, na anarudi kwenye kazi za nyumbani."}},"heroCta":"Anza majaribio yako ya bure ya siku 14","heroTrust":"Hakuna gumzo la wazi · Hakuna matangazo · Ghairi kwa mbofyo mmoja","ownerCta":"Nenda kwenye nafasi ya familia yako","stats":["Lugha 30+","Picha kwa kila maana","Hadi watoto 5","Ghairi kwa mbofyo mmoja"],"demoKicker":"Matokeo","demoTitle":"Mtoto wako anaelewa kila neno, na msamiati wake unakua kila siku","painKicker":"Uchungu halisi","painTitle":"Mtoto wako anasoma, lakini si mara zote anaelewa kweli","painBody1":"Kwa kweli unafurahi mtoto wako anaposimama kuuliza neno lina maana gani. Tatizo ni maneno yote asiyoyasimamia kuuliza. Anayaruka, anaendelea kusoma, na masomo hayaingii kichwani. Msamiati unabaki hafifu, na uelewa unavunjika neno baada ya neno.","painBody2":"Na hili linagusa mengi zaidi ya alama tu. Mtoto asiyeelewa anahisi hafai vya kutosha, anachukizwa na shule, na anapoteza kujiamini. Na hili hutokea kimyakimya, bila mtu yeyote kuweza kuonyesha mahali uzi ulipokatika.","reframe":"Na hapa ndipo hasa Gadit inapoingia.","puzzleKicker":"Kinachotokea kichwani mwa mtoto","puzzleTitle":"Maandishi ni fumbo. Kila neno ni kipande.","puzzleBody":"Mtoto anaposoma, akili yake huunda picha nzima kutoka kwa maneno. Kila neno analoelewa ni kipande kinachokaa mahali pake. Kila neno linalokosekana ni tundu katika picha. Matundu matatu au manne tu, na mtoto hasioni tena picha, hata kama alitamka kila herufi.","puzzleBefore":"Aya yenye maneno yanayokosekana","puzzleAfter":"Kwa Gadit, kila kipande mahali pake","puzzleLine":"Kila neno linapokuwa wazi, mtoto anaona picha nzima.","chainKicker":"Jinsi inavyofanya kazi","chainTitle":"Kila kitu mtoto wako anachopata, kwa kila neno","chainSteps":["Mtoto wako anaandika neno asiloelewa","Anapata maelezo yanayofaa kiwango chake, picha na mifano mitatu","Neno linahifadhiwa katika daftari lake binafsi","Na linarudi katika mazoezi mafupi, hadi liwe lake kabisa"],"howBlocks":[{"t":"Andika neno","b":"Mtoto wako anaandika neno lolote asiloelewa, katika Hali ya Watoto, mahali safi na salama."},{"t":"Ufafanuzi wazi","b":"Maelezo yanayofaa kiwango cha mtoto, bila maneno magumu kufafanua maneno magumu."},{"t":"Mifano mitatu","b":"Sentensi halisi zinazoonyesha jinsi neno linavyoishi ndani ya maandishi, pamoja na picha, si ufafanuzi tu."},{"t":"Picha kwa kila maana","b":"Kwa sababu watoto hukumbuka wanachokiona vizuri zaidi kuliko wanachoandikiwa."},{"t":"Muktadha","b":"Bandika sentensi kutoka kitabuni na Gadit huonyesha kwa usahihi maana inayofaa."},{"t":"Daftari binafsi","b":"Kila neno mtoto wako alilotafuta huhifadhiwa katika daftari lake, na halitoroki."},{"t":"Jaribio fupi","b":"Swali la haraka linalorudisha neno kabla tu halijasahaulika."},{"t":"Mchezo","b":"Kujifunza kupitia mchezo, kwa maneno ambayo mtoto wako alitafuta mwenyewe."},{"t":"Sikia, na uliseme","b":"Mtoto wako anasikia neno lolote na anafanya mazoezi ya kulitamka kwa sauti, ili kuzungumza kuwe jambo la kawaida, si kusoma tu."}],"chainCost":"","chainTurnTitle":"Na hiki ndicho unachopata","chainTurnBody":"Kila neno ambalo mtoto wako alikwama nalo linakuwa neno analolijua, na unaliona wazi kabisa: maneno mangapi aliyafunga, wiki baada ya wiki. Badala ya kutumaini kwamba kitu kinaimarika, unatazama tu likitokea.","dashKicker":"Dashibodi ya mzazi","dashTitle":"Unaona kwa usahihi kiasi gani kila mtoto amejifunza","dashBody":"Kila mtoto ana daftari lake binafsi la maneno linalokua. Katika dashibodi yako unaona, kwa jicho moja, maneno mangapi kila mtoto amejifunza, mangapi yaliongezwa wiki hii, na maneno yake ya hivi karibuni. Zana nyingine yoyote inamjibu mtoto wako na kusahau. Gadit inakumbuka, na wewe unaona maendeleo wiki baada ya wiki.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"maneno katika daftari","dashWeekLabel":"wiki hii","featuresKicker":"Kilichomo ndani","features":[{"kicker":"Kila maana","title":"Neno moja. Kila maana. Picha kwa kila moja.","body":"Neno moja mara nyingi lina maana kadhaa tofauti, na hapo ndipo watoto wanapochanganyikiwa. Gadit huwaonyesha zote mahali pamoja, kila moja ikiwa na mifano mitatu halisi na picha yake yenyewe, kwa sababu ubongo wa mtoto hukumbuka picha vizuri zaidi kuliko maneno."},{"kicker":"Hali ya Watoto","title":"Maelezo yanayofaa kiwango cha mtoto wako","body":"Swichi moja, na kila maelezo yanabadilika kuwa lugha ambayo mtoto wa miaka 8 anaielewa kweli. Hakuna maneno magumu kufafanua maneno magumu, hakuna ufafanuzi wa mzunguko. Uelewa tu."},{"kicker":"Muktadha","title":"Bandika sentensi, pata maana sahihi","body":"Maneno mengi yana maana zaidi ya moja, na hapo ndipo watoto wanapopotea. Bandika sentensi kutoka kitabuni au karatasi ya kazi, na Gadit huonyesha kwa usahihi maana inayofaa."},{"kicker":"Daftari binafsi","title":"Maneno hayatoroki","body":"Kila neno ambalo mtoto wako analitafuta huingia katika daftari lake binafsi, na mazoezi mafupi yenye akili hulirudisha kabla tu halijaanza kusahaulika. Hivyo ndivyo msamiati unavyojengwa kweli, neno moja kwa wakati mmoja."},{"kicker":"Wasifu kwa kila mtoto","title":"Kila mtoto anapata nafasi yake mwenyewe","body":"Kila mtoto katika familia anapata wasifu tofauti: daftari lake, mazoezi yake, historia yake. Hali ya Watoto hurekebisha maelezo, rahisi na wazi kwa wadogo na yaliyokamilika zaidi kwa wakubwa, na hakuna anayekanyaga maneno ya mwingine."},{"kicker":"Michezo ya maneno","title":"Michezo ya kujifunza kwa maneno ya mtoto wako","body":"Maswali mafupi na michezo iliyojengwa kutoka kwa maneno ambayo mtoto wako alitafuta kweli. Dakika chache za mchezo, na msamiati unakua bila juhudi."},{"kicker":"Lugha ya pili","title":"Msaidizi bora wa kazi za nyumbani kwa lugha ya pili","body":"Mtoto wako anaandika neno kwa Kiingereza na anapata maelezo rahisi kwa lugha yake mwenyewe, pamoja na picha na mifano. Hakuna kutangatanga kati ya kamusi, kifasiri na YouTube."}],"midCtaTitle":"Anza sasa, na uangalie msamiati wa mtoto wako ukikua siku baada ya siku","midCta":"Anza majaribio yako ya bure ya siku 14","compareKicker":"Tofauti","compareTitle":"Kwa nini usitafute tu Google au kuuliza chatbot?","compareGadit":"Gadit","compareOther":"Mtandao wa wazi","compareRows":[{"label":"Ukurasa mmoja safi kwa kila neno","gadit":true,"other":false},{"label":"Maelezo yanayofaa kiwango cha mtoto","gadit":true,"other":false},{"label":"Picha kwa kila maana","gadit":true,"other":false},{"label":"Daftari na mazoezi yanayodumu","gadit":true,"other":false},{"label":"Matangazo na viungo kila upande","gadit":false,"other":true},{"label":"Gumzo la wazi lisilo na mipaka","gadit":false,"other":true}],"safeTitle":"Eneo tofauti, safi. Si mlango wa kuelekea mahali pengine popote.","safeBody":"Gadit ni nafasi iliyofungwa kabisa: hakuna gumzo la wazi, hakuna mkondo, hakuna matangazo, hakuna viungo vya nje. Mtoto havutwi kutoka hapa kwenda TikTok au programu nyingine yoyote. Kuna jambo moja la kufanya hapa: kuelewa neno, na kurudi kwenye masomo.","safeLine":"Skrini moja unayoweza kumpa mtoto na akili tulivu.","stackTitle":"Kile ambacho mpango wa Familia unajumuisha","stackItems":["Utafutaji usio na kikomo kwa familia nzima","Kila maana, pamoja na picha kwa kila moja","Hali ya Watoto kwa kila umri","Ukaguzi wa sentensi wenye majibu ya papo hapo","Daftari binafsi na mazoezi yenye akili kwa kila mtoto","Michezo ya maneno na maswali","Hadi watoto 5 wenye wasifu tofauti","Lugha 30+ zenye msaada kamili"],"priceKicker":"Bei","priceTitle":"Mpango wa Familia","trialBadge":"Majaribio ya bure ya siku 14","yearly":"$59 / mwaka","yearlyNote":"hiyo ni $4.92 kwa mwezi kwa familia nzima, na inakuokolea karibu miezi miwili ukilinganisha na kulipa kila mwezi","priceAnchor":"Chini ya kipindi kimoja cha mafunzo binafsi, kwa mwaka mzima, kwa kila mtoto nyumbani","monthly":"$5.99 / mwezi","billedYearly":"Kila mwaka","billedMonthly":"Kila mwezi","yearlySave":"-18%","priceCta":"Anza majaribio","cancelNote":"Malipo ya kwanza tu baada ya siku 14. Ghairi wakati wowote kutoka ukurasa wa akaunti yako, kwa mbofyo mmoja.","singleChild":"Una mwanafunzi mmoja tu nyumbani? Deep ni $4.99/mwezi. Kwa kiasi kidogo zaidi unaweza kuongeza hadi watoto 5.","guaranteeTitle":"Jaribio lako: wiki mbili","guaranteeBody":"Lipe wiki mbili za matumizi halisi, bure. Ikiwa kufikia siku ya 14 daftari la mtoto wako halijakusanya angalau maneno mapya 20, ghairi kwa mbofyo mmoja na hukulipa chochote.","faqTitle":"Maswali ambayo wazazi huuliza","faq":[{"q":"Ninapata nini na Gadit?","a":"Kila neno ambalo mtoto wako analitafuta hupata ukurasa mmoja safi: kila maana, maelezo yanayofaa kiwango cha mtoto (Hali ya Watoto), mifano mitatu halisi, na picha kwa kila maana. Pamoja na muktadha (bandika sentensi na upate maana sahihi), daftari binafsi la maneno lenye mazoezi yenye akili, michezo ya maneno na maswali, dashibodi ya mzazi inayoonyesha kiasi gani kila mtoto amejifunza, hadi watoto 5 kwenye wasifu tofauti, yote katika lugha 30+, katika nafasi iliyofungwa na salama bila gumzo la wazi na bila matangazo."},{"q":"Kwa nini usiulize tu chatbot au Google?","a":"Kwa sababu hizo ni zana za watu wazima. Google hurudisha matangazo na viungo kila upande, na chatbot ya wazi ni mazungumzo yasiyo na mipaka ambayo hakuna mzazi anayemwacha mtoto peke yake ndani yake. Gadit imejengwa kwa njia iliyo kinyume: ukurasa mmoja uliofungwa na safi kwa kila neno, kwenye kiwango cha mtoto, bila njia ya kupotea."},{"q":"Nitajuaje kwamba mtoto wangu anaendelea kweli?","a":"Unapata dashibodi ya mzazi. Kwa jicho moja unaona maneno mangapi kila mtoto amejifunza, mangapi yaliongezwa wiki hii, na maneno yake ya hivi karibuni. Zana nyingine yoyote inamjibu mtoto na kusahau; Gadit huhifadhi kila neno katika daftari binafsi la mtoto, ili uangalie msamiati ukikua wiki baada ya wiki."},{"q":"Ni ya umri gani?","a":"Kiini cha Gadit ni watoto wa umri wa shule, kutoka darasa la kwanza hadi shule ya sekondari. Hali ya Watoto hufafanua kwa urahisi kwa wadogo, na maelezo kamili yanahudumia vijana na wazazi pia. Mzazi ndiye anayefungua akaunti."},{"q":"Je, inasaidia kwa Kiingereza na lugha nyingine?","a":"Sana. Mtoto anaweza kutafuta neno kwa Kiingereza na kupata maelezo rahisi kwa lugha yake mwenyewe, pamoja na picha na mifano, ndiyo hasa msaidizi anayekosekana nyumbani. Na inafanya kazi katika lugha 30+, hivyo mtoto anaweza kupata maelezo kwa lugha unayozungumza nyumbani pia."},{"q":"Inagharimu kiasi gani?","a":"$59 kwa mwaka au $5.99 kwa mwezi, baada ya majaribio ya siku 14. Hakuna ada zilizofichwa, na unaghairi wakati wowote kwa mbofyo mmoja."},{"q":"Ninaweza kuongeza watoto wangapi?","a":"Hadi watoto 5 kwenye mpango mmoja wa Familia, kila mmoja akiwa na wasifu wake, daftari lake na mazoezi yake."},{"q":"Tunaweza kujaribu bila kujitolea?","a":"Ndiyo. Majaribio yanaanza na kadi, lakini malipo ya kwanza hutokea tu wakati siku 14 zinapoisha. Ghairi wakati wowote kabla ya hapo, kwa mbofyo mmoja, na hulipi chochote."}],"finalTitle":"Anza leo, na uangalie msamiati ukikua","finalSub":"Wiki mbili bure. Ghairi kwa mbofyo mmoja. Na mtoto anayejifunza kuelewa maneno peke yake.","finalCta":"Anza majaribio yako ya bure ya siku 14","footerTerms":"Masharti","footerPrivacy":"Faragha"},
  "th": {"heroBadge":"พจนานุกรมภาพอัจฉริยะสำหรับทั้งครอบครัว","whatIs":"Gadit คือพจนานุกรมภาพอัจฉริยะสำหรับเด็ก ทุกคำจะมีคำอธิบายในระดับที่เด็กเข้าใจได้ พร้อมรูปภาพ ตัวอย่างประโยค และเกมกับแบบทดสอบที่ทำให้การเรียนรู้คำศัพท์เป็นเรื่องสนุก คลังคำศัพท์เพิ่มพูนขึ้น ความเข้าใจในการอ่านดีขึ้น และลูกของคุณก็ทำผลงานได้ดีขึ้นที่โรงเรียน","ctaMicro":"","trustLine":"รองรับลูกได้ถึง 5 คน แต่ละคนเรียนในระดับของตัวเอง","credLine":"สร้างขึ้นจากประสบการณ์ 15 ปี กับผู้ปกครอง นักเรียน และนักการศึกษากว่า 15,000 คน","credKicker":"เราคือใคร","credTitle":"15 ปีในวงการการศึกษา รวมไว้ในเครื่องมือเดียวเพื่อลูกของคุณ","credBody":"Gadit สร้างขึ้นโดยทีมที่มีประสบการณ์ 15 ปีในวงการการศึกษา และได้ทำงานกับผู้ปกครอง นักเรียน และนักการศึกษากว่า 15,000 คน สิ่งที่เราเห็นว่าได้ผลครั้งแล้วครั้งเล่า ทั้งในห้องเรียนและที่บ้าน เรานำมารวมไว้ในเครื่องมือง่ายๆ ชิ้นเดียวที่เด็กใช้ได้ด้วยตัวเอง","proofTitle":"สมุดคำศัพท์ · ตัวอย่าง","proofBig":"12 คำใหม่ในสัปดาห์นี้","proofWords":["ความฝัน","ชัดเจน","ลังเล"],"angles":{"vocab":{"h1":"คลังคำศัพท์ของลูกคุณเติบโตขึ้น ทีละคำ","sub":"ทุกคำที่ลูกของคุณสงสัยจะถูกบันทึกลงในสมุดคำศัพท์ส่วนตัวใน Gadit พร้อมรูปภาพ คำอธิบายในระดับที่เด็กเข้าใจ และแบบฝึกสั้นๆ ที่นำคำนั้นกลับมาให้ทบทวนจนกลายเป็นของเขาจริงๆ เปิดสมุดคำศัพท์ในตอนสิ้นเดือน แล้วดูคลังคำศัพท์เติบโตขึ้นทีละคำ"},"relief":{"h1":"เลิกเป็นพจนานุกรมประจำบ้านได้แล้ว","sub":"ตั้งแต่วันนี้ เมื่อลูกถามว่า \"คำนี้แปลว่าอะไร\" เขามีที่เดียวที่หาคำตอบได้ด้วยตัวเอง ทุกความหมาย พร้อมรูปภาพประกอบแต่ละความหมาย และคำอธิบายในระดับที่เด็กเข้าใจ ไม่มีแชทเปิดกว้าง ไม่มีโฆษณา"},"anxiety":{"h1":"ลูกของคุณอ่านทุกคำได้ถูกต้อง แต่ไม่ได้เข้าใจจริงๆ","sub":"เขาไม่ได้หยุดถามเสมอไป เขาข้ามคำที่ไม่เข้าใจไป อ่านต่อ แล้วเนื้อหาก็ไม่ซึมซับ เมื่อเวลาผ่านไป มันกลายเป็นความหงุดหงิดกับโรงเรียนและความรู้สึกว่า \"ฉันทำไม่ได้\" Gadit ให้ลูกของคุณมีที่เดียวที่จะหยุด เข้าใจอย่างแท้จริง แล้วกลับไปเรียนต่อพร้อมคำนั้นในมือ"},"safe":{"h1":"หน้าจอเดียวที่คุณส่งให้ลูกได้อย่างไม่ต้องกังวล","sub":"ไม่มีแชทเปิดกว้าง ไม่มีฟีดไม่รู้จบ ไม่มีโฆษณา ที่เดียวที่สะอาดตา ที่เด็กพิมพ์คำ เข้าใจอย่างเต็มที่ แล้วกลับไปทำการบ้านต่อ"}},"heroCta":"เริ่มทดลองใช้ฟรี 14 วัน","heroTrust":"ไม่มีแชทเปิดกว้าง · ไม่มีโฆษณา · ยกเลิกได้ด้วยคลิกเดียว","ownerCta":"ไปที่พื้นที่ครอบครัวของคุณ","stats":["30+ ภาษา","รูปภาพประกอบทุกความหมาย","ลูกได้ถึง 5 คน","ยกเลิกได้ด้วยคลิกเดียว"],"demoKicker":"ผลลัพธ์","demoTitle":"ลูกของคุณเข้าใจทุกคำ และคลังคำศัพท์ของเขาเติบโตขึ้นทุกวัน","painKicker":"ความเจ็บปวดที่แท้จริง","painTitle":"ลูกของคุณอ่านออก แต่ไม่ได้เข้าใจจริงๆ เสมอไป","painBody1":"จริงๆ แล้วคุณดีใจด้วยซ้ำเมื่อลูกหยุดถามว่าคำหนึ่งแปลว่าอะไร ปัญหาอยู่ที่คำทั้งหมดที่เขาไม่หยุดถาม เขาข้ามมันไป อ่านต่อ แล้วเนื้อหาก็ไม่ซึมซับ คลังคำศัพท์ยังคงบางเบา และความเข้าใจก็ขาดหายไปทีละคำ","painBody2":"และมันส่งผลมากกว่าแค่เกรด เด็กที่ไม่เข้าใจจะรู้สึกว่าตัวเองไม่ดีพอ หงุดหงิดกับโรงเรียน และสูญเสียความมั่นใจ และมันเกิดขึ้นอย่างเงียบๆ โดยไม่มีใครชี้ได้ว่าเส้นด้ายขาดตรงไหน","reframe":"และนี่คือจุดที่ Gadit เข้ามาช่วยพอดี","puzzleKicker":"สิ่งที่เกิดขึ้นในหัวของเด็ก","puzzleTitle":"ข้อความคือจิ๊กซอว์ ทุกคำคือชิ้นส่วนหนึ่ง","puzzleBody":"เมื่อเด็กอ่าน สมองของเขาประกอบภาพทั้งภาพขึ้นมาจากคำต่างๆ ทุกคำที่เขาเข้าใจคือชิ้นส่วนที่ต่อลงล็อกพอดี ทุกคำที่ขาดหายไปคือช่องโหว่ในภาพ แค่สามหรือสี่ช่องโหว่ เด็กก็มองไม่เห็นภาพนั้นอีกต่อไป แม้จะสะกดออกเสียงได้ทุกตัวอักษรก็ตาม","puzzleBefore":"ย่อหน้าที่มีคำหายไป","puzzleAfter":"เมื่อมี Gadit ทุกชิ้นส่วนเข้าที่","puzzleLine":"เมื่อทุกคำชัดเจน เด็กก็มองเห็นภาพทั้งภาพ","chainKicker":"มันทำงานอย่างไร","chainTitle":"ทุกสิ่งที่ลูกของคุณได้รับ ในทุกคำ","chainSteps":["ลูกของคุณพิมพ์คำที่ไม่เข้าใจ","เขาได้คำอธิบายในระดับสายตาของเขา รูปภาพ และตัวอย่างสามประโยค","คำนั้นถูกบันทึกในสมุดส่วนตัวของเขา","และกลับมาในแบบฝึกสั้นๆ จนกลายเป็นของเขาอย่างแท้จริง"],"howBlocks":[{"t":"พิมพ์คำ","b":"ลูกของคุณพิมพ์คำใดก็ได้ที่ไม่เข้าใจ ในโหมดเด็ก ในพื้นที่ที่สะอาดตาและปลอดภัย"},{"t":"คำนิยามที่ชัดเจน","b":"คำอธิบายในระดับสายตาของเด็ก ไม่มีคำยากมาอธิบายคำยาก"},{"t":"ตัวอย่างสามประโยค","b":"ประโยคจริงที่แสดงให้เห็นว่าคำนั้นมีชีวิตอยู่ในข้อความอย่างไร พร้อมรูปภาพ ไม่ใช่แค่คำนิยาม"},{"t":"รูปภาพสำหรับทุกความหมาย","b":"เพราะเด็กจดจำสิ่งที่เห็นได้ดีกว่าสิ่งที่เขียนให้เขามาก"},{"t":"บริบท","b":"วางประโยคจากหนังสือ แล้ว Gadit จะทำเครื่องหมายความหมายที่ตรงกับมันพอดี"},{"t":"สมุดคำศัพท์ส่วนตัว","b":"ทุกคำที่ลูกของคุณค้นหาถูกบันทึกในสมุดของเขา และไม่หนีหายไปไหน"},{"t":"แบบทดสอบสั้นๆ","b":"คำถามสั้นๆ ที่นำคำกลับมาก่อนที่มันจะเลือนหายไป"},{"t":"เกม","b":"เรียนรู้ผ่านการเล่น จากคำที่ลูกของคุณค้นหาด้วยตัวเอง"},{"t":"ฟังมัน แล้วพูดมัน","b":"ลูกของคุณได้ยินคำใดก็ได้และฝึกพูดออกมาดังๆ เพื่อให้รู้สึกเป็นธรรมชาติในการพูด ไม่ใช่แค่การอ่าน"}],"chainCost":"","chainTurnTitle":"และนี่คือสิ่งที่คุณได้รับ","chainTurnBody":"ทุกคำที่ลูกของคุณเคยติดขัดจะกลายเป็นคำที่เขารู้ และคุณเห็นมันชัดเจนขาวดำ ว่าเขาปิดจบไปกี่คำ สัปดาห์แล้วสัปดาห์เล่า แทนที่จะได้แต่หวังว่าบางอย่างกำลังดีขึ้น คุณแค่เฝ้าดูมันเกิดขึ้น","dashKicker":"แดชบอร์ดสำหรับผู้ปกครอง","dashTitle":"คุณเห็นได้อย่างชัดเจนว่าลูกแต่ละคนเรียนรู้ไปมากแค่ไหน","dashBody":"ลูกทุกคนมีสมุดคำศัพท์ส่วนตัวที่เติบโตขึ้น ในแดชบอร์ดของคุณ คุณเห็นได้ในพริบตาว่าลูกแต่ละคนเรียนรู้ไปกี่คำ เพิ่มขึ้นกี่คำในสัปดาห์นี้ และคำล่าสุดของเขา เครื่องมืออื่นๆ ตอบคำถามลูกของคุณแล้วก็ลืม แต่ Gadit จดจำ และคุณเห็นความก้าวหน้าสัปดาห์แล้วสัปดาห์เล่า","dashKids":[{"name":"โนอา","total":47,"week":12},{"name":"อิโด","total":31,"week":8},{"name":"มายา","total":63,"week":15}],"dashWordsLabel":"คำในสมุด","dashWeekLabel":"สัปดาห์นี้","featuresKicker":"มีอะไรอยู่ข้างใน","features":[{"kicker":"ทุกความหมาย","title":"หนึ่งคำ ทุกความหมาย พร้อมรูปภาพประกอบแต่ละความหมาย","body":"หนึ่งคำมักมีหลายความหมายที่แตกต่างกัน และนั่นคือจุดที่เด็กสับสน Gadit แสดงให้เห็นทั้งหมดในที่เดียว แต่ละความหมายพร้อมตัวอย่างจริงสามประโยคและรูปภาพของตัวเอง เพราะสมองของเด็กจดจำภาพได้ดีกว่าคำมาก"},{"kicker":"โหมดเด็ก","title":"คำอธิบายในระดับสายตาของลูกคุณ","body":"สลับสวิตช์เดียว แล้วทุกคำอธิบายกลายเป็นภาษาที่เด็กอายุ 8 ขวบเข้าใจได้จริง ไม่มีคำยากมาอธิบายคำยาก ไม่มีคำนิยามวนไปวนมา มีแค่ความเข้าใจ"},{"kicker":"บริบท","title":"วางประโยค ได้ความหมายที่ถูกต้อง","body":"คำส่วนใหญ่มีมากกว่าหนึ่งความหมาย และนั่นคือจุดที่เด็กหลงทาง วางประโยคจากหนังสือหรือใบงาน แล้ว Gadit จะทำเครื่องหมายว่าความหมายไหนตรงกันพอดี"},{"kicker":"สมุดคำศัพท์ส่วนตัว","title":"คำต่างๆ ไม่หนีหายไป","body":"ทุกคำที่ลูกของคุณค้นหาจะถูกบันทึกลงในสมุดส่วนตัวของเขา และแบบฝึกสั้นๆ อันชาญฉลาดจะนำมันกลับมาก่อนที่มันจะเลือนหายไป นั่นคือวิธีสร้างคลังคำศัพท์อย่างแท้จริง ทีละคำ"},{"kicker":"โปรไฟล์สำหรับลูกแต่ละคน","title":"ลูกทุกคนมีพื้นที่ของตัวเอง","body":"ลูกแต่ละคนในครอบครัวมีโปรไฟล์แยกกัน สมุดของเขา แบบฝึกของเขา ประวัติของเขา โหมดเด็กปรับคำอธิบายให้เรียบง่ายและชัดเจนสำหรับคนตัวเล็ก และเต็มขึ้นสำหรับคนโตกว่า และไม่มีใครไปเหยียบคำของใคร"},{"kicker":"เกมคำศัพท์","title":"เกมการเรียนรู้จากคำของลูกคุณ","body":"แบบทดสอบและเกมสั้นๆ ที่สร้างจากคำที่ลูกของคุณค้นหาจริง เล่นไม่กี่นาที แล้วคลังคำศัพท์ก็เติบโตขึ้นโดยไม่ต้องออกแรง"},{"kicker":"ภาษาที่สอง","title":"ผู้ช่วยทำการบ้านภาษาที่สองที่ดีที่สุด","body":"ลูกของคุณพิมพ์คำเป็นภาษาอังกฤษ แล้วได้คำอธิบายง่ายๆ ในภาษาของเขาเอง พร้อมรูปภาพและตัวอย่าง ไม่ต้องวนไปมาระหว่างพจนานุกรม ตัวแปลภาษา และ YouTube"}],"midCtaTitle":"เริ่มตอนนี้ แล้วดูคลังคำศัพท์ของลูกเติบโตขึ้นวันต่อวัน","midCta":"เริ่มทดลองใช้ฟรี 14 วัน","compareKicker":"ความแตกต่าง","compareTitle":"ทำไมไม่แค่ค้นใน Google หรือถามแชทบอท","compareGadit":"Gadit","compareOther":"อินเทอร์เน็ตที่เปิดกว้าง","compareRows":[{"label":"หน้าเดียวที่สะอาดตาต่อหนึ่งคำ","gadit":true,"other":false},{"label":"คำอธิบายในระดับเด็ก","gadit":true,"other":false},{"label":"รูปภาพประกอบทุกความหมาย","gadit":true,"other":false},{"label":"สมุดและแบบฝึกที่คงอยู่","gadit":true,"other":false},{"label":"โฆษณาและลิงก์เต็มไปหมด","gadit":false,"other":true},{"label":"แชทเปิดกว้างที่ไม่มีขอบเขต","gadit":false,"other":true}],"safeTitle":"พื้นที่แยกที่สะอาดตา ไม่ใช่ประตูไปที่อื่น","safeBody":"Gadit เป็นพื้นที่ปิดสนิท ไม่มีแชทเปิดกว้าง ไม่มีฟีด ไม่มีโฆษณา ไม่มีลิงก์ออกไปข้างนอก เด็กจะไม่ถูกดึงจากที่นี่ไปสู่ TikTok หรือแอปอื่นใด มีสิ่งเดียวที่ทำที่นี่ นั่นคือเข้าใจคำ แล้วกลับไปเรียนต่อ","safeLine":"หน้าจอเดียวที่คุณส่งให้ลูกได้อย่างสบายใจ","stackTitle":"แผนครอบครัวรวมอะไรบ้าง","stackItems":["ค้นหาได้ไม่จำกัดสำหรับทั้งครอบครัว","ทุกความหมาย พร้อมรูปภาพประกอบแต่ละความหมาย","โหมดเด็กสำหรับทุกวัย","ตรวจประโยคพร้อมผลตอบกลับทันที","สมุดคำศัพท์ส่วนตัวและแบบฝึกอัจฉริยะสำหรับลูกแต่ละคน","เกมคำศัพท์และแบบทดสอบ","ลูกได้ถึง 5 คน พร้อมโปรไฟล์แยกกัน","30+ ภาษา พร้อมการรองรับเต็มรูปแบบ"],"priceKicker":"ราคา","priceTitle":"แผนครอบครัว","trialBadge":"ทดลองใช้ฟรี 14 วัน","yearly":"$59 / ปี","yearlyNote":"เท่ากับเดือนละ $4.92 สำหรับทั้งครอบครัว และประหยัดได้เกือบสองเดือนเมื่อเทียบกับการจ่ายรายเดือน","priceAnchor":"น้อยกว่าค่าเรียนพิเศษตัวต่อตัวครั้งเดียว สำหรับทั้งปี สำหรับลูกทุกคนในบ้าน","monthly":"$5.99 / เดือน","billedYearly":"รายปี","billedMonthly":"รายเดือน","yearlySave":"-18%","priceCta":"เริ่มทดลองใช้","cancelNote":"เก็บเงินครั้งแรกหลังจากครบ 14 วันเท่านั้น ยกเลิกได้ทุกเมื่อจากหน้าบัญชีของคุณ ด้วยคลิกเดียว","singleChild":"มีนักเรียนแค่คนเดียวที่บ้านใช่ไหม แผน Deep ราคา $4.99/เดือน จ่ายเพิ่มอีกนิดเดียวก็เพิ่มลูกได้ถึง 5 คน","guaranteeTitle":"บททดสอบของคุณ สองสัปดาห์","guaranteeBody":"ลองใช้จริงสองสัปดาห์ ฟรี ถ้าเมื่อครบวันที่ 14 สมุดคำศัพท์ของลูกยังไม่ได้เก็บคำใหม่อย่างน้อย 20 คำ ยกเลิกด้วยคลิกเดียว แล้วคุณไม่ต้องจ่ายอะไรเลย","faqTitle":"คำถามที่ผู้ปกครองถามกัน","faq":[{"q":"ฉันได้อะไรจาก Gadit บ้าง","a":"ทุกคำที่ลูกของคุณค้นหาจะได้หน้าที่สะอาดตาหนึ่งหน้า ทุกความหมาย คำอธิบายในระดับเด็ก (โหมดเด็ก) ตัวอย่างจริงสามประโยค และรูปภาพประกอบแต่ละความหมาย พร้อมด้วยบริบท (วางประโยคแล้วได้ความหมายที่ถูกต้อง) สมุดคำศัพท์ส่วนตัวพร้อมแบบฝึกอัจฉริยะ เกมคำศัพท์และแบบทดสอบ แดชบอร์ดผู้ปกครองที่แสดงว่าลูกแต่ละคนเรียนรู้ไปมากแค่ไหน ลูกได้ถึง 5 คนบนโปรไฟล์แยกกัน ทั้งหมดใน 30+ ภาษา ในพื้นที่ปิดที่ปลอดภัย ไม่มีแชทเปิดกว้างและไม่มีโฆษณา"},{"q":"ทำไมไม่แค่ถามแชทบอทหรือ Google","a":"เพราะสิ่งเหล่านั้นเป็นเครื่องมือสำหรับผู้ใหญ่ Google แสดงโฆษณาและลิงก์เต็มไปหมด และแชทบอทที่เปิดกว้างคือบทสนทนาไร้ขอบเขตที่ไม่มีผู้ปกครองคนไหนปล่อยให้ลูกอยู่คนเดียว Gadit สร้างขึ้นในทางกลับกัน หนึ่งหน้าที่ปิดและสะอาดตาต่อหนึ่งคำ ในระดับเด็ก ไม่มีทางหลงทาง"},{"q":"ฉันจะรู้ได้อย่างไรว่าลูกกำลังก้าวหน้าจริงๆ","a":"คุณจะได้แดชบอร์ดสำหรับผู้ปกครอง คุณเห็นได้ในพริบตาว่าลูกแต่ละคนเรียนรู้ไปกี่คำ เพิ่มขึ้นกี่คำในสัปดาห์นี้ และคำล่าสุดของเขา เครื่องมืออื่นๆ ตอบคำถามลูกแล้วก็ลืม แต่ Gadit บันทึกทุกคำในสมุดส่วนตัวของลูก คุณจึงได้เฝ้าดูคลังคำศัพท์เติบโตขึ้นสัปดาห์แล้วสัปดาห์เล่า"},{"q":"เหมาะกับวัยไหน","a":"หัวใจของ Gadit คือเด็กวัยเรียน ตั้งแต่ประถมหนึ่งไปจนถึงมัธยมปลาย โหมดเด็กอธิบายอย่างเรียบง่ายสำหรับเด็กเล็ก และคำอธิบายฉบับเต็มก็ตอบโจทย์วัยรุ่นและผู้ปกครองด้วยเช่นกัน ผู้ปกครองเป็นคนเปิดบัญชี"},{"q":"ช่วยเรื่องภาษาอังกฤษและภาษาอื่นๆ ไหม","a":"ช่วยมาก เด็กสามารถค้นหาคำเป็นภาษาอังกฤษแล้วได้คำอธิบายง่ายๆ ในภาษาของเขาเอง พร้อมรูปภาพและตัวอย่าง นี่คือผู้ช่วยที่ขาดหายไปที่บ้านพอดี และมันใช้ได้ใน 30+ ภาษา ลูกจึงได้คำอธิบายในภาษาที่คุณพูดกันที่บ้านได้ด้วย"},{"q":"ราคาเท่าไร","a":"$59 ต่อปี หรือ $5.99 ต่อเดือน หลังจากทดลองใช้ 14 วัน ไม่มีค่าธรรมเนียมแอบแฝง และคุณยกเลิกได้ทุกเมื่อด้วยคลิกเดียว"},{"q":"ฉันเพิ่มลูกได้กี่คน","a":"ได้ถึง 5 คนบนแผนครอบครัวเดียว แต่ละคนมีโปรไฟล์ สมุด และแบบฝึกของตัวเอง"},{"q":"เราลองใช้โดยไม่ผูกมัดได้ไหม","a":"ได้ การทดลองใช้เริ่มต้นด้วยการผูกบัตร แต่การเก็บเงินครั้งแรกจะเกิดขึ้นเมื่อครบ 14 วันเท่านั้น ยกเลิกได้ทุกเมื่อก่อนหน้านั้น ด้วยคลิกเดียว แล้วคุณไม่ต้องจ่ายอะไรเลย"}],"finalTitle":"เริ่มวันนี้ แล้วดูคลังคำศัพท์เติบโตขึ้น","finalSub":"ฟรีสองสัปดาห์ ยกเลิกได้ด้วยคลิกเดียว และลูกที่เรียนรู้ที่จะเข้าใจคำต่างๆ ด้วยตัวเอง","finalCta":"เริ่มทดลองใช้ฟรี 14 วัน","footerTerms":"ข้อกำหนด","footerPrivacy":"ความเป็นส่วนตัว"},
  "vi": {"heroBadge":"Từ điển thông minh, trực quan cho cả gia đình","whatIs":"Gadit là từ điển thông minh, trực quan dành cho trẻ: mỗi từ đều có lời giải thích phù hợp với trẻ, một hình ảnh, ví dụ, cùng các trò chơi và bài đố giúp việc học từ trở nên thú vị. Vốn từ lớn dần, khả năng đọc hiểu tốt lên, và con bạn học tốt hơn ở trường.","ctaMicro":"","trustLine":"Tối đa 5 bé, mỗi bé một trình độ riêng","credLine":"Xây dựng trên 15 năm kinh nghiệm cùng hơn 15.000 phụ huynh, học sinh và nhà giáo dục","credKicker":"Chúng tôi là ai","credTitle":"15 năm trong giáo dục. Giờ gói gọn trong một công cụ cho con bạn.","credBody":"Gadit được xây dựng bởi một đội ngũ có 15 năm kinh nghiệm trong giáo dục, đã làm việc với hơn 15.000 phụ huynh, học sinh và nhà giáo dục. Những gì chúng tôi thấy phát huy hiệu quả hết lần này đến lần khác, cả trong lớp học lẫn ở nhà, chúng tôi đưa hết vào một công cụ đơn giản mà trẻ có thể tự dùng.","proofTitle":"Sổ từ vựng · ví dụ","proofBig":"12 từ mới trong tuần này","proofWords":["giấc mơ","sống động","ngần ngại"],"angles":{"vocab":{"h1":"Vốn từ của con bạn lớn dần. Từng từ một.","sub":"Mỗi từ con bạn thắc mắc đều được lưu vào sổ từ vựng cá nhân trong Gadit: kèm một hình ảnh, lời giải thích phù hợp với trẻ, và bài luyện tập ngắn giúp từ đó quay lại cho đến khi nó thực sự thuộc về con. Mở sổ vào cuối tháng và ngắm vốn từ lớn lên, từng từ một."},"relief":{"h1":"Đừng làm cuốn từ điển của cả nhà nữa","sub":"Từ hôm nay, khi con hỏi \"cái này nghĩa là gì?\", con có một nơi duy nhất để tự tìm câu trả lời: mọi nghĩa, một hình ảnh cho mỗi nghĩa, và lời giải thích ở mức của trẻ. Không có chat mở, không quảng cáo."},"anxiety":{"h1":"Con bạn đọc đúng từng chữ, nhưng không thực sự hiểu","sub":"Con không phải lúc nào cũng dừng lại để hỏi. Con bỏ qua một từ không hiểu, đọc tiếp, và bài học không đọng lại. Theo thời gian, điều đó biến thành sự chán nản với trường lớp và cảm giác \"mình không làm được\". Gadit cho con bạn một nơi để dừng lại, thực sự hiểu, rồi quay lại bài học với từ đó nằm gọn trong tay."},"safe":{"h1":"Màn hình duy nhất bạn có thể đưa cho con mà không phải lo lắng","sub":"Không có chat mở. Không có bảng tin bất tận. Không quảng cáo. Một nơi gọn gàng để trẻ gõ một từ, hiểu trọn vẹn, rồi quay lại làm bài tập."}},"heroCta":"Bắt đầu 14 ngày dùng thử miễn phí","heroTrust":"Không chat mở · Không quảng cáo · Hủy chỉ với một cú nhấp","ownerCta":"Vào không gian gia đình của bạn","stats":["30+ ngôn ngữ","Một hình ảnh cho mỗi nghĩa","Tối đa 5 bé","Hủy chỉ với một cú nhấp"],"demoKicker":"Kết quả","demoTitle":"Con bạn hiểu từng từ, và vốn từ lớn lên mỗi ngày","painKicker":"Nỗi đau thật sự","painTitle":"Con bạn đọc, nhưng không phải lúc nào cũng thực sự hiểu","painBody1":"Thật ra bạn nên mừng khi con dừng lại hỏi một từ có nghĩa gì. Vấn đề nằm ở tất cả những từ con không dừng lại để hỏi. Con bỏ qua chúng, đọc tiếp, và bài học không đọng lại. Vốn từ vẫn mỏng, và khả năng hiểu đứt gãy từ này qua từ khác.","painBody2":"Và điều đó ảnh hưởng xa hơn một điểm số rất nhiều. Một đứa trẻ không hiểu bài sẽ cảm thấy mình chưa đủ giỏi, chán nản với trường lớp, và mất tự tin. Chuyện đó diễn ra lặng lẽ, chẳng ai chỉ ra được sợi dây đứt ở đâu.","reframe":"Và đây chính là lúc Gadit bước vào.","puzzleKicker":"Điều diễn ra trong đầu một đứa trẻ","puzzleTitle":"Một đoạn văn là một bức ghép hình. Mỗi từ là một mảnh.","puzzleBody":"Khi một đứa trẻ đọc, trí óc con ghép nên một bức tranh trọn vẹn từ các từ ngữ. Mỗi từ con hiểu là một mảnh khớp vào đúng chỗ. Mỗi từ còn thiếu là một lỗ hổng trong bức tranh. Chỉ ba bốn lỗ hổng thôi, và đứa trẻ không còn thấy bức tranh nữa, dù đã đánh vần đúng từng chữ cái.","puzzleBefore":"Một đoạn văn với những từ còn thiếu","puzzleAfter":"Với Gadit, mọi mảnh đều vào đúng chỗ","puzzleLine":"Khi mọi từ đều rõ ràng, đứa trẻ nhìn thấy trọn bức tranh.","chainKicker":"Cách hoạt động","chainTitle":"Mọi thứ con bạn nhận được, trên mỗi từ","chainSteps":["Con bạn gõ một từ con không hiểu","Con nhận được lời giải thích ngang tầm mắt của mình, một hình ảnh và ba ví dụ","Từ đó được lưu vào sổ tay cá nhân của con","Và quay lại trong bài luyện tập ngắn, cho đến khi nó thực sự thuộc về con"],"howBlocks":[{"t":"Gõ từ","b":"Con bạn gõ bất kỳ từ nào con không hiểu, trong Chế độ Trẻ em, ở một nơi gọn gàng và an toàn."},{"t":"Một định nghĩa rõ ràng","b":"Lời giải thích ngang tầm mắt của trẻ, không dùng từ khó để giải nghĩa từ khó."},{"t":"Ba ví dụ","b":"Những câu thật cho thấy từ đó sống ra sao trong một đoạn văn, kèm hình ảnh, chứ không chỉ một định nghĩa."},{"t":"Một hình ảnh cho mỗi nghĩa","b":"Bởi trẻ nhớ điều mình nhìn thấy tốt hơn nhiều so với điều được viết ra cho mình."},{"t":"Ngữ cảnh","b":"Dán một câu trong sách vào và Gadit đánh dấu đúng cái nghĩa phù hợp với câu đó."},{"t":"Một cuốn sổ tay cá nhân","b":"Mọi từ con bạn tra đều được lưu vào sổ tay của con, và không chạy mất."},{"t":"Một bài đố ngắn","b":"Một câu hỏi nhanh đưa từ đó quay lại ngay trước khi nó trôi đi."},{"t":"Một trò chơi","b":"Học qua chơi, với chính những từ con bạn đã tra."},{"t":"Nghe, và nói ra","b":"Con bạn nghe bất kỳ từ nào và luyện nói to, để việc nói trở nên tự nhiên, không chỉ để đọc."}],"chainCost":"","chainTurnTitle":"Và đây là điều bạn nhận được","chainTurnBody":"Mỗi từ con bạn từng vướng mắc trở thành một từ con biết, và bạn thấy rõ mồn một: con đã hoàn thành bao nhiêu từ, tuần này qua tuần khác. Thay vì hy vọng có điều gì đó đang tiến bộ, bạn chỉ việc ngắm nó diễn ra.","dashKicker":"Bảng điều khiển của phụ huynh","dashTitle":"Bạn thấy chính xác mỗi bé đã học được bao nhiêu","dashBody":"Mỗi bé có một cuốn sổ từ vựng cá nhân lớn dần. Trong bảng điều khiển, bạn thấy ngay trong nháy mắt mỗi bé đã học bao nhiêu từ, tuần này thêm bao nhiêu, và những từ mới nhất của bé. Bất kỳ công cụ nào khác trả lời con bạn rồi quên. Gadit ghi nhớ, và bạn thấy sự tiến bộ tuần này qua tuần khác.","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"từ trong sổ tay","dashWeekLabel":"tuần này","featuresKicker":"Bên trong có gì","features":[{"kicker":"Mọi nghĩa","title":"Một từ. Mọi nghĩa. Một hình ảnh cho mỗi nghĩa.","body":"Một từ thường mang nhiều nghĩa khác nhau, và đó chính là chỗ trẻ hay bị nhầm lẫn. Gadit hiện tất cả ở một nơi, mỗi nghĩa kèm ba ví dụ thật và hình ảnh riêng, bởi trí óc trẻ nhớ hình ảnh tốt hơn từ ngữ rất nhiều."},{"kicker":"Chế độ Trẻ em","title":"Lời giải thích ngang tầm mắt con bạn","body":"Một cú gạt, và mọi lời giải thích chuyển thành ngôn ngữ mà một đứa trẻ 8 tuổi thực sự hiểu. Không dùng từ khó để giải nghĩa từ khó, không có định nghĩa vòng vo. Chỉ có sự thấu hiểu."},{"kicker":"Ngữ cảnh","title":"Dán một câu, nhận đúng nghĩa","body":"Phần lớn các từ có nhiều hơn một nghĩa, và đó là chỗ trẻ hay lạc lối. Dán câu trong sách hoặc phiếu bài tập vào, và Gadit đánh dấu chính xác nghĩa nào phù hợp."},{"kicker":"Sổ tay cá nhân","title":"Những từ không chạy mất","body":"Mỗi từ con bạn tra đều rơi vào sổ tay cá nhân của con, và bài luyện tập ngắn, thông minh đưa nó quay lại ngay trước khi nó trôi đi. Vốn từ được xây dựng thật sự là như vậy, mỗi lần một từ."},{"kicker":"Một hồ sơ cho mỗi bé","title":"Mỗi bé có không gian riêng của mình","body":"Mỗi bé trong gia đình có một hồ sơ riêng: sổ tay của bé, bài luyện tập của bé, lịch sử của bé. Chế độ Trẻ em điều chỉnh lời giải thích, đơn giản và rõ ràng cho các bé nhỏ và đầy đủ hơn cho các bé lớn, và không ai giẫm lên từ của ai."},{"kicker":"Trò chơi từ vựng","title":"Trò chơi học tập trên chính những từ của con bạn","body":"Những bài đố và trò chơi ngắn dựng nên từ chính những từ con bạn đã tra. Vài phút chơi, và vốn từ lớn lên mà không tốn công sức."},{"kicker":"Ngôn ngữ thứ hai","title":"Trợ thủ làm bài tập ngôn ngữ thứ hai tốt nhất","body":"Con bạn gõ một từ tiếng Anh và nhận lời giải thích đơn giản bằng tiếng của con, kèm hình ảnh và ví dụ. Không phải lang thang giữa từ điển, công cụ dịch và YouTube."}],"midCtaTitle":"Bắt đầu ngay, và ngắm vốn từ của con bạn lớn lên từng ngày","midCta":"Bắt đầu 14 ngày dùng thử miễn phí","compareKicker":"Sự khác biệt","compareTitle":"Tại sao không chỉ tra Google hay hỏi chatbot?","compareGadit":"Gadit","compareOther":"Internet mở","compareRows":[{"label":"Một trang gọn gàng cho mỗi từ","gadit":true,"other":false},{"label":"Lời giải thích ở mức của trẻ","gadit":true,"other":false},{"label":"Một hình ảnh cho mỗi nghĩa","gadit":true,"other":false},{"label":"Sổ tay và bài luyện tập giúp từ đọng lại","gadit":true,"other":false},{"label":"Quảng cáo và liên kết đủ mọi hướng","gadit":false,"other":true},{"label":"Trò chuyện mở không giới hạn","gadit":false,"other":true}],"safeTitle":"Một khu vực riêng, gọn gàng. Không phải cánh cửa dẫn đi đâu khác.","safeBody":"Gadit là một không gian hoàn toàn khép kín: không chat mở, không bảng tin, không quảng cáo, không liên kết ra ngoài. Trẻ không bị kéo từ đây sang TikTok hay bất kỳ ứng dụng nào khác. Ở đây chỉ có một việc để làm: hiểu một từ, rồi quay lại học bài.","safeLine":"Một màn hình bạn có thể đưa cho con với tâm trí thảnh thơi.","stackTitle":"Gói Gia đình bao gồm những gì","stackItems":["Tra không giới hạn cho cả gia đình","Mọi nghĩa, kèm một hình ảnh cho mỗi nghĩa","Chế độ Trẻ em cho mọi lứa tuổi","Kiểm tra câu với phản hồi tức thì","Sổ tay cá nhân và bài luyện tập thông minh cho mỗi bé","Trò chơi từ vựng và bài đố","Tối đa 5 bé với hồ sơ riêng","30+ ngôn ngữ được hỗ trợ đầy đủ"],"priceKicker":"Giá","priceTitle":"Gói Gia đình","trialBadge":"14 ngày dùng thử miễn phí","yearly":"$59 / năm","yearlyNote":"tức là $4.92 mỗi tháng cho cả gia đình, và giúp bạn tiết kiệm gần hai tháng so với trả theo tháng","priceAnchor":"Ít hơn một buổi học kèm riêng, cho trọn một năm, cho mỗi bé trong nhà","monthly":"$5.99 / tháng","billedYearly":"Theo năm","billedMonthly":"Theo tháng","yearlySave":"-18%","priceCta":"Bắt đầu dùng thử","cancelNote":"Chỉ tính phí lần đầu sau 14 ngày. Hủy bất cứ lúc nào từ trang tài khoản của bạn, chỉ một cú nhấp.","singleChild":"Chỉ có một học sinh ở nhà? Gói Deep là $4.99/tháng. Thêm một chút nữa là bạn có thể thêm tối đa 5 bé.","guaranteeTitle":"Bài kiểm tra của bạn: hai tuần","guaranteeBody":"Hãy dùng thật hai tuần, miễn phí. Nếu đến ngày thứ 14 mà sổ tay của con bạn chưa gom được ít nhất 20 từ mới, hãy hủy chỉ với một cú nhấp và bạn không phải trả gì cả.","faqTitle":"Những câu phụ huynh hay hỏi","faq":[{"q":"Tôi nhận được gì với Gadit?","a":"Mỗi từ con bạn tra đều có một trang gọn gàng: mọi nghĩa, lời giải thích ở mức của trẻ (Chế độ Trẻ em), ba ví dụ thật, và một hình ảnh cho mỗi nghĩa. Cùng với đó là ngữ cảnh (dán một câu và nhận đúng nghĩa), một cuốn sổ từ vựng cá nhân với bài luyện tập thông minh, trò chơi từ vựng và bài đố, một bảng điều khiển cho phụ huynh cho thấy mỗi bé đã học được bao nhiêu, tối đa 5 bé trên các hồ sơ riêng, tất cả bằng 30+ ngôn ngữ, trong một không gian khép kín, an toàn, không chat mở và không quảng cáo."},{"q":"Tại sao không chỉ hỏi chatbot hay Google?","a":"Bởi đó là những công cụ dành cho người lớn. Google trả về quảng cáo và liên kết đủ mọi hướng, còn một chatbot mở là cuộc trò chuyện không ranh giới mà không phụ huynh nào để con một mình bước vào. Gadit được xây dựng theo hướng ngược lại: một trang khép kín, gọn gàng cho mỗi từ, ở mức của trẻ, không có cách nào để lạc lối."},{"q":"Làm sao tôi biết con mình thực sự tiến bộ?","a":"Bạn có một bảng điều khiển cho phụ huynh. Chỉ trong nháy mắt, bạn thấy mỗi bé đã học bao nhiêu từ, tuần này thêm bao nhiêu, và những từ mới nhất của bé. Mọi công cụ khác trả lời con rồi quên; Gadit lưu mọi từ vào sổ tay cá nhân của con, nên bạn ngắm vốn từ lớn lên tuần này qua tuần khác."},{"q":"Dành cho độ tuổi nào?","a":"Trọng tâm của Gadit là trẻ trong độ tuổi đến trường, từ lớp một đến hết trung học. Chế độ Trẻ em giải thích đơn giản cho các bé nhỏ, còn phần giải thích đầy đủ phục vụ cả thiếu niên và phụ huynh. Phụ huynh là người mở tài khoản."},{"q":"Nó có giúp học tiếng Anh và các ngôn ngữ khác không?","a":"Rất nhiều. Một đứa trẻ có thể tra một từ tiếng Anh và nhận lời giải thích đơn giản bằng tiếng của mình, kèm hình ảnh và ví dụ, đúng là trợ thủ còn thiếu ở nhà. Và nó hoạt động với 30+ ngôn ngữ, nên trẻ cũng có thể nhận lời giải thích bằng chính ngôn ngữ bạn nói ở nhà."},{"q":"Giá bao nhiêu?","a":"$59 một năm hoặc $5.99 một tháng, sau 14 ngày dùng thử. Không phí ẩn, và bạn hủy bất cứ lúc nào chỉ với một cú nhấp."},{"q":"Tôi có thể thêm bao nhiêu bé?","a":"Tối đa 5 bé trên một gói Gia đình, mỗi bé có hồ sơ, sổ tay và bài luyện tập riêng."},{"q":"Chúng tôi có thể thử mà chưa cam kết không?","a":"Có. Bản dùng thử bắt đầu bằng một thẻ, nhưng lần tính phí đầu tiên chỉ diễn ra khi 14 ngày kết thúc. Hủy bất cứ lúc nào trước đó, chỉ một cú nhấp, và bạn không phải trả gì."}],"finalTitle":"Bắt đầu hôm nay, và ngắm vốn từ lớn lên","finalSub":"Hai tuần miễn phí. Hủy chỉ một cú nhấp. Và một đứa trẻ học được cách tự mình hiểu từ ngữ.","finalCta":"Bắt đầu 14 ngày dùng thử miễn phí","footerTerms":"Điều khoản","footerPrivacy":"Quyền riêng tư"},
  "zh-CN": {"heroBadge":"为全家打造的可视化智能词典","whatIs":"Gadit 是一款为孩子设计的可视化智能词典：每个词都有孩子看得懂的讲解、配图、例句，还有让学词变得有趣的游戏和小测验。词汇量涨上去，阅读理解跟着变好，孩子在学校也更出色。","ctaMicro":"","trustLine":"最多 5 个孩子，各按自己的水平学","credLine":"背后是 15 年的经验，服务过超过 15,000 位家长、学生和教育工作者","credKicker":"关于我们","credTitle":"深耕教育 15 年，如今浓缩成一款给孩子的工具。","credBody":"Gadit 由一支拥有 15 年教育经验的团队打造，我们服务过超过 15,000 位家长、学生和教育工作者。在课堂上和家庭里一次次被验证有效的做法，我们都放进了这一款孩子能自己上手的简单工具里。","proofTitle":"生词本 · 示例","proofBig":"本周新增 12 个词","proofWords":["梦想","鲜明","犹豫"],"angles":{"vocab":{"h1":"孩子的词汇量一个词一个词地涨起来。","sub":"孩子问到的每一个词，都会落进他们在 Gadit 里的专属生词本：配一张图、一段孩子看得懂的讲解，还有把词一次次带回来、直到真正掌握的简短练习。月底翻开生词本，看着词汇量一个词一个词地长大。"},"relief":{"h1":"别再当全家的活词典","sub":"从今天起，孩子再问“这是什么意思？”，他们有一个地方能自己找到答案：每个含义、每个含义配一张图，还有孩子看得懂的讲解。没有开放式聊天，没有广告。"},"anxiety":{"h1":"孩子每个字都读对了，却没真正读懂","sub":"他们不总是停下来问。碰到不懂的词就跳过去接着读，内容也就吸收不进去。时间一长，就变成了对学校的挫败感和一句“我不行”。Gadit 给孩子一个地方，停下来、真正弄懂、再带着这个词回到课本里。"},"safe":{"h1":"唯一一块你能放心交给孩子的屏幕","sub":"没有开放式聊天。没有刷不完的信息流。没有广告。就一个干净的地方，孩子输入一个词，彻底弄懂它，再回去写作业。"}},"heroCta":"开启 14 天免费试用","heroTrust":"没有开放式聊天 · 没有广告 · 一键取消","ownerCta":"进入你的家庭空间","stats":["30+ 种语言","每个含义一张图","最多 5 个孩子","一键取消"],"demoKicker":"结果","demoTitle":"孩子读懂每一个词，词汇量天天在涨","painKicker":"真正的痛点","painTitle":"孩子在读，却不总是真正读懂","painBody1":"孩子停下来问一个词是什么意思，其实你还挺高兴的。问题出在那些他们没停下来问的词。他们跳过去，接着读，内容却吸收不进去。词汇量一直单薄，理解也一个词一个词地断掉。","painBody2":"而这影响的远不止一个分数。读不懂的孩子会觉得自己不够好，对学校越来越挫败，慢慢失去信心。而这一切悄无声息地发生，没人说得清那根线是从哪儿断的。","reframe":"而这，正是 Gadit 登场的地方。","puzzleKicker":"孩子脑子里发生了什么","puzzleTitle":"一段文字就是一幅拼图。每个词都是一块。","puzzleBody":"孩子在阅读时，脑子会用一个个词拼出一整幅画面。每读懂一个词，就有一块拼图卡到位。每漏掉一个词，画面上就多一个洞。只要三四个洞，孩子就再也看不清整幅画面了，哪怕每个字母都念得出来。","puzzleBefore":"一段缺词的文字","puzzleAfter":"有了 Gadit，每一块都到位","puzzleLine":"每个词都清晰了，孩子就看得见整幅画面。","chainKicker":"运作方式","chainTitle":"每一个词，孩子都能得到这一切","chainSteps":["孩子输入一个不懂的词","得到一段与他视线齐平的讲解、一张图和三个例句","这个词被存进他的专属生词本","再通过简短练习回到眼前，直到真正属于他"],"howBlocks":[{"t":"输入词语","b":"孩子在“儿童模式”里，在一个干净又安全的地方，输入任何不懂的词。"},{"t":"清晰的释义","b":"一段与孩子视线齐平的讲解，不用难词去解释难词。"},{"t":"三个例句","b":"真实的句子，配上图片，展示这个词在一段文字里是怎么活起来的，而不只是一条干巴巴的释义。"},{"t":"每个含义一张图","b":"因为孩子记住看到的，远比记住写给他们的要牢得多。"},{"t":"上下文","b":"把书里的句子粘进来，Gadit 会正好标出适合它的那个含义。"},{"t":"专属生词本","b":"孩子查过的每个词都存进生词本里，跑不掉。"},{"t":"简短小测验","b":"在词快要溜走之前，用一道小问题把它拉回来。"},{"t":"一个游戏","b":"用孩子自己查过的词，在玩中学。"},{"t":"听一听，说一说","b":"孩子能听到任何一个词，再练着大声说出来，让开口说变得自然，而不只是会读。"}],"chainCost":"","chainTurnTitle":"而你得到的是这些","chainTurnBody":"每一个曾经卡住孩子的词，都变成了他认识的词，而且你看得清清楚楚：他一周又一周攻下了多少个词。不用再指望着“好像有在进步”，你就是亲眼看着它发生。","dashKicker":"家长看板","dashTitle":"你清楚看到每个孩子究竟学了多少","dashBody":"每个孩子都有一本不断变厚的专属生词本。在你的看板上，一眼就能看到每个孩子学了多少词、本周新增了多少、以及最近学的几个词。别的工具答完孩子就忘了。Gadit 会记住，而你能一周又一周地看着进步。","dashKids":[{"name":"诺雅","total":47,"week":12},{"name":"伊多","total":31,"week":8},{"name":"玛雅","total":63,"week":15}],"dashWordsLabel":"生词本里的词","dashWeekLabel":"本周","featuresKicker":"里面都有什么","features":[{"kicker":"每一个含义","title":"一个词。所有含义。每个含义一张图。","body":"一个词往往有好几个不同的含义，孩子常常就是在这里犯糊涂。Gadit 把它们全放在一处，每个含义配三个真实例句和一张专属图片，因为孩子的大脑记住图像，远比记住文字要牢得多。"},{"kicker":"儿童模式","title":"与孩子视线齐平的讲解","body":"轻轻一按，每段讲解都变成 8 岁孩子真正听得懂的语言。不用难词解释难词，也没有绕来绕去的循环定义。就是让孩子懂。"},{"kicker":"上下文","title":"粘一句话进来，得到正确的含义","body":"大多数词都不止一个含义，孩子往往就在这里迷路。把书上或练习册上的句子粘进来，Gadit 会正好标出哪个含义才对。"},{"kicker":"专属生词本","title":"词跑不掉了","body":"孩子查过的每个词都落进他的专属生词本，简短又聪明的练习会在词快溜走之前把它拉回来。词汇量就是这样一个词一个词真正搭起来的。"},{"kicker":"每个孩子一份档案","title":"每个孩子都有自己的空间","body":"家里的每个孩子都有独立的档案：自己的生词本、自己的练习、自己的记录。儿童模式会调整讲解，给小的简单清楚，给大的更完整，谁也不会踩到谁的词。"},{"kicker":"词语游戏","title":"用孩子自己的词做的学习游戏","body":"简短的小测验和游戏，都用孩子真正查过的词做成。玩上几分钟，词汇量在不知不觉中就涨了。"},{"kicker":"第二语言","title":"第二语言作业的最佳帮手","body":"孩子输入一个英文词，就能用自己的语言得到简单的讲解，还有配图和例句。不用在词典、翻译和 YouTube 之间来回打转。"}],"midCtaTitle":"现在就开始，看着孩子的词汇量一天天涨起来","midCta":"开启 14 天免费试用","compareKicker":"区别在哪","compareTitle":"为什么不直接谷歌一下，或者问问聊天机器人？","compareGadit":"Gadit","compareOther":"开放的互联网","compareRows":[{"label":"每个词一个干净的页面","gadit":true,"other":false},{"label":"孩子看得懂的讲解","gadit":true,"other":false},{"label":"每个含义一张图","gadit":true,"other":false},{"label":"记得住的生词本和练习","gadit":true,"other":false},{"label":"满屏乱窜的广告和链接","gadit":false,"other":true},{"label":"毫无边界的开放式聊天","gadit":false,"other":true}],"safeTitle":"一块独立、干净的区域。不是通往别处的入口。","safeBody":"Gadit 是一个完全封闭的空间：没有开放式聊天，没有信息流，没有广告，没有外链。孩子不会从这里被拽进 TikTok 或别的应用。这里只有一件事可做：弄懂一个词，然后回去学习。","safeLine":"一块你能安心交给孩子的屏幕。","stackTitle":"家庭套餐都包含什么","stackItems":["全家不限次数查词","每个含义，各配一张图","覆盖各个年龄的儿童模式","句子检查，即时反馈","每个孩子一本专属生词本和聪明练习","词语游戏和小测验","最多 5 个孩子，各有独立档案","30+ 种语言，全面支持"],"priceKicker":"价格","priceTitle":"家庭套餐","trialBadge":"14 天免费试用","yearly":"$59 / 年","yearlyNote":"折合全家每月 $4.92，比按月付费省下近两个月","priceAnchor":"一整年，家里每个孩子都能用，还不到一节私教课的钱","monthly":"$5.99 / 月","billedYearly":"按年","billedMonthly":"按月","yearlySave":"-18%","priceCta":"开始试用","cancelNote":"试用满 14 天才首次扣费。随时可在账户页面一键取消。","singleChild":"家里只有一个学生？Deep 套餐每月 $4.99。再加一点点，就能加到最多 5 个孩子。","guaranteeTitle":"给你的考验：两周","guaranteeBody":"拿两周真正用一用，免费。如果到第 14 天，孩子的生词本还没攒下至少 20 个新词，一键取消，你一分钱都不用付。","faqTitle":"家长常问的问题","faq":[{"q":"用 Gadit 我能得到什么？","a":"孩子查的每个词都会有一个干净的页面：所有含义、孩子看得懂的讲解（儿童模式）、三个真实例句，以及每个含义一张图。还有上下文（粘一句话就能得到正确含义）、带聪明练习的专属生词本、词语游戏和小测验、显示每个孩子学了多少的家长看板、最多 5 个孩子各用独立档案，全部支持 30+ 种语言，都在一个没有开放式聊天、没有广告的封闭安全空间里。"},{"q":"为什么不直接问聊天机器人或谷歌？","a":"因为那些是给大人用的工具。谷歌返回的是满屏乱窜的广告和链接，而开放式聊天机器人是一场没有边界的对话，没有哪个家长会放心把孩子单独留在里面。Gadit 反其道而行：每个词一个封闭、干净的页面，孩子看得懂，没有任何走丢的可能。"},{"q":"我怎么知道孩子真的在进步？","a":"你会有一个家长看板。一眼就能看到每个孩子学了多少词、本周新增了多少、以及最近学的几个词。别的工具答完孩子就忘了；Gadit 把每个词都存进孩子的专属生词本，你就能一周又一周地看着词汇量涨起来。"},{"q":"它适合什么年龄？","a":"Gadit 的核心是学龄孩子，从一年级到高中。儿童模式给小的孩子讲得简单，完整的讲解也照顾到青少年和家长。账户由家长开通。"},{"q":"它对英语和其他语言有帮助吗？","a":"很有帮助。孩子可以查一个英文词，用自己的语言得到简单的讲解，还有配图和例句，正好是家里缺的那个帮手。而且它支持 30+ 种语言，孩子也能用你们家里说的那种语言得到讲解。"},{"q":"多少钱？","a":"每年 $59，或每月 $5.99，都在 14 天试用之后。没有隐藏费用，随时可一键取消。"},{"q":"我能加几个孩子？","a":"一个家庭套餐最多加 5 个孩子，每人都有自己的档案、生词本和练习。"},{"q":"可以先试试再决定吗？","a":"可以。试用需要绑一张卡，但首次扣费只在 14 天结束时才发生。在那之前随时一键取消，你一分钱都不用付。"}],"finalTitle":"今天就开始，看着词汇量涨起来","finalSub":"免费两周。一键取消。还有一个学会自己读懂词语的孩子。","finalCta":"开启 14 天免费试用","footerTerms":"条款","footerPrivacy":"隐私"},
  "zh-TW": {"heroBadge":"為全家人打造的視覺化智慧字典","whatIs":"Gadit 是專為孩子設計的智慧視覺字典：每個字都有適合孩子的解釋、圖片、例句，還有讓學單字變好玩的遊戲和測驗。詞彙量不斷成長，閱讀理解力愈來愈好，孩子在學校也表現得更出色。","ctaMicro":"","trustLine":"最多 5 位孩子，各自依自己的程度學習","credLine":"奠基於 15 年經驗，服務過超過 15,000 位家長、學生與教育工作者","credKicker":"關於我們","credTitle":"15 年教育經驗，如今化為一個為你孩子而生的工具。","credBody":"Gadit 由一支擁有 15 年教育經驗的團隊打造，我們曾與超過 15,000 位家長、學生和教育工作者合作。那些在課堂上、在家裡一次又一次證明有效的做法，我們把它們濃縮成一個孩子能自己使用的簡單工具。","proofTitle":"單字筆記本 · 範例","proofBig":"本週學會 12 個新字","proofWords":["夢想","鮮明","猶豫"],"angles":{"vocab":{"h1":"孩子的詞彙量,一個字一個字地成長。","sub":"孩子問過的每個字,都會進到他在 Gadit 裡的專屬單字筆記本:附上圖片、適合孩子的解釋,還有把這個字反覆帶回來、直到真正變成他的短練習。月底翻開筆記本,親眼看著詞彙量一個字一個字地成長。"},"relief":{"h1":"別再當家裡的活字典","sub":"從今天起,當孩子問「這是什麼意思?」,他有一個地方可以自己找到答案:每一個意思、每個意思配一張圖片,還有適合孩子程度的解釋。沒有開放式聊天,沒有廣告。"},"anxiety":{"h1":"孩子每個字都念得對,卻沒有真正讀懂","sub":"他們不見得每次都會停下來問。遇到不懂的字就跳過去、繼續往下讀,結果內容根本沒吸收進去。時間一久,就變成對學校的挫折感,還有一種「我做不到」的心情。Gadit 給孩子一個地方,可以停下來、真正弄懂,然後帶著這個字回到功課上。"},"safe":{"h1":"一個能安心交到孩子手上的畫面","sub":"沒有開放式聊天。沒有無止盡的動態牆。沒有廣告。就是一個乾淨的地方,孩子在這裡輸入一個字、把它完全弄懂,再回去寫功課。"}},"heroCta":"開始 14 天免費試用","heroTrust":"無開放式聊天 · 無廣告 · 一鍵取消","ownerCta":"前往你的家庭空間","stats":["30+ 種語言","每個意思配一張圖","最多 5 位孩子","一鍵取消"],"demoKicker":"成果","demoTitle":"孩子讀懂每一個字,詞彙量每天都在成長","painKicker":"真正的痛點","painTitle":"孩子在讀,卻不見得真正讀懂","painBody1":"其實孩子願意停下來問一個字是什麼意思,你反而該高興。問題出在那些他們沒停下來問的字。他們直接跳過、繼續讀,內容根本沒吸收進去。詞彙量始終很薄弱,理解力一個字接一個字地斷裂。","painBody2":"而這遠遠不只影響一個分數。一個讀不懂的孩子會覺得自己不夠好、對學校感到挫折、失去自信。而這一切都悄悄發生,沒有人能指出線是在哪裡斷掉的。","reframe":"而這正是 Gadit 登場的地方。","puzzleKicker":"孩子的腦袋裡發生了什麼","puzzleTitle":"文章是一幅拼圖。每個字都是一片。","puzzleBody":"孩子在閱讀時,腦海會用這些字拼出一整幅畫面。每個他讀懂的字,都是一片剛好扣上的拼圖。每個缺漏的字,都是畫面上的一個破洞。只要三、四個破洞,孩子就再也看不清整幅畫面了,就算每個字他都念出來了也一樣。","puzzleBefore":"一段有缺字的文章","puzzleAfter":"有了 Gadit,每一片都到位","puzzleLine":"當每個字都清楚了,孩子就看見了整幅畫面。","chainKicker":"運作方式","chainTitle":"每個字,孩子都能得到這些","chainSteps":["孩子輸入一個他看不懂的字","得到符合他程度的解釋、一張圖片和三個例句","這個字被存進他的專屬筆記本","並在短練習中回來,直到真正變成他的"],"howBlocks":[{"t":"輸入這個字","b":"孩子在兒童模式下,在一個乾淨又安全的地方,輸入任何他看不懂的字。"},{"t":"清楚的定義","b":"符合孩子程度的解釋,不用難字去解釋難字。"},{"t":"三個例句","b":"真實的句子,呈現這個字在文章裡是怎麼活起來的,還配上圖片,不只是一句定義。"},{"t":"每個意思配一張圖","b":"因為孩子記住看到的東西,遠比記住寫給他看的東西還牢。"},{"t":"情境","b":"把書裡的一個句子貼上來,Gadit 會標出剛好符合這句話的意思。"},{"t":"專屬筆記本","b":"孩子查過的每個字都會存進他的筆記本,不會溜走。"},{"t":"小測驗","b":"在字快要忘掉之前,用一道快問把它帶回來。"},{"t":"遊戲","b":"在玩樂中學習,而且玩的就是孩子自己查過的字。"},{"t":"聽它,也說它","b":"孩子聽任何一個字,並練習大聲把它說出來,讓開口說變得自然,而不只是會讀。"}],"chainCost":"","chainTurnTitle":"而這就是你得到的","chainTurnBody":"每個曾經卡住孩子的字,都變成他學會的字,而且你看得清清楚楚:他一週又一週地攻克了多少個字。你不必再靠猜想某件事有沒有在進步,你只要看著它發生就好。","dashKicker":"家長儀表板","dashTitle":"你清楚看見每個孩子學了多少","dashBody":"每個孩子都有一本不斷成長的專屬單字筆記本。在你的儀表板上,你一眼就能看到每個孩子學會了多少字、這週新增了幾個字,還有他最近查的字。別的工具回答完孩子就忘了。Gadit 會記住,而你一週又一週地看著進步。","dashKids":[{"name":"Noa","total":47,"week":12},{"name":"Ido","total":31,"week":8},{"name":"Maya","total":63,"week":15}],"dashWordsLabel":"筆記本裡的字","dashWeekLabel":"本週","featuresKicker":"裡面有什麼","features":[{"kicker":"每一個意思","title":"一個字。每一個意思。每個意思一張圖。","body":"一個字常常有好幾個不同的意思,而孩子往往就在這裡搞混。Gadit 把它們全部放在同一個地方,每個意思都配三個真實例句和它自己的圖片,因為孩子的大腦記圖像遠比記文字牢得多。"},{"kicker":"兒童模式","title":"符合孩子程度的解釋","body":"只要切換一下,每個解釋就會變成 8 歲孩子真的聽得懂的語言。沒有難字去解釋難字,沒有繞圈子的定義。只有理解。"},{"kicker":"情境","title":"貼上一個句子,得到正確的意思","body":"大多數字都不只一個意思,而孩子往往就在這裡迷路。把書上或作業單上的句子貼上來,Gadit 會標出剛好符合的那個意思。"},{"kicker":"專屬筆記本","title":"這些字不會溜走","body":"孩子查過的每個字都會進到他的專屬筆記本,聰明的短練習會在字快溜走之前把它帶回來。詞彙量就是這樣真正建立起來的,一次一個字。"},{"kicker":"每個孩子一個檔案","title":"每個孩子都有自己的空間","body":"家裡的每個孩子都有獨立的檔案:他的筆記本、他的練習、他的紀錄。兒童模式會調整解釋方式,對小小孩簡單清楚、對大孩子更完整,誰也不會踩到誰的字。"},{"kicker":"單字遊戲","title":"用孩子自己的字玩的學習遊戲","body":"用孩子真正查過的字打造的小測驗和遊戲。玩個幾分鐘,詞彙量就毫不費力地成長。"},{"kicker":"第二語言","title":"第二語言最好的功課幫手","body":"孩子輸入一個英文字,就能用自己的母語得到簡單的解釋,還有圖片和例句。不必再在字典、翻譯和 YouTube 之間來回打轉。"}],"midCtaTitle":"現在就開始,看著孩子的詞彙量一天天成長","midCta":"開始 14 天免費試用","compareKicker":"差別在哪","compareTitle":"為什麼不直接 Google 或問聊天機器人?","compareGadit":"Gadit","compareOther":"開放的網路","compareRows":[{"label":"每個字一頁乾淨的畫面","gadit":true,"other":false},{"label":"符合孩子程度的解釋","gadit":true,"other":false},{"label":"每個意思配一張圖","gadit":true,"other":false},{"label":"會留下來的筆記本和練習","gadit":true,"other":false},{"label":"四面八方的廣告和連結","gadit":false,"other":true},{"label":"沒有界線的開放式聊天","gadit":false,"other":true}],"safeTitle":"一個獨立、乾淨的區域。不是通往別處的門。","safeBody":"Gadit 是一個完全封閉的空間:沒有開放式聊天、沒有動態牆、沒有廣告、沒有外連。孩子不會從這裡被拉去 TikTok 或任何其他 App。這裡只有一件事可做:弄懂一個字,然後回去讀書。","safeLine":"一個你能放心交到孩子手上的畫面。","stackTitle":"家庭方案包含什麼","stackItems":["全家人無限次查詢","每一個意思,每個意思一張圖","適合各年齡的兒童模式","句子檢查,即時回饋","每個孩子的專屬筆記本與聰明練習","單字遊戲與測驗","最多 5 位孩子,各自獨立的檔案","完整支援 30+ 種語言"],"priceKicker":"價格","priceTitle":"家庭方案","trialBadge":"14 天免費試用","yearly":"$59 / 年","yearlyNote":"全家人算下來一個月只要 $4.92,比按月付款省下將近兩個月的費用","priceAnchor":"不到一次家教的錢,就換來全年、家裡每個孩子都能用","monthly":"$5.99 / 月","billedYearly":"年繳","billedMonthly":"月繳","yearlySave":"-18%","priceCta":"開始試用","cancelNote":"14 天後才會首次扣款。隨時可在帳戶頁面一鍵取消。","singleChild":"家裡只有一個學生?Deep 方案每月 $4.99。只要多付一點點,就能加到最多 5 位孩子。","guaranteeTitle":"你的考驗:兩週","guaranteeBody":"先真正用兩週,完全免費。如果到了第 14 天,孩子的筆記本還沒累積至少 20 個新字,一鍵取消,你一毛錢都沒付。","faqTitle":"家長常問的問題","faq":[{"q":"用 Gadit 我能得到什麼?","a":"孩子查的每個字都會得到一頁乾淨的畫面:每一個意思、符合孩子程度的解釋(兒童模式)、三個真實例句,每個意思一張圖。另外還有情境功能(貼上一個句子,得到正確的意思)、附聰明練習的專屬單字筆記本、單字遊戲與測驗、顯示每個孩子學了多少的家長儀表板、最多 5 位孩子各自獨立的檔案,全部支援 30+ 種語言,而且是一個沒有開放式聊天、沒有廣告的封閉安全空間。"},{"q":"為什麼不直接問聊天機器人或 Google?","a":"因為那些是給大人用的工具。Google 回給你的是四面八方的廣告和連結,而開放式聊天機器人是一場沒有界線的對話,沒有一個家長會放心把孩子單獨留在那裡。Gadit 反其道而行:每個字一頁封閉、乾淨的畫面,符合孩子程度,沒有任何迷路的可能。"},{"q":"我怎麼知道孩子真的在進步?","a":"你會有一個家長儀表板。一眼就能看到每個孩子學會了多少字、這週新增了幾個字,還有他最近查的字。別的工具回答完孩子就忘了;Gadit 把每個字都存進孩子的專屬筆記本,讓你一週又一週地看著詞彙量成長。"},{"q":"適合什麼年齡?","a":"Gadit 的核心是學齡孩子,從一年級到高中都適用。兒童模式為年幼的孩子做簡單的解釋,完整的解釋也能服務青少年和家長。帳戶由家長開設。"},{"q":"它對英文和其他語言有幫助嗎?","a":"非常有幫助。孩子可以查一個英文字,然後用自己的母語得到簡單的解釋,還有圖片和例句,正是家裡缺的那個幫手。而且它支援 30+ 種語言,所以孩子也能用你家裡說的語言得到解釋。"},{"q":"費用是多少?","a":"14 天試用後,每年 $59 或每月 $5.99。沒有隱藏費用,而且你隨時可以一鍵取消。"},{"q":"我可以加幾個孩子?","a":"一個家庭方案最多可加 5 位孩子,每人各有自己的檔案、筆記本和練習。"},{"q":"可以先試用、不用馬上承諾嗎?","a":"可以。試用需要先綁一張卡,但首次扣款只會在 14 天結束時才發生。在那之前隨時取消,一鍵搞定,你一毛錢都不用付。"}],"finalTitle":"今天就開始,看著詞彙量成長","finalSub":"兩週免費。一鍵取消。還有一個學會自己讀懂單字的孩子。","finalCta":"開始 14 天免費試用","footerTerms":"條款","footerPrivacy":"隱私權"}
...
const FAM_MOCK: Record<string, FamMock> = {
  ...
  zu: {
    meaningsWord: "inyanga",
    meaning1T: "Into ekhanyayo esibhakabhakeni ebusuku",
    meaning1Ex: "\"Inyanga igcwele namuhla ebusuku.\"",
    meaning2T: "Isikhathi esiyizinsuku ezingaba ngu-30",
    meaning2Ex: "\"Sizohamba ngenyanga ezayo.\"",
    kidsBubble: "\"Reluctant\" yilapho ungafuni ngempela ukwenza okuthile, bese izinyawo zakho zihamba kancane. Njengokuya kudokotela wamazinyo.",
    contextSentence: "{Iphupho} lami elikhulu ukuba ngudokotela",
    contextMeaning: "Incazelo lapha: ithemba noma umgomo ofuna ukuwufinyelela",
    notebookTitle: "Incwadana kaLindiwe",
    notebookDue: "zijwayeze namuhla",
    profile1Name: "Lindiwe",
    profile1Grade: "Ibanga 2",
    profile2Name: "Sipho",
    profile2Grade: "Ibanga 6",
    profile3Name: "Zanele",
    profile3Grade: "Ibanga 9",
    gameTwinTrap: "Ugibe Lwamawele",
    gameTimeTraveler: "Umhambi Wesikhathi",
    gameStreak: "Izinsuku ezingu-6 ngokulandelana 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Ukungafuni ngempela",
    englishMeaningEx: "\"Wayengafuni ukuqala umsebenzi wakhe wesikole.\"",
    puzzleSentence: "Umatilosi {wayezimisele} ukufika esiqhingini, naphezu {kwesiphepho} akazange {angabaze}",
    dreamWord: "iphupho",
    dreamPos: "ibizo",
    dreamMeaningFull: "izithombe nemicabango edlula engqondweni ngesikhathi ulele",
    dreamExample: "\"Izolo ebusuku ngibe nephupho ngohambo olude.\"",
    dreamMeaningShort: "Izithombe nemicabango edlula engqondweni ngesikhathi ulele",
    dreamKidDef: "\"Iphupho\" yizithombe nezindaba ezidlula ekhanda lakho uma ulele. Ngezinye izikhathi ziyajabulisa, ngezinye ziyamangaza, futhi ziyanyamalala uma uvuka.",
    dreamEx1: "\"Izolo ebusuku ngibe nephupho ngohambo olude.\"",
    dreamEx2: "\"Uvuke ephusheni elesabekayo.\"",
    dreamEx3: "\"Iphupho lakhe elikhulu ukundiza aye emkhathini.\"",
    kidsLabel: "Imodi Yezingane",
    searchHint: "Thayipha igama",
    tabMeanings: "Izincazelo",
    tabPicture: "Isithombe",
    tabNotebook: "Incwadana",
    searchTagline: "Ingane ithayipha igama, kuphelile.",
    quizQ: "Lisho ukuthini \"iphupho\"?",
    quizRight: "Izithombe nemicabango ngesikhathi ulele",
    quizWrong1: "Uhlobo lwekhekhe",
    quizWrong2: "Insimbi yomculo",
  },
  el: {
    meaningsWord: "γλώσσα",
    meaning1T: "Το όργανο μέσα στο στόμα που μας βοηθά να γευόμαστε",
    meaning1Ex: "«Κάηκα στη γλώσσα με τη ζεστή σούπα.»",
    meaning2T: "Ο τρόπος που μιλάει ένας λαός",
    meaning2Ex: "«Η γιαγιά μου μιλάει τρεις γλώσσες.»",
    kidsBubble: "«Διστακτικός» είναι όταν δεν θέλεις πραγματικά να κάνεις κάτι και τα πόδια σου πάνε αργά. Όπως όταν πηγαίνεις στον οδοντίατρο.",
    contextSentence: "Το μεγαλύτερο {όνειρό} μου είναι να γίνω γιατρός",
    contextMeaning: "Η σημασία εδώ: μια ελπίδα ή ένας στόχος που θέλεις να πετύχεις",
    notebookTitle: "Το τετράδιο της Ελένης",
    notebookDue: "εξάσκηση σήμερα",
    profile1Name: "Ελένη",
    profile1Grade: "Β΄ Δημοτικού",
    profile2Name: "Γιώργος",
    profile2Grade: "ΣΤ΄ Δημοτικού",
    profile3Name: "Μαρία",
    profile3Grade: "Γ΄ Γυμνασίου",
    gameTwinTrap: "Παγίδα των Διδύμων",
    gameTimeTraveler: "Ταξιδιώτης στον Χρόνο",
    gameStreak: "6 μέρες στη σειρά 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Όταν δεν θέλεις πραγματικά",
    englishMeaningEx: "«Δεν ήθελε και πολύ να ξεκινήσει τα μαθήματά του.»",
    puzzleSentence: "Ο ναύτης ήταν {αποφασισμένος} να φτάσει στο νησί, και παρά την {καταιγίδα} ποτέ δεν {δίστασε}",
    dreamWord: "όνειρο",
    dreamPos: "ουσιαστικό",
    dreamMeaningFull: "εικόνες και σκέψεις που περνούν από το μυαλό την ώρα του ύπνου",
    dreamExample: "«Χθες το βράδυ είδα ένα όνειρο για ένα μακρινό ταξίδι.»",
    dreamMeaningShort: "Εικόνες και σκέψεις που περνούν από το μυαλό την ώρα του ύπνου",
    dreamKidDef: "«Όνειρο» είναι οι εικόνες και οι ιστορίες που τρέχουν στο κεφάλι σου όσο κοιμάσαι. Άλλοτε χαρούμενες, άλλοτε παράξενες, και σβήνουν μόλις ξυπνήσεις.",
    dreamEx1: "«Χθες το βράδυ είδα ένα όνειρο για ένα μεγάλο ταξίδι.»",
    dreamEx2: "«Ξύπνησε από ένα τρομακτικό όνειρο.»",
    dreamEx3: "«Το μεγάλο του όνειρο είναι να πετάξει στο διάστημα.»",
    kidsLabel: "Παιδική Λειτουργία",
    searchHint: "Γράψε μια λέξη",
    tabMeanings: "Σημασίες",
    tabPicture: "Εικόνα",
    tabNotebook: "Τετράδιο",
    searchTagline: "Το παιδί γράφει μια λέξη, και αυτό ήταν.",
    quizQ: "Τι σημαίνει «όνειρο»;",
    quizRight: "Εικόνες και σκέψεις στον ύπνο",
    quizWrong1: "Ένα είδος γλυκού",
    quizWrong2: "Ένα μουσικό όργανο",
  },
  vi: {
    meaningsWord: "đường",
    meaning1T: "Lối đi cho người và xe cộ",
    meaning1Ex: "\"Con đường đến trường có nhiều cây xanh.\"",
    meaning2T: "Chất ngọt dùng để nấu ăn",
    meaning2Ex: "\"Mẹ cho một thìa đường vào cốc sữa.\"",
    kidsBubble: "\"Ngần ngại\" là khi con không thật sự muốn làm việc gì đó, và đôi chân cứ bước chậm lại. Giống như lúc đi đến nha sĩ vậy.",
    contextSentence: "{Ước mơ} lớn nhất của em là trở thành bác sĩ",
    contextMeaning: "Nghĩa ở đây: một hy vọng hay mục tiêu muốn đạt được",
    notebookTitle: "Sổ tay của An",
    notebookDue: "luyện tập hôm nay",
    profile1Name: "An",
    profile1Grade: "Lớp 2",
    profile2Name: "Minh",
    profile2Grade: "Lớp 6",
    profile3Name: "Linh",
    profile3Grade: "Lớp 9",
    gameTwinTrap: "Bẫy Song Sinh",
    gameTimeTraveler: "Du Hành Thời Gian",
    gameStreak: "Chuỗi 6 ngày 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Không thật sự muốn làm",
    englishMeaningEx: "\"Cậu ấy ngần ngại bắt đầu làm bài tập về nhà.\"",
    puzzleSentence: "Chàng thủy thủ {quyết} tới hòn đảo, dù {bão} lớn anh chưa từng {lùi} bước",
    dreamWord: "giấc mơ",
    dreamPos: "danh từ",
    dreamMeaningFull: "những hình ảnh và suy nghĩ hiện ra trong đầu khi ngủ",
    dreamExample: "\"Đêm qua em mơ thấy một chuyến đi thật xa.\"",
    dreamMeaningShort: "Những hình ảnh và suy nghĩ hiện ra trong đầu khi ngủ",
    dreamKidDef: "\"Giấc mơ\" là những hình ảnh và câu chuyện chạy trong đầu con khi con ngủ. Có lúc vui, có lúc kỳ lạ, và chúng tan biến khi con thức dậy.",
    dreamEx1: "\"Đêm qua em có một giấc mơ về chuyến đi dài.\"",
    dreamEx2: "\"Cô bé tỉnh dậy sau một giấc mơ đáng sợ.\"",
    dreamEx3: "\"Ước mơ lớn của cậu ấy là bay vào vũ trụ.\"",
    kidsLabel: "Chế độ Trẻ em",
    searchHint: "Gõ một từ",
    tabMeanings: "Nghĩa",
    tabPicture: "Hình ảnh",
    tabNotebook: "Sổ tay",
    searchTagline: "Bé gõ một từ, thế là xong.",
    quizQ: "\"Giấc mơ\" nghĩa là gì?",
    quizRight: "Hình ảnh và suy nghĩ khi ngủ",
    quizWrong1: "Một loại bánh",
    quizWrong2: "Một loại nhạc cụ",
  },
  fil: {
    meaningsWord: "saya",
    meaning1T: "Masayang pakiramdam",
    meaning1Ex: "\"Punong-puno ng saya ang handaan.\"",
    meaning2T: "Isang uri ng palda na isinusuot ng babae",
    meaning2Ex: "\"Suot ni Lola ang kanyang pulang saya.\"",
    kidsBubble: "Ang \"nag-aatubili\" ay kapag ayaw mo talagang gawin ang isang bagay, kaya bumabagal ang mga paa mo. Parang papunta sa dentista.",
    contextSentence: "Ang pinakamalaki kong {pangarap} ay maging doktor",
    contextMeaning: "Ang kahulugan dito: isang pag-asa o layunin na gusto mong makamit",
    notebookTitle: "Kuwaderno ni Ella",
    notebookDue: "magsanay ngayon",
    profile1Name: "Ella",
    profile1Grade: "Ika-2 baitang",
    profile2Name: "Miguel",
    profile2Grade: "Ika-6 na baitang",
    profile3Name: "Bea",
    profile3Grade: "Ika-9 na baitang",
    gameTwinTrap: "Bitag ng Kambal",
    gameTimeTraveler: "Manlalakbay sa Panahon",
    gameStreak: "6 na araw na sunod-sunod 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Hindi talaga gustong gawin",
    englishMeaningEx: "\"Nag-aatubili siyang simulan ang kanyang takdang-aralin.\"",
    puzzleSentence: "Ang mandaragat ay {determinado} na marating ang isla, sa kabila ng {bagyo} hindi siya kailanman {nag-alinlangan}",
    dreamWord: "panaginip",
    dreamPos: "pangngalan",
    dreamMeaningFull: "mga larawan at kaisipang dumaraan sa isip habang natutulog",
    dreamExample: "\"Kagabi, nanaginip ako tungkol sa isang malayong paglalakbay.\"",
    dreamMeaningShort: "Mga larawan at kaisipang dumaraan sa isip habang natutulog",
    dreamKidDef: "Ang \"panaginip\" ay ang mga larawan at kuwentong tumatakbo sa ulo mo habang natutulog ka. Minsan masaya, minsan kakaiba, at naglalaho sila paggising mo.",
    dreamEx1: "\"Kagabi, nagkaroon ako ng panaginip tungkol sa mahabang paglalakbay.\"",
    dreamEx2: "\"Nagising siya mula sa nakakatakot na panaginip.\"",
    dreamEx3: "\"Ang malaki niyang pangarap ay lumipad sa kalawakan.\"",
    kidsLabel: "Kids Mode",
    searchHint: "Mag-type ng salita",
    tabMeanings: "Mga kahulugan",
    tabPicture: "Larawan",
    tabNotebook: "Kuwaderno",
    searchTagline: "Magta-type ang bata ng salita, at iyon na iyon.",
    quizQ: "Ano ang ibig sabihin ng \"panaginip\"?",
    quizRight: "Mga larawan at kaisipan habang natutulog",
    quizWrong1: "Isang uri ng keyk",
    quizWrong2: "Isang instrumentong pangmusika",
  },
  af: {
    meaningsWord: "bank",
    meaning1T: "'n Lang sitplek vir meer as een persoon",
    meaning1Ex: "\"Ons het saam op die bank gesit en TV gekyk.\"",
    meaning2T: "'n Plek waar jy jou geld bewaar",
    meaning2Ex: "\"Sy het haar spaargeld na die bank geneem.\"",
    kidsBubble: "\"Huiwerig\" is wanneer jy nie regtig lus is om iets te doen nie, en jou voete stadig loop. Soos om na die tandarts toe te stap.",
    contextSentence: "My grootste {droom} is om 'n dokter te word",
    contextMeaning: "Die betekenis hier: 'n hoop of doel wat jy wil bereik",
    notebookTitle: "Anika se boekie",
    notebookDue: "oefen vandag",
    profile1Name: "Anika",
    profile1Grade: "Graad 2",
    profile2Name: "Pieter",
    profile2Grade: "Graad 6",
    profile3Name: "Lize",
    profile3Grade: "Graad 9",
    gameTwinTrap: "Tweelingstrik",
    gameTimeTraveler: "Tydreisiger",
    gameStreak: "6 dae aaneen 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Nie regtig lus nie",
    englishMeaningEx: "\"Hy was huiwerig om met sy huiswerk te begin.\"",
    puzzleSentence: "Die matroos was {vasberade} om die eiland te bereik, ten spyte van die {storm} het hy nooit {gehuiwer} nie",
    dreamWord: "droom",
    dreamPos: "selfstandige naamwoord",
    dreamMeaningFull: "beelde en gedagtes wat deur jou kop gaan terwyl jy slaap",
    dreamExample: "\"Gisteraand het ek oor 'n verre reis gedroom.\"",
    dreamMeaningShort: "Beelde en gedagtes wat deur jou kop gaan terwyl jy slaap",
    dreamKidDef: "'n \"Droom\" is die prentjies en stories wat deur jou kop hardloop terwyl jy slaap. Soms lekker, soms snaaks, en hulle verdwyn wanneer jy wakker word.",
    dreamEx1: "\"Gisteraand het ek 'n droom oor 'n lang reis gehad.\"",
    dreamEx2: "\"Sy het uit 'n grillerige droom wakker geword.\"",
    dreamEx3: "\"Sy groot droom is om ruimte toe te vlieg.\"",
    kidsLabel: "Kindermodus",
    searchHint: "Tik 'n woord",
    tabMeanings: "Betekenisse",
    tabPicture: "Prent",
    tabNotebook: "Boekie",
    searchTagline: "Die kind tik 'n woord, en dis dit.",
    quizQ: "Wat beteken \"droom\"?",
    quizRight: "Beelde en gedagtes terwyl jy slaap",
    quizWrong1: "'n Soort koek",
    quizWrong2: "'n Musiekinstrument",
  },
  sw: {
    meaningsWord: "mbuzi",
    meaning1T: "Mnyama wa kufugwa mwenye pembe na ndevu",
    meaning1Ex: "\"Mbuzi anakula majani shambani.\"",
    meaning2T: "Kifaa cha kukunia nazi",
    meaning2Ex: "\"Mama alikuna nazi kwa mbuzi jikoni.\"",
    kidsBubble: "\"Kusitasita\" ni pale ambapo hutaki kabisa kufanya kitu, na miguu yako inatembea polepole. Kama kwenda kwa daktari wa meno.",
    contextSentence: "{Ndoto} yangu kubwa ni kuwa daktari",
    contextMeaning: "Maana hapa: tumaini au lengo unalotaka kufikia",
    notebookTitle: "Daftari la Amani",
    notebookDue: "fanya mazoezi leo",
    profile1Name: "Amani",
    profile1Grade: "Darasa la 2",
    profile2Name: "Baraka",
    profile2Grade: "Darasa la 6",
    profile3Name: "Neema",
    profile3Grade: "Darasa la 9",
    gameTwinTrap: "Mtego wa Mapacha",
    gameTimeTraveler: "Msafiri wa Wakati",
    gameStreak: "Siku 6 mfululizo 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Kutotaka kweli",
    englishMeaningEx: "\"Alisitasita kuanza kazi yake ya nyumbani.\"",
    puzzleSentence: "Baharia {aliazimia} kufika kisiwani, licha ya {dhoruba} hakuwahi {kusita}",
    dreamWord: "ndoto",
    dreamPos: "nomino",
    dreamMeaningFull: "picha na mawazo yanayopita akilini wakati wa usingizi",
    dreamExample: "\"Jana usiku niliota ndoto kuhusu safari ya mbali.\"",
    dreamMeaningShort: "Picha na mawazo yanayopita akilini wakati wa usingizi",
    dreamKidDef: "\"Ndoto\" ni picha na hadithi zinazopita kichwani mwako unapolala. Wakati mwingine za furaha, wakati mwingine za ajabu, na hupotea unapoamka.",
    dreamEx1: "\"Jana usiku niliota ndoto kuhusu safari ndefu.\"",
    dreamEx2: "\"Aliamka kutoka kwenye ndoto ya kutisha.\"",
    dreamEx3: "\"Ndoto yake kubwa ni kuruka hadi anga za juu.\"",
    kidsLabel: "Hali ya Watoto",
    searchHint: "Andika neno",
    tabMeanings: "Maana",
    tabPicture: "Picha",
    tabNotebook: "Daftari",
    searchTagline: "Mtoto anaandika neno, basi.",
    quizQ: "\"Ndoto\" ina maana gani?",
    quizRight: "Picha na mawazo wakati wa usingizi",
    quizWrong1: "Aina ya keki",
    quizWrong2: "Ala ya muziki",
  },
  "zh-CN": {
    meaningsWord: "花",
    meaning1T: "植物开出的花朵",
    meaning1Ex: "“公园里的花开得真漂亮。”",
    meaning2T: "用掉钱或时间",
    meaning2Ex: "“他花了十块钱买了一本书。”",
    kidsBubble: "“犹豫”就是你心里不太想做一件事，脚步也慢了下来。就像走去看牙医的时候。",
    contextSentence: "我最大的{梦想}是当一名医生",
    contextMeaning: "这里的意思：你希望实现的愿望或目标",
    notebookTitle: "小雨的生词本",
    notebookDue: "今天练习",
    profile1Name: "小雨",
    profile1Grade: "二年级",
    profile2Name: "浩然",
    ...
    profile3Grade: "初三",
    gameTwinTrap: "双胞胎陷阱",
    gameTimeTraveler: "时间旅行者",
    gameStreak: "连续 6 天 🔥",
    englishWord: "reluctant",
    englishMeaningT: "不太情愿",
    englishMeaningEx: "“他不太情愿开始写作业。”",
    puzzleSentence: "水手 {决心} 抵达小岛 即使遇到 {暴风雨} 也从不 {犹豫}",
    dreamWord: "梦",
    dreamPos: "名词",
    dreamMeaningFull: "睡觉时脑海中出现的画面和想法",
    dreamExample: "“昨晚我梦见了一次遥远的旅行。”",
    dreamMeaningShort: "睡觉时脑海中出现的画面和想法",
    dreamKidDef: "“梦”就是你睡觉时在脑袋里跑来跑去的画面和故事。有时开心，有时奇怪，醒来后就不见了。",
    dreamEx1: "“昨晚我做了一个关于长途旅行的梦。”",
    dreamEx2: "“她从一个可怕的梦中醒来。”",
    dreamEx3: "“他的大梦想是飞上太空。”",
    kidsLabel: "儿童模式",
    searchHint: "输入词语",
    tabMeanings: "含义",
  ...
  "zh-TW": {
    meaningsWord: "花",
    meaning1T: "植物開出的花朵",
    meaning1Ex: "「公園裡的花開得真漂亮。」",
    meaning2T: "用掉錢或時間",
    meaning2Ex: "「他花了一百元買了一本書。」",
    kidsBubble: "「猶豫」就是你心裡不太想做一件事，腳步也慢了下來。就像走去看牙醫的時候。",
    contextSentence: "我最大的{夢想}是當一位醫生",
    contextMeaning: "這裡的意思：你希望實現的願望或目標",
    notebookTitle: "小晴的筆記本",
    notebookDue: "今天練習",
    profile1Name: "小晴",
    profile1Grade: "二年級",
    profile2Name: "冠宇",
    ...
    profile3Grade: "國三",
    gameTwinTrap: "雙胞胎陷阱",
    gameTimeTraveler: "時間旅行者",
    gameStreak: "連續 6 天 🔥",
    englishWord: "reluctant",
    englishMeaningT: "不太情願",
    englishMeaningEx: "「他不太情願開始寫功課。」",
    puzzleSentence: "水手 {決心} 抵達小島 即使遇到 {暴風雨} 也從不 {猶豫}",
    dreamWord: "夢",
    dreamPos: "名詞",
    dreamMeaningFull: "睡覺時腦海中出現的畫面和想法",
    dreamExample: "「昨晚我夢見了一趟遙遠的旅行。」",
    dreamMeaningShort: "睡覺時腦海中出現的畫面和想法",
    dreamKidDef: "「夢」就是你睡覺時在腦袋裡跑來跑去的畫面和故事。有時開心，有時奇怪，醒來後就不見了。",
    dreamEx1: "「昨晚我做了一個關於長途旅行的夢。」",
    dreamEx2: "「她從一個可怕的夢中醒來。」",
    dreamEx3: "「他的大夢想是飛上太空。」",
    kidsLabel: "兒童模式",
    searchHint: "輸入一個字",
    tabMeanings: "意思",
  ...
  ko: {
    meaningsWord: "배",
    meaning1T: "물 위를 떠다니는 탈것",
    meaning1Ex: "\"배가 천천히 항구를 떠났다.\"",
    meaning2T: "달고 즙이 많은 과일",
    meaning2Ex: "\"할머니가 시원한 배를 깎아 주셨다.\"",
    kidsBubble: "\"머뭇거리다\"는 어떤 일을 정말 하고 싶지 않아서 발걸음이 느려지는 거예요. 치과에 걸어갈 때처럼요.",
    contextSentence: "내 가장 큰 {꿈}은 의사가 되는 거예요",
    contextMeaning: "여기서의 뜻: 이루고 싶은 희망이나 목표",
    notebookTitle: "지우의 단어 노트",
    notebookDue: "오늘 연습",
    profile1Name: "지우",
    profile1Grade: "초등 2학년",
    profile2Name: "민준",
    profile2Grade: "초등 6학년",
    profile3Name: "서연",
    profile3Grade: "중학교 3학년",
    gameTwinTrap: "쌍둥이 함정",
    gameTimeTraveler: "시간 여행자",
    gameStreak: "6일 연속 🔥",
    englishWord: "reluctant",
    englishMeaningT: "별로 하고 싶지 않은",
    englishMeaningEx: "\"그는 숙제를 시작하기 싫어서 머뭇거렸다.\"",
    puzzleSentence: "선원은 섬에 닿기로 {결심했고} 거센 {폭풍} 속에서도 한 번도 {망설이지} 않았다",
    dreamWord: "꿈",
    dreamPos: "명사",
    dreamMeaningFull: "잠자는 동안 머릿속을 지나가는 장면과 생각",
    dreamExample: "\"어젯밤 먼 여행을 떠나는 꿈을 꿨다.\"",
    dreamMeaningShort: "잠자는 동안 머릿속을 지나가는 장면과 생각",
    dreamKidDef: "\"꿈\"은 잠자는 동안 머릿속에서 펼쳐지는 그림과 이야기예요. 즐거울 때도 있고 이상할 때도 있는데, 잠에서 깨면 사라져요.",
    dreamEx1: "\"어젯밤 긴 여행을 떠나는 꿈을 꿨다.\"",
    dreamEx2: "\"그녀는 무서운 꿈에서 깼다.\"",
    dreamEx3: "\"그의 큰 꿈은 우주로 날아가는 것이다.\"",
    kidsLabel: "키즈 모드",
    searchHint: "단어를 입력하세요",
    tabMeanings: "의미",
    tabPicture: "그림",
    tabNotebook: "노트",
    searchTagline: "아이는 단어만 입력하면 끝.",
    quizQ: "\"꿈\"은 무슨 뜻일까요?",
    quizRight: "잠자는 동안의 장면과 생각",
    quizWrong1: "케이크의 한 종류",
    quizWrong2: "악기의 한 종류",
  },
  th: {
    meaningsWord: "ขัน",
    meaning1T: "ภาชนะสำหรับตักน้ำ",
    meaning1Ex: "\"แม่ใช้ขันตักน้ำรดต้นไม้\"",
    meaning2T: "เสียงร้องของไก่ตัวผู้ตอนเช้า",
    meaning2Ex: "\"ไก่ขันตั้งแต่เช้ามืด\"",
    kidsBubble: "\"ลังเล\" คือตอนที่หนูไม่ค่อยอยากทำอะไรสักอย่าง แล้วเท้าก็ก้าวช้าลง เหมือนตอนเดินไปหาหมอฟัน",
    contextSentence: "{ความฝัน}ที่ใหญ่ที่สุดของฉันคือการเป็นหมอ",
    contextMeaning: "ความหมายในที่นี้: ความหวังหรือเป้าหมายที่อยากทำให้สำเร็จ",
    notebookTitle: "สมุดของน้องมะลิ",
    notebookDue: "ฝึกวันนี้",
    profile1Name: "มะลิ",
    profile1Grade: "ป.2",
    profile2Name: "ภูมิ",
    profile2Grade: "ป.6",
    profile3Name: "ใบเตย",
    profile3Grade: "ม.3",
    gameTwinTrap: "กับดักฝาแฝด",
    gameTimeTraveler: "นักเดินทางข้ามเวลา",
    gameStreak: "ต่อเนื่อง 6 วัน 🔥",
    englishWord: "reluctant",
    englishMeaningT: "ไม่ค่อยอยากทำ",
    englishMeaningEx: "\"เขาไม่ค่อยอยากเริ่มทำการบ้าน\"",
    puzzleSentence: "กะลาสี {ตั้งใจ} จะไปให้ถึงเกาะ แม้จะเจอ {พายุ} เขาก็ไม่เคย {ลังเล} เลย",
    dreamWord: "ความฝัน",
    dreamPos: "คำนาม",
    dreamMeaningFull: "ภาพและความคิดที่ผ่านเข้ามาในหัวตอนนอนหลับ",
    dreamExample: "\"เมื่อคืนฉันฝันถึงการเดินทางไปที่ไกลๆ\"",
    dreamMeaningShort: "ภาพและความคิดที่ผ่านเข้ามาในหัวตอนนอนหลับ",
    dreamKidDef: "\"ความฝัน\" คือภาพและเรื่องราวที่วิ่งอยู่ในหัวตอนหนูหลับ บางทีก็สนุก บางทีก็แปลก และมันจะหายไปเมื่อหนูตื่น",
    dreamEx1: "\"เมื่อคืนฉันฝันถึงการเดินทางที่ยาวนาน\"",
    dreamEx2: "\"เธอสะดุ้งตื่นจากฝันร้าย\"",
    dreamEx3: "\"ความฝันยิ่งใหญ่ของเขาคือการบินไปอวกาศ\"",
    kidsLabel: "โหมดเด็ก",
    searchHint: "พิมพ์คำ",
    tabMeanings: "ความหมาย",
    tabPicture: "รูปภาพ",
    tabNotebook: "สมุด",
    searchTagline: "เด็กพิมพ์คำเดียว แค่นั้นเอง",
    quizQ: "\"ความฝัน\" แปลว่าอะไร",
    quizRight: "ภาพและความคิดตอนนอนหลับ",
    quizWrong1: "ขนมเค้กชนิดหนึ่ง",
    quizWrong2: "เครื่องดนตรีชนิดหนึ่ง",
  },
  bn: {
    meaningsWord: "পাতা",
    meaning1T: "গাছের চ্যাপ্টা সবুজ অংশ",
    meaning1Ex: "\"গাছ থেকে একটা হলুদ পাতা ঝরে পড়ল।\"",
    meaning2T: "বই বা খাতার একটি পৃষ্ঠা",
    meaning2Ex: "\"বইয়ের দশ নম্বর পাতাটা খোলো।\"",
    kidsBubble: "\"অনিচ্ছুক\" মানে যখন তুমি কোনো কাজ সত্যিই করতে চাও না, আর পা দুটো ধীরে ধীরে চলে। যেমন দাঁতের ডাক্তারের কাছে হেঁটে যাওয়ার সময়।",
    contextSentence: "আমার সবচেয়ে বড় {স্বপ্ন} হলো ডাক্তার হওয়া",
    contextMeaning: "এখানে অর্থ: এমন একটি আশা বা লক্ষ্য যা তুমি পূরণ করতে চাও",
    notebookTitle: "অদিতির খাতা",
    notebookDue: "আজ অনুশীলন",
    profile1Name: "অদিতি",
    profile1Grade: "দ্বিতীয় শ্রেণি",
    profile2Name: "আরিয়ান",
    profile2Grade: "ষষ্ঠ শ্রেণি",
    profile3Name: "রিয়া",
    profile3Grade: "নবম শ্রেণি",
    gameTwinTrap: "যমজের ফাঁদ",
    gameTimeTraveler: "সময়ের যাত্রী",
    gameStreak: "টানা 6 দিন 🔥",
    englishWord: "reluctant",
    englishMeaningT: "আসলে করতে না চাওয়া",
    englishMeaningEx: "\"সে বাড়ির কাজ শুরু করতে অনিচ্ছুক ছিল।\"",
    puzzleSentence: "নাবিক দ্বীপে পৌঁছাতে {দৃঢ়প্রতিজ্ঞ} ছিল, {ঝড়} সত্ত্বেও সে কখনো {দ্বিধা} করেনি",
    dreamWord: "স্বপ্ন",
    dreamPos: "বিশেষ্য",
    dreamMeaningFull: "ঘুমের সময় মনের মধ্যে ভেসে ওঠা ছবি আর ভাবনা",
    dreamExample: "\"গত রাতে আমি অনেক দূরের এক যাত্রার স্বপ্ন দেখেছি।\"",
    dreamMeaningShort: "ঘুমের সময় মনের মধ্যে ভেসে ওঠা ছবি আর ভাবনা",
    dreamKidDef: "\"স্বপ্ন\" হলো সেই ছবি আর গল্প যা তুমি ঘুমানোর সময় মাথার মধ্যে দেখো। কখনো মজার, কখনো অদ্ভুত, আর ঘুম ভাঙলেই মিলিয়ে যায়।",
    dreamEx1: "\"গত রাতে আমি এক লম্বা যাত্রার স্বপ্ন দেখেছি।\"",
    dreamEx2: "\"সে একটা ভয়ের স্বপ্ন দেখে জেগে উঠল।\"",
    dreamEx3: "\"তার বড় স্বপ্ন মহাকাশে উড়ে যাওয়া।\"",
    kidsLabel: "Kids Mode",
    searchHint: "একটি শব্দ লেখো",
    tabMeanings: "অর্থ",
    tabPicture: "ছবি",
    tabNotebook: "খাতা",
    searchTagline: "শিশু একটি শব্দ লেখে, ব্যস।",
    quizQ: "\"স্বপ্ন\" মানে কী?",
    quizRight: "ঘুমের সময়ের ছবি আর ভাবনা",
    quizWrong1: "এক ধরনের কেক",
    quizWrong2: "একটি বাদ্যযন্ত্র",
  },
  da: {
    meaningsWord: "is",
    meaning1T: "Frosset vand, hårdt og koldt",
    meaning1Ex: "„Søen er dækket af is om vinteren.”",
    meaning2T: "En kold, sød dessert",
    meaning2Ex: "„Vi købte en is med jordbærsmag.”",
    kidsBubble: "„Tøvende” er når du ikke rigtig har lyst til at gøre noget, og dine fødder går langsomt. Ligesom når du går til tandlægen.",
    contextSentence: "Min største {drøm} er at blive læge",
    contextMeaning: "Betydningen her: et håb eller et mål, du gerne vil nå",
    notebookTitle: "Idas ordbog",
    notebookDue: "øv i dag",
    profile1Name: "Ida",
    profile1Grade: "2. klasse",
    profile2Name: "Oscar",
    profile2Grade: "6. klasse",
    profile3Name: "Freja",
    profile3Grade: "9. klasse",
    gameTwinTrap: "Tvillingefælden",
    gameTimeTraveler: "Tidsrejsende",
    gameStreak: "6 dage i træk 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Ikke rigtig have lyst",
    englishMeaningEx: "„Han var tøvende med at gå i gang med lektierne.”",
    puzzleSentence: "Sømanden var {beslutsom} og ville nå øen, trods {stormen} {tøvede} han aldrig",
    dreamWord: "drøm",
    dreamPos: "navneord",
    dreamMeaningFull: "billeder og tanker, der går gennem hovedet, mens man sover",
    dreamExample: "„I nat havde jeg en drøm om en fjern rejse.”",
    dreamMeaningShort: "Billeder og tanker, der går gennem hovedet, mens man sover",
    dreamKidDef: "En „drøm” er de billeder og historier, der løber gennem dit hoved, mens du sover. Nogle gange glade, nogle gange mærkelige, og de forsvinder, når du vågner.",
    dreamEx1: "„I nat havde jeg en drøm om en lang rejse.”",
    dreamEx2: "„Hun vågnede af en uhyggelig drøm.”",
    dreamEx3: "„Hans store drøm er at flyve ud i rummet.”",
    kidsLabel: "Børnetilstand",
    searchHint: "Skriv et ord",
    tabMeanings: "Betydninger",
    tabPicture: "Billede",
    tabNotebook: "Ordbog",
    searchTagline: "Barnet skriver et ord, og så er det det.",
    quizQ: "Hvad betyder „drøm”?",
    quizRight: "Billeder og tanker, mens man sover",
    quizWrong1: "En slags kage",
    quizWrong2: "Et musikinstrument",
  },
  hu: {
    meaningsWord: "levél",
    meaning1T: "A fa zöld, lapos része",
    meaning1Ex: "„Egy sárga levél hullott le a fáról.”",
    meaning2T: "Írott üzenet, amit valakinek küldünk",
    meaning2Ex: "„Levelet írtam a nagymamámnak.”",
    kidsBubble: "A „vonakodó” az, amikor igazán nincs kedved valamit csinálni, és a lábad lassan megy. Mint amikor a fogorvoshoz sétálsz.",
    contextSentence: "A legnagyobb {álmom} az, hogy orvos legyek",
    contextMeaning: "A jelentés itt: remény vagy cél, amit el szeretnél érni",
    notebookTitle: "Lili füzete",
    notebookDue: "gyakorlás ma",
    profile1Name: "Lili",
    profile1Grade: "2. osztály",
    profile2Name: "Bence",
    profile2Grade: "6. osztály",
    profile3Name: "Anna",
    profile3Grade: "9. osztály",
    gameTwinTrap: "Ikercsapda",
    gameTimeTraveler: "Időutazó",
    gameStreak: "6 napos sorozat 🔥",
    englishWord: "reluctant",
    englishMeaningT: "Nincs igazán kedve hozzá",
    englishMeaningEx: "„Nem volt kedve nekikezdeni a házi feladatnak.”",
    puzzleSentence: "A tengerész {elszánta} magát, hogy eléri a szigetet, a {vihar} ellenére sem {habozott} soha",
    dreamWord: "álom",
    dreamPos: "főnév",
    dreamMeaningFull: "képek és gondolatok, amelyek alvás közben suhannak át az elmén",
    dreamExample: "„Tegnap éjjel egy távoli utazásról álmodtam.”",
    dreamMeaningShort: "Képek és gondolatok, amelyek alvás közben suhannak át az elmén",
    dreamKidDef: "Az „álom” azok a képek és történetek, amelyek alvás közben futnak át a fejeden. Néha vidámak, néha furcsák, és ébredéskor elhalványulnak.",
    dreamEx1: "„Tegnap éjjel egy hosszú utazásról álmodtam.”",
    dreamEx2: "„Egy ijesztő álomból ébredt fel.”",
    dreamEx3: "„Nagy álma, hogy az űrbe repüljön.”",
    kidsLabel: "Gyerek mód",
    searchHint: "Írj be egy szót",
    tabMeanings: "Jelentések",
    tabPicture: "Kép",
    tabNotebook: "Füzet",
    searchTagline: "A gyerek beír egy szót, és ennyi.",
    quizQ: "Mit jelent az, hogy „álom”?",
    quizRight: "Képek és gondolatok alvás közben",
    quizWrong1: "Egyfajta sütemény",
    quizWrong2: "Egy hangszer",
  },
};
...
const EXAMPLE_WORDS: Record<string, [string, string, string]> = {
  ...
  zu: ["iphupho", "okugqamile", "ovilaphayo"],
  el: ["όνειρο", "ζωντανός", "διστακτικός"],
  vi: ["giấc mơ", "sống động", "ngần ngại"],
  fil: ["panaginip", "malinaw", "nag-aatubili"],
  af: ["droom", "helder", "huiwerig"],
  sw: ["ndoto", "wazi", "kusitasita"],
  "zh-CN": ["梦想", "鲜明", "犹豫"],
  "zh-TW": ["夢想", "鮮明", "猶豫"],
  ko: ["꿈", "생생한", "머뭇거리는"],
  th: ["ความฝัน", "ชัดเจน", "ลังเล"],
  bn: ["স্বপ্ন", "প্রাণবন্ত", "অনিচ্ছুক"],
  da: ["drøm", "levende", "tøvende"],
  hu: ["álom", "élénk", "vonakodó"],
};
...
function PuzzleMock({ lang, beforeLabel, afterLabel }: { lang: string; beforeLabel: string; afterLabel: string }) {
  // Tokenize into words, spaces and {hidden} words. A hidden word may be glued
  // to its neighbours (Hebrew "ה{סערה}", or space-less Japanese/Chinese/Thai
  // with several hidden words in one run), so match braces anywhere rather
  // than only whole space-separated tokens; that older rule printed the braces
  // literally in those languages (Gadi 2026-09-25).
  type Tok = string | { k: string } | { sp: true };
  const tokens: Tok[] = [];
  const src = famMock(lang).puzzleSentence;
  const pushText = (txt: string) => {
    for (const part of txt.split(/(\s+)/)) {
      if (!part) continue;
      tokens.push(/^\s+$/.test(part) ? { sp: true } : part);
    }
  };
  const re = /\{([^}]*)\}/g;
  let last = 0;
  ...
  while ((mt = re.exec(src))) {
    if (mt.index > last) pushText(src.slice(last, mt.index));
    tokens.push({ k: mt[1] });
    last = re.lastIndex;
  }
