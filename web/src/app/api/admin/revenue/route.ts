...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    summary: {
      ...
      trialingCardedMrrUsd: r.trialingCardedMrrUsd,
      trialingCardlessMrrUsd: r.trialingCardlessMrrUsd,
      trialingCardedCount: r.trialingCardedCount,
      trialingCardlessCount: r.trialingCardlessCount,
