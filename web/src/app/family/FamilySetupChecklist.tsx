...
const COPY: Record<string, Copy> = {
  ...
  zu: {
    ...
    step3: "Gcina i-Gadit esikrinini sasekhaya",
    step3sub: "Efonini, kuthebulethi noma ekhompyutheni, ukuze ihlale isekuthinteni okukodwa.",
    cta: "Xhuma",
    add: "Engeza",
    homeHelp: "Kumenyu yesiphequluli khetha \"Engeza Esikrinini Sasekhaya\" noma \"Faka\". Ekhompyutheni, isithonjana sokufaka sivela embhalweni wekheli.",
  ...
  el: {
    ...
    step3: "Αποθήκευσε το Gadit στην αρχική οθόνη",
    step3sub: "Σε κινητό, τάμπλετ ή υπολογιστή, ώστε να είναι πάντα ένα πάτημα μακριά.",
    cta: "Σύνδεση",
    add: "Προσθήκη",
    homeHelp: "Από το μενού του προγράμματος περιήγησης επίλεξε \"Προσθήκη στην αρχική οθόνη\" ή \"Εγκατάσταση\". Σε υπολογιστή, το εικονίδιο εγκατάστασης εμφανίζεται στη γραμμή διευθύνσεων.",
