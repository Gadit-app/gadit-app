...
const FIELD_META: Array<{ key: keyof LangCfg; he: string; en: string; hintHe?: string; hintEn?: string; big?: boolean }> = [
  ...
  { key: "commissionExplain", he: "הסבר העמלה", en: "Commission explanation", hintHe: "{year1} מחושב אוטומטית: העמלה של השותף בשנה הראשונה ממנוי משפחתי (האחוז שלו × ~240 ₪).", hintEn: "{year1} is auto-calculated: the partner's year-one commission on a Family plan (their rate × ~₪240 / $72).", big: true },
