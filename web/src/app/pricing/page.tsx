...
export default function PricingPage() {
  ...
  const PLANS = [
    ...
    },
    {
      ...
      features: [t.allBasicFeatures, t.unlimitedSearches, t.forKidsFeature, t.aiImages, t.useThisWordFeature],
              ...
              >
                ...
                <ul className="mb-7 flex-1 space-y-2.5 mx-auto w-fit" dir={dir}>
                  {plan.features.map((f, i) => (
                    <li key={i} className="flex gap-2 text-sm font-normal text-slate-600 items-start text-start">
