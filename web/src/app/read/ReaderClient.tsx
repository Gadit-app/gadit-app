...
const READER_COPY: Record<string, ReaderStrings> = {
  en: {
    ...
    hint: "Tap any word to see its meaning. Words you've opened turn green.",
  ...
  he: {
    ...
    hint: "לוחצים על כל מילה כדי לראות את ההסבר שלה. מילים שפתחת נצבעות בירוק.",
